...
__int64 sub_1402419E0()
{
	...
	if (qword_140C649B0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TelegraphDamage"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\TelegraphDamage.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140241A7C: variable 'v1' is possibly undefined
// 140AAB050: using guessed type wchar_t aTelegraphdamag[16];
// 140AAB1A8: using guessed type wchar_t aDbTelegraphdam[23];
// 140AD7A08: using guessed type wchar_t *off_140AD7A08;
...
// 140C647C8: using guessed type int dword_140C647C8;
// 140C649B0: using guessed type __int64 qword_140C649B0;
// 140C64B70: using guessed type int dword_140C64B70;
