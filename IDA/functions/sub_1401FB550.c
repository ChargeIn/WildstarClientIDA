...
//----- (00000001401FB550) ----------------------------------------------------
__int64 sub_1401FB550()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6A018, qword_140C63858);
	if (dword_140C65190 || (int)sub_1401FB340() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C651B8 + 40i64))(qword_140C651B8);
}
