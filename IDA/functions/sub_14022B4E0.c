...
__int64 sub_14022B4E0()
{
	...
	if (qword_140C64DF0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"QuestDirection"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\QuestDirection.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022B57C: variable 'v1' is possibly undefined
// 140A9E6B8: using guessed type wchar_t aQuestdirection[15];
// 140A9E918: using guessed type wchar_t aDbQuestdirecti[22];
// 140AD0188: using guessed type wchar_t *off_140AD0188;
