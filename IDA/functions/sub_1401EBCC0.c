...
__int64 sub_1401EBCC0()
{
	...
	if (qword_140C655F0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ArchiveEntry"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ArchiveEntry.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401EBD5C: variable 'v1' is possibly undefined
// 140A52248: using guessed type wchar_t aDbArchiveentry[20];
// 140A52430: using guessed type wchar_t aArchiveentry[13];
// 140ACE248: using guessed type wchar_t *off_140ACE248;
