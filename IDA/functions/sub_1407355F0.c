...
//----- (00000001407355F0) ----------------------------------------------------
__int64 __fastcall sub_1407355F0(_QWORD* a1)
{
	__int64 v1; // rdx
	...
	*(_QWORD*)v4 = v5;
	...
	if (v6 && (v7 = sub_1402074E0(*(_DWORD*)(v6 + 68))) != 0 && (v8 = sub_140203DA0(*(_DWORD*)(v7 + 12))) != 0)
		v9 = *(_DWORD*)(v8 + 8);
	else
		v9 = 63;
...
// 1407356B7: variable 'v11' is possibly undefined
