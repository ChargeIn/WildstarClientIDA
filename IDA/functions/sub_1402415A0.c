...
__int64 sub_1402415A0()
{
	...
	if (qword_140C63AC0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TaxiRoute"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\TaxiRoute.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024163C: variable 'v1' is possibly undefined
// 140AAADA0: using guessed type wchar_t aDbTaxirouteTbl[17];
// 140AAAE30: using guessed type wchar_t aTaxiroute[10];
// 140ACE210: using guessed type wchar_t *off_140ACE210;
...
// 140C63DE4: using guessed type int dword_140C63DE4;
// 140C64320: using guessed type int dword_140C64320;
// 140C65480: using guessed type int dword_140C65480;
