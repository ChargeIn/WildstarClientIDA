...
//----- (000000014022DD30) ----------------------------------------------------
__int64 sub_14022DD30()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6C9A8, qword_140C63858);
	if (dword_140C64774 || (int)sub_14022DB20() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64ED8 + 40i64))(qword_140C64ED8);
}
