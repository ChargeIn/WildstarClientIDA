...
//----- (0000000140209250) ----------------------------------------------------
__int64 sub_140209250()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6AB78, qword_140C63858);
	if (dword_140C643A8 || (int)sub_140209040() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C63CA0 + 40i64))(qword_140C63CA0);
}
