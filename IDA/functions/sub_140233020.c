...
__int64 sub_140233020()
{
	...
	if (qword_140C638A0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"SoundDirectionalAmbience"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\SoundDirectionalAmbience.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402330BC: variable 'v1' is possibly undefined
// 140A6F220: using guessed type wchar_t *off_140A6F220;
// 140AA2E40: using guessed type wchar_t aSounddirection[25];
// 140AA30C0: using guessed type wchar_t aDbSounddirecti[32];
...
// 140C65398: using guessed type int dword_140C65398;
// 140C65598: using guessed type int dword_140C65598;
