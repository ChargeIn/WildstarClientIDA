...
__int64 sub_1402182E0()
{
	...
	if (qword_140C64878)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ModelBonePriority"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ModelBonePriority.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021837C: variable 'v1' is possibly undefined
// 140A939A0: using guessed type wchar_t aModelboneprior[18];
// 140A93AB0: using guessed type wchar_t aDbModelbonepri[25];
// 140AD5908: using guessed type wchar_t *off_140AD5908;
...
// 140C63F74: using guessed type int dword_140C63F74;
// 140C64848: using guessed type int dword_140C64848;
