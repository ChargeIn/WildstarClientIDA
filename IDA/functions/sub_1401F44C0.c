...
__int64 sub_1401F44C0()
{
	...
	if (qword_140C65158)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ColorShift"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ColorShift.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F455C: variable 'v1' is possibly undefined
// 140A52C00: using guessed type wchar_t *off_140A52C00;
// 140A64308: using guessed type wchar_t aColorshift[11];
// 140A64568: using guessed type wchar_t aDbColorshiftTb[18];
...
// 140C63AD0: using guessed type int dword_140C63AD0;
// 140C64914: using guessed type int dword_140C64914;
