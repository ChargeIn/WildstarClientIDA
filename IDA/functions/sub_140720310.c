...
//----- (0000000140720310) ----------------------------------------------------
void __fastcall sub_140720310(__int64 a1, __int64* a2)
{
	__int64 v3; // rcx
	__int64* v4; // rdx
	int v5; // ebx
	...
	if ((__int64*)v3 == v4)
	{
		...
		*((_QWORD*)&v9 + 1) = TlsGetValue(dwTlsIndex);
		...
		v12 = 0x141E4F6B0i64;
		v11 = v9;
		v5 = sub_1401971E0(&dword_140C8B124, 1, &v12, &v10);
		TlsValue = &off_140B5E648;
...
// 1407203F1: variable 'v7' is possibly undefined
// 140B5E648: using guessed type __int64 (__fastcall *off_140B5E648)();
// 140C8B124: using guessed type _DWORD dword_140C8B124;
