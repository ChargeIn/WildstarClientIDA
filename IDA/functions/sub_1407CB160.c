...
//----- (00000001407CB160) ----------------------------------------------------
__int64 __fastcall sub_1407CB160(__int64 a1, unsigned __int64 a2, __int128* a3)
{
	__m128* v6; // rax
	__m128* v7; // rbx
	double v8; // xmm7_8
	...
	if (v6)
	{
		sub_140262D50((float*)(a1 + 3936), v6 + 8);
		*(_QWORD*)&v8 = (unsigned int)dword_140C3B438;
		*(float*)&v8 = *(float*)&dword_140C3B438 * 0.0055555557;
		v9 = v8;
		*(float*)&v8 = (float)(*(float*)&dword_140C3B438 * 0.0055555557) * *(float*)(a1 + 4868);
		*(float*)&v9 = *(float*)&v9 * *(float*)(a1 + 4864);
		...
		*v7 = v23;
		...
		{
			v36 = *v29++;
			*(__int128*)((char*)v29 + (_QWORD)v35 - 4656) = v36;
			--v30;
		} while (v30);
		(*(void(__fastcall**)(__int64))(*(_QWORD*)qword_140C65670 + 264i64))(qword_140C65670);
	}
	return (*(__int64(__fastcall**)(__int64, __int64, __int64))(*(_QWORD*)a1 + 312i64))(a1, 1i64, 1i64);
}
