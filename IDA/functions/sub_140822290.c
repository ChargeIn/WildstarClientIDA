//----- (0000000140822290) ----------------------------------------------------
__int64 __fastcall sub_140822290(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
	...
	if (v8 && v8 != -14)
		return v8;
	if (v8 == -14)
		qword_140C617D8 = 0i64;
	if (qword_140C617D8 && dword_140C617E0 != dword_140C60980[v9])
		qword_140C617D8 = 0i64;
	if (!qword_140C617D8 && v6 && nvapi_QueryInterface)
	{
		qword_140C617D8 = nvapi_QueryInterface(3978267753i64);
		dword_140C617E0 = dword_140C60980[v9];
	}
	if (qword_140C617D8)
	{
		v5 = (__int64(__fastcall*)(__int64, __int64, __int64, __int64, _QWORD))qword_140C617D8;
		v7 = 0i64;
		if (qword_140C60938)
			qword_140C60938(3978267753i64, &v7);
		v8 = v5(a1, a2, a3, a4, v5);
		if (qword_140C60940)
			qword_140C60940(3978267753i64, v7, v8);
		--dword_140C60970[v9];
		return v8;
	}
	else
...
// 140C617D8: using guessed type __int64 qword_140C617D8;
// 140C617E0: using guessed type int dword_140C617E0;
