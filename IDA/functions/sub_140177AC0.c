...
//----- (0000000140177AC0) ----------------------------------------------------
__int64 __fastcall sub_140177AC0(_QWORD* a1)
{
	__int64 result; // rax
	_DWORD* v3; // rax
	__int64 v4; // rax
	...
	if (result && (*(_BYTE*)(result + 432) & 0x10) == 0)
	{
		...
		if (v3 == dword_140A12138 || (v4 = (int)v3[2], (_DWORD)v4 == -1))
			...
			v5 = off_140A123B0[v4];
		v6 = (const char*)sub_140058780((__int64)a1, (unsigned __int64*)"%s expected, got %s", "ComboBox", v5);
