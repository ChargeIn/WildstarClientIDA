//----- (00000001407D8350) ----------------------------------------------------
unsigned __int64 __fastcall sub_1407D8350(__int64 a1, unsigned int a2, _OWORD* a3, __int64 a4, char* a5)
{
	__m128 v5; // xmm2
	unsigned int v6; // ebx
	...
	{
		result = (unsigned int)dword_140DC4F70;
		if ((dword_140DC4F70 & 1) == 0)
		{
			result = dword_140DC4F70 | 1u;
			dword_140DC4F70 |= 1u;
		}
		*a3 = xmmword_140DC4F80;
	}
	return result;
}
// 1407D840F: variable 'v5' is possibly undefined
// 140DC4F70: using guessed type int dword_140DC4F70;
// 140DC4F80: using guessed type __int128 xmmword_140DC4F80;
