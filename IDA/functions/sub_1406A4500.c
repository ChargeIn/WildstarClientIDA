//----- (00000001406A4500) ----------------------------------------------------
__int64 __fastcall sub_1406A4500(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Game.ICComm");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6;
	sub_140057020(a1, "ICComm", &off_140B70030);
	return 1i64;
}
// 1406A4613: variable 'v14' is possibly undefined
// 140B70030: using guessed type char *off_140B70030;
// 140C5D6E0: using guessed type char *off_140C5D6E0;
