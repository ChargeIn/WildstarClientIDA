//----- (000000014080F340) ----------------------------------------------------
__int64 __fastcall sub_14080F340(__int64 a1, __int64 a2)
{
	...
	if (v6 && v6 != -14)
		return v6;
	if (v6 == -14)
		qword_140C60BD8 = 0i64;
	if (qword_140C60BD8 && dword_140C60BE0 != dword_140C60980[v7])
		qword_140C60BD8 = 0i64;
	if (!qword_140C60BD8 && v4 && nvapi_QueryInterface)
	{
		qword_140C60BD8 = nvapi_QueryInterface(464619300i64);
		dword_140C60BE0 = dword_140C60980[v7];
	}
	if (qword_140C60BD8)
	{
		v3 = (__int64(__fastcall*)(__int64, __int64))qword_140C60BD8;
		v5 = 0i64;
		if (qword_140C60938)
			qword_140C60938(464619300i64, &v5);
		v6 = v3(a1, a2);
		if (qword_140C60940)
			qword_140C60940(464619300i64, v5, v6);
		--dword_140C60970[v7];
		return v6;
	}
	else
...
// 140C60BD8: using guessed type __int64 qword_140C60BD8;
// 140C60BE0: using guessed type int dword_140C60BE0;
