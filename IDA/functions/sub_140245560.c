...
__int64 sub_140245560()
{
	...
	if (qword_140C64828)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TradeskillProficiency"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\TradeskillProficiency.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402455FC: variable 'v1' is possibly undefined
// 140AACA80: using guessed type wchar_t aTradeskillprof[22];
// 140AACC40: using guessed type wchar_t aDbTradeskillpr[29];
// 140ACD0E0: using guessed type wchar_t *off_140ACD0E0;
...
// 140C640C4: using guessed type int dword_140C640C4;
// 140C64630: using guessed type int dword_140C64630;
