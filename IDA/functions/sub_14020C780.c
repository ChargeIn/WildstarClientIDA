...
__int64 sub_14020C780()
{
	...
	if (qword_140C63F00)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ItemRandomStatGroup"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ItemRandomStatGroup.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020C81C: variable 'v1' is possibly undefined
// 140A8FD70: using guessed type wchar_t aDbItemrandomst_0[27];
// 140A8FE40: using guessed type wchar_t aItemrandomstat_0[20];
// 140ACDCF8: using guessed type wchar_t *off_140ACDCF8;
...
// 140C63F98: using guessed type int dword_140C63F98;
// 140C640F4: using guessed type int dword_140C640F4;
