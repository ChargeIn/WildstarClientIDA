...
__int64 sub_14020E100()
{
	...
	if (qword_140C65040)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ItemRuneSlotRandomization"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\ItemRuneSlotRandomization.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020E19C: variable 'v1' is possibly undefined
// 140A632A0: using guessed type wchar_t *off_140A632A0;
// 140A908E8: using guessed type wchar_t aItemruneslotra[26];
// 140A909F0: using guessed type wchar_t aDbItemruneslot[33];
...
// 140C639EC: using guessed type int dword_140C639EC;
// 140C63BEC: using guessed type int dword_140C63BEC;
// 140C63D44: using guessed type int dword_140C63D44;
