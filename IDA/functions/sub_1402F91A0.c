//----- (00000001402F91A0) ----------------------------------------------------
__int64 __fastcall sub_1402F91A0(_QWORD* a1, int* a2, unsigned __int64 a3)
{
	__int64 v3; // rax
	__int64 result; // rax
	...
	if ((_DWORD)result)
	{
		...
		for (i = 0i64; i < a1[110]; ++i)
		{
			...
			result = v10;
			if (v10 == a3)
				result = (*(__int64(__fastcall**)(_QWORD*, __int64, __int64*))(*a1 + 584i64))(a1, v9, &v13);
		}
	}
	else
	{
		...
		if (result)
			return (__int64)sub_1402EF570((_QWORD*)result, (__int64)a1, a2, a3);
	}
	return result;
}
// 1402F91A0: using guessed type int var_38[4];
