...
//----- (0000000140211EF0) ----------------------------------------------------
__int64 sub_140211EF0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6B2B0, qword_140C63858);
	if (dword_140C653EC || (int)sub_140211CE0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64278 + 40i64))(qword_140C64278);
}
