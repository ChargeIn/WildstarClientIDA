//----- (000000014081DDE0) ----------------------------------------------------
__int64 __fastcall sub_14081DDE0(__int64 a1)
{
	...
	if (v5 && v5 != -14)
		return v5;
	if (v5 == -14)
		qword_140C61518 = 0i64;
	if (qword_140C61518 && dword_140C61520 != dword_140C60980[v6])
		qword_140C61518 = 0i64;
	if (!qword_140C61518 && v3 && nvapi_QueryInterface)
	{
		qword_140C61518 = nvapi_QueryInterface(1543937955i64);
		dword_140C61520 = dword_140C60980[v6];
	}
	if (qword_140C61518)
	{
		v2 = (__int64(__fastcall*)(__int64))qword_140C61518;
		v4 = 0i64;
		if (qword_140C60938)
			qword_140C60938(1543937955i64, &v4);
		v5 = v2(a1);
		if (qword_140C60940)
			qword_140C60940(1543937955i64, v4, v5);
		--dword_140C60970[v6];
		return v5;
	}
	else
...
// 140C61518: using guessed type __int64 qword_140C61518;
// 140C61520: using guessed type int dword_140C61520;
