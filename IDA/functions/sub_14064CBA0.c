...
//----- (000000014064CBA0) ----------------------------------------------------
__int64 __fastcall sub_14064CBA0(__int64 a1)
{
	float* v2; // rsi
	__int64 v4; // rbx
	__int64 v5; // rax
	...
	if (v2)
	{
		...
		*(_QWORD*)(a1 + 16) += 16i64;
		v6 = sub_1400578C0(a1);
		v7 = sub_140462EF0(v2).m128_f32[0] * 100.0;
...
// 14064CD2A: variable 'v16' is possibly undefined
// 14064CD50: variable 'v18' is possibly undefined
// 14064CD62: variable 'v19' is possibly undefined
// 140B2BDD0: using guessed type wchar_t aNamount_17[8];
// 140B2BDE0: using guessed type wchar_t aEdrstate_10[9];
