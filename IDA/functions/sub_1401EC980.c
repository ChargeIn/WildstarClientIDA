...
__int64 sub_1401EC980()
{
	...
	if (qword_140C64650)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"AttributeMilestoneGroup"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\AttributeMilestoneGroup.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401ECA1C: variable 'v1' is possibly undefined
// 140A55128: using guessed type wchar_t aDbAttributemil[31];
// 140A55220: using guessed type wchar_t aAttributemiles[24];
// 140A68308: using guessed type wchar_t *off_140A68308;
...
// 140C639A8: using guessed type int dword_140C639A8;
// 140C639B4: using guessed type int dword_140C639B4;
