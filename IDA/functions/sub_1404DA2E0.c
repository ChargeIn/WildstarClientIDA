...
//----- (00000001404DA2E0) ----------------------------------------------------
void __fastcall sub_1404DA2E0(__int64 a1, int a2)
{
	int v4; // eax
	...
	(*(void(__fastcall**)(__int64, bool))(*(_QWORD*)qword_140C89D90 + 64i64))(qword_140C89D90, a2 != 0);
	if (a2)
	{
		v4 = dword_140C45E40;
		...
		{
			(*(void(__fastcall**)(__int64, __int64))(*(_QWORD*)qword_140C89D90 + 64i64))(qword_140C89D90, 2i64);
		}
		else
		{
			v5 = 0;
			...
			v8 = 0i64;
			v7 = sub_1404DA3C0;
			sub_140195960(a1 + 5360, dword_140C65904, (__int64)&v5, 4);
		}
	}
}
