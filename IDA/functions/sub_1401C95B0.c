//----- (00000001401C95B0) ----------------------------------------------------
_WORD* __fastcall sub_1401C95B0(_WORD* a1, __m128i* a2)
{
	__m128i si128; // xmm7
	__m128i v3; // xmm3
	__m128i v4; // xmm2
	...
	__m128i v10; // xmm0
	__m128i v11; // xmm2
	__m128i v13; // [rsp+0h] [rbp-38h] BYREF
	...
	if (_mm_movemask_epi8(v6))
	{
		...
		v10 = _mm_sub_epi32(_mm_load_si128((const __m128i*) & xmmword_140B7A9D0), _mm_srli_epi32(v3, 0x17u));
		v13.m128i_i64[1] = v9.m128i_i64[1];
		v13.m128i_i32[0] = (unsigned int)_mm_cvtsi128_si32(v9) >> _mm_cvtsi128_si32(v10);
		v13.m128i_i32[1] = (unsigned __int32)v9.m128i_i32[1] >> _mm_cvtsi128_si32(_mm_srli_si128(v10, 4));
		v8 = _mm_or_si128(_mm_and_si128(_mm_load_si128(&v13), v6), _mm_andnot_si128(v6, v8));
	}
	v11 = _mm_or_si128(
		_mm_andnot_si128(
			v4,
		...
		v7);
	*a1 = _mm_extract_epi16(v11, 0);
	a1[1] = _mm_extract_epi16(v11, 2);
	return a1;
}
