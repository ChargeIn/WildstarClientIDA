...
__int64 sub_14023CD60()
{
	...
	if (qword_140C64558)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4ValidTargets"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4ValidTargets.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023CDFC: variable 'v1' is possibly undefined
// 140AA8B00: using guessed type wchar_t aDbSpell4validt[26];
// 140AA8B38: using guessed type wchar_t aSpell4validtar[19];
// 140ACDBB0: using guessed type wchar_t *off_140ACDBB0;
