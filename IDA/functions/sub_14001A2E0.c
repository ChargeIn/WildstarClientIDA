...
//----- (000000014001A2E0) ----------------------------------------------------
int** __fastcall sub_14001A2E0(__int64 a1, int** a2, __int64* a3, unsigned int* a4)
{
	__int64 v4; // rax
	__int64 v5; // r8
	int** result; // rax
	...
	if (v5 == v4)
	{
		...
		if (*(_DWORD*)(v12 + 32) >= *a4)
		{
			v16 = *(int**)sub_14001AE60(a1, (__int64)v21, a4);
			result = a2;
			*a2 = v16;
		}
		else
		{
			if (v12 == v4 || *a4 < *(_DWORD*)(v12 + 32))
			{
				v13 = sub_14018B280(48i64, 0);
				if (v13 != (int*)-32i64)
					sub_14001AF60((__int64)(v13 + 8), (__int64)a4);
				*(_QWORD*)(v12 + 16) = v13;
				v15 = *(_QWORD*)(a1 + 8);
				if (v12 == v15)
				{
	...
	else
	{
		...
		if (*(_DWORD*)(v17 + 32) >= *a4 || *a4 >= *(_DWORD*)(v5 + 32))
		{
			v10 = a4;
		LABEL_7:
			v11 = *(int**)sub_14001AE60(a1, (__int64)v21, v10);
			result = a2;
			*a2 = v11;
			return result;
		}
		...
		if (*(_QWORD*)(v17 + 24))
			goto LABEL_5;
		sub_14001AD60(a1, a2, 0i64, v17, a4);
		return a2;
	}
	return result;
}
