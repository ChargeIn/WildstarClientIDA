...
//----- (0000000140080D70) ----------------------------------------------------
__int64 __fastcall sub_140080D70(__int64 a1, _QWORD* a2, __int64 a3)
{
	__int64 result; // rax
	...
	if ((int)result >= 0)
	{
		...
		if ((int)result >= 0)
		{
			...
			if ((int)result >= 0)
			{
				result = sub_14006C090(a1, (_DWORD*)(a3 + 20), 2ui64);
				if ((int)result >= 0)
				{
					...
					if ((int)result >= 0)
					{
						...
						if ((int)result >= 0)
						{
							...
							if ((int)result >= 0)
							{
								...
								if ((int)result >= 0)
									return sub_14006C090(a1, (_DWORD*)(a3 + 40), 0xEui64);
							}
						}
					}
				}
