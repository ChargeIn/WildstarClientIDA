...
//----- (0000000140238730) ----------------------------------------------------
__int64 sub_140238730()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6D268, qword_140C63858);
	if (dword_140C644E4 || (int)sub_140238520() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C63BA0 + 40i64))(qword_140C63BA0);
}
