...
__int64 sub_140249960()
{
	...
	if (qword_140C64100)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Wind"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Wind.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402499FC: variable 'v1' is possibly undefined
// 140AAF060: using guessed type wchar_t aDbWindTbl[12];
// 140AAF078: using guessed type wchar_t aWind[5];
// 140AD80C8: using guessed type wchar_t *off_140AD80C8;
...
// 140C63E48: using guessed type int dword_140C63E48;
// 140C64014: using guessed type int dword_140C64014;
