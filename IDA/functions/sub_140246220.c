...
__int64 sub_140246220()
{
	...
	if (qword_140C64160)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TradeskillTier"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\TradeskillTier.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402462BC: variable 'v1' is possibly undefined
// 140A7D200: using guessed type wchar_t *off_140A7D200;
// 140AAD4C8: using guessed type wchar_t aDbTradeskillti[22];
// 140AAD4F8: using guessed type wchar_t aTradeskilltier[15];
...
// 140C64034: using guessed type int dword_140C64034;
// 140C64160: using guessed type __int64 qword_140C64160;
// 140C650F0: using guessed type int dword_140C650F0;
