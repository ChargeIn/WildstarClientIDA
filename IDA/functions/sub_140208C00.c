...
__int64 sub_140208C00()
{
	...
	if (qword_140C644F8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"InputActionCategory"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\InputActionCategory.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140208C9C: variable 'v1' is possibly undefined
// 140A8DBB8: using guessed type wchar_t aDbInputactionc[27];
// 140A8DBF0: using guessed type wchar_t aInputactioncat[20];
// 140AD0A30: using guessed type wchar_t *off_140AD0A30;
...
// 140C64404: using guessed type int dword_140C64404;
// 140C644F8: using guessed type __int64 qword_140C644F8;
// 140C655C4: using guessed type int dword_140C655C4;
