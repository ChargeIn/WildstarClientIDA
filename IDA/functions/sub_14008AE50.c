//----- (000000014008AE50) ----------------------------------------------------
__int64 __fastcall sub_14008AE50(__int64 a1, unsigned int* a2)
{
	__int64 v2; // r8
			...
			(unsigned __int64)(8i64 * (*(_QWORD*)(v16 + 24) - *(_QWORD*)(v16 + 32)) - v18) >= 0x40))
	{
		...
		*v20 |= (unsigned __int64)(unsigned int)v19 << *(_QWORD*)(a1 + 16);
		v21 = *(_QWORD*)(a1 + 16);
		if (((v21 + 15) & 0xFFFFFFFFFFFFFFF8ui64) > 0x40)
			*(_BYTE*)(*(_QWORD*)(v16 + 32) + 8i64) = v19 >> (64 - (unsigned __int8)v21);
		*(_QWORD*)(v16 + 32) += (unsigned __int64)(*(_QWORD*)(a1 + 16) + 8i64) >> 3;
		*(_QWORD*)(a1 + 16) &= 7ui64;
	}
	else
	{
		result = sub_140336470(a1, v17, 8ui64);
		if ((int)result < 0)
			return result;
	}
	return sub_1400A7110(a1, a2[3], 0xBui64);
}
