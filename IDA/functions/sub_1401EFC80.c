...
__int64 sub_1401EFC80()
{
	...
	if (qword_140C63F68)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"CharacterCreation"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\CharacterCreation.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401EFD1C: variable 'v1' is possibly undefined
// 140A5E320: using guessed type wchar_t aDbCharactercre[25];
// 140A5E568: using guessed type wchar_t aCharactercreat_3[18];
// 140A70EA8: using guessed type wchar_t *off_140A70EA8;
...
// 140C64A34: using guessed type int dword_140C64A34;
// 140C64BC8: using guessed type int dword_140C64BC8;
