...
//----- (000000014021C070) ----------------------------------------------------
__int64 sub_14021C070()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6BB00, qword_140C63858);
	if (dword_140C65184 || (int)sub_14021BE60() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C63CE8 + 40i64))(qword_140C63CE8);
}
