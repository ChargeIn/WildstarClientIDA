...
__int64 sub_140249520()
{
	...
	if (qword_140C64BA0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"WaterSurfaceEffect"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\WaterSurfaceEffect.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402495BC: variable 'v1' is possibly undefined
// 140AAED30: using guessed type wchar_t aDbWatersurface[26];
// 140AAED68: using guessed type wchar_t aWatersurfaceef[19];
// 140ADAEB8: using guessed type wchar_t *off_140ADAEB8;
...
// 140C63CF4: using guessed type int dword_140C63CF4;
// 140C645FC: using guessed type int dword_140C645FC;
