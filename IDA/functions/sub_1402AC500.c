//----- (00000001402AC500) ----------------------------------------------------
void __fastcall sub_1402AC500(__int64 a1)
{
	__int64 v2; // rbx
	...
	LABEL_9:
		(*(void(__fastcall**)(_QWORD, _QWORD, __int64))(**(_QWORD**)(*(_QWORD*)(a1 + 16) + 6352i64) + 224i64))(
...
// 1402AC58A: variable 'v4' is possibly undefined
