...
__int64 __fastcall sub_140499A20(__int64 a1, int a2)
{
	...
	*(_DWORD*)(a1 + 16) = a2;
	...
	v5 = a2 ^ v2;
	if (v5 < 0 && a2 < 0)
		Apollo_LUAEvent(*(_QWORD*)(qword_140C65898 + 29504), "GalacticArchiveArticleAdded", L"G", *(_QWORD*)(a1 + 8));
	v6 = 1;
	for (i = 0; i < 0x10; ++i)
	{
		if ((v6 & v5) != 0 && (v6 & a2) != 0)
		{
			...
			if (v8)
			{
				Apollo_LUAEvent(*(_QWORD*)(qword_140C65898 + 29504), "GalacticArchiveEntryAdded", "Gg", *(_QWORD*)(a1 + 8), v8);
