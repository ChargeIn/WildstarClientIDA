...
__int64 sub_1402129A0()
{
	...
	if (qword_140C63AB8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"MapZoneHex"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\MapZoneHex.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140212A3C: variable 'v1' is possibly undefined
// 140A80D88: using guessed type wchar_t *off_140A80D88;
// 140A92138: using guessed type wchar_t aMapzonehex[11];
// 140A92220: using guessed type wchar_t aDbMapzonehexTb[18];
...
// 140C63B54: using guessed type int dword_140C63B54;
// 140C63E08: using guessed type int dword_140C63E08;
// 140C63E28: using guessed type int dword_140C63E28;
