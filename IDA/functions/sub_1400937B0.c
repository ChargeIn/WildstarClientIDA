//----- (00000001400937B0) ----------------------------------------------------
__int64 __fastcall sub_1400937B0(__int64 a1, unsigned int* a2)
{
	__int64 v2; // r8
	...
	result = sub_1400A8C80(a1, (int*)a2 + 1);
	if ((int)result >= 0)
	{
		v11 = *(_QWORD*)(a1 + 8);
		v12 = a2[3];
		...
		result = sub_1400A8C80(a1, (int*)a2 + 4);
		if ((int)result >= 0)
			return sub_1400A89E0(a1, (float*)a2 + 6);
	}
	return result;
}
