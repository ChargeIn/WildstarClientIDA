...
__int64 sub_140207F40()
{
	...
	if (qword_140C64A00)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"HousingWarplotPlugInfo"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\HousingWarplotPlugInfo.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140207FDC: variable 'v1' is possibly undefined
// 140A8D6E8: using guessed type wchar_t aHousingwarplot[23];
// 140A8D868: using guessed type wchar_t aDbHousingwarpl[30];
// 140AD1D88: using guessed type wchar_t *off_140AD1D88;
...
// 140C63984: using guessed type int dword_140C63984;
// 140C63D40: using guessed type int dword_140C63D40;
