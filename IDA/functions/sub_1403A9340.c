...
//----- (00000001403A9340) ----------------------------------------------------
__int64 __fastcall sub_1403A9340(__int64 a1, int* a2)
{
	__int64 v4; // rbx
	int* v5; // rax
	int* v6; // rax
	...
	*((_QWORD*)&v20 + 1) = v5;
	...
	v10 = (int*)sub_14034BDD0(v9, 751825);
	if (v10)
	{
		v12 = 0i64;
		if (*(_WORD*)v10)
	...
	Apollo_LUAEvent(*(_QWORD*)(a1 + 29504), "MountUnlocked", L"i", (unsigned int)*a2);
	if ((_QWORD)v20)
		sub_14018B900(v20, 0);
	sub_1400B7390(&v16);
	return 0i64;
}
// 1403A942C: variable 'v9' is possibly undefined
// 1403A947D: variable 'v11' is possibly undefined
// 1409EE6AC: using guessed type wchar_t aI_6[2];
...
// 1403A9340: using guessed type char var_E0[8];
