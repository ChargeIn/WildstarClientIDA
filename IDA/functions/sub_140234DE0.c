...
__int64 sub_140234DE0()
{
	...
	if (qword_140C64D40)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"SoundReplaceDescription"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\SoundReplaceDescription.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140234E7C: variable 'v1' is possibly undefined
// 140AA3828: using guessed type wchar_t aDbSoundreplace_0[31];
// 140AA3868: using guessed type wchar_t aSoundreplacede[24];
// 140AD9E18: using guessed type wchar_t *off_140AD9E18;
...
// 140C63F94: using guessed type int dword_140C63F94;
// 140C6442C: using guessed type int dword_140C6442C;
