...
//----- (000000014021E270) ----------------------------------------------------
__int64 sub_14021E270()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6BCC0, qword_140C63858);
	if (dword_140C65668 || (int)sub_14021E060() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64CD8 + 40i64))(qword_140C64CD8);
}
