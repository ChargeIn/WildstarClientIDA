//----- (0000000140632090) ----------------------------------------------------
int** __fastcall sub_140632090(__int64 a1, int** a2, __int64* a3, int* a4)
{
	__int64 v4; // rax
	__int64 v5; // r8
	int** result; // rax
	...
	if (v5 == v4)
	{
		...
		{
			v19 = *(int**)sub_140632D20(a1, (__int64)v24, a4);
			result = a2;
			*a2 = v19;
		}
		else
	...
	else
	{
		...
		if (*(_DWORD*)(v20 + 32) >= *a4 || *a4 >= *(_DWORD*)(v5 + 32))
		{
			v10 = a4;
		LABEL_7:
			v11 = *(int**)sub_140632D20(a1, (__int64)v24, v10);
			result = a2;
			*a2 = v11;
			return result;
		}
		...
		if (*(_QWORD*)(v20 + 24))
			goto LABEL_5;
		sub_140632C10(a1, a2, 0i64, v20, a4);
		return a2;
	}
	return result;
}
