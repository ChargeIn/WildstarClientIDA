...
__int64 sub_1401F0500()
{
	...
	if (qword_140C64A08)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"CharacterCustomization"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\CharacterCustomization.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F059C: variable 'v1' is possibly undefined
// 140A4BD30: using guessed type wchar_t *off_140A4BD30;
// 140A5ED08: using guessed type wchar_t aDbCharactercus[30];
// 140A5EE10: using guessed type wchar_t aCharactercusto[23];
