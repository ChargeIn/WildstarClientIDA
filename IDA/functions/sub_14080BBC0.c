...
//----- (000000014080BBC0) ----------------------------------------------------
__int64 __fastcall sub_14080BBC0(__int64 a1)
{
	...
	if (v5 && v5 != -14)
		return v5;
	if (v5 == -14)
		qword_140C609A8 = 0i64;
	if (qword_140C609A8 && dword_140C609B0 != dword_140C60980[v6])
		qword_140C609A8 = 0i64;
	if (!qword_140C609A8 && v3 && nvapi_QueryInterface)
	{
		qword_140C609A8 = nvapi_QueryInterface(17121189i64);
		dword_140C609B0 = dword_140C60980[v6];
	}
	if (qword_140C609A8)
	{
		v2 = (__int64(__fastcall*)(__int64))qword_140C609A8;
		v4 = 0i64;
		if (qword_140C60938)
			qword_140C60938(17121189i64, &v4);
		v5 = v2(a1);
		if (qword_140C60940)
			qword_140C60940(17121189i64, v4, v5);
		--dword_140C60970[v6];
		return v5;
	}
	else
...
// 140C609A8: using guessed type __int64 qword_140C609A8;
// 140C609B0: using guessed type int dword_140C609B0;
