...
__int64 sub_14023EB20()
{
	...
	if (qword_140C64570)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spline2"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spline2.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023EBBC: variable 'v1' is possibly undefined
// 140A7D668: using guessed type wchar_t *off_140A7D668;
// 140AAA008: using guessed type wchar_t aDbSpline2Tbl[15];
// 140AAA088: using guessed type wchar_t aSpline2[8];
...
// 140C63870: using guessed type int dword_140C63870;
...
// 140C64CCC: using guessed type int dword_140C64CCC;
