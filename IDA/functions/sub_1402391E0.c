...
__int64 sub_1402391E0()
{
	...
	if (qword_140C651C8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4HitResults"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4HitResults.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023927C: variable 'v1' is possibly undefined
// 140A82E30: using guessed type wchar_t *off_140A82E30;
// 140AA7AF8: using guessed type wchar_t aDbSpell4hitres[24];
// 140AA7B28: using guessed type wchar_t aSpell4hitresul[17];
...
// 140C646C0: using guessed type int dword_140C646C0;
// 140C64D68: using guessed type int dword_140C64D68;
