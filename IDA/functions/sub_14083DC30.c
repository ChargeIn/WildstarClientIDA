//----- (000000014083DC30) ----------------------------------------------------
__int64 __fastcall sub_14083DC30(__int64 a1, __int64 a2, __int64 a3, struct _RTL_CRITICAL_SECTION* a4)
{
	unsigned int v8; // ebx
	unsigned int* v9; // rax
	__int64 v10; // r14
	...
	v14 = sub_14086C7C0(v12, 1);
	v13 = v14;
	if (v14)
	{
		v8 = sub_14086DCF0(v14, v10, *(_DWORD*)(a2 + 1));
		if (v8 != 1)
