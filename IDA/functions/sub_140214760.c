...
__int64 sub_140214760()
{
	...
	if (qword_140C65580)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"MapZoneWorldJoin"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\MapZoneWorldJoin.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402147FC: variable 'v1' is possibly undefined
// 140A6F290: using guessed type wchar_t *off_140A6F290;
// 140A92820: using guessed type wchar_t aDbMapzoneworld[24];
// 140A92850: using guessed type wchar_t aMapzoneworldjo[17];
...
// 140C64F48: using guessed type int dword_140C64F48;
// 140C65264: using guessed type int dword_140C65264;
