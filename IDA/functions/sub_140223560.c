...
__int64 sub_140223560()
{
	...
	if (qword_140C64658)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathSoldierAssassinate"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PathSoldierAssassinate.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402235FC: variable 'v1' is possibly undefined
// 140A99830: using guessed type wchar_t aDbPathsoldiera_0[30];
// 140A99870: using guessed type wchar_t aPathsoldierass[23];
// 140AD03A8: using guessed type wchar_t *off_140AD03A8;
...
// 140C638B4: using guessed type int dword_140C638B4;
...
// 140C6517C: using guessed type int dword_140C6517C;
