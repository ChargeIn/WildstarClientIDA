...
__int64 sub_1401F9140()
{
	...
	if (qword_140C65028)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Creature2OutfitInfo"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Creature2OutfitInfo.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F91DC: variable 'v1' is possibly undefined
// 140A793D8: using guessed type wchar_t *off_140A793D8;
// 140A803D8: using guessed type wchar_t aCreature2outfi[20];
// 140A80660: using guessed type wchar_t aDbCreature2out[27];
