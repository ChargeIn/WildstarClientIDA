//----- (0000000140018BC0) ----------------------------------------------------
void** __fastcall sub_140018BC0(char* a1)
{
	void** result; // rax
	int* v2; // rbx
	__int64 v3; // rax
	...
	if (a1)
	{
		...
		if ((int*)((char*)v4 + 2 * v5))
			*((_WORD*)v4 + v5) = 0;
		v6 = *(_QWORD*)(*(_QWORD*)(qword_140C635F0 + 5864) + 40i64);
		if (v6)
		{
...
// 1409E0AC0: using guessed type wchar_t aAuthntoken[13];
// 140C3FE68: using guessed type __int64 qword_140C3FE68;
// 140C3FE70: using guessed type __int64 qword_140C3FE70;
// 140C635F0: using guessed type __int64 qword_140C635F0;
// 140018BC0: using guessed type char var_68[8];
// 140018BC0: using guessed type char var_48[8];
