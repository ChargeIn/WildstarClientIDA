//----- (0000000140441080) ----------------------------------------------------
int** __fastcall sub_140441080(__int64 a1, int** a2, __int64* a3, unsigned int* a4)
{
	__int64 v4; // rax
	__int64 v5; // r8
	int** result; // rax
	...
	if (v5 == v4)
	{
		...
		{
			v18 = *(int**)sub_1404414C0(a1, (__int64)v23, a4);
			result = a2;
			*a2 = v18;
		}
		else
		{
			...
			{
				v15 = sub_140441270(v12, (__int64)a4);
				*(_QWORD*)(v13 + 16) = v15;
				v17 = *(_QWORD*)(a1 + 8);
				if (v13 == v17)
				{
			...
			{
				v14 = sub_140441270(v12, (__int64)a4);
				*(_QWORD*)(v13 + 24) = v14;
				v15 = v14;
				v16 = *(_QWORD*)(a1 + 8);
	...
	else
	{
		...
		if (*(_DWORD*)(v19 + 32) >= *a4 || *a4 >= *(_DWORD*)(v5 + 32))
		{
			v10 = a4;
		LABEL_7:
			v11 = *(int**)sub_1404414C0(a1, (__int64)v23, v10);
			result = a2;
			*a2 = v11;
			return result;
		}
		...
		if (*(_QWORD*)(v19 + 24))
			goto LABEL_5;
		sub_1404412F0(a1, a2, 0i64, v19, a4);
		return a2;
	}
	return result;
}
