...
__int64 sub_140243BE0()
{
	...
	if (qword_140C64E30)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TradeskillBonus"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\TradeskillBonus.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140243C7C: variable 'v1' is possibly undefined
// 140AAC0C0: using guessed type wchar_t aTradeskillbonu[16];
// 140AAC1D8: using guessed type wchar_t aDbTradeskillbo[23];
// 140ADAC28: using guessed type wchar_t *off_140ADAC28;
...
// 140C63AF8: using guessed type int dword_140C63AF8;
// 140C64478: using guessed type int dword_140C64478;
