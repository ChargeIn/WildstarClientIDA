...
//----- (0000000140736180) ----------------------------------------------------
__int64 __fastcall sub_140736180(_QWORD* a1)
{
	int v1; // eax
	__int64 v2; // rcx
	__int64 v3; // rax
	...
	if (v3)
	{
		...
		v7 = *(_QWORD*)(v3 + 184);
		v8 = *(_QWORD*)(v3 + 192);
		sub_1403F4900(qword_140C65898, 0x531u, (__int64)&v6);
	}
	else
	{
		v5 = 3;
		Apollo_LUAEvent(*(_QWORD*)(qword_140C65898 + 29504), "HousingResult", byte_1409EBB6C, &unk_1409F9244, v5);
	}
	return 0i64;
}
// 140736190: variable 'v2' is possibly undefined
