//----- (00000001407ABE40) ----------------------------------------------------
__int64 __fastcall sub_1407ABE40(__int64 a1, unsigned int a2, unsigned int a3, int a4, int a5, unsigned int a6)
{
	int v6; // edi
	unsigned int v7; // ebx
	...
	while (1)
	{
		...
		v13 = *(_QWORD*)(a1 + 8 * (a6 + 2 * (v12 + 8i64 * a3)) + 65696);
		if (v13)
			break;
	LABEL_12:
		if ((_DWORD)v12)
...
// 1407ABEA0: conditional instruction was optimized away because rax.8 is in (==1|==8)
