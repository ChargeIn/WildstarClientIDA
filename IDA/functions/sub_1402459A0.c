...
__int64 sub_1402459A0()
{
	...
	if (qword_140C63868)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TradeskillSchematic2"))
	{
...
// 140245A3C: variable 'v1' is possibly undefined
// 140AAD040: using guessed type wchar_t aDbTradeskillsc[28];
// 140AAD078: using guessed type wchar_t aTradeskillsche[21];
// 140AD36B8: using guessed type wchar_t *off_140AD36B8;
...
// 140C63AC8: using guessed type int dword_140C63AC8;
// 140C64E74: using guessed type int dword_140C64E74;
