...
__int64 sub_140211020()
{
	...
	if (qword_140C64188)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"LocalizedText"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\LocalizedText.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402110BC: variable 'v1' is possibly undefined
// 140A4BAB0: using guessed type wchar_t *off_140A4BAB0;
// 140A91940: using guessed type wchar_t aDbLocalizedtex[21];
// 140A91970: using guessed type wchar_t aLocalizedtext[14];
