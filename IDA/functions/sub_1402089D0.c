//----- (00000001402089D0) ----------------------------------------------------
__int64 sub_1402089D0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6AB08, qword_140C63858);
	if (dword_140C64954 || (int)sub_1402087C0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64350 + 40i64))(qword_140C64350);
}
