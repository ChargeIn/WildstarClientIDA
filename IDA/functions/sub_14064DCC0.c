//----- (000000014064DCC0) ----------------------------------------------------
__int64 __fastcall sub_14064DCC0(__int64 a1)
{
	float* v2; // rsi
	__int64 v4; // rbx
	__int64 v5; // rax
	...
	if (v2)
	{
		...
		*(_QWORD*)(a1 + 16) += 16i64;
		v6 = sub_1400578C0(a1);
		v7 = sub_140464240((__int64)v2, v2[453] + v2[423], v2[575] + v2[659]).m128_f32[0] * 100.0;
		...
		*(_QWORD*)(a1 + 16) -= 48i64;
		sub_140464430((__int64)v2, v2[453] + v2[423]);
...
// 14064DE7A: variable 'v16' is possibly undefined
// 14064DEA0: variable 'v18' is possibly undefined
// 14064DEB2: variable 'v19' is possibly undefined
// 140B2BF60: using guessed type wchar_t aNamount_23[8];
// 140B2BF70: using guessed type wchar_t aEdrstate_16[9];
