//----- (000000014058C130) ----------------------------------------------------
void __fastcall sub_14058C130(__int64 a1)
{
	__int64 v2; // rdx
	__int64 v3; // rax
	__int16* v4; // rax
	...
	if (v3)
	{
		...
		if ((unsigned __int64)((v32 - v31) >> 5) >= 2)
		{
			...
			sub_14057EA50(v5, v19 - 1, v18);
		}
		else
		{
			v17 = sub_14034BDD0(v14, 282592);
...
// 14058C34C: variable 'v14' is possibly undefined
// 140B1F570: using guessed type wchar_t asc_140B1F570[5];
// 140C658A0: using guessed type __int64 qword_140C658A0;
// 140C7DE18: using guessed type __int64 qword_140C7DE18;
// 140C7DE20: using guessed type __int64 qword_140C7DE20;
// 14058C130: using guessed type char var_88[8];
// 14058C130: using guessed type char var_68[8];
// 14058C130: using guessed type char var_48[8];
