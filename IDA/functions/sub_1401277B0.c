//----- (00000001401277B0) ----------------------------------------------------
void __fastcall sub_1401277B0(__int64 a1)
{
	__int64 v2; // rcx
	int i; // r10d
	__int64 v4; // r8
	...
	for (i = 255; i > -1; i = v7 - 1)
	{
		...
		do
		{
			v6 = sub_1401280F0((float)(int)v4 * 1.4078431, v5, (float)(255 - *(_DWORD*)(a1 + 1048)) * 0.0039215689);
...
// 14012784C: variable 'v9' is possibly undefined
// 140127853: variable 'v10' is possibly undefined
// 140127865: variable 'v7' is possibly undefined
// 140127868: variable 'v8' is possibly undefined
// 1401278EF: variable 'v16' is possibly undefined
// 1401278F6: variable 'v17' is possibly undefined
// 1401278FD: variable 'v14' is possibly undefined
// 140127900: variable 'v15' is possibly undefined
