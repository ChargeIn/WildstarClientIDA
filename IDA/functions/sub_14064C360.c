//----- (000000014064C360) ----------------------------------------------------
__int64 __fastcall sub_14064C360(__int64 a1)
{
	float* v2; // rsi
	__int64 v4; // rbx
	__int64 v5; // rax
	...
	if (v2)
	{
		...
		*(_QWORD*)(a1 + 16) += 16i64;
		v6 = sub_1400578C0(a1);
		v7 = sub_1404621B0(v2).m128_f32[0] * 100.0;
...
// 14064C4EA: variable 'v16' is possibly undefined
// 14064C510: variable 'v18' is possibly undefined
// 14064C522: variable 'v19' is possibly undefined
// 140B2BE20: using guessed type wchar_t aNamount_15[8];
// 140B2BE30: using guessed type wchar_t aEdrstate_8[9];
