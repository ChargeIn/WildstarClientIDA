...
__int64 sub_1402010C0()
{
	...
	if (qword_140C64E50)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"GenericUnlockEntry"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\GenericUnlockEntry.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020115C: variable 'v1' is possibly undefined
// 140A5B710: using guessed type wchar_t *off_140A5B710;
// 140A8A008: using guessed type wchar_t aDbGenericunloc[26];
// 140A8A040: using guessed type wchar_t aGenericunlocke[19];
...
// 140C6415C: using guessed type int dword_140C6415C;
// 140C64C20: using guessed type int dword_140C64C20;
// 140C64DE0: using guessed type int dword_140C64DE0;
