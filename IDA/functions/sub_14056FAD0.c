...
__int64 sub_14056FAD0()
{
		...
		if (v2 != v1)
		{
			do
			{
				...
				if ((*(unsigned int(__fastcall**)(_QWORD*))(*v3 + 40i64))(v3))
					Apollo_LUAEvent(*(_QWORD*)(qword_140C65898 + 29504), "PlayerPathMissionActivate", byte_1409ECCAC, v3[6]);
				v4 = v2[3];
				if (v4)
				{
					v2 = (_QWORD*)v2[3];
	...
	return Apollo_LUAEvent(*(_QWORD*)(qword_140C65898 + 29504), "PlayerPathRefresh", byte_1409D10FF);
}
