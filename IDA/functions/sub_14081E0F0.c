//----- (000000014081E0F0) ----------------------------------------------------
__int64 __fastcall sub_14081E0F0(__int64 a1)
{
	...
	if (v5 && v5 != -14)
		return v5;
	if (v5 == -14)
		qword_140C61538 = 0i64;
	if (qword_140C61538 && dword_140C61540 != dword_140C60980[v6])
		qword_140C61538 = 0i64;
	if (!qword_140C61538 && v3 && nvapi_QueryInterface)
	{
		qword_140C61538 = nvapi_QueryInterface(3383291116i64);
		dword_140C61540 = dword_140C60980[v6];
	}
	if (qword_140C61538)
	{
		v2 = (__int64(__fastcall*)(__int64))qword_140C61538;
		v4 = 0i64;
		if (qword_140C60938)
			qword_140C60938(3383291116i64, &v4);
		v5 = v2(a1);
		if (qword_140C60940)
			qword_140C60940(3383291116i64, v4, v5);
		--dword_140C60970[v6];
		return v5;
	}
	else
...
// 140C61538: using guessed type __int64 qword_140C61538;
// 140C61540: using guessed type int dword_140C61540;
