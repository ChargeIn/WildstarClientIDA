...
__int64 sub_14021BE60()
{
	...
	if (qword_140C63CE8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"MTXCategory"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Redacted.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021BEFC: variable 'v1' is possibly undefined
// 140A94AE8: using guessed type wchar_t aDbRedactedTbl[16];
// 140A94B70: using guessed type wchar_t aMtxcategory[12];
// 140ACC588: using guessed type wchar_t *off_140ACC588;
...
// 140C64994: using guessed type int dword_140C64994;
// 140C65184: using guessed type int dword_140C65184;
// 140C65404: using guessed type int dword_140C65404;
