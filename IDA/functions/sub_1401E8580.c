...
__int64 sub_1401E8580()
{
	...
	if (qword_140C64A98)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"AccountCurrencyType"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\AccountCurrencyType.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401E861C: variable 'v1' is possibly undefined
// 140ACD8C8: using guessed type wchar_t *off_140ACD8C8;
// 140AE3010: using guessed type wchar_t aDbAccountcurre[27];
// 140AE3318: using guessed type wchar_t aAccountcurrenc[20];
...
// 140C64714: using guessed type int dword_140C64714;
// 140C64A98: using guessed type __int64 qword_140C64A98;
// 140C64D5C: using guessed type int dword_140C64D5C;
