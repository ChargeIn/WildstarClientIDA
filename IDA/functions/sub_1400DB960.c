...
//----- (00000001400DB960) ----------------------------------------------------
__int64 __fastcall sub_1400DB960(_QWORD* a1)
{
	__int64 v1; // rsi
	...
	if (v6)
	{
		...
		if (v8 != 3)
		{
			if (v8 != 4 || !sub_14005AC80((char*)(*v7 + 32), (unsigned __int64*)&v16))
			{
				v9 = 0.0;
				goto LABEL_13;
			}
	...
	LABEL_13:
		...
		{
			v10 = v9;
			v12[2] = *(float*)&dword_140C63664 - (float)-(float)(v10 * *(float*)(*(_QWORD*)v12 + 112i64));
		}
	}
	return 0i64;
}
