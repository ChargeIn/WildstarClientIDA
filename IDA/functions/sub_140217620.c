...
__int64 sub_140217620()
{
	...
	if (qword_140C64220)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"MissileRevolverTrack"))
	{
...
// 1402176BC: variable 'v1' is possibly undefined
// 140A93868: using guessed type wchar_t aDbMissilerevol[28];
// 140A938A0: using guessed type wchar_t aMissilerevolve[21];
// 140ADA998: using guessed type wchar_t *off_140ADA998;
...
// 140C63BC8: using guessed type int dword_140C63BC8;
// 140C64004: using guessed type int dword_140C64004;
