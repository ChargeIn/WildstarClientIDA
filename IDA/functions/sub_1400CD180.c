...
//----- (00000001400CD180) ----------------------------------------------------
__int64 __fastcall sub_1400CD180(__int64* a1, __int64 a2)
{
	__int64 result; // rax
	int* v5; // rax
	_QWORD* v6; // rbx
	...
	if (!a2)
		return (*(__int64(__fastcall**)(__int64*))(*a1 + 488))(a1);
	...
	result = (*(__int64(__fastcall**)(__int64*, _QWORD*))(*a1 + 488))(a1, v6);
	if (v6)
