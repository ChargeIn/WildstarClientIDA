...
__int64 sub_14022CA20()
{
	...
	if (qword_140C63B78)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"QuestGroup"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\QuestGroup.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022CABC: variable 'v1' is possibly undefined
// 140A9EDA0: using guessed type wchar_t aDbQuestgroupTb[18];
// 140A9EDC8: using guessed type wchar_t aQuestgroup[11];
// 140AE28F0: using guessed type wchar_t *off_140AE28F0;
...
// 140C641DC: using guessed type int dword_140C641DC;
// 140C64778: using guessed type int dword_140C64778;
