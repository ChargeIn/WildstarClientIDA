...
__int64 sub_1401F5A00()
{
	...
	if (qword_140C64F50)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"CostumeSpecies"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\CostumeSpecies.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F5A9C: variable 'v1' is possibly undefined
// 140A65600: using guessed type wchar_t aCostumespecies[15];
// 140A65EE0: using guessed type wchar_t aDbCostumespeci[22];
// 140A77460: using guessed type wchar_t *off_140A77460;
...
// 140C6463C: using guessed type int dword_140C6463C;
// 140C64B58: using guessed type int dword_140C64B58;
