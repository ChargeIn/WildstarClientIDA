...
__int64 sub_14024C3E0()
{
	...
	if (qword_140C64D28)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"WorldWaterEnvironment"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\WorldWaterEnvironment.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024C47C: variable 'v1' is possibly undefined
// 140AB01F8: using guessed type wchar_t aWorldwaterenvi[22];
// 140AB03C0: using guessed type wchar_t aDbWorldwateren[29];
// 140AD9DE0: using guessed type wchar_t *off_140AD9DE0;
...
// 140C63B98: using guessed type int dword_140C63B98;
// 140C64D28: using guessed type __int64 qword_140C64D28;
// 140C65588: using guessed type int dword_140C65588;
