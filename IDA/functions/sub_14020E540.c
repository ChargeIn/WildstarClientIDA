...
__int64 sub_14020E540()
{
	...
	if (qword_140C648E8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ItemSlot"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ItemSlot.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020E5DC: variable 'v1' is possibly undefined
// 140A5A0B8: using guessed type wchar_t *off_140A5A0B8;
// 140A90A58: using guessed type wchar_t aItemslot[9];
// 140A90BA8: using guessed type wchar_t aDbItemslotTbl[16];
...
// 140C647E0: using guessed type int dword_140C647E0;
// 140C648E8: using guessed type __int64 qword_140C648E8;
// 140C64AD4: using guessed type int dword_140C64AD4;
