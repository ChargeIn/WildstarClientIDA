...
__int64 sub_140224660()
{
	...
	if (qword_140C63B28)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathSoldierTowerDefense"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PathSoldierTowerDefense.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402246FC: variable 'v1' is possibly undefined
// 140A655C8: using guessed type wchar_t *off_140A655C8;
// 140A99E80: using guessed type wchar_t aDbPathsoldiert[31];
// 140A99F88: using guessed type wchar_t aPathsoldiertow[24];
...
// 140C6409C: using guessed type int dword_140C6409C;
// 140C64284: using guessed type int dword_140C64284;
// 140C6530C: using guessed type int dword_140C6530C;
