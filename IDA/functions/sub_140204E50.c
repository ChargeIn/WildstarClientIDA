...
//----- (0000000140204E50) ----------------------------------------------------
__int64 sub_140204E50()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6A7F8, qword_140C63858);
	if (dword_140C63E00 || (int)sub_140204C40() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64C88 + 40i64))(qword_140C64C88);
}
