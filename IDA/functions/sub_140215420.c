...
__int64 sub_140215420()
{
	...
	if (qword_140C64D10)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"MatchingRandomReward"))
	{
...
// 1402154BC: variable 'v1' is possibly undefined
// 140A92E40: using guessed type wchar_t aMatchingrandom[21];
// 140A92FF8: using guessed type wchar_t aDbMatchingrand[28];
// 140AD57A8: using guessed type wchar_t *off_140AD57A8;
...
// 140C65440: using guessed type int dword_140C65440;
// 140C6558C: using guessed type int dword_140C6558C;
// 140C65658: using guessed type int dword_140C65658;
