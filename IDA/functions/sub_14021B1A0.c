...
__int64 sub_14021B1A0()
{
	...
	if (qword_140C653B0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ModelSequenceByWeapon"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\ModelSequenceByWeapon.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021B23C: variable 'v1' is possibly undefined
// 140A5F0C0: using guessed type wchar_t *off_140A5F0C0;
// 140A94800: using guessed type wchar_t aDbModelsequenc_2[29];
// 140A94840: using guessed type wchar_t aModelsequenceb_1[22];
...
// 140C63C7C: using guessed type int dword_140C63C7C;
// 140C648A0: using guessed type int dword_140C648A0;
// 140C64970: using guessed type int dword_140C64970;
