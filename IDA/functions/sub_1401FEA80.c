...
__int64 sub_1401FEA80()
{
	...
	if (qword_140C63958)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"EpisodeQuest"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\EpisodeQuest.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401FEB1C: variable 'v1' is possibly undefined
// 140A891F0: using guessed type wchar_t aDbEpisodequest[20];
// 140A89278: using guessed type wchar_t aEpisodequest[13];
// 140AD5568: using guessed type wchar_t *off_140AD5568;
...
// 140C6447C: using guessed type int dword_140C6447C;
// 140C648AC: using guessed type int dword_140C648AC;
