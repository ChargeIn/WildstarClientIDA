...
__int64 sub_14020A580()
{
	...
	if (qword_140C644B0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ItemBudget"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ItemBudget.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020A61C: variable 'v1' is possibly undefined
// 140A86CA0: using guessed type wchar_t *off_140A86CA0;
// 140A8EAF0: using guessed type wchar_t aDbItembudgetTb[18];
// 140A8EB18: using guessed type wchar_t aItembudget[11];
