...
//----- (000000014024A830) ----------------------------------------------------
__int64 sub_14024A830()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6E148, qword_140C63858);
	if (dword_140C640C0 || (int)sub_14024A620() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C65660 + 40i64))(qword_140C65660);
}
