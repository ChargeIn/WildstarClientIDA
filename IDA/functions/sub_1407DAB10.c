//----- (00000001407DAB10) ----------------------------------------------------
__int64 __fastcall sub_1407DAB10(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, char* a5)
{
	unsigned int v5; // r9d
	__int64 result; // rax
	__int64 v10; // rcx
	...
	{
		result = (unsigned int)dword_140DC51B0;
		if ((dword_140DC51B0 & 1) == 0)
		{
			result = dword_140DC51B0 | 1u;
			dword_140DC51B0 |= 1u;
		}
		*(_DWORD*)a3 = dword_140DC51C0;
		*(_DWORD*)(a3 + 4) = dword_140DC51C4;
		*(_OWORD*)(a3 + 16) = xmmword_140DC51D0;
		*(_DWORD*)(a3 + 32) = dword_140DC51E0;
	}
	return result;
}
// 140DC51B0: using guessed type int dword_140DC51B0;
// 140DC51C0: using guessed type int dword_140DC51C0;
// 140DC51C4: using guessed type int dword_140DC51C4;
// 140DC51D0: using guessed type __int128 xmmword_140DC51D0;
// 140DC51E0: using guessed type int dword_140DC51E0;
