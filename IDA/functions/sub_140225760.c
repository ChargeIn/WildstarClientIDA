...
__int64 sub_140225760()
{
	...
	if (qword_140C64208)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Prerequisite"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Prerequisite.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402257FC: variable 'v1' is possibly undefined
// 140A9A500: using guessed type wchar_t aDbPrerequisite[20];
// 140A9A528: using guessed type wchar_t aPrerequisite[13];
// 140AD14C8: using guessed type wchar_t *off_140AD14C8;
...
// 140C64444: using guessed type int dword_140C64444;
// 140C647D0: using guessed type int dword_140C647D0;
// 140C64FCC: using guessed type int dword_140C64FCC;
