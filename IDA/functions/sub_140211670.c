//----- (0000000140211670) ----------------------------------------------------
__int64 sub_140211670()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6B240, qword_140C63858);
	if (dword_140C642E8 || (int)sub_140211460() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64508 + 40i64))(qword_140C64508);
}
