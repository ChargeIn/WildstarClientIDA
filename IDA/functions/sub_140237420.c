...
__int64 sub_140237420()
{
	...
	if (qword_140C64A28)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4ClientMissile"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4ClientMissile.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402374BC: variable 'v1' is possibly undefined
// 140AA6380: using guessed type wchar_t aDbSpell4client[27];
// 140AA6458: using guessed type wchar_t aSpell4clientmi[20];
// 140AD6658: using guessed type wchar_t *off_140AD6658;
