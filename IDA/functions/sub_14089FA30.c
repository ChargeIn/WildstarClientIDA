...
//----- (000000014089FA30) ----------------------------------------------------
__int64 __fastcall sub_14089FA30(__int64 a1, __int64 a2, float* a3)
{
	double v3; // xmm6_8
	float v7; // xmm0_4
	float v8; // xmm11_4
