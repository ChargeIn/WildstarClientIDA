//----- (000000014022F6B0) ----------------------------------------------------
__int64 sub_14022F6B0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6CAF8, qword_140C63858);
	if (dword_140C653FC || (int)sub_14022F4A0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C65228 + 40i64))(qword_140C65228);
}
