...
//----- (00000001406F1C70) ----------------------------------------------------
__int64 __fastcall sub_1406F1C70(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Game.CREDDExchangeOrder");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6;
	sub_140057020(a1, "CREDDExchangeOrder", &off_140B72550);
	return 1i64;
}
// 1406F1D83: variable 'v14' is possibly undefined
// 140B72550: using guessed type char *off_140B72550;
// 140C5EB30: using guessed type char *off_140C5EB30;
