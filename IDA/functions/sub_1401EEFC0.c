...
__int64 sub_1401EEFC0()
{
	...
	if (qword_140C645B8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"CCStates"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\CCStates.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401EF05C: variable 'v1' is possibly undefined
// 140A5CC18: using guessed type wchar_t aCcstates[9];
// 140A5D018: using guessed type wchar_t aDbCcstatesTbl[16];
// 140A77658: using guessed type wchar_t *off_140A77658;
