//----- (000000014075DE60) ----------------------------------------------------
__int64 __fastcall sub_14075DE60(_QWORD* a1, __int64 a2)
{
	__int64 v3; // rdi
	__int64 result; // rax
	...
	if ((_DWORD)result)
	{
		...
		*(_QWORD*)(v3 + 16) += 16i64;
		...
		v12 = v10;
		v36 = v10;
		v13 = *(__int64**)(*(_QWORD*)(a2 + 88) + 8 * (v5 % ((v11 - *(_QWORD*)(a2 + 88)) >> 3)));
		if (!v13)
			goto LABEL_7;
...
// 14075DF7E: conditional instruction was optimized away because rax.8!=0
// 14075DF5C: variable 'v17' is possibly undefined
// 14075DF5C: variable 'v15' is possibly undefined
// 14075E01E: variable 'v25' is possibly undefined
// 14075E01E: variable 'v26' is possibly undefined
// 14075E02C: variable 'v27' is possibly undefined
// 14075E06C: variable 'v30' is possibly undefined
// 14075E06C: variable 'v31' is possibly undefined
// 14075E088: variable 'v32' is possibly undefined
// 140B4CB58: using guessed type wchar_t aStrname_106[8];
// 140B4CB68: using guessed type wchar_t aNid_40[4];
