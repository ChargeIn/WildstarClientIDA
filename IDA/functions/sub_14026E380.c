//----- (000000014026E380) ----------------------------------------------------
__int64 __fastcall sub_14026E380(__int64 a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, __int64* a9)
{
	int* v15; // rbx
...
LABEL_10:
	v20 = sub_14018B280(376i64, 0);
	if (v20)
		v21 = sub_140291C80((__int64)v20, a1);
	else
		v21 = 0i64;
	v22 = sub_1402920F0(v21, a2, a3, a4, a5, a6, a7, a8);
	if (v22 >= 0)
	{
		*a9 = v21;
		v22 = 0;
