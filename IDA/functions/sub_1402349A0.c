...
__int64 sub_1402349A0()
{
	...
	if (qword_140C64240)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"SoundReplace"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\SoundReplace.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140234A3C: variable 'v1' is possibly undefined
// 140AA36D8: using guessed type wchar_t aDbSoundreplace[20];
// 140AA3700: using guessed type wchar_t aSoundreplace[13];
// 140AD2BB8: using guessed type wchar_t *off_140AD2BB8;
...
// 140C649C8: using guessed type int dword_140C649C8;
// 140C6525C: using guessed type int dword_140C6525C;
