...
__int64 sub_1401F77C0()
{
	...
	if (qword_140C65640)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Creature2ActionSet"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Creature2ActionSet.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F785C: variable 'v1' is possibly undefined
// 140A64270: using guessed type wchar_t *off_140A64270;
// 140A7D088: using guessed type wchar_t aDbCreature2act_0[26];
// 140A7D0C0: using guessed type wchar_t aCreature2actio_0[19];
...
// 140C64514: using guessed type int dword_140C64514;
// 140C65350: using guessed type int dword_140C65350;
