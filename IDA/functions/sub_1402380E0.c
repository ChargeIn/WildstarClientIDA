...
__int64 sub_1402380E0()
{
	...
	if (qword_140C65328)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4EffectModification"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\Spell4EffectModification.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023817C: variable 'v1' is possibly undefined
// 140AA6840: using guessed type wchar_t aDbSpell4effect[32];
// 140AA6880: using guessed type wchar_t aSpell4effectmo[25];
// 140ACC440: using guessed type wchar_t *off_140ACC440;
...
// 140C640E4: using guessed type int dword_140C640E4;
// 140C6428C: using guessed type int dword_140C6428C;
// 140C64328: using guessed type int dword_140C64328;
