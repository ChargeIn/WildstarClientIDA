...
__int64 sub_140204800()
{
	...
	if (qword_140C63A70)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"HousingContributionType"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\HousingContributionType.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020489C: variable 'v1' is possibly undefined
// 140A8B2D0: using guessed type wchar_t aDbHousingcontr[31];
// 140A8B310: using guessed type wchar_t aHousingcontrib[24];
// 140ACC278: using guessed type wchar_t *off_140ACC278;
...
// 140C63D24: using guessed type int dword_140C63D24;
// 140C64AF0: using guessed type int dword_140C64AF0;
