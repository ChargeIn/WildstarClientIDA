...
__int64 sub_140214FE0()
{
	...
	if (qword_140C641F0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"MatchingGameMap"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\MatchingGameMap.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021507C: variable 'v1' is possibly undefined
// 140A92C78: using guessed type wchar_t aMatchinggamema[16];
// 140A92DB8: using guessed type wchar_t aDbMatchinggame_0[23];
// 140AD0D18: using guessed type wchar_t *off_140AD0D18;
...
// 140C644F4: using guessed type int dword_140C644F4;
// 140C64BE0: using guessed type int dword_140C64BE0;
