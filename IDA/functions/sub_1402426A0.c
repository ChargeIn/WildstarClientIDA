...
__int64 sub_1402426A0()
{
	...
	if (qword_140C653C0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TrackingSlot"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\TrackingSlot.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024273C: variable 'v1' is possibly undefined
// 140A64858: using guessed type wchar_t *off_140A64858;
// 140AAB380: using guessed type wchar_t aTrackingslot[13];
// 140AAB510: using guessed type wchar_t aDbTrackingslot[20];
