...
//----- (000000014064ACE0) ----------------------------------------------------
__int64 __fastcall sub_14064ACE0(__int64 a1)
{
	float* v2; // rsi
	__int64 v4; // rbx
	__int64 v5; // rax
	...
	if (v2)
	{
		...
		*(_QWORD*)(a1 + 16) += 16i64;
		v6 = sub_1400578C0(a1);
		v7 = sub_140460670(v2).m128_f32[0] * 100.0;
...
// 14064AE6A: variable 'v16' is possibly undefined
// 14064AE90: variable 'v18' is possibly undefined
// 14064AEA2: variable 'v19' is possibly undefined
// 140B2BCF8: using guessed type wchar_t aNamount_7[8];
// 140B2BD08: using guessed type wchar_t aEdrstate_0[9];
