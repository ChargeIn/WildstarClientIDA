...
__int64 sub_1401FE640()
{
	...
	if (qword_140C64F40)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Episode"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Episode.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401FE6DC: variable 'v1' is possibly undefined
// 140A89040: using guessed type wchar_t aEpisode[8];
// 140A89168: using guessed type wchar_t aDbEpisodeTbl[15];
// 140ACDB78: using guessed type wchar_t *off_140ACDB78;
...
// 140C64C00: using guessed type int dword_140C64C00;
// 140C64F40: using guessed type __int64 qword_140C64F40;
// 140C65604: using guessed type int dword_140C65604;
