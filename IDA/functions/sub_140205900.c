...
__int64 sub_140205900()
{
	...
	if (qword_140C63C90)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"HousingNeighborhoodInfo"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\HousingNeighborhoodInfo.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020599C: variable 'v1' is possibly undefined
// 140A8B9C8: using guessed type wchar_t aDbHousingneigh[31];
// 140A8BA08: using guessed type wchar_t aHousingneighbo[24];
// 140AD7958: using guessed type wchar_t *off_140AD7958;
...
// 140C65000: using guessed type int dword_140C65000;
// 140C6555C: using guessed type int dword_140C6555C;
