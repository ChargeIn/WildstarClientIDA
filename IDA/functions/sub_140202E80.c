...
__int64 sub_140202E80()
{
	...
	if (qword_140C65030)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Hazard"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Hazard.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140202F1C: variable 'v1' is possibly undefined
// 140A884C8: using guessed type wchar_t *off_140A884C8;
// 140A8AB50: using guessed type wchar_t aDbHazardTbl[14];
// 140A8AB70: using guessed type wchar_t aHazard[7];
...
// 140C639C8: using guessed type int dword_140C639C8;
// 140C63B5C: using guessed type int dword_140C63B5C;
// 140C63D74: using guessed type int dword_140C63D74;
