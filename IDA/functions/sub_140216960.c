...
__int64 sub_140216960()
{
	...
	if (qword_140C64908)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"MaterialSet"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\MaterialSet.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402169FC: variable 'v1' is possibly undefined
// 140A93448: using guessed type wchar_t aMaterialset[12];
// 140A93580: using guessed type wchar_t aDbMaterialsetT[19];
// 140AD7E88: using guessed type wchar_t *off_140AD7E88;
...
// 140C64C40: using guessed type int dword_140C64C40;
// 140C6561C: using guessed type int dword_140C6561C;
