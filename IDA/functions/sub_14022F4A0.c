...
__int64 sub_14022F4A0()
{
	...
	if (qword_140C65228)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"RewardPropertyPremiumModifier"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\RewardPropertyPremiumModifier.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022F53C: variable 'v1' is possibly undefined
// 140A63A20: using guessed type wchar_t *off_140A63A20;
// 140AA16A0: using guessed type wchar_t aDbRewardproper_0[37];
// 140AA17B0: using guessed type wchar_t aRewardproperty_0[30];
...
// 140C649BC: using guessed type int dword_140C649BC;
// 140C65150: using guessed type int dword_140C65150;
