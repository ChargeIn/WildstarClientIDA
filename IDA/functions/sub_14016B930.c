//----- (000000014016B930) ----------------------------------------------------
__int64 __fastcall sub_14016B930(_QWORD* a1)
{
	__int64 v1; // rbx
...
LABEL_7:
	...
	{
		v8 = *(_QWORD**)(v1 + 400);
		v9 = (char*)sub_14018F0E0(&v14, word_1409DCDE4)[1];
		...
		v12 = v17;
		if (v11)
			sub_140109710((__int64*)(v7 + 1168), v11 + 240, v17, 0);
		if (v12)
			sub_14018B900((__int64)v12, 0);
	}
	return 0i64;
}
// 1409DCDE4: using guessed type unsigned __int16 word_1409DCDE4[12];
