...
//----- (0000000140098740) ----------------------------------------------------
__int64 __fastcall sub_140098740(__int64 a1, unsigned __int16** a2)
{
	__int64 v2; // r8
	...
	result = sub_1403360D0(a1, a2[1], (__int64)&a2[1][2 * *((unsigned int*)a2 + 1)]);
	if ((int)result >= 0)
	{
		result = sub_1400A7110(a1, *((_DWORD*)a2 + 4), 0xEui64);
		if ((int)result >= 0)
			return sub_1400A7110(a1, *((_DWORD*)a2 + 5), 0x20ui64);
	}
	return result;
}
