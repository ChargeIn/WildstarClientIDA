...
__int64 sub_14022F060()
{
	...
	if (qword_140C651A8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"RewardProperty"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\RewardProperty.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022F0FC: variable 'v1' is possibly undefined
// 140AA14C0: using guessed type wchar_t aRewardproperty[15];
// 140AA1640: using guessed type wchar_t aDbRewardproper[22];
// 140AD9BC0: using guessed type wchar_t *off_140AD9BC0;
