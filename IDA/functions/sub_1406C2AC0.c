//----- (00000001406C2AC0) ----------------------------------------------------
__int64 __fastcall sub_1406C2AC0(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	...
	if (v3)
	{
		...
		*(_DWORD*)(v4 + 8) = v5[2];
		...
		if (v6)
		{
			...
			sub_140773F70(v3 + 1024, (__int64)&v15);
			v6 = v13;
		}
		v12 = off_140B56A08;
		if (v14)
...
// 1406C2B05: variable 'v2' is possibly undefined
// 1406C2B8D: variable 'v9' is possibly undefined
// 1406C2BDC: variable 'v7' is possibly undefined
