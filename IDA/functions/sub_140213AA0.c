...
__int64 sub_140213AA0()
{
	...
	if (qword_140C645E8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"MapZoneNemesisRegion"))
	{
...
// 140213B3C: variable 'v1' is possibly undefined
// 140A92568: using guessed type wchar_t aDbMapzonenemes[28];
// 140A92628: using guessed type wchar_t aMapzonenemesis[21];
// 140ACBDC0: using guessed type wchar_t *off_140ACBDC0;
...
// 140C63D20: using guessed type int dword_140C63D20;
// 140C645E8: using guessed type __int64 qword_140C645E8;
// 140C647A4: using guessed type int dword_140C647A4;
