...
//----- (000000014060B630) ----------------------------------------------------
void __fastcall sub_14060B630(int* a1)
{
	__int64 v2; // rdi
	__int64 v3; // rdx
	__int64 v4; // rbx
	...
	*(_QWORD*)(v2 + 16) += 16i64;
	...
	v9 = qword_140C65898;
	*(_QWORD*)(v2 + 16) -= 16i64;
	Apollo_LUAEvent(*(_QWORD*)(v9 + 29504), "CombatLogHealingAbsorption", "T", (unsigned int)v4, v11);
	sub_1400579E0(v2, v10, v4);
}
// 14060B6F9: variable 'v8' is possibly undefined
// 14060B73C: variable 'v10' is possibly undefined
// 140B263A0: using guessed type wchar_t aNamount_1[8];
