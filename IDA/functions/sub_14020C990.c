...
//----- (000000014020C990) ----------------------------------------------------
__int64 sub_14020C990()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6AE50, qword_140C63858);
	if (dword_140C64868 || (int)sub_14020C780() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C63F00 + 40i64))(qword_140C63F00);
}
