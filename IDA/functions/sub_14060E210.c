...
//----- (000000014060E210) ----------------------------------------------------
void __fastcall sub_14060E210(int* a1)
{
	__int64 v2; // rdi
	__int64 v3; // rdx
	__int64 v4; // rbx
	...
	*(_QWORD*)(v2 + 16) += 16i64;
	...
	v9 = qword_140C65898;
	*(_QWORD*)(v2 + 16) -= 16i64;
	Apollo_LUAEvent(*(_QWORD*)(v9 + 29504), "CombatLogModifyInterruptArmor", "T", (unsigned int)v4, v11);
	sub_1400579E0(v2, v10, v4);
}
// 14060E2D9: variable 'v8' is possibly undefined
// 14060E31C: variable 'v10' is possibly undefined
// 140B26C38: using guessed type wchar_t aNamount_2[8];
