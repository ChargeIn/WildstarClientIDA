...
//----- (00000001401FDB90) ----------------------------------------------------
__int64 sub_1401FDB90()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6A210, qword_140C63858);
	if (dword_140C64648 || (int)sub_1401FD980() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64040 + 40i64))(qword_140C64040);
}
