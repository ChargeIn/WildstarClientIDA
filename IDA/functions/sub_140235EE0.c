...
__int64 sub_140235EE0()
{
	...
	if (qword_140C63C88)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"SoundZoneKit"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\SoundZoneKit.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140235F7C: variable 'v1' is possibly undefined
// 140A70F50: using guessed type wchar_t *off_140A70F50;
// 140AA3CF8: using guessed type wchar_t aSoundzonekit[13];
// 140AA3F10: using guessed type wchar_t aDbSoundzonekit[20];
