...
//----- (000000014064AFB0) ----------------------------------------------------
__int64 __fastcall sub_14064AFB0(__int64 a1)
{
	float* v2; // rsi
	__int64 v4; // rbx
	__int64 v5; // rax
	...
	if (v2)
	{
		...
		*(_QWORD*)(a1 + 16) += 16i64;
		v6 = sub_1400578C0(a1);
		v7 = sub_140460A30(v2).m128_f32[0] * 100.0;
...
// 14064B13A: variable 'v16' is possibly undefined
// 14064B160: variable 'v18' is possibly undefined
// 14064B172: variable 'v19' is possibly undefined
// 140B2BCD0: using guessed type wchar_t aNamount_8[8];
// 140B2BCE0: using guessed type wchar_t aEdrstate_1[9];
