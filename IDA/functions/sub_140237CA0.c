...
__int64 sub_140237CA0()
{
	...
	if (qword_140C65590)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4CCConditions"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4CCConditions.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140237D3C: variable 'v1' is possibly undefined
// 140A5B4E0: using guessed type wchar_t *off_140A5B4E0;
// 140AA65A8: using guessed type wchar_t aDbSpell4cccond[26];
// 140AA6688: using guessed type wchar_t aSpell4cccondit[19];
...
// 140C63E10: using guessed type int dword_140C63E10;
// 140C642EC: using guessed type int dword_140C642EC;
// 140C6504C: using guessed type int dword_140C6504C;
