...
__int64 sub_14024BFA0()
{
	...
	if (qword_140C643C8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"WorldSocket"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\WorldSocket.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024C03C: variable 'v1' is possibly undefined
// 140A752B8: using guessed type wchar_t *off_140A752B8;
// 140AB0188: using guessed type wchar_t aWorldsocket[12];
// 140AB0250: using guessed type wchar_t aDbWorldsocketT[19];
...
// 140C63AEC: using guessed type int dword_140C63AEC;
// 140C643C8: using guessed type __int64 qword_140C643C8;
// 140C64F7C: using guessed type int dword_140C64F7C;
