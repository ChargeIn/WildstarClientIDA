...
__int64 sub_140234560()
{
	...
	if (qword_140C655B8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"SoundParameter"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\SoundParameter.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402345FC: variable 'v1' is possibly undefined
// 140AA35B8: using guessed type wchar_t aDbSoundparamet[22];
// 140AA3618: using guessed type wchar_t aSoundparameter[15];
// 140AD2018: using guessed type wchar_t *off_140AD2018;
...
// 140C63C78: using guessed type int dword_140C63C78;
// 140C649E0: using guessed type int dword_140C649E0;
