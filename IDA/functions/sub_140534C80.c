//----- (0000000140534C80) ----------------------------------------------------
__int64 __fastcall sub_140534C80(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rdi
	...
	if (v3)
	{
		...
		*(_DWORD*)(v4 + 8) = v5[2];
		...
		if (v8 != v7)
		{
			do
			{
				sub_1407727C0(v8 + 48, (__int64)&v13, 1);
				v9 = *(_QWORD*)(v8 + 24);
				if (v9)
				{
					v8 = *(_QWORD*)(v8 + 24);
...
// 140534CC5: variable 'v2' is possibly undefined
// 140534DB1: variable 'v6' is possibly undefined
