...
__int64 sub_1402065C0()
{
	...
	if (qword_140C63C60)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"HousingBuild"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\HousingBuild.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020665C: variable 'v1' is possibly undefined
// 140A8C058: using guessed type wchar_t aDbHousingbuild[20];
// 140A8C0F8: using guessed type wchar_t aHousingbuild[13];
// 140ADC700: using guessed type wchar_t *off_140ADC700;
