//----- (00000001406CAB70) ----------------------------------------------------
void __fastcall sub_1406CAB70(__int64 a1)
{
	_QWORD* v1; // rdi
	int v3; // r9d
	int v4; // r8d
	...
	int v14; // eax
	__int64 v15; // rbx
	__int64(__fastcall * v16)(__int64, __int64, __int64, __int64, __int64); // rax
	unsigned int* v17; // r9
	...
	unsigned int* v30; // r9
	__int64 v31; // rbx
	__int64(__fastcall * v32)(__int64, __int64, __int64, __int64, __int64); // rax
	__int64 v33; // r9
	__int64 v34; // rdx
	int v35; // ecx
	__int64 v36; // rdx
	...
	__int64(__fastcall * v44)(__int64, __int64, __int64, __int64, __int64); // [rsp+20h] [rbp-4048h] BYREF
	...
	v8 = 0;
	v9 = &v46[v7 / 8];
	v10 = (char*)&(&off_140C5E490)[v7 / 0xFFFFFFFFFFFFFFF8ui64] - (char*)v46;
	do
	{
	...
	} while ((unsigned __int64)v8 < 8);
	sub_1400569B0((__int64)v1, (unsigned __int64*)"Apollo.ActionBarButton");
	v12 = v1[2];
	if (*(_DWORD*)(v12 - 8) != 2)
	{
...
LABEL_16:
	...
	*(_DWORD*)(v12 + 8) = *(_DWORD*)(v12 - 8);
	v1[2] += 16i64;
	v15 = v1[2];
	v16 = (__int64(__fastcall*)(__int64, __int64, __int64, __int64, __int64))sub_140062650(
		(__int64)v1,
		...
		do
		{
			...
			*(_DWORD*)(v25 + 8) = 6;
			...
			do
				++v27;
			while (*((_BYTE*)v18 + v27));
			v29 = (__int64(__fastcall*)(__int64, __int64, __int64, __int64, __int64))sub_140062650((__int64)v1, v18, v27);
	...
	v31 = v1[4];
	v1[2] = v19 - 16;
	v32 = (__int64(__fastcall*)(__int64, __int64, __int64, __int64, __int64))sub_140062650(
		(__int64)v1,
...
LABEL_35:
	...
	if (!sub_1406C98E0)
		v43 = 0i64;
	v45 = v43;
	sub_1400F85D0(a1 + 2688, (int*)L"ActionBarButton", &v44);
}
// 140B39040: using guessed type wchar_t aActionbarbutto[16];
// 140C56A80: using guessed type char *off_140C56A80;
// 140C5E490: using guessed type char *off_140C5E490;
