...
__int64 sub_140238520()
{
	...
	if (qword_140C63BA0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4Effects"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4Effects.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402385BC: variable 'v1' is possibly undefined
// 140A511D8: using guessed type wchar_t *off_140A511D8;
// 140AA6D20: using guessed type wchar_t aSpell4effects[14];
// 140AA6EB0: using guessed type wchar_t aDbSpell4effect_0[21];
...
// 140C647A0: using guessed type int dword_140C647A0;
// 140C6519C: using guessed type int dword_140C6519C;
