...
__int64 sub_140229720()
{
	...
	if (qword_140C64DA0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PublicEventUnitPropertyModifier"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PublicEventUnitPropertyModifier.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402297BC: variable 'v1' is possibly undefined
// 140A79AF0: using guessed type wchar_t *off_140A79AF0;
// 140A9C500: using guessed type wchar_t aPubliceventuni[32];
// 140A9C5D0: using guessed type wchar_t aDbPubliceventu[39];
...
// 140C64BEC: using guessed type int dword_140C64BEC;
// 140C64DA0: using guessed type __int64 qword_140C64DA0;
// 140C64DA8: using guessed type int dword_140C64DA8;
