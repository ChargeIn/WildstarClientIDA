...
__int64 sub_140204C40()
{
	...
	if (qword_140C64C88)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"HousingContributionInfo"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\HousingContributionInfo.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140204CDC: variable 'v1' is possibly undefined
// 140A8B508: using guessed type wchar_t aDbHousingcontr_0[31];
// 140A8B548: using guessed type wchar_t aHousingcontrib_0[24];
// 140ACBDF8: using guessed type wchar_t *off_140ACBDF8;
...
// 140C63E70: using guessed type int dword_140C63E70;
// 140C641CC: using guessed type int dword_140C641CC;
