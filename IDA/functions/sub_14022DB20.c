...
__int64 sub_14022DB20()
{
	...
	if (qword_140C64ED8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"RandomTextLineSet"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\RandomTextLineSet.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022DBBC: variable 'v1' is possibly undefined
// 140A83188: using guessed type wchar_t *off_140A83188;
// 140A9FF80: using guessed type wchar_t aRandomtextline_0[18];
// 140AA01A0: using guessed type wchar_t aDbRandomtextli_0[25];
