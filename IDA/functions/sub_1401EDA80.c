...
__int64 sub_1401EDA80()
{
	...
	if (qword_140C64308)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"BinkMovieSubtitle"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\BinkMovieSubtitle.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401EDB1C: variable 'v1' is possibly undefined
// 140A5C2A0: using guessed type wchar_t aDbBinkmoviesub[25];
// 140A5C478: using guessed type wchar_t aBinkmoviesubti[18];
// 140AD1458: using guessed type wchar_t *off_140AD1458;
...
// 140C6435C: using guessed type int dword_140C6435C;
// 140C65108: using guessed type int dword_140C65108;
