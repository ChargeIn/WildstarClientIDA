...
__int64 sub_140242F20()
{
	...
	if (qword_140C63E50)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TradeskillAchievementLayout"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\TradeskillAchievementLayout.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140242FBC: variable 'v1' is possibly undefined
// 140AAB858: using guessed type wchar_t aTradeskillachi[28];
// 140AAB9E0: using guessed type wchar_t aDbTradeskillac[35];
// 140AD7408: using guessed type wchar_t *off_140AD7408;
...
// 140C642A4: using guessed type int dword_140C642A4;
// 140C64B14: using guessed type int dword_140C64B14;
// 140C65070: using guessed type int dword_140C65070;
