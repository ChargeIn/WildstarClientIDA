...
__int64 sub_1402292E0()
{
	...
	if (qword_140C63888)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PublicEventTeam"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PublicEventTeam.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022937C: variable 'v1' is possibly undefined
// 140A64FD8: using guessed type wchar_t *off_140A64FD8;
// 140A9C320: using guessed type wchar_t aPubliceventtea[16];
// 140A9C570: using guessed type wchar_t aDbPubliceventt[23];
...
// 140C63EE0: using guessed type int dword_140C63EE0;
// 140C64BD8: using guessed type int dword_140C64BD8;
// 140C64EC4: using guessed type int dword_140C64EC4;
