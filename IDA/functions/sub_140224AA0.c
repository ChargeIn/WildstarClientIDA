...
__int64 sub_140224AA0()
{
	...
	if (qword_140C64A38)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PetFlair"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PetFlair.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140224B3C: variable 'v1' is possibly undefined
// 140A64C60: using guessed type wchar_t *off_140A64C60;
// 140A99FD8: using guessed type wchar_t aPetflair[9];
// 140A9A110: using guessed type wchar_t aDbPetflairTbl[16];
...
// 140C64168: using guessed type int dword_140C64168;
// 140C64A38: using guessed type __int64 qword_140C64A38;
// 140C64E44: using guessed type int dword_140C64E44;
