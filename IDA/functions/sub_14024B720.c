...
__int64 sub_14024B720()
{
	...
	if (qword_140C65388)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"WorldLocation2"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\WorldLocation2.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024B7BC: variable 'v1' is possibly undefined
// 140AB0020: using guessed type wchar_t aDbWorldlocatio[22];
// 140AB0050: using guessed type wchar_t aWorldlocation2[15];
// 140AD2D08: using guessed type wchar_t *off_140AD2D08;
...
// 140C639DC: using guessed type int dword_140C639DC;
// 140C63B70: using guessed type int dword_140C63B70;
