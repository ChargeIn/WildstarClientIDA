...
//----- (000000014067C550) ----------------------------------------------------
__int64 __fastcall sub_14067C550(_QWORD* a1)
{
	__int64 v2; // rax
	__int64 v3; // rsi
	int* v4; // rax
	...
	if (v2 && (*(int(__fastcall**)(__int64))(*(_QWORD*)v2 + 208i64))(v2) >= 2)
	{
		...
		*((_QWORD*)&v21 + 1) = v4;
		...
		v7 = (int*)sub_14034BDD0(**(_QWORD**)(v3 + 48), *(_DWORD*)(**(_QWORD**)(v3 + 48) + 68i64));
		if (v7)
		{
			v8 = 0i64;
			if (*(_WORD*)v7)
	...
	{
		v12 = (unsigned __int64*)sub_14018F0E0(&v15, word_1409F50EC)[1];
		if (v12)
		{
			v13 = -1i64;
			do
...
// 1409F50EC: using guessed type unsigned __int16 word_1409F50EC[2];
// 140B69230: using guessed type __int64 (__fastcall *off_140B69230[25])();
// 140C65898: using guessed type __int64 qword_140C65898;
// 14067C550: using guessed type char var_E0[8];
