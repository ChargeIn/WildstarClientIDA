...
__int64 sub_14022C5E0()
{
	...
	if (qword_140C64640)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Quest2Reward"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Quest2Reward.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022C67C: variable 'v1' is possibly undefined
// 140A9ECE0: using guessed type wchar_t aQuest2reward[13];
// 140A9EE10: using guessed type wchar_t aDbQuest2reward[20];
// 140AD0AA0: using guessed type wchar_t *off_140AD0AA0;
...
// 140C64344: using guessed type int dword_140C64344;
// 140C64640: using guessed type __int64 qword_140C64640;
// 140C64694: using guessed type int dword_140C64694;
