...
__int64 sub_14023BC60()
{
	...
	if (qword_140C64CE8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4TargetMechanics"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\Spell4TargetMechanics.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023BCFC: variable 'v1' is possibly undefined
// 140AA8590: using guessed type wchar_t aDbSpell4target_0[29];
// 140AA85D0: using guessed type wchar_t aSpell4targetme[22];
// 140AD4A68: using guessed type wchar_t *off_140AD4A68;
...
// 140C63CCC: using guessed type int dword_140C63CCC;
// 140C63E38: using guessed type int dword_140C63E38;
