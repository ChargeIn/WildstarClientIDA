...
__int64 sub_140245DE0()
{
	...
	if (qword_140C63B08)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TradeskillTalentTier"))
	{
...
// 140245E7C: variable 'v1' is possibly undefined
// 140A66C58: using guessed type wchar_t *off_140A66C58;
// 140AAD2F8: using guessed type wchar_t aDbTradeskillta[28];
// 140AAD330: using guessed type wchar_t aTradeskilltale[21];
...
// 140C63928: using guessed type int dword_140C63928;
...
// 140C65080: using guessed type int dword_140C65080;
