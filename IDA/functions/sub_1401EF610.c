...
//----- (00000001401EF610) ----------------------------------------------------
__int64 sub_1401EF610()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A69640, qword_140C63858);
	if (dword_140C63878 || (int)sub_1401EF400() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C63860 + 40i64))(qword_140C63860);
}
