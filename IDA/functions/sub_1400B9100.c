...
//----- (00000001400B9100) ----------------------------------------------------
int** __fastcall sub_1400B9100(__int64 a1, int** a2, __int64* a3, __int64 a4)
{
	_QWORD* v4; // rbx
	__int64 v5; // rdi
	_QWORD* v9; // rdi
	...
	if ((_QWORD*)v5 != v4)
	{
		...
		if ((int)sub_14018E2C0(v13[5], *(unsigned __int16**)(a4 + 8)) < 0
			&& (int)sub_14018E2C0(*(_QWORD*)(a4 + 8), *(unsigned __int16**)(v5 + 40)) < 0)
		{
			if (!v13[3])
			{
				sub_1400B99F0(a1, a2, 0i64, (__int64)v13, a4);
				return a2;
			}
			goto LABEL_4;
		}
	LABEL_30:
		*a2 = *(int**)sub_1400B9AF0(a1, (__int64)v17, a4);
		return a2;
	}
	v9 = (_QWORD*)v4[3];
...
// 1400B9100: using guessed type char var_18[24];
