...
//----- (00000001400A9260) ----------------------------------------------------
__int64 __fastcall sub_1400A9260(__int64 a1, unsigned int* a2)
{
	__int64 v2; // r8
	...
	if ((int)result >= 0)
	{
		...
		if ((int)result >= 0)
		{
			...
			if ((int)result >= 0)
			{
				...
				if ((int)result >= 0)
				{
					result = sub_1400A7110(a1, a2[10], 0x12ui64);
					if ((int)result >= 0)
					{
						result = sub_1403360D0(a1, (unsigned __int16*)a2 + 22, (__int64)(a2 + 16));
						if ((int)result >= 0)
							return sub_1403360D0(a1, (unsigned __int16*)a2 + 32, (__int64)(a2 + 24));
					}
				}
			}
		}
