...
__int64 __fastcall sub_14045B790(__int64 a1, unsigned int a2)
{
	...
	if (a1 && (*(_QWORD*)(qword_140C65898 + 120) == a1 || *(_QWORD*)(qword_140C65898 + 25744) == a1))
		return sub_1400EA3E0(*(_QWORD*)(qword_140C65898 + 29504), "PlayerTitleChange", &unk_1409D10E1);
	else
		return sub_1400EA3E0(*(_QWORD*)(qword_140C65898 + 29504), "UnitTitleChanged", L"U", *(unsigned int*)(a1 + 8));
}
