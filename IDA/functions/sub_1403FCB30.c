...
//----- (00000001403FCB30) ----------------------------------------------------
void __fastcall sub_1403FCB30(unsigned int a1, _DWORD* a2, __int64 a3)
{
	__int64 v3; // r9
	__int64 v6; // rax
	__int64 v7; // rdx
...
// 1403FCC90: conditional instruction was optimized away because eax.4>=1
