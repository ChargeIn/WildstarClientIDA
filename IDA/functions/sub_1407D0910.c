...
//----- (00000001407D0910) ----------------------------------------------------
__int64 __fastcall sub_1407D0910(__int64 a1, int* a2)
{
	__int64 v2; // rdi
	...
	v2 = a1 + 6592;
	v5 = (*(__int64(__fastcall**)(int*))(a1 + 6616))(a2);
	...
	sub_1403514F0(v8, a2, (__int64)&off_140AD0898);
	return 0i64;
}
// 1407D09E3: variable 'v10' is possibly undefined
