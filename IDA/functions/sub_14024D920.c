...
__int64 sub_14024D920()
{
	...
	if (qword_140C64270)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"WorldZone"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\WorldZone.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024D9BC: variable 'v1' is possibly undefined
// 140A61D70: using guessed type wchar_t *off_140A61D70;
// 140AB0CC8: using guessed type wchar_t aDbWorldzoneTbl[17];
// 140AB0D78: using guessed type wchar_t aWorldzone[10];
...
// 140C64A6C: using guessed type int dword_140C64A6C;
// 140C651E0: using guessed type int dword_140C651E0;
