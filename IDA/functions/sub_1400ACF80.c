//----- (00000001400ACF80) ----------------------------------------------------
__int64 __fastcall sub_1400ACF80(__int64 a1, unsigned int* a2)
{
	__int64 v2; // r8
			...
			(unsigned __int64)(8i64 * (*(_QWORD*)(v11 + 24) - *(_QWORD*)(v11 + 32)) - v12) >= 0x40))
	{
		...
		v14 = *(_QWORD**)(v11 + 32);
		*v14 &= (1i64 << v12) - 1;
		*v14 |= (v13 & 0x1F) << *(_QWORD*)(a1 + 16);
		v15 = *(_QWORD*)(a1 + 16);
		if (((v15 + 12) & 0xFFFFFFFFFFFFFFF8ui64) > 0x40)
			*(_BYTE*)(*(_QWORD*)(v11 + 32) + 8i64) = v13 >> (64 - (unsigned __int8)v15);
		*(_QWORD*)(v11 + 32) += (unsigned __int64)(*(_QWORD*)(a1 + 16) + 5i64) >> 3;
		*(_QWORD*)(a1 + 16) = ((unsigned __int8)*(_QWORD*)(a1 + 16) - 3) & 7;
	}
	else
	{
		result = sub_140336470(a1, (int)a2[1], 5ui64);
		if ((int)result < 0)
			return result;
	}
	...
	if ((int)result >= 0)
	{
		result = sub_1400A7110(a1, a2[3], 0xEui64);
		if ((int)result >= 0)
		{
			result = sub_1400A7110(a1, a2[4], 0x20ui64);
			if ((int)result >= 0)
			{
				result = sub_140085170(a1, a2 + 6);
				if ((int)result >= 0)
					return sub_1400A7110(a1, a2[10], 0x20ui64);
			}
		}
	}
	return result;
