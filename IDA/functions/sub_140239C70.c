...
//----- (0000000140239C70) ----------------------------------------------------
__int64 sub_140239C70()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6D380, qword_140C63858);
	if (dword_140C64628 || (int)sub_140239A60() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64D98 + 40i64))(qword_140C64D98);
}
