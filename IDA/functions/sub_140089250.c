...
//----- (0000000140089250) ----------------------------------------------------
__int64 __fastcall sub_140089250(__int64 a1, unsigned int* a2)
{
	__int64 v2; // r8
	...
	v17 = *((_BYTE*)a2 + 8);
	if (!v16)
		return sub_140336470(a1, v17, 3ui64);
	v18 = *(_QWORD*)(a1 + 16);
	...
	v20 = *(_QWORD**)(v16 + 32);
	*v20 &= (1i64 << v18) - 1;
	*v20 |= (v19 & 7) << *(_QWORD*)(a1 + 16);
	v21 = *(_QWORD*)(a1 + 16);
	if (((v21 + 10) & 0xFFFFFFFFFFFFFFF8ui64) > 0x40)
		*(_BYTE*)(*(_QWORD*)(v16 + 32) + 8i64) = v19 >> (64 - (unsigned __int8)v21);
	*(_QWORD*)(v16 + 32) += (unsigned __int64)(*(_QWORD*)(a1 + 16) + 3i64) >> 3;
