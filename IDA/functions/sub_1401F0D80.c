...
__int64 sub_1401F0D80()
{
	...
	if (qword_140C645B0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"CharacterCustomizationSelection"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\CharacterCustomizationSelection.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F0E1C: variable 'v1' is possibly undefined
// 140A5B530: using guessed type wchar_t *off_140A5B530;
// 140A5EFC0: using guessed type wchar_t aDbCharactercus_1[39];
// 140A5F120: using guessed type wchar_t aCharactercusto_1[32];
