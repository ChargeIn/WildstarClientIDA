...
//----- (000000014072C500) ----------------------------------------------------
__int64 __fastcall sub_14072C500(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Game.CharacterTitle");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6;
	sub_140057020(a1, "CharacterTitle", &off_140B74670);
	return 1i64;
}
// 14072C613: variable 'v14' is possibly undefined
// 140B74670: using guessed type char *off_140B74670;
// 140C5EC40: using guessed type char *off_140C5EC40;
