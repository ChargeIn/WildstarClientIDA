//----- (000000014081CA00) ----------------------------------------------------
__int64 __fastcall sub_14081CA00(unsigned int a1)
{
	...
	if (v5 && v5 != -14)
		return v5;
	if (v5 == -14)
		qword_140C61448 = 0i64;
	if (qword_140C61448 && dword_140C61450 != dword_140C60980[v6])
		qword_140C61448 = 0i64;
	if (!qword_140C61448 && v3 && nvapi_QueryInterface)
	{
		qword_140C61448 = nvapi_QueryInterface(4044863540i64);
		dword_140C61450 = dword_140C60980[v6];
	}
	if (qword_140C61448)
	{
		v2 = (__int64(__fastcall*)(_QWORD))qword_140C61448;
		v4 = 0i64;
		if (qword_140C60938)
			qword_140C60938(4044863540i64, &v4);
		v5 = v2(a1);
		if (qword_140C60940)
			qword_140C60940(4044863540i64, v4, v5);
		--dword_140C60970[v6];
		return v5;
	}
	else
...
// 140C61448: using guessed type __int64 qword_140C61448;
// 140C61450: using guessed type int dword_140C61450;
