...
__int64 sub_14024E1A0()
{
	...
	if (qword_140C64F98)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ZoneCompletion"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ZoneCompletion.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024E23C: variable 'v1' is possibly undefined
// 140AB0FC0: using guessed type wchar_t aDbZonecompleti[22];
// 140AB1088: using guessed type wchar_t aZonecompletion[15];
// 140AD7440: using guessed type wchar_t *off_140AD7440;
...
// 140C64440: using guessed type int dword_140C64440;
// 140C64F98: using guessed type __int64 qword_140C64F98;
// 140C654F4: using guessed type int dword_140C654F4;
