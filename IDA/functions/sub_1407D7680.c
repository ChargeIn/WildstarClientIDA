//----- (00000001407D7680) ----------------------------------------------------
__int64 __fastcall sub_1407D7680(_QWORD* a1, __int64 a2, unsigned int* a3)
{
	__int64 v3; // rax
	__int64 v6; // r8
	__int64 v8; // rcx
	...
	*((_QWORD*)a3 + 1) = v9;
	...
	while (1)
	{
		...
		v17 = *((_QWORD*)v12 + 2);
		*((_QWORD*)v12 + 1) = v16;
		if ((unsigned __int64)(v17 + v11) < *a1 || v11 + v17 + 108 * (unsigned __int64)(unsigned int)v15 > a1[1])
			break;
		v18 = 0i64;
		if ((_DWORD)v15)
			v18 = v17 + v11;
