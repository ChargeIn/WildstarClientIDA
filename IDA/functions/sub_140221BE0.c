...
__int64 sub_140221BE0()
{
	...
	if (qword_140C64300)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathSettlerInfrastructure"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PathSettlerInfrastructure.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140221C7C: variable 'v1' is possibly undefined
// 140A78DB0: using guessed type wchar_t *off_140A78DB0;
// 140A98308: using guessed type wchar_t aPathsettlerinf[26];
// 140A98340: using guessed type wchar_t aDbPathsettleri_0[33];
...
// 140C64620: using guessed type int dword_140C64620;
// 140C652C4: using guessed type int dword_140C652C4;
