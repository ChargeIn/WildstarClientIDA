...
__int64 sub_1402098C0()
{
	...
	if (qword_140C64E00)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Item2Category"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Item2Category.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020995C: variable 'v1' is possibly undefined
// 140A8E5F8: using guessed type wchar_t aDbItem2categor[21];
// 140A8E6A8: using guessed type wchar_t aItem2category[14];
// 140ACD118: using guessed type wchar_t *off_140ACD118;
...
// 140C64F28: using guessed type int dword_140C64F28;
// 140C6505C: using guessed type int dword_140C6505C;
