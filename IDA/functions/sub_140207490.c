...
//----- (0000000140207490) ----------------------------------------------------
__int64 sub_140207490()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6A9F0, qword_140C63858);
	if (dword_140C643E0 || (int)sub_140207280() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64488 + 40i64))(qword_140C64488);
}
