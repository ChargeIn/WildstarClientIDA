...
__int64 sub_140211460()
{
	...
	if (qword_140C64508)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"LootPinataInfo"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\LootPinataInfo.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402114FC: variable 'v1' is possibly undefined
// 140A889C8: using guessed type wchar_t *off_140A889C8;
// 140A919B0: using guessed type wchar_t aLootpinatainfo[15];
// 140A91B10: using guessed type wchar_t aDbLootpinatain[22];
