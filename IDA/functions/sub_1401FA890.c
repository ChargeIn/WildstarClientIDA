...
//----- (00000001401FA890) ----------------------------------------------------
__int64 sub_1401FA890()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A69F70, qword_140C63858);
	if (dword_140C64580 || (int)sub_1401FA680() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C65470 + 40i64))(qword_140C65470);
}
