...
//----- (000000014028C520) ----------------------------------------------------
__int64 __fastcall sub_14028C520(__int64 a1, int* a2, int a3, unsigned int a4, int a5, int a6, int a7, int a8)
{
	int v10; // ebx
	__int64 result; // rax
	__int64 v12; // rdi
	...
	if (a4 <= 2)
	{
		...
		*(_DWORD*)(a1 + 80) = a8;
		...
		if ((int)result >= 0)
		{
			...
			*v15 = v17;
			++* (_QWORD*)v13;
			v20 = (__int64*)(*(_QWORD*)(a1 + 16) + 7216i64);
			if (!*(_QWORD*)(a1 + 240))
			{
				*(_QWORD*)(a1 + 240) = v20;
				*(_QWORD*)(a1 + 248) = *v20;
			...
			v35 = 0i64;
			v33 = sub_14028D140;
			sub_1401B6BF0((__int64)v20, &v30, (int**)(a1 + 184));
			return 0i64;
		}
	}
	else
	{
		...
		v10 = sub_1401971E0(&dword_140C8A3EC, 14, &v29, &v30, v36);
		v22 = &off_140B5E648;
...
// 140C8A3EC: using guessed type _DWORD dword_140C8A3EC;
