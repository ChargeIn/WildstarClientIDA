//----- (0000000140233EF0) ----------------------------------------------------
__int64 sub_140233EF0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6CEB0, qword_140C63858);
	if (dword_140C64614 || (int)sub_140233CE0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C638E8 + 40i64))(qword_140C638E8);
}
