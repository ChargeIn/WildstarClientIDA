//----- (000000014028B1C0) ----------------------------------------------------
__int64 __fastcall sub_14028B1C0(__int64 a1, unsigned int a2, unsigned int a3, char a4)
{
	unsigned int v5; // ebx
	int v8; // r14d
	int v9; // ebx
	...
	if ((a4 & 1) != 0 && *(_DWORD*)(a1 + 32) == 1)
	{
		...
		*((_QWORD*)&v20 + 1) = TlsGetValue(dwTlsIndex);
		...
		v23 = 0x141DE3EA0i64;
		v29 = v20;
		v9 = sub_1401971E0(&dword_140C8A3C0, 14, &v23, &v28);
		TlsValue = &off_140B5E648;
	...
	if (a2 + v5 > *(_DWORD*)(a1 + 24))
	{
		...
		*((_QWORD*)&v18 + 1) = TlsGetValue(dwTlsIndex);
		...
		v25 = 0x141DE3E30i64;
		v27 = v18;
		v12 = sub_1401971E0(&dword_140C8A3C4, 14, &v25, &v26);
		v17 = &off_140B5E648;
	...
	*(_DWORD*)(a1 + 48) = 1;
	...
	if (v14 >= 0)
	{
		v16 = (volatile signed __int32*)(48i64 * *(int*)(a1 + 32) + *(_QWORD*)(a1 + 16) + 532i64);
		if (v8)
		{
...
// 140C8A3C0: using guessed type _DWORD dword_140C8A3C0;
// 140C8A3C4: using guessed type _DWORD dword_140C8A3C4;
