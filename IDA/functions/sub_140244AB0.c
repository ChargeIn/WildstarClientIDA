...
//----- (0000000140244AB0) ----------------------------------------------------
__int64 sub_140244AB0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6DC78, qword_140C63858);
	if (dword_140C65320 || (int)sub_1402448A0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C646E0 + 40i64))(qword_140C646E0);
}
