...
__int64 sub_1401FD980()
{
	...
	if (qword_140C64040)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Emotes"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Emotes.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401FDA1C: variable 'v1' is possibly undefined
// 140A88C80: using guessed type wchar_t aDbEmotesTbl[14];
// 140A88CA0: using guessed type wchar_t aEmotes[7];
// 140AD3740: using guessed type wchar_t *off_140AD3740;
...
// 140C64E24: using guessed type int dword_140C64E24;
// 140C65178: using guessed type int dword_140C65178;
