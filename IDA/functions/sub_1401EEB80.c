...
__int64 sub_1401EEB80()
{
	...
	if (qword_140C63B80)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"CCStateDiminishingReturns"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\CCStateDiminishingReturns.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401EEC1C: variable 'v1' is possibly undefined
// 140A5CB98: using guessed type wchar_t aCcstatediminis[26];
// 140A5CC30: using guessed type wchar_t aDbCcstatedimin[33];
// 140A80C10: using guessed type wchar_t *off_140A80C10;
...
// 140C64584: using guessed type int dword_140C64584;
// 140C65054: using guessed type int dword_140C65054;
