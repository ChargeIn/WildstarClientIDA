//----- (00000001400A1A80) ----------------------------------------------------
__int64 __fastcall sub_1400A1A80(__int64 a1, unsigned __int16** a2)
{
	__int64 v2; // r8
	...
	{
		result = sub_140336470(a1, *((int*)a2 + 1), 0x20ui64);
		if ((int)result < 0)
			return result;
	}
	result = sub_1400A72A0(a1, *((_DWORD*)a2 + 2));
	if ((int)result >= 0)
	{
		result = sub_140336040(a1, a2[2]);
		if ((int)result >= 0)
			return sub_140336040(a1, a2[3]);
	}
	return result;
}
