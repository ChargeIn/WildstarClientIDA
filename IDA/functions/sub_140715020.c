//----- (0000000140715020) ----------------------------------------------------
__int64 __fastcall sub_140715020(__int64 a1, unsigned int a2, __int64 a3, _DWORD* a4)
{
	__int64 v4; // rax
	int* v5; // rbx
	int** v6; // rdi
	...
	if (!*(_DWORD*)(a3 + 8) || !v5 || (*(unsigned int(__fastcall**)(int*))(*(_QWORD*)v5 + 8i64))(v5) != 10)
	{
...
// 140B73C58: using guessed type __int64 (__fastcall *off_140B73C58[14])();
