...
__int64 sub_140202A40()
{
	...
	if (qword_140C646B0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"GuildPerk"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\GuildPerk.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140202ADC: variable 'v1' is possibly undefined
// 140A83A98: using guessed type wchar_t *off_140A83A98;
// 140A8A7B0: using guessed type wchar_t aGuildperk[10];
// 140A8A9C8: using guessed type wchar_t aDbGuildperkTbl[17];
...
// 140C64364: using guessed type int dword_140C64364;
// 140C646B0: using guessed type __int64 qword_140C646B0;
// 140C64C08: using guessed type int dword_140C64C08;
