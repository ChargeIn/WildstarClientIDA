...
__int64 sub_14020EDC0()
{
	...
	if (qword_140C64598)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"LevelDifferentialAttribute"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\LevelDifferentialAttribute.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020EE5C: variable 'v1' is possibly undefined
// 140A90CF8: using guessed type wchar_t aLeveldifferent[27];
// 140A90DD0: using guessed type wchar_t aDbLeveldiffere[34];
// 140AD55A0: using guessed type wchar_t *off_140AD55A0;
...
// 140C641D8: using guessed type int dword_140C641D8;
// 140C64598: using guessed type __int64 qword_140C64598;
// 140C6512C: using guessed type int dword_140C6512C;
