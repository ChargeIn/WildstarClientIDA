//----- (0000000140484360) ----------------------------------------------------
__int64 __fastcall sub_140484360(unsigned __int64 a1, int a2, unsigned int a3)
{
	__int64 v3; // rsi
	__int64 result; // rax
	__int64 v5; // rsi
	...
	if (result)
	{
		...
		if (v7)
		{
			...
			if (v7 != (_QWORD*)-24i64)
				return sub_140007810(v7[3] + 408i64, (__int64)v8, &v9);
		}
	}
	return result;
}
// 140C65918: using guessed type __int64 qword_140C65918;
// 140484360: using guessed type char var_18[24];
