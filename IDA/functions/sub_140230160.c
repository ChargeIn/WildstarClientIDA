...
__int64 sub_140230160()
{
	...
	if (qword_140C64FF8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"RewardRotationEssence"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\RewardRotationEssence.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402301FC: variable 'v1' is possibly undefined
// 140AA1A98: using guessed type wchar_t aRewardrotation_1[22];
// 140AA1C30: using guessed type wchar_t aDbRewardrotati_1[29];
// 140AD9DA8: using guessed type wchar_t *off_140AD9DA8;
...
// 140C641E0: using guessed type int dword_140C641E0;
// 140C643D4: using guessed type int dword_140C643D4;
