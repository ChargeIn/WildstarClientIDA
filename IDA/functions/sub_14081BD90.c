//----- (000000014081BD90) ----------------------------------------------------
__int64 __fastcall sub_14081BD90(__int64 a1)
{
	...
	if (v5 && v5 != -14)
		return v5;
	if (v5 == -14)
		qword_140C613C8 = 0i64;
	if (qword_140C613C8 && dword_140C613D0 != dword_140C60980[v6])
		qword_140C613C8 = 0i64;
	if (!qword_140C613C8 && v3 && nvapi_QueryInterface)
	{
		qword_140C613C8 = nvapi_QueryInterface(3454591395i64);
		dword_140C613D0 = dword_140C60980[v6];
	}
	if (qword_140C613C8)
	{
		v2 = (__int64(__fastcall*)(__int64))qword_140C613C8;
		v4 = 0i64;
		if (qword_140C60938)
			qword_140C60938(3454591395i64, &v4);
		v5 = v2(a1);
		if (qword_140C60940)
			qword_140C60940(3454591395i64, v4, v5);
		--dword_140C60970[v6];
		return v5;
	}
	else
...
// 140C613C8: using guessed type __int64 qword_140C613C8;
// 140C613D0: using guessed type int dword_140C613D0;
