...
//----- (000000014001DBA0) ----------------------------------------------------
int* __fastcall sub_14001DBA0(__int64 a1, int* a2)
{
	__int64 v2; // r9
	__int64 v5; // rax
	int* v6; // rbx
	...
	if (v6 == (int*)v2 || *a2 < (unsigned int)v6[8])
	{
		...
		*((_QWORD*)v9 + 3) = v9;
		v11 = *a2;
		sub_14001E110((__int64)v12, (__int64)v8);
		v15 = v6;
		sub_14001F230(a1, &v16, (__int64*)&v15, &v11);
		v6 = v16;
		if (v14)
		{
			sub_14001E4A0((__int64)v12, *(_QWORD**)(v13 + 8));
			*(_QWORD*)(v13 + 16) = v13;
			*(_QWORD*)(v13 + 8) = 0i64;
			*(_QWORD*)(v13 + 24) = v13;
			v14 = 0i64;
		...
		if (v10)
		{
			sub_14001E4A0((__int64)v8, *((_QWORD**)v9 + 1));
			*((_QWORD*)v9 + 2) = v9;
			*((_QWORD*)v9 + 1) = 0i64;
			*((_QWORD*)v9 + 3) = v9;
			v10 = 0i64;
...
// 14001DBA0: using guessed type char var_50[8];
// 14001DBA0: using guessed type char var_28[8];
