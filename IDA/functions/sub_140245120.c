...
__int64 sub_140245120()
{
	...
	if (qword_140C649F0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TradeskillMaterialCategory"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\TradeskillMaterialCategory.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402451BC: variable 'v1' is possibly undefined
// 140AAC8A0: using guessed type wchar_t aTradeskillmate_0[27];
// 140AACB50: using guessed type wchar_t aDbTradeskillma_0[34];
// 140AD7920: using guessed type wchar_t *off_140AD7920;
