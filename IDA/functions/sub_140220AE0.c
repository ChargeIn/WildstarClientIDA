...
__int64 sub_140220AE0()
{
	...
	if (qword_140C64F58)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathScientistFieldStudy"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PathScientistFieldStudy.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140220B7C: variable 'v1' is possibly undefined
// 140A96FB0: using guessed type wchar_t aDbPathscientis_3[31];
// 140A96FF0: using guessed type wchar_t aPathscientistf[24];
// 140AD67A8: using guessed type wchar_t *off_140AD67A8;
