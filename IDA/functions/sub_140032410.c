...
//----- (0000000140032410) ----------------------------------------------------
int** __fastcall sub_140032410(__int64 a1, int** a2, __int64* a3, __int64 a4)
{
	__int64 v4; // rax
	__int64 v5; // r8
	int** result; // rax
	...
	if (v5 == v4)
	{
		...
		{
			v17 = *(int**)sub_140033160(a1, (__int64)v22, (int*)a4);
			result = a2;
			*a2 = v17;
		}
		else
	...
	else
	{
		...
		if (*(_DWORD*)(v18 + 32) >= *(_DWORD*)a4 || *(_DWORD*)a4 >= *(_DWORD*)(v5 + 32))
		{
			v10 = (int*)a4;
		LABEL_7:
			v11 = *(int**)sub_140033160(a1, (__int64)v22, v10);
			result = a2;
			*a2 = v11;
			return result;
		}
		...
		if (*(_QWORD*)(v18 + 24))
			goto LABEL_5;
		sub_140033050(a1, a2, 0i64, v18, a4);
		return a2;
	}
	return result;
}
