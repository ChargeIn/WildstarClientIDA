//----- (0000000140264CB0) ----------------------------------------------------
__int64 __fastcall sub_140264CB0(__int64 a1, __m128* a2, int a3)
{
	__m128* v3; // r9
	_BYTE* v4; // rcx
	__m128 v5; // xmm2
	...
	if (a2 < v3)
	{
		...
		do
		{
			if (v4 != (_BYTE*)1)
			{
				...
				v4[1] = (int)v5.m128_f32[0];
				*v4 = (int)_mm_shuffle_ps(v5, v5, 85).m128_f32[0];
				*(v4 - 1) = (int)_mm_shuffle_ps(v5, v5, 170).m128_f32[0];
