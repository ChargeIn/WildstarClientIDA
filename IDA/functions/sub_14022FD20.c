...
__int64 sub_14022FD20()
{
	...
	if (qword_140C64480)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"RewardRotationItem"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\RewardRotationItem.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022FDBC: variable 'v1' is possibly undefined
// 140AA1970: using guessed type wchar_t aRewardrotation_0[19];
// 140AA1B90: using guessed type wchar_t aDbRewardrotati_0[26];
// 140AD0AD8: using guessed type wchar_t *off_140AD0AD8;
...
// 140C64EC0: using guessed type int dword_140C64EC0;
// 140C65624: using guessed type int dword_140C65624;
