...
__int64 sub_1401F5E40()
{
	...
	if (qword_140C64260)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Creature2ArcheType"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Creature2ArcheType.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F5EDC: variable 'v1' is possibly undefined
// 140A5CB18: using guessed type wchar_t *off_140A5CB18;
// 140A6EE70: using guessed type wchar_t aCreature2arche[19];
// 140A6F1B0: using guessed type wchar_t aDbCreature2arc[26];
...
// 140C642C4: using guessed type int dword_140C642C4;
// 140C64F08: using guessed type int dword_140C64F08;
// 140C6523C: using guessed type int dword_140C6523C;
