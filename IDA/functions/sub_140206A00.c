...
__int64 sub_140206A00()
{
	...
	if (qword_140C64258)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"HousingPlugItem"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\HousingPlugItem.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140206A9C: variable 'v1' is possibly undefined
// 140A8C8F8: using guessed type wchar_t aHousingplugite[16];
// 140A8CB28: using guessed type wchar_t aDbHousingplugi[23];
// 140AD7478: using guessed type wchar_t *off_140AD7478;
...
// 140C65268: using guessed type int dword_140C65268;
// 140C65618: using guessed type int dword_140C65618;
