//----- (00000001407F28FC) ----------------------------------------------------
__int64 __fastcall sub_1407F28FC(unsigned __int16* a1, _DWORD* a2)
{
	unsigned int v2; // ebx
	...
	else
	{
		...
		v70 = v5;
		v9 = 0;
		v72 = dword_140C104D0 - 1;
		v10 = dword_140C104D0 / 32;
		v11 = 31 - dword_140C104D0 % 32;
		v12 = *((_DWORD*)&v76 + dword_140C104D0 / 32);
		if (_bittest(&v12, v11))
		{
		...
		*((_DWORD*)&v76 + v10) &= -1 << v11;
		...
		if (v9)
			++v5;
		if (v5 >= dword_140C104CC - dword_140C104D0)
		{
			if (v5 > dword_140C104CC)
			{
				v50 = dword_140C104C8;
				v51 = dword_140C104D4 % 32;
				v52 = dword_140C104D4 / 32;
				v53 = ~(-1 << (dword_140C104D4 % 32));
				if (v5 < dword_140C104C8)
				{
					LODWORD(v76) = v76 & 0x7FFFFFFF;
					v60 = 0;
					v7 = v5 + dword_140C104DC;
					v61 = dword_140C104D4 % 32;
					v62 = 32 - v51;
					v63 = &v76;
					do
					{
			...
			else
			{
				...
				v21 = 0;
				v22 = &v76;
				v23 = (dword_140C104CC - v70) / 32;
				v24 = (dword_140C104CC - v70) % 32;
				do
				{
				...
				*((_DWORD*)&v76 + v29) &= -1 << v30;
				...
				v40 = 0;
				v41 = &v76;
				v42 = (dword_140C104D4 + 1) % 32;
				v43 = (dword_140C104D4 + 1) / 32;
				v44 = v42;
				v45 = 32 - v42;
				v46 = ~(-1 << v42);
				do
...
LABEL_80:
	v67 = v76 | (v71 != 0 ? 0x80000000 : 0) | (v7 << (31 - dword_140C104D4));
	if (dword_140C104D8 == 64)
	{
		v68 = HIDWORD(v76);
		a2[1] = v67;
		*a2 = v68;
	}
	else if (dword_140C104D8 == 32)
	{
		*a2 = v67;
	}
	return v2;
}
// 140C104C8: using guessed type int dword_140C104C8;
// 140C104CC: using guessed type int dword_140C104CC;
// 140C104D0: using guessed type int dword_140C104D0;
// 140C104D4: using guessed type int dword_140C104D4;
// 140C104D8: using guessed type int dword_140C104D8;
// 140C104DC: using guessed type int dword_140C104DC;
