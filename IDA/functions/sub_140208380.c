...
__int64 sub_140208380()
{
	...
	if (qword_140C638D8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"HousingWarplotBossToken"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\HousingWarplotBossToken.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020841C: variable 'v1' is possibly undefined
// 140A64A48: using guessed type wchar_t *off_140A64A48;
// 140A8D7B8: using guessed type wchar_t aHousingwarplot_0[24];
// 140A8D9F8: using guessed type wchar_t aDbHousingwarpl_0[31];
...
// 140C651FC: using guessed type int dword_140C651FC;
// 140C65488: using guessed type int dword_140C65488;
// 140C6557C: using guessed type int dword_140C6557C;
