...
__int64 sub_140211CE0()
{
	...
	if (qword_140C64278)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"LuaEvent"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\LuaEvent.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140211D7C: variable 'v1' is possibly undefined
// 140A91C78: using guessed type wchar_t aLuaevent[9];
// 140A91DE8: using guessed type wchar_t aDbLuaeventTbl[16];
// 140ACB748: using guessed type wchar_t *off_140ACB748;
...
// 140C642CC: using guessed type int dword_140C642CC;
// 140C647DC: using guessed type int dword_140C647DC;
