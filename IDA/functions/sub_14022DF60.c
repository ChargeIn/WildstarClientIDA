...
__int64 sub_14022DF60()
{
	...
	if (qword_140C64D00)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"RealmDataCenter"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\RealmDataCenter.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022DFFC: variable 'v1' is possibly undefined
// 140A4BB18: using guessed type wchar_t *off_140A4BB18;
// 140AA0348: using guessed type wchar_t aDbRealmdatacen[23];
// 140AA0418: using guessed type wchar_t aRealmdatacente_1[16];
...
// 140C63EB0: using guessed type int dword_140C63EB0;
// 140C64360: using guessed type int dword_140C64360;
