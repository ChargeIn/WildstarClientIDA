...
__int64 sub_14022F8E0()
{
	...
	if (qword_140C644D0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"RewardRotationContent"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\RewardRotationContent.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022F97C: variable 'v1' is possibly undefined
// 140A5A880: using guessed type wchar_t *off_140A5A880;
// 140AA18D0: using guessed type wchar_t aDbRewardrotati[29];
// 140AA1910: using guessed type wchar_t aRewardrotation[22];
