...
__int64 sub_140209040()
{
	...
	if (qword_140C63CA0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"InstancePortal"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\InstancePortal.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402090DC: variable 'v1' is possibly undefined
// 140A80340: using guessed type wchar_t *off_140A80340;
// 140A8DC18: using guessed type wchar_t aDbInstanceport[22];
// 140A8DCD8: using guessed type wchar_t aInstanceportal[15];
...
// 140C643B8: using guessed type int dword_140C643B8;
// 140C64678: using guessed type int dword_140C64678;
