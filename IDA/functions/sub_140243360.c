...
__int64 sub_140243360()
{
	...
	if (qword_140C643A0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TradeskillAchievementReward"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\TradeskillAchievementReward.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402433FC: variable 'v1' is possibly undefined
// 140A87718: using guessed type wchar_t *off_140A87718;
// 140AABA58: using guessed type wchar_t aTradeskillachi_0[28];
// 140AABC40: using guessed type wchar_t aDbTradeskillac_0[35];
...
// 140C63F24: using guessed type int dword_140C63F24;
// 140C643A0: using guessed type __int64 qword_140C643A0;
// 140C648DC: using guessed type int dword_140C648DC;
