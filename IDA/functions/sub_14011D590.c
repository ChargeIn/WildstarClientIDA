//----- (000000014011D590) ----------------------------------------------------
__int64 __fastcall sub_14011D590(_QWORD* a1)
{
	int* v1; // rdi
	...
	if (!v8)
	{
		...
		*((_QWORD*)&v27 + 1) = TlsGetValue(dwTlsIndex);
		...
		v32 = 0x141D18A90i64;
		v29 = v27;
		v9 = sub_1401971E0(&dword_140C8A114, 13, &v32, &v28);
		TlsValue = &off_140B5E648;
	...
	v25 = v19;
	v23 = v31;
	sub_1400E9780(v7, v8, v1, v31, v25, (const __m128i*)v27);
	if (v22)
		sub_14018B900(v22, 0);
	if (v23)
...
// 140C8A114: using guessed type _DWORD dword_140C8A114;
