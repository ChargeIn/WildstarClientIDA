...
__int64 sub_140241E20()
{
	...
	if (qword_140C63D50)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TicketCategory"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\TicketCategory.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140241EBC: variable 'v1' is possibly undefined
// 140AAB158: using guessed type wchar_t aTicketcategory[15];
// 140AAB320: using guessed type wchar_t aDbTicketcatego[22];
// 140ADCD08: using guessed type wchar_t *off_140ADCD08;
