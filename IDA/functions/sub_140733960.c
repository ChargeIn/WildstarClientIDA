...
//----- (0000000140733960) ----------------------------------------------------
__int64 __fastcall sub_140733960(__int64 a1)
{
	__int64 v1; // r13
	__int64 v2; // r13
	__int64 v3; // rdi
	...
	v1 = *(_QWORD*)(qword_140C659F0 + 552);
	v41 = a1;
	v2 = v1 - *(_QWORD*)(qword_140C659F0 + 544);
	v3 = a1;
	v4 = *(_QWORD*)(a1 + 32);
	v39 = off_140B569F0;
	v5 = *(_QWORD*)(v4 + 112);
	...
	*(_QWORD*)(v3 + 16) += 16i64;
	...
	if (v6)
	{
		...
		do
		{
			if ((unsigned int)((__int64)(*(_QWORD*)(v12 + 552) - *(_QWORD*)(v12 + 544)) >> 3) > (unsigned int)v10
				&& *(_QWORD*)(*(_QWORD*)(v12 + 544) + 8i64 * (unsigned int)v10))
			{
				...
				*(_QWORD*)(v3 + 16) += 16i64;
				sub_1400F0870(v3, v27, L"strResidenceName", v28);
				*(_QWORD*)(v3 + 16) -= 16i64;
				v29 = sub_14005C3C0(*(_QWORD*)(*(_QWORD*)(v3 + 32) + 160i64), v15);
				*(_QWORD*)v30 = *v29;
				*(_DWORD*)(v30 + 8) = *((_DWORD*)v29 + 2);
				*(_QWORD*)(v3 + 16) += 16i64;
				sub_1400F0870(v3, v31, L"strCommunityLeader", v32);
				*(_QWORD*)(v3 + 16) -= 16i64;
...
// 140733BB6: variable 'v26' is possibly undefined
// 140733BC8: variable 'v27' is possibly undefined
// 140733BC8: variable 'v28' is possibly undefined
// 140733BFA: variable 'v30' is possibly undefined
// 140733C0C: variable 'v31' is possibly undefined
// 140733C0C: variable 'v32' is possibly undefined
// 140733C32: variable 'v33' is possibly undefined
// 140A12138: using guessed type _DWORD dword_140A12138[4];
// 140B473E0: using guessed type wchar_t aStrcommunityle[19];
// 140B47408: using guessed type wchar_t aStrresidencena_0[17];
// 140B47430: using guessed type wchar_t aNid_34[4];
