...
__int64 sub_140236320()
{
	...
	if (qword_140C653F0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402363BC: variable 'v1' is possibly undefined
// 140AA5098: using guessed type wchar_t aDbSpell4Tbl[14];
// 140AA5148: using guessed type wchar_t aSpell4[7];
// 140AD8188: using guessed type wchar_t *off_140AD8188;
...
// 140C64120: using guessed type int dword_140C64120;
// 140C644A8: using guessed type int dword_140C644A8;
