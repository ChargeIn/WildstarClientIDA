//----- (0000000140233670) ----------------------------------------------------
__int64 sub_140233670()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6CE40, qword_140C63858);
	if (dword_140C64140 || (int)sub_140233460() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C63BF0 + 40i64))(qword_140C63BF0);
}
