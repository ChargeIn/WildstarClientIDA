...
__int64 sub_14021A0A0()
{
	...
	if (qword_140C64860)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ModelPose"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ModelPose.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021A13C: variable 'v1' is possibly undefined
// 140A7F468: using guessed type wchar_t *off_140A7F468;
// 140A94100: using guessed type wchar_t aDbModelposeTbl[17];
// 140A94128: using guessed type wchar_t aModelpose[10];
