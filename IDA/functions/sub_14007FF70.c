...
//----- (000000014007FF70) ----------------------------------------------------
__int64 __fastcall sub_14007FF70(__int64 a1, char* a2)
{
	__int64 v2; // r8
	...
	{
		result = sub_140336470(a1, v12, 1ui64);
		if ((int)result < 0)
			return result;
	}
	v17 = *(_QWORD*)(a1 + 8);
			...
			(unsigned __int64)(8i64 * (*(_QWORD*)(v17 + 24) - *(_QWORD*)(v17 + 32)) - v19) >= 0x40))
	{
		...
		*v21 |= (unsigned __int64)(unsigned int)v20 << *(_QWORD*)(a1 + 16);
		v22 = *(_QWORD*)(a1 + 16);
		if (((v22 + 15) & 0xFFFFFFFFFFFFFFF8ui64) > 0x40)
			*(_BYTE*)(*(_QWORD*)(v17 + 32) + 8i64) = v20 >> (64 - (unsigned __int8)v22);
		*(_QWORD*)(v17 + 32) += (unsigned __int64)(*(_QWORD*)(a1 + 16) + 8i64) >> 3;
		*(_QWORD*)(a1 + 16) &= 7ui64;
	}
	else
	{
		result = sub_140336470(a1, v18, 8ui64);
		if ((int)result < 0)
			return result;
	}
	return sub_140336040(a1, *((unsigned __int16**)a2 + 2));
}
