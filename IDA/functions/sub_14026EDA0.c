...
//----- (000000014026EDA0) ----------------------------------------------------
__int64 __fastcall sub_14026EDA0(__int64 a1, int* a2, __int64* a3)
{
	...
	v6 = (*(__int64(__fastcall**)(__m128i**))(a1 + 7512))(&v18);
	v7 = *(_QWORD**)(*(_QWORD*)(a1 + 7504) + 8 * (v6 % *(_QWORD*)(a1 + 7496)));
	if (!v7)
		goto LABEL_10;
	while (v6 != *v7 || !(*(unsigned int(__fastcall**)(__m128i**, _QWORD*))(a1 + 7520))(&v18, v7 + 2))
	{
		v7 = (_QWORD*)v7[1];
		if (!v7)
			goto LABEL_10;
	...
	{
	LABEL_10:
		v8 = sub_14018B280(136i64, 0);
		v9 = (__int64)v8;
		if (v8)
		{
			*(_QWORD*)v8 = off_140B61AA0;
			*((_QWORD*)v8 + 10) = 0i64;
			*((_QWORD*)v8 + 11) = 0i64;
			*((_QWORD*)v8 + 12) = 0i64;
			*((_QWORD*)v8 + 13) = 0i64;
		...
		v12 = sub_140297180(v9, v18->m128i_i32);
		if (v12 < 0)
		{
			if (v9)
			{
...
// 14026EDA0: using guessed type __m128i var_238[33];
