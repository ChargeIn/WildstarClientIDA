//----- (0000000140154AC0) ----------------------------------------------------
__int64 __fastcall sub_140154AC0(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Apollo.ApolloCursor");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6 - 16;
	sub_140057020(a1, "ApolloCursor", &off_140B5C700);
	a1[2] -= 16i64;
	return 0i64;
}
// 140154BD3: variable 'v14' is possibly undefined
// 140B5C700: using guessed type void *off_140B5C700;
// 140C57BD0: using guessed type char *off_140C57BD0;
