#include "../winhttp.h"
#include "sub_1403C74D0.c"
#include "sub_1403C08D0.c"
#include "sub_14056AC90.c"
#include "sub_14062D0F0.c"
#include "sub_14054F210.c"
#include "sub_14048F960.c"
#include "Apollo_LUAEvent.c"
#include "sub_1403D1E10.c"
#include "sub_140611F20.c"
#include "sub_140643F00.c"
#include "sub_1403C9A70.c"
#include "sub_1403CD9E0.c"
#include "sub_140611F20.c"
#include "sub_1403C6A90.c"
#include "sub_1403C9A70.c"
#include "sub_1403B8790.c"
#include "sub_1403B8630.c"
#include "sub_1403B88D0.c"
#include "sub_14048E2B0.c"
#include "sub_14048DED0.c"
#include "sub_1403C0F90.c"
#include "sub_140498A40.c"
#include "sub_1403CC360.c"
#include "sub_1403CC270.c"
#include "sub_1403ACBB0.c"
#include "sub_140008410.c"
#include "sub_1404A7B30.c"
#include "sub_1404A75D0.c"
#include "sub_1403CBB60.c"
#include "sub_1403C9180.c"
#include "sub_1403B67E0.c"
#include "sub_140572430.c"
#include "sub_140572360.c"
#include "sub_1405725F0.c"
#include "sub_140572670.c"
#include "sub_1403D1CE0.c"
#include "sub_1403D90D0.c"
#include "sub_1403B9720.c"
#include "sub_1403B95C0.c"
#include "sub_1403D2550.c"
#include "sub_1404A7D40.c"
#include "sub_140572550.c"
#include "sub_1403CB990.c"
#include "sub_1405724B0.c"
#include "sub_14049A790.c"
    ...
    *(_DWORD *) (a1 + 31564) = dword_140C636A8;
    switch (a3) {
        ...
        case 0xA9u:
            ...
            return (unsigned int) v13;
        case 0xAAu:
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "ChallengeShareTimedOut", byte_1409E9994, *a4);
            goto LABEL_995;
        case 0xADu:
        ...
        case 0xBDu:
            ...
            return (unsigned int) v13;
        case 0xC1u:
            Apollo_LUAEvent(*(_QWORD *) (a1 + 29504), "DuelCancelWarning", byte_1409D10AF);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0xC4u:
            LODWORD(v13) = 0;
        ...
        case 0x846u:
            goto LABEL_5;
        case 0xD3u:
            Apollo_LUAEvent(*(_QWORD *) (a1 + 29504), "HideInstanceGameModeDialog", byte_1409E8FBC, 0i64);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0xD6u:
        ...
        case 0xDFu:
            ...
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "DatacubeUpdated", &unk_1409D0C13);
            goto LABEL_378;
        case 0xE0u:
        ...
        case 0xE1u:
            ...
            LODWORD(v13) = 0;
            if (*v8)
                Apollo_LUAEvent(v130, "DatacubeUpdated", byte_1409E9484);
            else
                Apollo_LUAEvent(v130, "DatacubeUpdated", &unk_1409D0C13);
        ...
        case 0xE2u:
            ...
            if (*v8)
                Apollo_LUAEvent(v131, "DatacubeUpdated", byte_1409E9484);
            else
                Apollo_LUAEvent(v131, "DatacubeUpdated", &unk_1409D0C13);
            goto LABEL_378;
        case 0xEBu:
        ...
        case 0xFEu:
            ...
            *(_DWORD *) (a1 + 25384) = *a4;
            Apollo_LUAEvent(v226, "CharacterFlagsUpdated", &unk_1409D1329);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x100u:
            ...
            return (unsigned int) v13;
        case 0x101u:
            Apollo_LUAEvent(*(_QWORD *) (a1 + 29504), "ForceResurrect", &unk_1409D0946);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x102u:
        ...
        case 0x13Du:
            ...
            if (v235) {
                ...
                *(_DWORD *) (a1 + 28136) = 0;
                Apollo_LUAEvent(v236, "UnitPvpFlagsChanged", L"U", *(unsigned int *) (v235 + 8));
            }
            return (unsigned int) v13;
        case 0x13Eu:
            v234 = *(_QWORD *) (a1 + 120);
            ...
            *(_DWORD *) (a1 + 28136) = v12 + *a4;
            Apollo_LUAEvent(*(_QWORD *) (a1 + 29504), "UnitPvpFlagsChanged", L"U", *(unsigned int *) (v234 + 8));
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x140u:
        ...
        case 0x143u:
            ...
            return (unsigned int) v13;
        case 0x145u:
            Apollo_LUAEvent(*(_QWORD *) (a1 + 29504), "CharacterRecustomizationResult", L"i", *a4);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x148u:
        ...
        LABEL_576:
            ...
            return (unsigned int) v13;
        case 0x14Du:
            Apollo_LUAEvent(*(_QWORD *) (a1 + 29504), "RepairItemCompleted", &unk_1409D0D86);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x152u:
        ...
        case 0x155u:
            v225 = a4[1];
        LABEL_675:
            Apollo_LUAEvent(*(_QWORD *) (a1 + 29504), "OnInstanceResetResult", byte_1409E8FEC, v225);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x157u:
            v24 = *(_QWORD *) (a1 + 28048);
            ...
            return (unsigned int) v13;
        case 0x158u:
            Apollo_LUAEvent(*(_QWORD *) (a1 + 29504), "ShowInstanceRestrictedDialog", &unk_1409D09DF);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x15Bu:
            ...
            *(_DWORD *) (a1 + 7048) = 1;
            ...
            if (v27)
                v28 = v27;
            Apollo_LUAEvent(v26, "CasterResurrectedPlayer", byte_1409E8FAC, v28);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x160u:
            Apollo_LUAEvent(*(_QWORD *) (a1 + 29504), "ScriptResurrect", &unk_1409D0943);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x164u:
        ...
        case 0x175u:
            ...
            Apollo_LUAEvent(*(_QWORD *) (a1 + 29504), "SpecChanged", byte_1409ECDE4, (unsigned int) v281 + 1, v8[1]);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x176u:
        ...
        LABEL_377:
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "FlightPathUpdate", &unk_1409D0E02);
        LABEL_378:
            LODWORD(v13) = 0;
            *(_DWORD *) (qword_140C65898 + 28568) = 1;
            return (unsigned int) v13;
        ...
        LABEL_55:
            Apollo_LUAEvent(*(_QWORD *) (a1 + 29504), "P2PTradeChange", byte_1409D1277);
            return (unsigned int) v13;
        case 0x199u:
        ...
        case 0x1A6u:
            ...
            *(_DWORD *) (a1 + 1372) = *a4;
            Apollo_LUAEvent(v224, "UpdateGearScore", &unk_1409D0E2E);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x1A7u:
        ...
        case 0x1B4u:
            ...
            if (!v222)
                goto LABEL_5;
            (*(void (__fastcall **)(__int64, _QWORD, _QWORD)) (*(_QWORD *) v222 + 144i64))(v222, *((_QWORD *) v8 + 1),
                                                                                           v8[1]);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x1B5u:
        ...
        case 0x24Au:
            ...
            goto LABEL_896;
        case 0x24Bu:
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "CommodityAuctionRemoved", byte_1409EC83C, a4[14], a4);
            goto LABEL_926;
        case 0x24Cu:
        ...
        case 0x252u:
            ...
            return (unsigned int) v13;
        case 0x257u:
            Apollo_LUAEvent(*(_QWORD *) (a1 + 29504), "CostumeSaveResult", "iii", a4[1], *a4, a4[2]);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x258u:
        ...
        case 0x363u:
            ...
            if (!v199)
                goto LABEL_5;
            Apollo_LUAEvent((__int64) v13, "Dialog_QuestShare", byte_1409E91EC, v199, v198);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x366u:
        ...
        case 0x3A5u:
            ...
            *(_DWORD *) (a1 + 27360) = *a4 & 2;
            Apollo_LUAEvent(*(_QWORD *) (v279 + 29504), "FriendshipAccountPersonalStatusUpdate", &unk_1409D0EFD);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x3A6u:
        ...
        LABEL_896:
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), v239, v238, a4, v237);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x3C6u:
        ...
        case 0x3D2u:
            ...
            LODWORD(v13) = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD, unsigned int *)) (*(_QWORD *) v280 +
                                                                                                 88i64))(
                    v280,
                    a2,
                    a3,
        ...
        case 0x3E1u:
            if (*a4) {
                if (*a4 == 1)
                    Apollo_LUAEvent(*(_QWORD *) (a1 + 29504), "RealmBroadcastTierMedium", byte_1409EBA1C,
                                  *((_QWORD *) a4 + 1));
            } else {
                Apollo_LUAEvent(*(_QWORD *) (a1 + 29504), "RealmBroadcastTierHigh", byte_1409EB9E4, *((_QWORD *) a4 + 1));
            }
            LODWORD(v13) = 0;
        ...
        case 0x424u:
            ...
            *(_QWORD *) (a1 + 27712) = v266;
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "Group_JoinRequest", byte_1409EA1EC,
                          *((_QWORD *) a4 + 4));
            goto LABEL_138;
        case 0x427u:
        ...
        case 0x45Au:
            ...
            Apollo_LUAEvent(v274, "ZoneMapPing", byte_1409E9DC4, v272, &v291);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x45Bu:
        ...
        case 0x4AEu:
            ...
            *(_DWORD *) (v242 + 152) = v8[4];
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "UnitGuildNameplateChanged", byte_1409EDCCC, *v8);
            goto LABEL_995;
        case 0x4AFu:
        ...
        case 0x555u:
            ...
            *(_DWORD *) (a1 + 7044) = *a4;
            Apollo_LUAEvent(v283, "InstanceSetBusy", byte_1409E8F04);
            *(_DWORD *) (a1 + 28568) = 1;
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x55Fu:
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "ItemAuctionBidPosted", byte_1409EC93C, a4);
            goto LABEL_138;
        case 0x560u:
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "ItemAuctionBidResult", byte_1409EC8B4, *a4, a4 + 2);
            goto LABEL_926;
        case 0x561u:
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "ItemAuctionExpired", byte_1409EC404, a4);
            goto LABEL_138;
        case 0x562u:
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "ItemAuctionOutbid", byte_1409EC4A4, a4);
            goto LABEL_138;
        case 0x563u:
            ...
            return (unsigned int) v13;
        case 0x564u:
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "ItemAuctionWon", byte_1409EC424, a4);
            goto LABEL_138;
        case 0x565u:
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "ItemCancelResult", byte_1409EC91C, a4[28], a4);
            goto LABEL_926;
        case 0x566u:
        ...
        case 0x5A0u:
            ...
            if (!v202)
                goto LABEL_5;
            Apollo_LUAEvent(*(_QWORD *) (a1 + 29504), "EldanForgeResult", "O", v202);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x5A1u:
            if (*(_QWORD *) (a1 + 32144))
        ...
        case 0x5BEu:
            *(_DWORD *) (qword_140C65B98 + 340) = 1;
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "MatchFinished", byte_1409D1257);
            goto LABEL_151;
        case 0x5BFu:
            v227 = qword_140C65B98;
            *(_DWORD *) (qword_140C65B98 + 264) = *a4;
            *(_DWORD *) (v227 + 336) = 1;
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "MatchEntered", &unk_1409D1273);
            goto LABEL_151;
        case 0x5C0u:
            LODWORD(v13) = 0;
            *(_DWORD *) (qword_140C65B98 + 336) = 0;
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "MatchExited", byte_1409D12A3);
            return (unsigned int) v13;
        case 0x5C4u:
        ...
        case 0x5E5u:
            ...
            goto LABEL_926;
        case 0x5E6u:
            Apollo_LUAEvent(*(_QWORD *) (a1 + 29504), "MatchingPvpInactivityAlert", L"i", *a4);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x5E7u:
        ...
        case 0x66Cu:
            ...
            Apollo_LUAEvent(v37, "SettlerBuildResult", "iS", v36, v13);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x66Du:
            if (!*(_QWORD *) (a1 + 120) || *(_DWORD *) (a1 + 26180) != 30 || !a4[1] ||
                !sub_1403D90D0(qword_140C65898, *a4))
                goto LABEL_5;
        ...
        case 0x66Fu:
            ...
            Apollo_LUAEvent((__int64) v13, "SettlerHubReward", L"S", v101);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x671u:
            if (!*(_QWORD *) (a1 + 120))
        ...
        case 0x672u:
            ...
            return (unsigned int) v13;
        case 0x673u:
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "SettlerInfrastructureComplete", &unk_1409D1143);
            goto LABEL_151;
        case 0x674u:
            if (!*(_QWORD *) (a1 + 120))
                goto LABEL_5;
            ...
            v41[5] = v8[2];
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "SettlerInfrastructureUpdated", byte_1409D118B);
            goto LABEL_151;
        case 0x675u:
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "SettlerInfrastructureStarted", &unk_1409D11C2);
            goto LABEL_151;
        case 0x676u:
        ...
        LABEL_136:
            v34 = *((_QWORD *) v32 + 19);
        LABEL_137:
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "UpdateSoldierBuild", L"#", v34);
        LABEL_138:
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x687u:
        ...
        case 0x6BCu:
            ...
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "SetPlayerPath", &unk_1409D1142);
            sub_1405B3A80();
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x6BEu:
            ...
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "PathUnlockResult", byte_1409EBB94, *a4);
            goto LABEL_995;
        case 0x6BFu:
            if (!*(_QWORD *) (a1 + 120) || !qword_140C65970)
                goto LABEL_5;
        ...
        case 0x6DBu:
            ...
            return (unsigned int) v13;
        case 0x6DDu:
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "PostItemAuctionResult", byte_1409EC8D4, *a4, a4 + 2);
            goto LABEL_926;
        case 0x6DFu:
        ...
        case 0x6F1u:
            ...
            return (unsigned int) v13;
        case 0x6F5u:
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "PublicEventBombDropped", byte_1409ED424, *a4, a4[1]);
            goto LABEL_926;
        case 0x6F6u:
            ...
            v211 = a4[1];
        LABEL_602:
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), v210, v209, a4[2], v211, v288);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x6F9u:
        ...
        case 0x737u:
            ...
            if (v8[1])
                Apollo_LUAEvent(v157, "GenericMapNodeEnabled", "R", v156);
            else
                Apollo_LUAEvent(v157, "GenericMapNodeDisabled", "R", v156);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x738u:
        ...
        case 0x856u:
            ...
            return (unsigned int) v13;
        case 0x85Du:
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "TradeSkillSigilResult", L"i", *a4);
            goto LABEL_995;
        case 0x85Eu:
        ...
        case 0x88Au:
            ...
            *(_DWORD *) (v120 + 13836) = v8[1];
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "UnitMiniMapMarkerChanged", byte_1409EDC1C, v121);
            goto LABEL_995;
        case 0x88Cu:
        ...
        case 0x8ACu:
            ...
            *(_DWORD *) (v127 + 532) = v8[1];
            ...
            if (!v128 || !*(_DWORD *) (v128 + 168))
                goto LABEL_5;
            Apollo_LUAEvent(*(_QWORD *) (qword_140C65898 + 29504), "UnitMiniMapMarkerChanged", byte_1409EDC1C, *v8);
        LABEL_995:
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x8B2u:
        ...
        case 0x936u:
            ...
            *(_QWORD *) (v93 + 6304) = *((_QWORD *) v8 + 1);
            Apollo_LUAEvent(*(_QWORD *) (a1 + 29504), "UnitGroupChanged", L"U", *v8);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x937u:
        ...
        case 0x93Fu:
            ...
            if (!v52)
                goto LABEL_5;
            *(_DWORD *) (v52 + 584) = v8[1];
            Apollo_LUAEvent(*(_QWORD *) (a1 + 29504), "RefreshHealthCeiling", &unk_1409D08F3);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x940u:
            ...
            if (!v53)
                goto LABEL_5;
            *(_DWORD *) (v53 + 588) = v8[1];
            Apollo_LUAEvent(*(_QWORD *) (a1 + 29504), "RefreshHealthFloor", &unk_1409D08BF);
            LODWORD(v13) = 0;
            return (unsigned int) v13;
        case 0x951u:
