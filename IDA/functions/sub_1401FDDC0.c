...
__int64 sub_1401FDDC0()
{
	...
	if (qword_140C64018)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Entitlement"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Entitlement.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401FDE5C: variable 'v1' is possibly undefined
// 140A88D18: using guessed type wchar_t aEntitlement[12];
// 140A88E68: using guessed type wchar_t aDbEntitlementT[19];
// 140ADE5D8: using guessed type wchar_t *off_140ADE5D8;
...
// 140C648D0: using guessed type int dword_140C648D0;
// 140C64CC4: using guessed type int dword_140C64CC4;
