...
__int64 sub_14021B5E0()
{
	...
	if (qword_140C63D90)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ModelSequenceTransition"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\ModelSequenceTransition.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021B67C: variable 'v1' is possibly undefined
// 140A70C68: using guessed type wchar_t *off_140A70C68;
// 140A948D0: using guessed type wchar_t aDbModelsequenc_3[31];
// 140A949C8: using guessed type wchar_t aModelsequencet[24];
...
// 140C63F54: using guessed type int dword_140C63F54;
// 140C647D4: using guessed type int dword_140C647D4;
