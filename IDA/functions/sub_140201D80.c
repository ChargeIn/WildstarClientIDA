...
__int64 sub_140201D80()
{
	...
	if (qword_140C63BA8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"GossipSet"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\GossipSet.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140201E1C: variable 'v1' is possibly undefined
// 140A8A410: using guessed type wchar_t aDbGossipsetTbl[17];
// 140A8A438: using guessed type wchar_t aGossipset[10];
// 140ACAE18: using guessed type wchar_t *off_140ACAE18;
...
// 140C63DCC: using guessed type int dword_140C63DCC;
// 140C64280: using guessed type int dword_140C64280;
