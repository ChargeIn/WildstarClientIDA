...
__int64 sub_140236760()
{
	...
	if (qword_140C63E80)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4AoeTargetConstraints"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\Spell4AoeTargetConstraints.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402367FC: variable 'v1' is possibly undefined
// 140A71850: using guessed type wchar_t *off_140A71850;
// 140AA51B8: using guessed type wchar_t aSpell4aoetarge[27];
// 140AA53B0: using guessed type wchar_t aDbSpell4aoetar[34];
...
// 140C641C0: using guessed type int dword_140C641C0;
// 140C64CC8: using guessed type int dword_140C64CC8;
// 140C650D0: using guessed type int dword_140C650D0;
