...
//----- (00000001402173F0) ----------------------------------------------------
__int64 sub_1402173F0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6B710, qword_140C63858);
	if (dword_140C6565C || (int)sub_1402171E0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C65548 + 40i64))(qword_140C65548);
}
