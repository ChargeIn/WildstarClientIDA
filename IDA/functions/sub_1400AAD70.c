...
//----- (00000001400AAD70) ----------------------------------------------------
__int64 __fastcall sub_1400AAD70(__int64 a1, float* a2)
{
	__int64 v2; // r8
	...
	if ((int)result >= 0)
	{
		...
		if ((int)result >= 0)
		{
			result = sub_1400A72A0(a1, *((_DWORD*)a2 + 4));
			if ((int)result >= 0)
			{
				result = sub_1400A7110(a1, *((_DWORD*)a2 + 5), 0x12ui64);
				if ((int)result >= 0)
				{
					...
					if ((int)result >= 0)
					{
						...
						if ((int)result >= 0)
						{
							result = sub_1400A7250(a1, *((_DWORD*)a2 + 8) != 0, 1ui64);
							if ((int)result >= 0)
							{
								result = sub_1400A7250(a1, *((_DWORD*)a2 + 9) != 0, 1ui64);
								if ((int)result >= 0)
								{
									result = sub_1400A7250(a1, *((_DWORD*)a2 + 10) != 0, 1ui64);
									if ((int)result >= 0)
									{
