//----- (00000001407F84B0) ----------------------------------------------------
__int64 __fastcall sub_1407F84B0(int* a1, int a2, char a3, __int64 a4)
{
	__int16 v4; // di
	int v5; // r10d
	unsigned int v7; // r9d
	...
	char* v100; // [rsp+40h] [rbp-59h]
	int v101; // [rsp+48h] [rbp-51h]
	int v103; // [rsp+50h] [rbp-49h]
	__int64 v104; // [rsp+58h] [rbp-41h]
	...
	if (v10)
	{
		...
		*(_WORD*)a4 = 1;
		...
		{
			if ((unsigned int)sub_1407EA194((_BYTE*)(a4 + 4), 22i64, "1#SNAN"))
			{
				sub_1407DC390();
				__debugbreak();
			}
		...
		if (v9 && v7 == -1073741824)
		{
			if (!v5)
			{
				if ((unsigned int)sub_1407EA194((_BYTE*)(a4 + 4), 22i64, "1#IND"))
				{
					sub_1407DC390();
					__debugbreak();
				}
		...
		{
			if ((unsigned int)sub_1407EA194((_BYTE*)(a4 + 4), 22i64, "1#INF"))
			{
				sub_1407DC390();
				__debugbreak();
			}
		...
		if ((unsigned int)sub_1407EA194((_BYTE*)(a4 + 4), 22i64, "1#QNAN"))
		{
			sub_1407DC390();
			__debugbreak();
		}
	...
	if ((unsigned int)(v16 + v12 - 323162868) >> 16)
	{
		...
		if (!v19)
		{
			...
			else
			{
				...
				{
					++v30;
					if ((v24[1] & 0x7FFFFFFF) == 0 && !*((_DWORD*)v24 + 1) && !*(_DWORD*)v24)
						goto LABEL_41;
				}
				v31 = 0;
				v32 = v107;
...
// 1407F87F1: conditional instruction was optimized away because edi.4>=1
// 1407F8AF3: conditional instruction was optimized away because r12d.4>=1
