//----- (000000014080BA30) ----------------------------------------------------
__int64 __fastcall sub_14080BA30(unsigned int a1, __int64 a2)
{
	...
	if (v6 && v6 != -14)
		return v6;
	if (v6 == -14)
		qword_140C60998 = 0i64;
	if (qword_140C60998 && dword_140C609A0 != dword_140C60980[v7])
		qword_140C60998 = 0i64;
	if (!qword_140C60998 && v4 && nvapi_QueryInterface)
	{
		qword_140C60998 = nvapi_QueryInterface(1814889612i64);
		dword_140C609A0 = dword_140C60980[v7];
	}
	if (qword_140C60998)
	{
		v3 = (__int64(__fastcall*)(_QWORD, __int64))qword_140C60998;
		v5 = 0i64;
		if (qword_140C60938)
			qword_140C60938(1814889612i64, &v5);
		v6 = v3(a1, a2);
		if (qword_140C60940)
			qword_140C60940(1814889612i64, v5, v6);
		--dword_140C60970[v7];
		return v6;
	}
	else
...
// 140C60998: using guessed type __int64 qword_140C60998;
// 140C609A0: using guessed type int dword_140C609A0;
