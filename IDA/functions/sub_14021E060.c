...
__int64 sub_14021E060()
{
	...
	if (qword_140C64CD8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathExplorerPowerMap"))
	{
...
// 14021E0FC: variable 'v1' is possibly undefined
// 140A955A0: using guessed type wchar_t aPathexplorerpo[21];
// 140A95718: using guessed type wchar_t aDbPathexplorer_4[28];
// 140AE1518: using guessed type wchar_t *off_140AE1518;
...
// 140C64900: using guessed type int dword_140C64900;
// 140C64C24: using guessed type int dword_140C64C24;
