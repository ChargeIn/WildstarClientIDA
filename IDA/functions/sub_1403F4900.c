...
//----- (00000001403F4900) ----------------------------------------------------
void __fastcall sub_1403F4900(__int64 a1, unsigned int a2, __int64 a3)
{
	int v4; // ebx
	__int64 v5; // rcx
	__int64 v6; // rax
	...
	if (*(_QWORD*)(a1 + 31016) && qword_140C65808)
	{
			...
			a3))
		{
			...
			*((_QWORD*)&v16 + 1) = TlsGetValue(dwTlsIndex);
			...
			v19 = 0x141DF2A98i64;
			v18 = v16;
			v4 = sub_1401971E0(&dword_140C8A770, 5, &v19, &v17);
			TlsValue = &off_140B5E648;
...
// 140C8A770: using guessed type _DWORD dword_140C8A770;
