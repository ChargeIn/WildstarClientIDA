...
//----- (0000000140382C20) ----------------------------------------------------
__int64 __fastcall sub_140382C20(__int64 a1)
{
	__int64 v2; // rcx
	__int64 result; // rax
	int v4; // eax
	...
	{
		v4 = (*(__int64(__fastcall**)(_QWORD, __int64))(**(_QWORD**)(a1 + 16) + 64i64))(*(_QWORD*)(a1 + 16), 31i64);
		result = sub_140350A20(*(_QWORD*)(*(_QWORD*)a1 + 16i64), 7i64, v4, (int**)(a1 + 1176));
		if ((int)result >= 0 && (_DWORD)result != 1)
		{
			v5 = *(_QWORD*)(a1 + 16);
			v14 = 0i64;
			(*(void(__fastcall**)(__int64, __int64, __int64**))(*(_QWORD*)v5 + 72i64))(v5, 31i64, &v14);
			v6 = *(_QWORD*)(*(_QWORD*)(a1 + 1176) + 32i64);
