...
__int64 sub_1401F2F80()
{
	...
	if (qword_140C63C28)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Class"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Class.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F301C: variable 'v1' is possibly undefined
// 140A4BE38: using guessed type wchar_t *off_140A4BE38;
// 140A62CD0: using guessed type wchar_t aDbClassTbl[13];
// 140A63068: using guessed type wchar_t aClass_0[6];
...
// 140C64C0C: using guessed type int dword_140C64C0C;
// 140C65254: using guessed type int dword_140C65254;
// 140C652FC: using guessed type int dword_140C652FC;
