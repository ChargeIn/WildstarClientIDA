...
__int64 sub_1401EABC0()
{
	...
	if (qword_140C646A0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ActionBarShortcutSet"))
	{
...
// 1401EAC5C: variable 'v1' is possibly undefined
// 140A4EDA8: using guessed type wchar_t aDbActionbarsho[28];
// 140A50A28: using guessed type wchar_t aActionbarshort[21];
// 140AD5738: using guessed type wchar_t *off_140AD5738;
...
// 140C64760: using guessed type int dword_140C64760;
// 140C64ABC: using guessed type int dword_140C64ABC;
// 140C64B04: using guessed type int dword_140C64B04;
