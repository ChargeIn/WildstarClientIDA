...
//----- (00000001404B1BB0) ----------------------------------------------------
__int64 __fastcall sub_1404B1BB0(_QWORD* a1)
{
	__m128i* v2; // rax
	__int64 v3; // rcx
	__int64 v4; // rcx
	...
	if (v84)
	{
		while (1)
		{
			...
			if (v12)
			{
				...
				v15 = L"ViewedLevelUpUnlocks";
				if (v14 == L"ViewedLevelUpUnlocks")
					break;
				v16 = 0;
				if (*v14)
				{
		...
		if (v13)
		{
			for (i = sub_1401A5AE0(v13, L"LevelUpUnlock"); i; i = sub_1401A5BC0(i, L"LevelUpUnlock"))
			{
				v19 = *(_QWORD*)(i + 96);
				LODWORD(v74) = 0;
				if (v19)
			...
			LABEL_50:
				LODWORD(v75) = v74;
				sub_1400293C0((__int64)(a1 + 12), (__int64)v78, (int*)&v75);
			}
		}
	LABEL_51:
		v25 = v84;
		if (v84)
		{
			while (1)
			{
				...
				if (v26)
				{
					...
					v29 = L"PendingLevelUpUnlocks";
					if (v28 == L"PendingLevelUpUnlocks")
						break;
					v30 = 0;
					if (*v28)
					{
			...
			if (v27)
			{
				...
				if (v32)
				{
					while (1)
					{
						...
						for (j = sub_1401A5AE0(v32, L"LevelUpUnlock"); j; j = sub_1401A5BC0(j, L"LevelUpUnlock"))
						{
							v43 = *(_QWORD*)(j + 96);
							v44 = 0;
							LODWORD(v74) = 0;
						...
						if (v57 != *(_QWORD**)(v54 + 16))
							break;
						sub_1400EECD0((__int64)(a1 + 16), &v79, (__int64)v56, v57, v78);
					LABEL_147:
						v32 = sub_1401A5BC0(v32, L"Character");
						if (!v32)
							goto LABEL_148;
					}
					if (*(_BYTE*)v57 || *(_QWORD**)(v57[1] + 8i64) != v57)
					{
						v58 = (_QWORD*)v57[2];
						if (v58)
						{
				...
				LABEL_133:
					if (v58[4] < v39)
					{
						if (v57 == (_QWORD*)v54 || v39 < v57[4])
						{
							...
							{
								v63[1] = v61;
								*(_QWORD*)(a1[17] + 24i64) = v61;
							}
							else if (v57 == (_QWORD*)v63[2])
							{
								v63[2] = v61;
							}
						}
						...
						*((_QWORD*)v61 + 2) = 0i64;
						*((_QWORD*)v61 + 3) = 0i64;
						sub_1400081C0((__int64)v61, (_QWORD*)(a1[17] + 8i64));
						++a1[18];
					}
					goto LABEL_147;
				}
...
// 1404B1E97: conditional instruction was optimized away because rdi.8!=0
// 1404B2032: conditional instruction was optimized away because rdi.8!=0
// 1404B215A: conditional instruction was optimized away because rdi.8!=0
// 1404B22DF: conditional instruction was optimized away because rcx.8==0
// 1404B1CA5: variable 'v4' is possibly undefined
...
// 140B03A84: using guessed type wchar_t aId_10[3];
// 140B07404: using guessed type wchar_t aId_12[3];
// 140B07AB4: using guessed type wchar_t aId_11[3];
// 140B08F08: using guessed type wchar_t aLevelupunlocks[19];
// 140B08FA8: using guessed type wchar_t aLevelupunlock_0[14];
// 140B090B8: using guessed type wchar_t aLevelupunlock_1[14];
// 140B090D8: using guessed type wchar_t aPendinglevelup[22];
// 140B091B0: using guessed type wchar_t aViewedlevelupu[21];
// 140B092B0: using guessed type wchar_t aLevelupunlock_3[14];
// 140B09328: using guessed type wchar_t aCharacter_4[10];
// 140B09340: using guessed type wchar_t aCharacter_5[10];
// 140B09358: using guessed type wchar_t aLevelupunlock_2[14];
...
// 1404B1BB0: using guessed type __m128i var_240[33];
// 1404B1BB0: using guessed type char var_250[16];
