...
__int64 sub_1402327A0()
{
	...
	if (qword_140C63EF0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"SoundCombatLoop"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\SoundCombatLoop.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023283C: variable 'v1' is possibly undefined
// 140AA2C50: using guessed type wchar_t aSoundcombatloo[16];
// 140AA2E10: using guessed type wchar_t aDbSoundcombatl[23];
// 140ADD380: using guessed type wchar_t *off_140ADD380;
...
// 140C6387C: using guessed type int dword_140C6387C;
...
// 140C64904: using guessed type int dword_140C64904;
