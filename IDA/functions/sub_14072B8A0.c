...
//----- (000000014072B8A0) ----------------------------------------------------
_QWORD* __fastcall sub_14072B8A0(_QWORD* a1, int a2)
{
	int* v4; // rax
	_QWORD* v5; // r15
	__int64* v6; // rax
...
// 14072BBEE: variable 'v27' is possibly undefined
// 140A12138: using guessed type _DWORD dword_140A12138[4];
// 140B466A8: using guessed type wchar_t aCount_8[6];
// 140B466B8: using guessed type wchar_t aKey_2[4];
// 140B466C0: using guessed type wchar_t aName_33[5];
// 140B466D0: using guessed type wchar_t aFemale_4[7];
// 140B466E0: using guessed type wchar_t aMale_4[5];
// 140B466F0: using guessed type wchar_t aSex_5[4];
// 14072B8A0: using guessed type char var_70[8];
