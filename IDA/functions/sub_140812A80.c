//----- (0000000140812A80) ----------------------------------------------------
__int64 __fastcall sub_140812A80(unsigned int a1, __int64 a2)
{
	...
	if (v6 && v6 != -14)
		return v6;
	if (v6 == -14)
		qword_140C60E08 = 0i64;
	if (qword_140C60E08 && dword_140C60E10 != dword_140C60980[v7])
		qword_140C60E08 = 0i64;
	if (!qword_140C60E08 && v4 && nvapi_QueryInterface)
	{
		qword_140C60E08 = nvapi_QueryInterface(3806455536i64);
		dword_140C60E10 = dword_140C60980[v7];
	}
	if (qword_140C60E08)
	{
		v3 = (__int64(__fastcall*)(_QWORD, __int64))qword_140C60E08;
		v5 = 0i64;
		if (qword_140C60938)
			qword_140C60938(3806455536i64, &v5);
		v6 = v3(a1, a2);
		if (qword_140C60940)
			qword_140C60940(3806455536i64, v5, v6);
		--dword_140C60970[v7];
		return v6;
	}
	else
...
// 140C60E08: using guessed type __int64 qword_140C60E08;
// 140C60E10: using guessed type int dword_140C60E10;
