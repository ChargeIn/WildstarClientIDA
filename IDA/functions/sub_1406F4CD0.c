...
//----- (00000001406F4CD0) ----------------------------------------------------
__int64 __fastcall sub_1406F4CD0(_QWORD* a1)
{
	__int64 v1; // rbx
	char* v3; // rax
	unsigned int* v4; // rcx
	...
	unsigned __int16 v37[64]; // [rsp+90h] [rbp-B8h] BYREF

	v1 = *(_QWORD*)(qword_140C65898 + 30088);
	v3 = (char*)sub_140056BB0(a1, 1u, 0i64);
	sub_14018F2D0(&v33, v3);
	if (v1
		&& (v4 = (unsigned int*)(*(__int64(__fastcall**)(__int64, __int64, _QWORD))(*(_QWORD*)v1 + 344i64))(
			v1,
			v34,
			0i64)) != 0i64)
	{
	...
	else
	{
		...
		{
			v16 = sub_14018EFA0(&v35, (__int64)L"<<%d>>", 63i64);
			if (v16 != &v29)
			{
		...
		{
			v25 = *(unsigned __int16*)((char*)v24 + (char*)v8 - (char*)v37);
			if (!v25)
				break;
			*v24++ = v25;
			if (!--v23)
	...
	v26 = (unsigned __int64*)sub_14018F0E0(&v35, v37)[1];
	if (v26)
	{
		v27 = -1i64;
		do
...
// 1406F4F8B: conditional instruction was optimized away because rdx.8!=0
// 1406F4E4F: variable 'v13' is possibly undefined
// 140A171C0: using guessed type wchar_t aD_17[7];
// 140B41108: using guessed type wchar_t aError_2[6];
// 140C63650: using guessed type __int64 qword_140C63650;
// 140C65898: using guessed type __int64 qword_140C65898;
// 1406F4CD0: using guessed type unsigned __int16 var_B8[64];
