...
//----- (00000001400DA6D0) ----------------------------------------------------
__int64 __fastcall sub_1400DA6D0(_QWORD* a1)
{
	__int64 v1; // rdi
...
LABEL_7:
	...
	if (v7)
	{
		v8 = *(_QWORD**)(v1 + 400);
		v9 = dword_140A12138;
		v10 = (char*)sub_14018F0E0(&v17, word_1409D3174)[1];
		...
		if (v18)
			sub_14018B900(v18, 0);
		v12 = (*(__int64(__fastcall**)(_QWORD*, __int64))(*v7 + 456i64))(v7, v16);
		if (v16)
			sub_14018B900(v16, 0);
		if (v12)
		{
...
// 1409D3174: using guessed type unsigned __int16 word_1409D3174[128];
