//----- (0000000140756610) ----------------------------------------------------
__int64 __fastcall sub_140756610(_QWORD* a1)
{
	unsigned int v3; // eax
	__int64 v4; // rcx
	__int64 v5; // rdx
				...
				if (v9 != v8)
				{
					do
					{
						...
						*(_QWORD*)v10 = *(_OWORD*)&_mm_cvtepi32_pd(v11);
						a1[2] += 16i64;
						if ((unsigned int)sub_140755660((__int64)a1, *(unsigned int***)(v9 + 40)))
						{
							sub_14005EA50(
								(__int64)a1,
								(__int64*)(a1[2] - 48i64),
...
// 14075666E: variable 'v4' is possibly undefined
// 1407566AC: variable 'v5' is possibly undefined
