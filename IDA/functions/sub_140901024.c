...
//----- (0000000140901024) ----------------------------------------------------
__int64 __fastcall sub_140901024(int a1, _OWORD* a2)
{
	__int64 v2; // rdi
	__int64 v3; // rdx
	int v4; // eax
	...
	if ((unsigned int)v2 >= 0x100)
	{
		...
		v8 = sub_1407F09F8(&v10, *(_QWORD*)(v10 + 312), 0x200u, &v13, v6, &v16, 3, *(_DWORD*)(v10 + 4), 1);
		if (v8)
		{
			v9 = v8 == 1;
	...
	else
	{
		...
		if (*(int*)(v10 + 212) <= 1)
		{
			v4 = *(_WORD*)(*(_QWORD*)(v10 + 264) + 2 * v2) & 2;
		}
		else
		{
			v4 = sub_1407EA448(v2, 2, &v10);
			v3 = v10;
		}
		if (v4)
		{
			result = *(unsigned __int8*)(*(_QWORD*)(v3 + 280) + v2);
		LABEL_17:
			if (v12)
				*(_DWORD*)(v11 + 200) &= ~2u;
			return result;
