...
__int64 sub_1401FF300()
{
	...
	if (qword_140C64820)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Faction2Relationship"))
	{
...
// 1401FF39C: variable 'v1' is possibly undefined
// 140A68C68: using guessed type wchar_t *off_140A68C68;
// 140A89378: using guessed type wchar_t aFaction2relati[21];
// 140A89530: using guessed type wchar_t aDbFaction2rela[28];
