...
//----- (0000000140240270) ----------------------------------------------------
__int64 sub_140240270()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6D8C0, qword_140C63858);
	if (dword_140C650F4 || (int)sub_140240060() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64C70 + 40i64))(qword_140C64C70);
}
