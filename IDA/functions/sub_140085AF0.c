...
//----- (0000000140085AF0) ----------------------------------------------------
__int64 __fastcall sub_140085AF0(__int64 a1, int* a2)
{
	__int64 v2; // r8
	...
	result = sub_1400A7360(a1, *((_WORD*)a2 + 3));
	if ((int)result >= 0)
	{
		v17 = *a2;
		if (v17 < 0xC)
			return ((__int64(__fastcall*)(__int64, __int64, _DWORD*))funcs_140085C86[v17])(
				a1,
				(__int64)(a2 + 2),
				funcs_140085C86);
		else
...
// 140C1EC30: using guessed type __int64 (__fastcall *funcs_140085C86[55])();
