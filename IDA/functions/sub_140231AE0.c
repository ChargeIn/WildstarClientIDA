...
__int64 sub_140231AE0()
{
	...
	if (qword_140C63920)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"SkyCloudSet"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\SkyCloudSet.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140231B7C: variable 'v1' is possibly undefined
// 140AA26F0: using guessed type wchar_t aDbSkycloudsetT[19];
// 140AA2718: using guessed type wchar_t aSkycloudset[12];
...
// 140C63ECC: using guessed type int dword_140C63ECC;
// 140C643D0: using guessed type int dword_140C643D0;
