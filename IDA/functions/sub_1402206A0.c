...
__int64 sub_1402206A0()
{
	...
	if (qword_140C65520)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathScientistExperimentationPattern"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PathScientistExperimentationPattern.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022073C: variable 'v1' is possibly undefined
// 140A969F0: using guessed type wchar_t aDbPathscientis_2[43];
// 140A96B80: using guessed type wchar_t aPathscientiste_0[36];
// 140ADD1C0: using guessed type wchar_t *off_140ADD1C0;
...
// 140C63D78: using guessed type int dword_140C63D78;
// 140C6453C: using guessed type int dword_140C6453C;
// 140C64E1C: using guessed type int dword_140C64E1C;
