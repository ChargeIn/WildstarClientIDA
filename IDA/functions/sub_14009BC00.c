...
//----- (000000014009BC00) ----------------------------------------------------
__int64 __fastcall sub_14009BC00(__int64 a1, __int64 a2)
{
	__int64 v2; // r8
			...
			(unsigned __int64)(8i64 * (*(_QWORD*)(v10 + 24) - *(_QWORD*)(v10 + 32)) - v11) >= 0x40))
	{
		...
		v13 = *(_QWORD**)(v10 + 32);
		*v13 &= (1i64 << v11) - 1;
		*v13 |= (unsigned __int64)(unsigned int)v12 << *(_QWORD*)(a1 + 16);
		v14 = *(_QWORD*)(a1 + 16);
		if (((v14 + 39) & 0xFFFFFFFFFFFFFFF8ui64) > 0x40)
	...
	{
		result = sub_140336470(a1, *(int*)(a2 + 8), 0x20ui64);
		if ((int)result < 0)
			return result;
	}
	return sub_140336040(a1, *(unsigned __int16**)(a2 + 16));
}
