...
//----- (0000000140713CF0) ----------------------------------------------------
__int64 __fastcall sub_140713CF0(__int64 a1, int a2, unsigned int* a3, __int64 a4)
{
	int* v8; // rax
	__int64 v9; // rbx
	int v10; // esi
	...
	if (v8)
	{
		...
		*((_QWORD*)v8 + 6) = 0i64;
		*((_QWORD*)v8 + 7) = 0i64;
		*(_QWORD*)v8 = off_140B77D80;
	}
	else
	{
		v9 = 0i64;
	}
	v10 = sub_140781780(v9, a2, (__int64)a3, a4);
	if (v10 >= 0)
	{
		if (!*(_QWORD*)(v9 + 40))
		{
	...
	else
	{
		...
		v12 = sub_140196F30(&dword_140C8B0FC, 37, &v15, v11, v19);
		TlsValue = &off_140B5E648;
...
// 140C8B0FC: using guessed type _DWORD dword_140C8B0FC;
