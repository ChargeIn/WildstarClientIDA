...
__int64 sub_14022B0A0()
{
	...
	if (qword_140C63D08)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"QuestCategory"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\QuestCategory.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022B13C: variable 'v1' is possibly undefined
// 140A751A0: using guessed type wchar_t *off_140A751A0;
// 140A9E2E0: using guessed type wchar_t aQuestcategory[14];
// 140A9E508: using guessed type wchar_t aDbQuestcategor[21];
...
// 140C638D4: using guessed type int dword_140C638D4;
// 140C63970: using guessed type __int64 qword_140C63970;
// 140C639E8: using guessed type int dword_140C639E8;
