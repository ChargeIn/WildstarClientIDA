...
//----- (00000001400AFB30) ----------------------------------------------------
__int64 __fastcall sub_1400AFB30(__int64 a1, unsigned int* a2)
{
	__int64 v2; // r8
			...
			(unsigned __int64)(8i64 * (*(_QWORD*)(v11 + 24) - *(_QWORD*)(v11 + 32)) - v13) >= 0x40))
	{
		...
		v15 = *(_QWORD**)(v11 + 32);
		*v15 &= (1i64 << v13) - 1;
		*v15 |= (v14 & 0x7FFF) << *(_QWORD*)(a1 + 16);
		v16 = *(_QWORD*)(a1 + 16);
		if (((v16 + 22) & 0xFFFFFFFFFFFFFFF8ui64) > 0x40)
			*(_BYTE*)(*(_QWORD*)(v11 + 32) + 8i64) = v14 >> (64 - (unsigned __int8)v16);
		*(_QWORD*)(v11 + 32) += (unsigned __int64)(*(_QWORD*)(a1 + 16) + 15i64) >> 3;
		*(_QWORD*)(a1 + 16) = ((unsigned __int8)*(_QWORD*)(a1 + 16) - 1) & 7;
	}
	else
	{
		result = sub_140336470(a1, v12, 0xFui64);
		if ((int)result < 0)
			return result;
	}
	result = sub_1400A7420(a1, a2[2]);
	if ((int)result >= 0)
	{
		result = sub_1400A7110(a1, a2[3], 0x20ui64);
		if ((int)result >= 0)
		{
			for (i = 0i64; (unsigned int)i < a2[3]; i = (unsigned int)(i + 1))
			{
				result = sub_1400AF9B0(a1, *((_QWORD*)a2 + 2) + 40 * i);
				if ((int)result < 0)
					break;
			}
		}
