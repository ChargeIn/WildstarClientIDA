...
__int64 sub_140203B40()
{
	...
	if (qword_140C65008)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"HousingDecorInfo"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\HousingDecorInfo.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140203BDC: variable 'v1' is possibly undefined
// 140A8AF30: using guessed type wchar_t aDbHousingdecor[24];
// 140A8AFD8: using guessed type wchar_t aHousingdecorin[17];
// 140ACB5F8: using guessed type wchar_t *off_140ACB5F8;
...
// 140C64AC4: using guessed type int dword_140C64AC4;
// 140C65008: using guessed type __int64 qword_140C65008;
// 140C65250: using guessed type int dword_140C65250;
