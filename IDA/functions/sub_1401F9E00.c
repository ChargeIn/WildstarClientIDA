...
__int64 sub_1401F9E00()
{
	...
	if (qword_140C64DD0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Creature2OverrideProperties"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\Creature2OverrideProperties.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F9E9C: variable 'v1' is possibly undefined
// 140A52210: using guessed type wchar_t *off_140A52210;
// 140A83760: using guessed type wchar_t aDbCreature2ove[35];
// 140A837A8: using guessed type wchar_t aCreature2overr[28];
...
// 140C63A14: using guessed type int dword_140C63A14;
// 140C63FAC: using guessed type int dword_140C63FAC;
// 140C64CC0: using guessed type int dword_140C64CC0;
