//----- (000000014083D830) ----------------------------------------------------
__int64 __fastcall sub_14083D830(__int64 a1, __int64 a2, __int64 a3, struct _RTL_CRITICAL_SECTION* a4)
{
	unsigned int v8; // ebx
	unsigned int* v9; // rax
	...
	v14 = sub_14086EE10(v12);
	v13 = (__int64)v14;
	if (v14)
	{
		v8 = (*(__int64(__fastcall**)(_QWORD*, unsigned int*, _QWORD))(*v14 + 648i64))(
			v14,
			v10,
			*(unsigned int*)(a2 + 1));
		if (v8 != 1)
