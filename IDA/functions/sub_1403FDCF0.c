...
//----- (00000001403FDCF0) ----------------------------------------------------
int** __fastcall sub_1403FDCF0(__int64 a1, int** a2, __int64* a3, __int64 a4)
{
	_QWORD* v4; // rbx
	__int64 v5; // rdi
	_QWORD* v9; // rdi
	...
	if ((_QWORD*)v5 != v4)
	{
				...
				*(_QWORD*)(v5 + 48)) < 0)
		{
			if (!v15[3])
			{
				sub_1403FEF80(a1, a2, 0i64, (__int64)v15, a4);
				return a2;
			}
			goto LABEL_4;
		}
	LABEL_30:
		*a2 = *(int**)sub_1403FF060(a1, (__int64)v19, a4);
		return a2;
	}
	v9 = (_QWORD*)v4[3];
...
// 1403FDDAE: variable 'v10' is possibly undefined
// 1403FDCF0: using guessed type char var_18[24];
