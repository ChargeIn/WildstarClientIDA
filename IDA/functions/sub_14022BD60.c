...
__int64 sub_14022BD60()
{
	...
	if (qword_140C65188)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"QuestHub"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\QuestHub.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022BDFC: variable 'v1' is possibly undefined
// 140A647B8: using guessed type wchar_t *off_140A647B8;
// 140A9EAA8: using guessed type wchar_t aDbQuesthubTbl[16];
// 140A9EB38: using guessed type wchar_t aQuesthub[9];
...
// 140C6392C: using guessed type int dword_140C6392C;
// 140C63970: using guessed type __int64 qword_140C63970;
// 140C644EC: using guessed type int dword_140C644EC;
