...
__int64 sub_1401FFFC0()
{
	...
	if (qword_140C64C58)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"GameFormula"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\GameFormula.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020005C: variable 'v1' is possibly undefined
// 140A89AC0: using guessed type wchar_t aDbGameformulaT[19];
// 140A89AE8: using guessed type wchar_t aGameformula[12];
// 140AE1670: using guessed type wchar_t *off_140AE1670;
...
// 140C642DC: using guessed type int dword_140C642DC;
// 140C64B4C: using guessed type int dword_140C64B4C;
