...
__int64 sub_1402193E0()
{
	...
	if (qword_140C65100)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ModelEvent"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ModelEvent.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021947C: variable 'v1' is possibly undefined
// 140A93D50: using guessed type wchar_t aDbModeleventTb[18];
// 140A93D78: using guessed type wchar_t aModelevent[11];
// 140ACE348: using guessed type wchar_t *off_140ACE348;
...
// 140C64414: using guessed type int dword_140C64414;
// 140C64B40: using guessed type int dword_140C64B40;
