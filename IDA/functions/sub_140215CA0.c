...
__int64 sub_140215CA0()
{
	...
	if (qword_140C654D8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"MatchTypeRewardRotationContent"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\MatchTypeRewardRotationContent.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140215D3C: variable 'v1' is possibly undefined
// 140A5A978: using guessed type wchar_t *off_140A5A978;
// 140A932E0: using guessed type wchar_t aDbMatchtyperew[38];
// 140A93330: using guessed type wchar_t aMatchtyperewar[31];
