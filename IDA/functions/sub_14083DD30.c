...
//----- (000000014083DD30) ----------------------------------------------------
__int64 __fastcall sub_14083DD30(__int64 a1, __int64 a2, __int64 a3, struct _RTL_CRITICAL_SECTION* a4)
{
	unsigned int v8; // ebx
	unsigned int* v9; // rax
	__int64 v10; // r14
	...
	v14 = (_BYTE*)sub_14086A480(v12);
	v13 = (__int64)v14;
	if (v14)
	{
		v8 = sub_14086B660(v14, v10, *(_DWORD*)(a2 + 1));
		if (v8 != 1)
