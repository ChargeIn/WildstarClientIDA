...
__int64 sub_1401FAAC0()
{
	...
	if (qword_140C65438)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"CustomizationParameterMap"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\CustomizationParameterMap.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401FAB5C: variable 'v1' is possibly undefined
// 140A83C68: using guessed type wchar_t aCustomizationp_0[26];
// 140A84160: using guessed type wchar_t aDbCustomizatio_0[33];
// 140ACDBE8: using guessed type wchar_t *off_140ACDBE8;
