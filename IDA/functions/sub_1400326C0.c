...
//----- (00000001400326C0) ----------------------------------------------------
int* __fastcall sub_1400326C0(__int64 a1, int* a2)
{
	__int64 v2; // r9
	__int64 v5; // rax
	int* v6; // rbx
	...
	if (v6 == (int*)v2 || *a2 < (unsigned int)v6[8])
	{
		...
		*((_QWORD*)v9 + 3) = v9;
		v11 = *a2;
		sub_140030C70((__int64)v12, (__int64)v8);
		v14 = v6;
		sub_140032D40(a1, &v15, (__int64*)&v14, &v11);
		v6 = v15;
...
// 1400326C0: using guessed type char var_58[8];
// 1400326C0: using guessed type char var_30[8];
