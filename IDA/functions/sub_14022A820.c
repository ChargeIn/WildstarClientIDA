...
__int64 sub_14022A820()
{
	...
	if (qword_140C642A8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Quest2"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Quest2.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022A8BC: variable 'v1' is possibly undefined
// 140A9E108: using guessed type wchar_t aDbQuest2Tbl[14];
// 140A9E128: using guessed type wchar_t aQuest2[7];
// 140ACD188: using guessed type wchar_t *off_140ACD188;
...
// 140C641C8: using guessed type int dword_140C641C8;
// 140C64254: using guessed type int dword_140C64254;
