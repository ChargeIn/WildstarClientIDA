...
__int64 sub_1401ED200()
{
	...
	if (qword_140C63DF8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"BindPoint"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\BindPoint.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401ED29C: variable 'v1' is possibly undefined
// 140A5C018: using guessed type wchar_t aDbBindpointTbl[17];
// 140A5C040: using guessed type wchar_t aBindpoint_0[10];
// 140ACD900: using guessed type wchar_t *off_140ACD900;
...
// 140C63F34: using guessed type int dword_140C63F34;
// 140C643D8: using guessed type int dword_140C643D8;
