//----- (000000014064B820) ----------------------------------------------------
__int64 __fastcall sub_14064B820(__int64 a1)
{
	float* v2; // rsi
	__int64 v4; // rbx
	__int64 v5; // rax
	...
	if (v2)
	{
		...
		*(_QWORD*)(a1 + 16) += 16i64;
		v6 = sub_1400578C0(a1);
		v7 = (float)(sub_1404611B0(v2).m128_f32[0] * 100.0) - 100.0;
...
// 14064B9B6: variable 'v16' is possibly undefined
// 14064B9DC: variable 'v18' is possibly undefined
// 14064B9EE: variable 'v19' is possibly undefined
// 140B2BEC0: using guessed type wchar_t aNamount_11[8];
// 140B2BED0: using guessed type wchar_t aEdrstate_4[9];
