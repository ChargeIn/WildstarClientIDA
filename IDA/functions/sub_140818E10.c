...
//----- (0000000140818E10) ----------------------------------------------------
__int64 __fastcall sub_140818E10(__int64 a1)
{
	...
	if (v5 && v5 != -14)
		return v5;
	if (v5 == -14)
		qword_140C611F8 = 0i64;
	if (qword_140C611F8 && dword_140C61200 != dword_140C60980[v6])
		qword_140C611F8 = 0i64;
	if (!qword_140C611F8 && v3 && nvapi_QueryInterface)
	{
		qword_140C611F8 = nvapi_QueryInterface(3140163498i64);
		dword_140C61200 = dword_140C60980[v6];
	}
	if (qword_140C611F8)
	{
		v2 = (__int64(__fastcall*)(__int64))qword_140C611F8;
		v4 = 0i64;
		if (qword_140C60938)
			qword_140C60938(3140163498i64, &v4);
		v5 = v2(a1);
		if (qword_140C60940)
			qword_140C60940(3140163498i64, v4, v5);
		--dword_140C60970[v6];
		return v5;
	}
	else
...
// 140C611F8: using guessed type __int64 qword_140C611F8;
// 140C61200: using guessed type int dword_140C61200;
