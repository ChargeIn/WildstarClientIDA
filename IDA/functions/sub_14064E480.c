...
//----- (000000014064E480) ----------------------------------------------------
__int64 __fastcall sub_14064E480(__int64 a1)
{
	float* v2; // rsi
	__int64 v4; // rbx
	__int64 v5; // rax
	...
	if (v2)
	{
		...
		*(_QWORD*)(a1 + 16) += 16i64;
		v6 = sub_1400578C0(a1);
		v7 = (*(double(__fastcall**)(float*, __int64))(*(_QWORD*)v2 + 168i64))(v2, 1i64);
		...
		*(_QWORD*)(a1 + 16) += 16i64;
		...
		v12 = *(_QWORD*)(a1 + 16);
		*(_DWORD*)(v12 + 8) = 3;
		*(double*)v12 = (float)(*(float*)&v7 * 100.0);
		*(_QWORD*)(a1 + 16) += 16i64;
...
// 14064E61B: variable 'v16' is possibly undefined
// 14064E641: variable 'v18' is possibly undefined
// 14064E653: variable 'v19' is possibly undefined
// 140B2BF10: using guessed type wchar_t aNamount_25[8];
// 140B2BF20: using guessed type wchar_t aEdrstate_18[9];
