//----- (0000000140085420) ----------------------------------------------------
__int64 __fastcall sub_140085420(__int64 a1, unsigned int* a2)
{
	__int64 v2; // r8
	...
	v3 = *a2;
	if (!v2)
		return sub_140336470(a1, *a2, 0x12ui64);
	v5 = *(_QWORD*)(a1 + 16);
	if ((unsigned __int64)(8i64 * (*(_QWORD*)(v2 + 24) - *(_QWORD*)(v2 + 32)) - v5) < 0x40)
		return sub_140336470(a1, *a2, 0x12ui64);
	v6 = *(_QWORD**)(v2 + 32);
	*v6 &= (1i64 << v5) - 1;
	*v6 |= (v3 & 0x3FFFF) << *(_QWORD*)(a1 + 16);
	v7 = *(_QWORD*)(a1 + 16);
	if (((v7 + 25) & 0xFFFFFFFFFFFFFFF8ui64) > 0x40)
