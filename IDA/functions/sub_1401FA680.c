...
__int64 sub_1401FA680()
{
	...
	if (qword_140C65470)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"CustomizationParameter"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\CustomizationParameter.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401FA71C: variable 'v1' is possibly undefined
// 140A4C760: using guessed type wchar_t *off_140A4C760;
// 140A83B00: using guessed type wchar_t aDbCustomizatio[30];
// 140A83C08: using guessed type wchar_t aCustomizationp[23];
...
// 140C645A8: using guessed type int dword_140C645A8;
// 140C64ECC: using guessed type int dword_140C64ECC;
