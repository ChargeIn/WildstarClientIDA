...
__int64 sub_140233460()
{
	...
	if (qword_140C63BF0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"SoundEnvironment"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\SoundEnvironment.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402334FC: variable 'v1' is possibly undefined
// 140AA2F98: using guessed type wchar_t aDbSoundenviron[24];
// 140AA2FD8: using guessed type wchar_t aSoundenvironme[17];
// 140AD23E0: using guessed type wchar_t *off_140AD23E0;
...
// 140C63DC8: using guessed type int dword_140C63DC8;
// 140C64140: using guessed type int dword_140C64140;
// 140C645C8: using guessed type int dword_140C645C8;
