...
//----- (0000000140235CB0) ----------------------------------------------------
__int64 sub_140235CB0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6D038, qword_140C63858);
	if (dword_140C65648 || (int)sub_140235AA0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C63D60 + 40i64))(qword_140C63D60);
}
