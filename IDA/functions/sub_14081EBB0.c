...
//----- (000000014081EBB0) ----------------------------------------------------
__int64 __fastcall sub_14081EBB0(__int64 a1, unsigned int a2)
{
	...
	if (v6 && v6 != -14)
		return v6;
	if (v6 == -14)
		qword_140C615A8 = 0i64;
	if (qword_140C615A8 && dword_140C615B0 != dword_140C60980[v7])
		qword_140C615A8 = 0i64;
	if (!qword_140C615A8 && v4 && nvapi_QueryInterface)
	{
		qword_140C615A8 = nvapi_QueryInterface(2469179712i64);
		dword_140C615B0 = dword_140C60980[v7];
	}
	if (qword_140C615A8)
	{
		v3 = (__int64(__fastcall*)(__int64, _QWORD))qword_140C615A8;
		v5 = 0i64;
		if (qword_140C60938)
			qword_140C60938(2469179712i64, &v5);
		v6 = v3(a1, a2);
		if (qword_140C60940)
			qword_140C60940(2469179712i64, v5, v6);
		--dword_140C60970[v7];
		return v6;
	}
	else
...
// 140C615A8: using guessed type __int64 qword_140C615A8;
// 140C615B0: using guessed type int dword_140C615B0;
