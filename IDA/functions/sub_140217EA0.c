...
__int64 sub_140217EA0()
{
	...
	if (qword_140C643B0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ModelBone"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ModelBone.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140217F3C: variable 'v1' is possibly undefined
// 140A938D0: using guessed type wchar_t aModelbone[10];
// 140A93A40: using guessed type wchar_t aDbModelboneTbl[17];
// 140ADFFE0: using guessed type wchar_t *off_140ADFFE0;
...
// 140C63AD4: using guessed type int dword_140C63AD4;
// 140C63F38: using guessed type int dword_140C63F38;
// 140C643B0: using guessed type __int64 qword_140C643B0;
// 140C64DC8: using guessed type int dword_140C64DC8;
