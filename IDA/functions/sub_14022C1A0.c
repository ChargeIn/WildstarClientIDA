...
__int64 sub_14022C1A0()
{
	...
	if (qword_140C638F8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Quest2RandomTextLineJoin"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\Quest2RandomTextLineJoin.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022C23C: variable 'v1' is possibly undefined
// 140A9EB98: using guessed type wchar_t aQuest2randomte[25];
// 140A9EC10: using guessed type wchar_t aDbQuest2random[32];
// 140AD93C8: using guessed type wchar_t *off_140AD93C8;
...
// 140C63A80: using guessed type int dword_140C63A80;
// 140C64074: using guessed type int dword_140C64074;
