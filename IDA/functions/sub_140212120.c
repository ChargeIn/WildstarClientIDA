...
__int64 sub_140212120()
{
	...
	if (qword_140C652A8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"MapContinent"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\MapContinent.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402121BC: variable 'v1' is possibly undefined
// 140A91F48: using guessed type wchar_t aDbMapcontinent[20];
// 140A91F70: using guessed type wchar_t aMapcontinent[13];
// 140AE0F70: using guessed type wchar_t *off_140AE0F70;
...
// 140C64840: using guessed type int dword_140C64840;
// 140C651D0: using guessed type int dword_140C651D0;
