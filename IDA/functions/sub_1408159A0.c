//----- (00000001408159A0) ----------------------------------------------------
__int64 __fastcall sub_1408159A0(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
	...
	if (v8 && v8 != -14)
		return v8;
	if (v8 == -14)
		qword_140C60FE8 = 0i64;
	if (qword_140C60FE8 && dword_140C60FF0 != dword_140C60980[v9])
		qword_140C60FE8 = 0i64;
	if (!qword_140C60FE8 && v6 && nvapi_QueryInterface)
	{
		qword_140C60FE8 = nvapi_QueryInterface(3602488713i64);
		dword_140C60FF0 = dword_140C60980[v9];
	}
	if (qword_140C60FE8)
	{
		v5 = (__int64(__fastcall*)(__int64, __int64, __int64, __int64, _QWORD))qword_140C60FE8;
		v7 = 0i64;
		if (qword_140C60938)
			qword_140C60938(3602488713i64, &v7);
		v8 = v5(a1, a2, a3, a4, v5);
		if (qword_140C60940)
			qword_140C60940(3602488713i64, v7, v8);
		--dword_140C60970[v9];
		return v8;
	}
	else
...
// 140C60FE8: using guessed type __int64 qword_140C60FE8;
// 140C60FF0: using guessed type int dword_140C60FF0;
