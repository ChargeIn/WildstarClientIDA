...
__int64 sub_1401FBBC0()
{
	...
	if (qword_140C63F60)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"DailyLoginReward"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\DailyLoginReward.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401FBC5C: variable 'v1' is possibly undefined
// 140A5BA40: using guessed type wchar_t *off_140A5BA40;
// 140A84A10: using guessed type wchar_t aDbDailyloginre[24];
// 140A84AE0: using guessed type wchar_t aDailyloginrewa[17];
...
// 140C638B0: using guessed type int dword_140C638B0;
// 140C63970: using guessed type __int64 qword_140C63970;
// 140C63E64: using guessed type int dword_140C63E64;
