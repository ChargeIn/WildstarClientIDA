...
__int64 sub_14023A2E0()
{
	...
	if (qword_140C64A80)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4Runner"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4Runner.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023A37C: variable 'v1' is possibly undefined
// 140A76C20: using guessed type wchar_t *off_140A76C20;
// 140AA7FB8: using guessed type wchar_t aSpell4runner[13];
// 140AA80F0: using guessed type wchar_t aDbSpell4runner[20];
...
// 140C64624: using guessed type int dword_140C64624;
// 140C64A80: using guessed type __int64 qword_140C64A80;
// 140C653F8: using guessed type int dword_140C653F8;
// 140C6551C: using guessed type int dword_140C6551C;
