...
__int64 sub_1402032C0()
{
	...
	if (qword_140C64DC0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"HookAsset"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\HookAsset.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020335C: variable 'v1' is possibly undefined
// 140A83360: using guessed type wchar_t *off_140A83360;
// 140A8ACE0: using guessed type wchar_t aDbHookassetTbl[17];
// 140A8AD08: using guessed type wchar_t aHookasset[10];
...
// 140C64194: using guessed type int dword_140C64194;
// 140C64DC0: using guessed type __int64 qword_140C64DC0;
// 140C64DCC: using guessed type int dword_140C64DCC;
