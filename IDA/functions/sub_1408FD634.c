...
//----- (00000001408FD634) ----------------------------------------------------
__int64 __fastcall sub_1408FD634(unsigned __int64 a1, double* a2, int* a3)
{
	int v4; // r11d
	...
	v8 = v4 % 36;
	v9 = v7 + 3;
	v10 = v6 * qword_140C1ABE0[v9];
	v11 = (v10 >> 36) + v6 * qword_140C1ABE0[v9 - 1];
	v12 = qword_140C1ABE0[v9 - 2];
...
// 140C1ABE0: using guessed type _QWORD qword_140C1ABE0[14];
