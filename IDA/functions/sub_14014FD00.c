//----- (000000014014FD00) ----------------------------------------------------
__int64 __fastcall sub_14014FD00(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Apollo.WindowLocation");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6 - 16;
	sub_140057020(a1, "WindowLocation", &off_140C57B30);
	a1[2] -= 16i64;
	return 1i64;
}
// 14014FE13: variable 'v14' is possibly undefined
// 140C57B30: using guessed type char *off_140C57B30;
// 140C57B60: using guessed type char *off_140C57B60;
