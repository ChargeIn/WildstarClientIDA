...
__int64 sub_140244460()
{
	...
	if (qword_140C64B38)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TradeskillCatalystOrdering"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\TradeskillCatalystOrdering.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402444FC: variable 'v1' is possibly undefined
// 140A51178: using guessed type wchar_t *off_140A51178;
// 140AAC510: using guessed type wchar_t aDbTradeskillca_0[34];
// 140AAC558: using guessed type wchar_t aTradeskillcata_0[27];
...
// 140C63910: using guessed type int dword_140C63910;
// 140C63970: using guessed type __int64 qword_140C63970;
// 140C6479C: using guessed type int dword_140C6479C;
