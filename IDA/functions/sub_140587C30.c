...
//----- (0000000140587C30) ----------------------------------------------------
void __fastcall sub_140587C30(__int64 a1)
{
	__int64 v2; // rdx
	__int64 v3; // rax
	__int16* v4; // rax
...
// 140587E4C: variable 'v14' is possibly undefined
// 140B1F3F8: using guessed type wchar_t asc_140B1F3F8[5];
// 140C658A0: using guessed type __int64 qword_140C658A0;
// 140C7DE18: using guessed type __int64 qword_140C7DE18;
// 140C7DE20: using guessed type __int64 qword_140C7DE20;
// 140587C30: using guessed type char var_88[8];
// 140587C30: using guessed type char var_68[8];
// 140587C30: using guessed type char var_48[8];
