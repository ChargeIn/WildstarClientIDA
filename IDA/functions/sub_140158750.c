...
//----- (0000000140158750) ----------------------------------------------------
void __fastcall sub_140158750(__int64 a1)
{
	_QWORD* v1; // rax
	int* v3; // rax
	int v4; // ebp
				...
				if (v10 > 0)
				{
					...
					do
					{
						...
						sub_1401589F0(
							(__int64)&v33[16 * v15],
							(__int64)v31,
							(unsigned __int8(__fastcall*)(__int64*, __int64))sub_1401572A0);
						++v16;
						*v17 = (__int64)v6;
						v17 += 2;
						++v15;
...
// 140158750: using guessed type char var_438[8];
// 140158750: using guessed type char var_448[8];
