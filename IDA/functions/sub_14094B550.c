...
__int64 sub_14094B550()
{
	...
	v0 = (__m128)(unsigned int)xmmword_140C7F830;
	v1 = (__m128)DWORD2(xmmword_140C7F830);
	v1.m128_f32[0] = (float)((float)(*((float*)&xmmword_140C7F830 + 2) + *(float*)&dword_140C3B738)
		* (float)(1.0 / *(float*)&dword_140C66F48))
		+ 1.0;
	v0.m128_f32[0] = (float)((float)(*(float*)&xmmword_140C7F830 + *(float*)&dword_140C3B738)
	...
	v15 = (__m128)(unsigned int)xmmword_140C7F820;
	v16 = (int)v3.m128_f32[0];
	v17 = (__m128)DWORD2(xmmword_140C7F820);
	v18 = v16 + 2;
	v17.m128_f32[0] = (float)((float)(*((float*)&xmmword_140C7F820 + 2) + *(float*)&dword_140C3B738)
		* (float)(1.0 / *(float*)&dword_140C66F48))
		+ 1.0;
	v15.m128_f32[0] = (float)((float)(*(float*)&xmmword_140C7F820 + *(float*)&dword_140C3B738)
		* (float)(1.0 / *(float*)&dword_140C66F1C))
		+ 0.5;
	...
	dword_140C7F818 = v14 + 2;
	result = (unsigned int)((int)v20.m128_f32[0] - 1);
	dword_140C7F810 = (int)(float)(v29 + v22.m128_f32[0]) - 1;
	dword_140C7F81C = v18;
	dword_140C7F814 = (int)v20.m128_f32[0] - 1;
	return result;
}
...
// 140C7F810: using guessed type int dword_140C7F810;
// 140C7F814: using guessed type int dword_140C7F814;
// 140C7F818: using guessed type int dword_140C7F818;
// 140C7F81C: using guessed type int dword_140C7F81C;
