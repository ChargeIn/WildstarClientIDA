...
__int64 sub_1401EC100()
{
	...
	if (qword_140C64EB0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ArchiveEntryUnlockRule"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\ArchiveEntryUnlockRule.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401EC19C: variable 'v1' is possibly undefined
// 140A529D0: using guessed type wchar_t aDbArchiveentry_0[30];
// 140A52A10: using guessed type wchar_t aArchiveentryun[23];
// 140ACC550: using guessed type wchar_t *off_140ACC550;
...
// 140C63C00: using guessed type int dword_140C63C00;
// 140C64230: using guessed type int dword_140C64230;
