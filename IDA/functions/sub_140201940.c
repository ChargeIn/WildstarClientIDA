...
__int64 sub_140201940()
{
	...
	if (qword_140C63ED8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"GossipEntry"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\GossipEntry.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402019DC: variable 'v1' is possibly undefined
// 140A7E938: using guessed type wchar_t *off_140A7E938;
// 140A8A1D0: using guessed type wchar_t aGossipentry[12];
// 140A8A2E8: using guessed type wchar_t aDbGossipentryT[19];
...
// 140C64108: using guessed type int dword_140C64108;
// 140C64744: using guessed type int dword_140C64744;
// 140C650DC: using guessed type int dword_140C650DC;
