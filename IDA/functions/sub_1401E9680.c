...
__int64 sub_1401E9680()
{
	...
	if (qword_140C64768)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"AchievementCategory"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\AchievementCategory.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401E971C: variable 'v1' is possibly undefined
// 140A4C210: using guessed type wchar_t aDbAchievementc[27];
// 140A4C248: using guessed type wchar_t aAchievementcat[20];
// 140ACAF28: using guessed type wchar_t *off_140ACAF28;
...
// 140C64B8C: using guessed type int dword_140C64B8C;
// 140C65484: using guessed type int dword_140C65484;
