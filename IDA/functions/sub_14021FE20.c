...
__int64 sub_14021FE20()
{
	...
	if (qword_140C64B60)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathScientistDatacubeDiscovery"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PathScientistDatacubeDiscovery.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021FEBC: variable 'v1' is possibly undefined
// 140A96660: using guessed type wchar_t aDbPathscientis_0[38];
// 140A96768: using guessed type wchar_t aPathscientistd[31];
// 140AD43F8: using guessed type wchar_t *off_140AD43F8;
