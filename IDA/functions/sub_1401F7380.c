...
__int64 sub_1401F7380()
{
	...
	if (qword_140C63A48)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Creature2Action"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Creature2Action.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F741C: variable 'v1' is possibly undefined
// 140A7C990: using guessed type wchar_t aDbCreature2act[23];
// 140A7C9C0: using guessed type wchar_t aCreature2actio[16];
// 140ACFE00: using guessed type wchar_t *off_140ACFE00;
...
// 140C63DB4: using guessed type int dword_140C63DB4;
// 140C63ED0: using guessed type int dword_140C63ED0;
