//----- (00000001407B5480) ----------------------------------------------------
__int64 __fastcall sub_1407B5480(__int64 a1, __int64 a2, __int64 a3)
{
	__int64 v4; // rcx
	__int64 v6; // rdi
	bool v8; // al
	...
	if (v8)
	{
		if (v9 == *(_QWORD*)(v4 + 16))
		{
			*(_QWORD*)a2 = *sub_1407B53A0(a1, &v23, v6, v9, a3);
			*(_BYTE*)(a2 + 8) = 1;
			return a2;
		}
...
// 1407B55AE: conditional instruction was optimized away because rdi.8==0
// 1407B55CA: variable 'v17' is possibly undefined
