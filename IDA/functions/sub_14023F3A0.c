...
__int64 sub_14023F3A0()
{
	...
	if (qword_140C650F8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"StoreDisplayInfo"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\StoreDisplayInfo.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023F43C: variable 'v1' is possibly undefined
// 140A67280: using guessed type wchar_t *off_140A67280;
// 140AAA390: using guessed type wchar_t aDbStoredisplay[24];
// 140AAA3C0: using guessed type wchar_t aStoredisplayin[17];
...
// 140C63ACC: using guessed type int dword_140C63ACC;
// 140C64420: using guessed type int dword_140C64420;
