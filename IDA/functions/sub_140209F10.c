...
//----- (0000000140209F10) ----------------------------------------------------
__int64 sub_140209F10()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6AC20, qword_140C63858);
	if (dword_140C63A54 || (int)sub_140209D00() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C65060 + 40i64))(qword_140C65060);
}
