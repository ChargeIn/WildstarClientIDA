...
__int64 sub_140220260()
{
	...
	if (qword_140C63D80)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathScientistExperimentation"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PathScientistExperimentation.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402202FC: variable 'v1' is possibly undefined
// 140A96940: using guessed type wchar_t aDbPathscientis_1[36];
// 140A96988: using guessed type wchar_t aPathscientiste[29];
// 140AD9BF8: using guessed type wchar_t *off_140AD9BF8;
...
// 140C638D0: using guessed type int dword_140C638D0;
// 140C63970: using guessed type __int64 qword_140C63970;
// 140C639CC: using guessed type int dword_140C639CC;
