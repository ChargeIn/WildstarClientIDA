...
__int64 sub_140229B60()
{
	...
	if (qword_140C649A8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PublicEventRewardModifier"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PublicEventRewardModifier.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140229BFC: variable 'v1' is possibly undefined
// 140A9C700: using guessed type wchar_t aDbPubliceventr[33];
// 140A9C7A8: using guessed type wchar_t aPubliceventrew[26];
// 140AD5700: using guessed type wchar_t *off_140AD5700;
