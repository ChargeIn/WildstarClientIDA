...
__int64 sub_140232BE0()
{
	...
	if (qword_140C63EA0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"SoundContext"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\SoundContext.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140232C7C: variable 'v1' is possibly undefined
// 140A786A8: using guessed type wchar_t *off_140A786A8;
// 140AA2D60: using guessed type wchar_t aSoundcontext[13];
// 140AA2F40: using guessed type wchar_t aDbSoundcontext[20];
...
// 140C63DE0: using guessed type int dword_140C63DE0;
// 140C63EA0: using guessed type __int64 qword_140C63EA0;
// 140C63F4C: using guessed type int dword_140C63F4C;
