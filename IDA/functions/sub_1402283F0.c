...
//----- (00000001402283F0) ----------------------------------------------------
__int64 sub_1402283F0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6C510, qword_140C63858);
	if (dword_140C638C4 || (int)sub_1402281E0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64890 + 40i64))(qword_140C64890);
}
