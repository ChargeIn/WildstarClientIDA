...
__int64 sub_14021C2A0()
{
	...
	if (qword_140C65138)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"RandomPlayerName"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\RandomPlayerName.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021C33C: variable 'v1' is possibly undefined
// 140A58550: using guessed type wchar_t *off_140A58550;
// 140A94BE8: using guessed type wchar_t aRandomplayerna[17];
// 140A94D00: using guessed type wchar_t aDbRandomplayer[24];
...
// 140C63C04: using guessed type int dword_140C63C04;
// 140C649B8: using guessed type int dword_140C649B8;
