...
//----- (00000001406B9BA0) ----------------------------------------------------
__int64 __fastcall sub_1406B9BA0(_QWORD* a1)
{
	__int64 v2; // rax
	__int64 v3; // rcx
	__int64 v4; // rsi
	...
	if (v2
		&& (v4 = *(_QWORD*)(v2 + 8)) != 0
		&& (v5 = *(_QWORD*)(v4 + 8)) != 0
		&& sub_14034BDD0(v3, *(_DWORD*)(*(_QWORD*)(v5 + 8) + 16i64))
		&& *sub_14034BDD0(v6, *(_DWORD*)(*(_QWORD*)(v5 + 8) + 16i64)))
	{
		...
		*((_QWORD*)&v25 + 1) = v7;
		...
		v11 = (int*)sub_14034BDD0(v10, *(_DWORD*)(*(_QWORD*)(v5 + 8) + 16i64));
		if (v11)
		{
			v12 = 0i64;
			if (*(_WORD*)v11)
	...
	{
		v16 = (unsigned __int64*)sub_14018F0E0(&v19, word_1409F6E1C)[1];
		if (v16)
		{
			v17 = -1i64;
			do
...
// 1406B9BF0: variable 'v3' is possibly undefined
// 1406B9C05: variable 'v6' is possibly undefined
// 1406B9CAC: variable 'v10' is possibly undefined
// 1409F6E1C: using guessed type unsigned __int16 word_1409F6E1C[48];
// 140B69230: using guessed type __int64 (__fastcall *off_140B69230[25])();
// 140C65898: using guessed type __int64 qword_140C65898;
// 1406B9BA0: using guessed type char var_E0[8];
