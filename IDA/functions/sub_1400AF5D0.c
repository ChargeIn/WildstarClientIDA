//----- (00000001400AF5D0) ----------------------------------------------------
__int64 __fastcall sub_1400AF5D0(__int64 a1, unsigned int* a2)
{
	__int64 v2; // r8
	...
	if ((int)result >= 0)
	{
		result = sub_1403360D0(a1, *((unsigned __int16**)a2 + 2), *((_QWORD*)a2 + 2) + 4i64 * *a2);
		if ((int)result >= 0)
			return sub_1400A7110(a1, a2[6], 0x20ui64);
	}
	return result;
}
