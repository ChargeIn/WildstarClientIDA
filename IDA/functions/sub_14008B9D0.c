...
//----- (000000014008B9D0) ----------------------------------------------------
__int64 __fastcall sub_14008B9D0(__int64 a1, unsigned __int16** a2)
{
	__int64 v2; // r8
	...
	{
		result = sub_140336470(a1, *((int*)a2 + 1), 2ui64);
		if ((int)result < 0)
			return result;
	}
	v16 = *(_QWORD*)(a1 + 8);
	...
	result = sub_1403360D0(a1, a2[2], (__int64)&a2[2][2 * *((unsigned int*)a2 + 2)]);
	if ((int)result >= 0)
	{
		result = sub_1403360D0(a1, a2[3], (__int64)&a2[3][2 * *((unsigned int*)a2 + 2)]);
		if ((int)result >= 0)
		{
			result = sub_1400A7110(a1, *((_DWORD*)a2 + 8), 0x20ui64);
			if ((int)result >= 0)
			{
				result = sub_1403360D0(a1, a2[5], (__int64)&a2[5][2 * *((unsigned int*)a2 + 8)]);
				if ((int)result >= 0)
					return sub_1400A7250(a1, *((_DWORD*)a2 + 12) != 0, 1ui64);
			}
		}
	}
	return result;
