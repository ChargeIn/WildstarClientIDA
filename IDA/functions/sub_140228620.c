...
__int64 sub_140228620()
{
	...
	if (qword_140C64C68)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PublicEventObjectiveBombDeployment"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PublicEventObjectiveBombDeployment.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402286BC: variable 'v1' is possibly undefined
// 140A9BB50: using guessed type wchar_t aDbPublicevento_0[42];
// 140A9BBB0: using guessed type wchar_t aPubliceventobj_0[35];
// 140ACB548: using guessed type wchar_t *off_140ACB548;
...
// 140C638F4: using guessed type int dword_140C638F4;
// 140C63970: using guessed type __int64 qword_140C63970;
// 140C64638: using guessed type int dword_140C64638;
