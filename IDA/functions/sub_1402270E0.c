...
__int64 sub_1402270E0()
{
	...
	if (qword_140C64738)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PublicEventCustomStat"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PublicEventCustomStat.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022717C: variable 'v1' is possibly undefined
// 140A9B148: using guessed type wchar_t aDbPubliceventc[29];
// 140A9B188: using guessed type wchar_t aPubliceventcus[22];
// 140AD8150: using guessed type wchar_t *off_140AD8150;
...
// 140C63E4C: using guessed type int dword_140C63E4C;
// 140C63FA8: using guessed type int dword_140C63FA8;
