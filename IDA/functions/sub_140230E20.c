...
__int64 sub_140230E20()
{
	...
	if (qword_140C64D60)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"RewardTrackRewards"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\RewardTrackRewards.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140230EBC: variable 'v1' is possibly undefined
// 140AA22E8: using guessed type wchar_t aRewardtrackrew[19];
// 140AA2450: using guessed type wchar_t aDbRewardtrackr[26];
// 140AD9818: using guessed type wchar_t *off_140AD9818;
