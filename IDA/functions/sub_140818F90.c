//----- (0000000140818F90) ----------------------------------------------------
__int64 __fastcall sub_140818F90(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
	...
	if (v8 && v8 != -14)
		return v8;
	if (v8 == -14)
		qword_140C61208 = 0i64;
	if (qword_140C61208 && dword_140C61210 != dword_140C60980[v9])
		qword_140C61208 = 0i64;
	if (!qword_140C61208 && v6 && nvapi_QueryInterface)
	{
		qword_140C61208 = nvapi_QueryInterface(3855527489i64);
		dword_140C61210 = dword_140C60980[v9];
	}
	if (qword_140C61208)
	{
		v5 = (__int64(__fastcall*)(__int64, __int64, __int64, _QWORD, _QWORD))qword_140C61208;
		v7 = 0i64;
		if (qword_140C60938)
			qword_140C60938(3855527489i64, &v7);
		v8 = v5(a1, a2, a3, a4, v5);
		if (qword_140C60940)
			qword_140C60940(3855527489i64, v7, v8);
		--dword_140C60970[v9];
		return v8;
	}
	else
...
// 140C61208: using guessed type __int64 qword_140C61208;
// 140C61210: using guessed type int dword_140C61210;
