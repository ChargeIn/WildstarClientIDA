//----- (0000000140261EC0) ----------------------------------------------------
void __fastcall sub_140261EC0(__int64 a1, __m128** a2, __int64 a3)
{
	__int64 v5; // r8
	...
	if (*(_DWORD*)(a1 + 2408))
	{
		...
		if ((unsigned int)sub_14025FA40(
			...
			**(unsigned int**)(v5 + 16),
			v9))
		{
			(*(void(__fastcall**)(__int64, __int64))(*(_QWORD*)qword_140C65670 + 336i64))(qword_140C65670, 1i64);
...
// 140261F32: variable 'v5' is possibly undefined
// 140C65670: using guessed type __int64 qword_140C65670;
// 140261EC0: using guessed type __m128 var_B8[4];
