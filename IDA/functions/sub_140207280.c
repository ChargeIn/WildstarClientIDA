...
__int64 sub_140207280()
{
	...
	if (qword_140C64488)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"HousingResidenceInfo"))
	{
...
// 14020731C: variable 'v1' is possibly undefined
// 140A8D048: using guessed type wchar_t aDbHousingresid[28];
// 140A8D080: using guessed type wchar_t aHousingresiden[21];
// 140ADE138: using guessed type wchar_t *off_140ADE138;
