...
//----- (00000001402A9A70) ----------------------------------------------------
__int64 __fastcall sub_1402A9A70(_QWORD* a1, unsigned int a2)
{
	__int64 v3; // rdi
	unsigned int* v4; // rdx
	int v5; // esi
	...
	v5 = (*(__int64(__fastcall**)(_QWORD, _QWORD, _QWORD, _QWORD, __int64))(**(_QWORD**)(a1[2] + 6336i64) + 96i64))(
		*(_QWORD*)(a1[2] + 6336i64),
		*((_QWORD*)v4 + 1),
		*v4,
		0i64,
	...
	*(_QWORD*)&v12 = &off_140B5E640;
	...
	v15 = 0x141DE6A50i64;
	v14[0] = v12;
	v6 = sub_1401971E0(&dword_140C8A520, 14, &v15, v14, v11);
	*(_QWORD*)&v12 = &off_140B5E648;
...
// 140C8A520: using guessed type _DWORD dword_140C8A520;
