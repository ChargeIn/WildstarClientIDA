...
//----- (00000001407855D0) ----------------------------------------------------
__int64 __fastcall sub_1407855D0(__int64 a1, unsigned int a2, int* a3, int* a4, int a5, int a6, int a7, __int64 a8)
{
	int v8; // ebp
	int* v10; // r12
	...
	if (!a5)
	{
		if (a2)
		{
			...
			{
				v44 = 12 * v12;
				if (!is_mul_ok(v12, 0xCui64))
					v44 = -1i64;
				v45 = sub_14018B280(v44, 8u);
				*(_QWORD*)(a1 + 32) = v45;
				sub_1407DB590(v45, v10, 12 * v12);
	...
	if (v10)
	{
		...
		*(_QWORD*)(a1 + 32) = v28;
		*(_QWORD*)(a1 + 24) = v28;
		sub_1407DB590(v28, v10, 12 * v12);
		*(_QWORD*)(a1 + 24) = *(_QWORD*)(a1 + 32) + 12i64;
	}
	*(_DWORD*)a1 = v12 - 2;
LABEL_44:
	*(_DWORD*)(a1 + 4) = 0;
