...
__int64 sub_14020A9C0()
{
	...
	if (qword_140C63FD0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ItemStat"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ItemStat.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020AA5C: variable 'v1' is possibly undefined
// 140A87818: using guessed type wchar_t *off_140A87818;
// 140A8ECC8: using guessed type wchar_t aDbItemstatTbl[16];
// 140A8ECE8: using guessed type wchar_t aItemstat[9];
