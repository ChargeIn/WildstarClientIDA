...
__int64 sub_140209D00()
{
	...
	if (qword_140C65060)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Item2Family"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Item2Family.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140209D9C: variable 'v1' is possibly undefined
// 140A8E710: using guessed type wchar_t aItem2family[12];
// 140A8E8A8: using guessed type wchar_t aDbItem2familyT[19];
// 140ADDEA8: using guessed type wchar_t *off_140ADDEA8;
