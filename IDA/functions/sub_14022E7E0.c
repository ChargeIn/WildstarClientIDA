...
__int64 sub_14022E7E0()
{
	...
	if (qword_140C64388)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ResourceConversion"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ResourceConversion.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022E87C: variable 'v1' is possibly undefined
// 140A5ABB0: using guessed type wchar_t *off_140A5ABB0;
// 140AA1280: using guessed type wchar_t aDbResourceconv[26];
// 140AA12B8: using guessed type wchar_t aResourceconver[19];
...
// 140C64FD8: using guessed type int dword_140C64FD8;
// 140C654D0: using guessed type int dword_140C654D0;
