...
//----- (0000000140271610) ----------------------------------------------------
void __fastcall sub_140271610(__int64 a1, __int64* a2, unsigned int a3)
{
	__int64 v3; // rax
	__int64 v6; // rsi
	int v7; // ebx
	...
	if ((unsigned int)v6 < *((_DWORD*)a2 + 7))
	{
		...
		v10 = 8 * v9;
		if (*(_QWORD*)(8 * v9 + a2[9])
			|| (v11 = (*(__int64(__fastcall**)(_QWORD, _QWORD))(**(_QWORD**)(a1 + 6608) + 848i64))(
				*(_QWORD*)(a1 + 6608),
				*(_QWORD*)(*(_QWORD*)(v8 + 16) + 16 * v9 + 8)),
				v11 >= 0))
		{
			v13 = *(_QWORD*)(v10 + a2[9]);
			if (*(_QWORD*)(a1 + 10040) != v13)
			{
				v14 = *(_QWORD*)(a1 + 6608);
				*(_QWORD*)(a1 + 10040) = v13;
				(*(void(__fastcall**)(__int64))(*(_QWORD*)v14 + 856i64))(v14);
			}
			v15 = *(_DWORD*)(a1 + 240);
			if (*((_DWORD*)a2 + 21) != v15)
			{
				*((_DWORD*)a2 + 21) = v15;
				...
				_InterlockedExchangeAdd((volatile signed __int32*)(a1 + 336), *((_DWORD*)a2 + 11));
			}
		}
		else
		{
			...
			*(_QWORD*)&v21 = &off_140B5E640;
			...
			v29 = 0x141DE19C0i64;
			v27[0] = v21;
			v12 = sub_1401971E0(&dword_140C8A2FC, 14, &v29, v27, v25);
			*(_QWORD*)&v21 = &off_140B5E648;
	...
	else
	{
		...
		*((_QWORD*)&v17 + 1) = TlsGetValue(dwTlsIndex);
		...
		v28 = 0x141DE1A10i64;
		v24 = v17;
		v7 = sub_1401971E0(&dword_140C8A30C, 14, &v28, &v23);
		TlsValue = &off_140B5E648;
...
// 140C8A2FC: using guessed type _DWORD dword_140C8A2FC;
// 140C8A30C: using guessed type _DWORD dword_140C8A30C;
// 140271610: using guessed type int var_40[4];
