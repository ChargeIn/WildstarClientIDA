...
__int64 sub_140226CA0()
{
	...
	if (qword_140C63BE0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PublicEvent"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PublicEvent.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140226D3C: variable 'v1' is possibly undefined
// 140A9AED8: using guessed type wchar_t aPublicevent[12];
// 140A9B040: using guessed type wchar_t aDbPubliceventT[19];
// 140ACDCC0: using guessed type wchar_t *off_140ACDCC0;
...
// 140C641A8: using guessed type int dword_140C641A8;
// 140C641FC: using guessed type int dword_140C641FC;
