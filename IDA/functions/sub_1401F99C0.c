...
__int64 sub_1401F99C0()
{
	...
	if (qword_140C64988)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"CreatureLevel"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\CreatureLevel.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F9A5C: variable 'v1' is possibly undefined
// 140A83628: using guessed type wchar_t aDbCreatureleve[21];
// 140A83658: using guessed type wchar_t aCreaturelevel[14];
// 140A840B8: using guessed type wchar_t *off_140A840B8;
...
// 140C63F7C: using guessed type int dword_140C63F7C;
// 140C64988: using guessed type __int64 qword_140C64988;
// 140C64990: using guessed type int dword_140C64990;
// 140C64F34: using guessed type int dword_140C64F34;
