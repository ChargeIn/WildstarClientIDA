...
__int64 sub_140200C80()
{
	...
	if (qword_140C63A28)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"GenericStringGroups"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\GenericStringGroups.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140200D1C: variable 'v1' is possibly undefined
// 140A70FC0: using guessed type wchar_t *off_140A70FC0;
// 140A89D50: using guessed type wchar_t aGenericstringg[20];
// 140A89EC8: using guessed type wchar_t aDbGenericstrin[27];
...
// 140C6485C: using guessed type int dword_140C6485C;
// 140C64984: using guessed type int dword_140C64984;
