...
__int64 sub_140246EE0()
{
	...
	if (qword_140C65160)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TutorialLayout"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\TutorialLayout.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140246F7C: variable 'v1' is possibly undefined
// 140AAD8B8: using guessed type wchar_t aDbTutoriallayo[22];
// 140AAD8E8: using guessed type wchar_t aTutoriallayout[15];
// 140ADE4C8: using guessed type wchar_t *off_140ADE4C8;
...
// 140C6433C: using guessed type int dword_140C6433C;
// 140C65160: using guessed type __int64 qword_140C65160;
// 140C65198: using guessed type int dword_140C65198;
