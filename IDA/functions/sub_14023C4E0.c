...
__int64 sub_14023C4E0()
{
	...
	if (qword_140C63BD8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4Thresholds"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4Thresholds.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023C57C: variable 'v1' is possibly undefined
// 140AA88E0: using guessed type wchar_t aSpell4threshol[17];
// 140AA8A68: using guessed type wchar_t aDbSpell4thresh[24];
// 140AD1D50: using guessed type wchar_t *off_140AD1D50;
...
// 140C64928: using guessed type int dword_140C64928;
// 140C64ED4: using guessed type int dword_140C64ED4;
