...
__int64 sub_14020CBC0()
{
	...
	if (qword_140C63D38)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ItemQuality"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ItemQuality.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020CC5C: variable 'v1' is possibly undefined
// 140A8FFF8: using guessed type wchar_t aItemquality[12];
// 140A90148: using guessed type wchar_t aDbItemqualityT[19];
// 140ADB4C8: using guessed type wchar_t *off_140ADB4C8;
...
// 140C64294: using guessed type int dword_140C64294;
// 140C64CA0: using guessed type int dword_140C64CA0;
