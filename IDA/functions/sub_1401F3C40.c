...
__int64 sub_1401F3C40()
{
	...
	if (qword_140C64BB0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ClientEventAction"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ClientEventAction.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F3CDC: variable 'v1' is possibly undefined
// 140A4C168: using guessed type wchar_t *off_140A4C168;
// 140A639D8: using guessed type wchar_t aClienteventact[18];
// 140A63D40: using guessed type wchar_t aDbClienteventa[25];
...
// 140C63F50: using guessed type int dword_140C63F50;
// 140C641E8: using guessed type int dword_140C641E8;
