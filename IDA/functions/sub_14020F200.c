...
__int64 sub_14020F200()
{
	...
	if (qword_140C640B8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"LevelUpUnlock"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\LevelUpUnlock.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020F29C: variable 'v1' is possibly undefined
// 140A68228: using guessed type wchar_t *off_140A68228;
// 140A90E98: using guessed type wchar_t aLevelupunlock[14];
// 140A90FD8: using guessed type wchar_t aDbLevelupunloc[21];
...
// 140C63BBC: using guessed type int dword_140C63BBC;
// 140C640B8: using guessed type __int64 qword_140C640B8;
// 140C64700: using guessed type int dword_140C64700;
