...
__int64 sub_140222CE0()
{
	...
	if (qword_140C64008)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathSettlerSheriff"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PathSettlerSheriff.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140222D7C: variable 'v1' is possibly undefined
// 140A75DA0: using guessed type wchar_t *off_140A75DA0;
// 140A995C0: using guessed type wchar_t aDbPathsettlers[26];
// 140A99698: using guessed type wchar_t aPathsettlershe[19];
...
// 140C64158: using guessed type int dword_140C64158;
// 140C642D4: using guessed type int dword_140C642D4;
// 140C6445C: using guessed type int dword_140C6445C;
