...
__int64 sub_140225BA0()
{
	...
	if (qword_140C64758)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PrerequisiteType"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PrerequisiteType.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140225C3C: variable 'v1' is possibly undefined
// 140A66A60: using guessed type wchar_t *off_140A66A60;
// 140A9A5A8: using guessed type wchar_t aDbPrerequisite_0[24];
// 140A9A670: using guessed type wchar_t aPrerequisitety[17];
