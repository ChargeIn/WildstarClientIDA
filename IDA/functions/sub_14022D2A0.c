...
__int64 sub_14022D2A0()
{
	...
	if (qword_140C63918)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Race"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Race.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022D33C: variable 'v1' is possibly undefined
// 140A9F5A8: using guessed type wchar_t aDbRaceTbl[12];
// 140A9F678: using guessed type wchar_t aRace[5];
// 140ACEB58: using guessed type wchar_t *off_140ACEB58;
...
// 140C639A4: using guessed type int dword_140C639A4;
// 140C64C3C: using guessed type int dword_140C64C3C;
// 140C653E0: using guessed type int dword_140C653E0;
