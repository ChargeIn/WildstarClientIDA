...
__int64 sub_14022A3E0()
{
	...
	if (qword_140C64EE8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PvPRatingFloor"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PvPRatingFloor.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022A47C: variable 'v1' is possibly undefined
// 140A9CB00: using guessed type wchar_t aPvpratingfloor[15];
// 140A9CC48: using guessed type wchar_t aDbPvpratingflo[22];
// 140ACC7C8: using guessed type wchar_t *off_140ACC7C8;
...
// 140C648E0: using guessed type int dword_140C648E0;
// 140C64EE8: using guessed type __int64 qword_140C64EE8;
// 140C6503C: using guessed type int dword_140C6503C;
