...
__int64 sub_1401EE300()
{
	...
	if (qword_140C63C68)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"BugSubcategory"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\BugSubcategory.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401EE39C: variable 'v1' is possibly undefined
// 140A5C7F0: using guessed type wchar_t aDbBugsubcatego[22];
// 140A5C820: using guessed type wchar_t aBugsubcategory[15];
// 140AD40C8: using guessed type wchar_t *off_140AD40C8;
...
// 140C6424C: using guessed type int dword_140C6424C;
// 140C64E58: using guessed type int dword_140C64E58;
// 140C64F60: using guessed type int dword_140C64F60;
