//----- (000000014029F8C0) ----------------------------------------------------
__int64 __fastcall sub_14029F8C0(__int64 a1, int a2, unsigned int a3, int a4)
{
	int v4; // eax
	...
	if ((a4 & 1) != 0)
	{
		...
		if (!v10)
		{
			...
			*((_QWORD*)&v40 + 1) = TlsGetValue(dwTlsIndex);
			...
			v31 = 0x141DE56C0i64;
			v50 = v40;
			v12 = sub_1401971E0(&dword_140C8A470, 14, &v31, &v49);
			v39 = &off_140B5E648;
		...
		if (v10 == 2)
		{
			...
			*((_QWORD*)&v38 + 1) = TlsGetValue(dwTlsIndex);
			...
			v32 = 0x141DE5800i64;
			v54 = v38;
			v11 = sub_1401971E0(&dword_140C8A474, 14, &v32, &v53);
			TlsValue = &off_140B5E648;
	...
	if (v5 + a2 > *(_DWORD*)(a1 + 24))
	{
		...
		*((_QWORD*)&v34 + 1) = TlsGetValue(dwTlsIndex);
		...
		v48 = 0x141DE57A0i64;
		v56 = v34;
		v13 = sub_1401971E0(&dword_140C8A468, 14, &v48, &v55);
		v33 = &off_140B5E648;
	...
	if (*(_QWORD*)(a1 + 48))
	{
		...
		*((_QWORD*)&v36 + 1) = TlsGetValue(dwTlsIndex);
		...
		v45 = 0x141DE5730i64;
		v52 = v36;
		v14 = sub_1401971E0(&dword_140C8A46C, 14, &v45, &v51);
		v35 = &off_140B5E648;
		...
		*(_DWORD*)(a1 + 60) = v5;
		...
		else
		{
			...
			if (v9)
			{
				...
				{
					(*(void(__fastcall**)(__int64, __int64, _QWORD))(*(_QWORD*)v21 + 376i64))(v21, v20, *(_QWORD*)(a1 + 40));
				}
				else
				{
					v67 = 0i64;
		...
		{
			sub_14003D880(&v30);
			v28 = (volatile signed __int32*)(48i64 * *(int*)(a1 + 32) + *(_QWORD*)(a1 + 16) + 532i64);
			if (v9)
			{
...
// 140C8A468: using guessed type _DWORD dword_140C8A468;
// 140C8A46C: using guessed type _DWORD dword_140C8A46C;
// 140C8A470: using guessed type _DWORD dword_140C8A470;
// 140C8A474: using guessed type _DWORD dword_140C8A474;
