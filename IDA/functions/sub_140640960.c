...
//----- (0000000140640960) ----------------------------------------------------
__int64 __fastcall sub_140640960(__int64 a1, __int64 a2, unsigned __int16* a3, _DWORD* a4)
{
	int v6; // ebp
	wchar_t** v7; // rsi
	...
	do
	{
		...
		++v7;
		++v6;
	} while ((__int64)v7 < (__int64)off_140C394D8);
	return 0i64;
}
...
// 140C394D8: using guessed type char *off_140C394D8[16];
