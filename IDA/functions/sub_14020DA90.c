...
//----- (000000014020DA90) ----------------------------------------------------
__int64 sub_14020DA90()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6AF30, qword_140C63858);
	if (dword_140C63AAC || (int)sub_14020D880() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C63A68 + 40i64))(qword_140C63A68);
}
