//----- (000000014022E9F0) ----------------------------------------------------
__int64 sub_14022E9F0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6CA50, qword_140C63858);
	if (dword_140C6564C || (int)sub_14022E7E0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64388 + 40i64))(qword_140C64388);
}
