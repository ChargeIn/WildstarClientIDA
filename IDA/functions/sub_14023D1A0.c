...
__int64 sub_14023D1A0()
{
	...
	if (qword_140C64FE8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4Visual"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4Visual.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023D23C: variable 'v1' is possibly undefined
// 140A6FE00: using guessed type wchar_t *off_140A6FE00;
// 140AA8FC8: using guessed type wchar_t aDbSpell4visual[20];
// 140AA9378: using guessed type wchar_t aSpell4visual[13];
...
// 140C64E14: using guessed type int dword_140C64E14;
// 140C64FC8: using guessed type int dword_140C64FC8;
