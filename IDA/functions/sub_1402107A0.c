...
__int64 sub_1402107A0()
{
	...
	if (qword_140C63B68)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Language"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Language.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021083C: variable 'v1' is possibly undefined
// 140A91620: using guessed type wchar_t aDbLanguageTbl[16];
// 140A91640: using guessed type wchar_t aLanguage[9];
// 140AE17B0: using guessed type wchar_t *off_140AE17B0;
...
// 140C63ADC: using guessed type int dword_140C63ADC;
// 140C63B68: using guessed type __int64 qword_140C63B68;
// 140C64808: using guessed type int dword_140C64808;
