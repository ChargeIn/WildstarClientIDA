...
__int64 sub_140248420()
{
	...
	if (qword_140C63AA0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"VeteranTier"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\VeteranTier.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402484BC: variable 'v1' is possibly undefined
// 140AAE450: using guessed type wchar_t aDbVeterantierT[19];
// 140AAE478: using guessed type wchar_t aVeterantier[12];
// 140AE3580: using guessed type wchar_t *off_140AE3580;
...
// 140C641E4: using guessed type int dword_140C641E4;
// 140C65010: using guessed type int dword_140C65010;
