//----- (00000001400885C0) ----------------------------------------------------
__int64 __fastcall sub_1400885C0(__int64 a1, unsigned int* a2)
{
	__int64 v2; // r8
			...
			(unsigned __int64)(8i64 * (*(_QWORD*)(v11 + 24) - *(_QWORD*)(v11 + 32)) - v13) >= 0x40))
	{
		...
		v15 = *(_QWORD**)(v11 + 32);
		*v15 &= (1i64 << v13) - 1;
		*v15 |= (v14 & 0x7F) << *(_QWORD*)(a1 + 16);
		v16 = *(_QWORD*)(a1 + 16);
		if (((v16 + 14) & 0xFFFFFFFFFFFFFFF8ui64) > 0x40)
	...
	{
		result = sub_140336470(a1, v12, 7ui64);
		if ((int)result < 0)
			return result;
	}
	v17 = *(_QWORD*)(a1 + 8);
