...
//----- (00000001403D2990) ----------------------------------------------------
int* __fastcall sub_1403D2990(__int64 a1, int* a2)
{
	__int64 v2; // r9
	__int64 v5; // rax
	int* v6; // rbx
	...
	if (v6 == (int*)v2 || *a2 < (unsigned int)v6[8])
	{
		...
		*((_QWORD*)v9 + 3) = v9;
		v11 = *a2;
		sub_1403D2AA0((__int64)v12, (__int64)v8);
		v14 = v6;
		sub_1403D5430(a1, &v15, (__int64*)&v14, &v11);
		v6 = v15;
...
// 1403D2990: using guessed type char var_58[8];
// 1403D2990: using guessed type char var_30[8];
