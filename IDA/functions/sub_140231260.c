...
__int64 sub_140231260()
{
	...
	if (qword_140C64078)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Salvage"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Salvage.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402312FC: variable 'v1' is possibly undefined
// 140AA2420: using guessed type wchar_t aSalvage[8];
// 140AA2550: using guessed type wchar_t aDbSalvageTbl[15];
// 140AD7BF8: using guessed type wchar_t *off_140AD7BF8;
...
// 140C64238: using guessed type int dword_140C64238;
// 140C64430: using guessed type int dword_140C64430;
// 140C64D8C: using guessed type int dword_140C64D8C;
