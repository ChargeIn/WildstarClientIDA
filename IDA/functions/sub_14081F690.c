//----- (000000014081F690) ----------------------------------------------------
__int64 __fastcall sub_14081F690(unsigned int a1)
{
	...
	if (v5 && v5 != -14)
		return v5;
	if (v5 == -14)
		qword_140C61618 = 0i64;
	if (qword_140C61618 && dword_140C61620 != dword_140C60980[v6])
		qword_140C61618 = 0i64;
	if (!qword_140C61618 && v3 && nvapi_QueryInterface)
	{
		qword_140C61618 = nvapi_QueryInterface(1586433004i64);
		dword_140C61620 = dword_140C60980[v6];
	}
	if (qword_140C61618)
	{
		v2 = (__int64(__fastcall*)(_QWORD))qword_140C61618;
		v4 = 0i64;
		if (qword_140C60938)
			qword_140C60938(1586433004i64, &v4);
		v5 = v2(a1);
		if (qword_140C60940)
			qword_140C60940(1586433004i64, v4, v5);
		--dword_140C60970[v6];
		return v5;
	}
	else
...
// 140C61618: using guessed type __int64 qword_140C61618;
// 140C61620: using guessed type int dword_140C61620;
