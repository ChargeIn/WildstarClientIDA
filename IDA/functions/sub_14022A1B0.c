...
//----- (000000014022A1B0) ----------------------------------------------------
__int64 sub_14022A1B0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6C698, qword_140C63858);
	if (dword_140C65308 || (int)sub_140229FA0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C655B0 + 40i64))(qword_140C655B0);
}
