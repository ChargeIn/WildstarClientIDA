...
//----- (00000001402261F0) ----------------------------------------------------
__int64 sub_1402261F0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6C350, qword_140C63858);
	if (dword_140C64FC4 || (int)sub_140225FE0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C65078 + 40i64))(qword_140C65078);
}
