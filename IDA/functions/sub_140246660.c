...
__int64 sub_140246660()
{
	...
	if (qword_140C65608)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Tutorial"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Tutorial.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402466FC: variable 'v1' is possibly undefined
// 140A73908: using guessed type wchar_t *off_140A73908;
// 140AAD568: using guessed type wchar_t aTutorial[9];
// 140AAD728: using guessed type wchar_t aDbTutorialTbl[16];
...
// 140C642C8: using guessed type int dword_140C642C8;
// 140C65170: using guessed type int dword_140C65170;
