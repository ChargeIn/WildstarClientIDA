...
__int64 sub_140229FA0()
{
	...
	if (qword_140C655B0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PublicEventVote"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PublicEventVote.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022A03C: variable 'v1' is possibly undefined
// 140A88A58: using guessed type wchar_t *off_140A88A58;
// 140A9CA08: using guessed type wchar_t aPubliceventvot[16];
// 140A9CB78: using guessed type wchar_t aDbPubliceventv_0[23];
...
// 140C63A3C: using guessed type int dword_140C63A3C;
// 140C64A88: using guessed type int dword_140C64A88;
