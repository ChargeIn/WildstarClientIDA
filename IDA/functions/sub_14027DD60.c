...
//----- (000000014027DD60) ----------------------------------------------------
int __fastcall sub_14027DD60(__int64 a1)
{
	...
	v1 = *(unsigned int*)(a1 + 8344);
	if ((unsigned int)v1 < 0xD)
	{
		v3 = *(_QWORD*)(a1 + 8 * v1 + 8240);
		if (v3)
		{
			v4 = a1 + 6368;
		...
		LABEL_10:
			...
			if (*(_DWORD*)(a1 + 6436))
			{
				...
				{
					v7 = *(_QWORD*)(a1 + 6352);
					v8 = *(unsigned int*)(a1 + 8344);
					v17 = 0i64;
					(*(void(__fastcall**)(__int64, __int64, __int64, __int64*))(*(_QWORD*)v7 + 56i64))(v7, v8, 1i64, &v17);
				}
				v9 = *(_QWORD*)(a1 + 6360);
				v10 = *(unsigned int*)(a1 + 8344);
				v18 = *(_QWORD*)(v3 + 24);
				v11 = (_DWORD*)(v3 + 12);
				v12 = (_DWORD*)(v3 + 8);
				(*(void(__fastcall**)(__int64, __int64, __int64, __int64*, _DWORD*, _DWORD*))(*(_QWORD*)v9 + 952i64))(
					v9,
					v10,
					1i64,
					&v18,
			...
			{
				v13 = *(_QWORD*)(a1 + 6352);
				v14 = *(unsigned int*)(a1 + 8344);
				v19 = *(_QWORD*)(v3 + 24);
				(*(void(__fastcall**)(__int64, __int64, __int64, __int64*))(*(_QWORD*)v13 + 56i64))(v13, v14, 1i64, &v19);
			}
			v1 = *(_QWORD*)(v4 + 8);
			if (v1 <= 1)
			{
