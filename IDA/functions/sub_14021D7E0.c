...
__int64 sub_14021D7E0()
{
	...
	if (qword_140C63BF8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathExplorerDoorEntrance"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PathExplorerDoorEntrance.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021D87C: variable 'v1' is possibly undefined
// 140A65078: using guessed type wchar_t *off_140A65078;
// 140A951E0: using guessed type wchar_t aPathexplorerdo_0[25];
// 140A953D0: using guessed type wchar_t aDbPathexplorer_2[32];
...
// 140C6432C: using guessed type int dword_140C6432C;
// 140C64674: using guessed type int dword_140C64674;
