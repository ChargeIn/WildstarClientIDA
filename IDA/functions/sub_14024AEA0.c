...
__int64 sub_14024AEA0()
{
	...
	if (qword_140C65348)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"WorldClutter"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\WorldClutter.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024AF3C: variable 'v1' is possibly undefined
// 140A71A80: using guessed type wchar_t *off_140A71A80;
// 140AAFA68: using guessed type wchar_t aWorldclutter[13];
// 140AAFBA0: using guessed type wchar_t aDbWorldclutter[20];
...
// 140C63C44: using guessed type int dword_140C63C44;
// 140C64C84: using guessed type int dword_140C64C84;
