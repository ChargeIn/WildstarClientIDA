...
__int64 sub_140239EA0()
{
	...
	if (qword_140C647A8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4Reagent"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4Reagent.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140239F3C: variable 'v1' is possibly undefined
// 140AA7EA0: using guessed type wchar_t aDbSpell4reagen[21];
// 140AA7F58: using guessed type wchar_t aSpell4reagent[14];
// 140AD0970: using guessed type wchar_t *off_140AD0970;
