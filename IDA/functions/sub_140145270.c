...
//----- (0000000140145270) ----------------------------------------------------
__int64 __fastcall sub_140145270(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Vector2");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6 - 16;
	sub_140057020(a1, "Vector2", &off_140B5C5A0);
	a1[2] -= 16i64;
	return 0i64;
}
// 140145383: variable 'v14' is possibly undefined
// 140B5C5A0: using guessed type char *off_140B5C5A0;
// 140C57A50: using guessed type char *off_140C57A50;
