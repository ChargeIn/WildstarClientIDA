...
//----- (0000000140203090) ----------------------------------------------------
__int64 sub_140203090()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6A670, qword_140C63858);
	if (dword_140C63B5C || (int)sub_140202E80() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C65030 + 40i64))(qword_140C65030);
}
