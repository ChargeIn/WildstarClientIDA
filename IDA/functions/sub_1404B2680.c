...
//----- (00000001404B2680) ----------------------------------------------------
_BOOL8 __fastcall sub_1404B2680(__int64 a1)
{
	__int64 v1; // r12
	__m128i* v2; // rax
	bool v3; // zf
	...
	v12[10] = &v129;
	sub_1401A4C50((__int64)(v12 + 3), (int*)L"ViewedLevelUpUnlocks");
	if (v12[1] == v118)
	{
		v13 = v12[2];
		if (v13)
	...
	if (v19 != v18)
	{
		do
		{
			...
			*(_QWORD*)(v21 + 32) = v24;
			sub_1407DB590(v24, (int*)L"LevelUpUnlock", 2 * v22 + 2);
			v25 = *(_QWORD*)(v21 + 32);
			*(_DWORD*)(v21 + 24) = 512;
	...
	*(_QWORD*)(v42 + 32) = v45;
	sub_1407DB590(v45, (int*)L"PendingLevelUpUnlocks", 2 * v43 + 2);
	v46 = *(_QWORD*)(v42 + 32);
	*(_DWORD*)(v42 + 24) = 512;
				...
				*(_QWORD*)(v61 + 48) = v65 + 2 * v62;
				...
				if (v73 != v72)
				{
					...
					do
					{
						...
						*(_QWORD*)(v76 + 32) = v79;
						sub_1407DB590(v79, (int*)L"LevelUpUnlock", 2 * v77 + 2);
						v80 = *(_QWORD*)(v76 + 32);
						*(_DWORD*)(v76 + 24) = 512;
...
// 1404B33EA: variable 'v100' is possibly undefined
// 1404B33EA: variable 'v101' is possibly undefined
...
// 140B04814: using guessed type wchar_t aId_14[3];
// 140B06304: using guessed type wchar_t aId_15[3];
// 140B06734: using guessed type wchar_t aId_13[3];
// 140B09218: using guessed type wchar_t aCharacter_6[10];
// 140B09230: using guessed type wchar_t aLevelupunlock_5[14];
// 140B09250: using guessed type wchar_t aLevelupunlock_4[14];
// 140B09270: using guessed type wchar_t aPendinglevelup_0[22];
// 140B092A0: using guessed type wchar_t aI64d_0[6];
// 140B092D0: using guessed type wchar_t aLevelupunlocks_0[19];
// 140B092F8: using guessed type wchar_t aViewedlevelupu_0[21];
...
// 1404B2680: using guessed type __m128i var_240[33];
