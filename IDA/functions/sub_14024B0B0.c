...
//----- (000000014024B0B0) ----------------------------------------------------
__int64 sub_14024B0B0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6E1B8, qword_140C63858);
	if (dword_140C64E10 || (int)sub_14024AEA0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C65348 + 40i64))(qword_140C65348);
}
