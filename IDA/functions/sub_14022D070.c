...
//----- (000000014022D070) ----------------------------------------------------
__int64 sub_14022D070()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6C900, qword_140C63858);
	if (dword_140C64F4C || (int)sub_14022CE60() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C652A0 + 40i64))(qword_140C652A0);
}
