...
__int64 sub_140239620()
{
	...
	if (qword_140C63B48)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4Modification"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4Modification.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402396BC: variable 'v1' is possibly undefined
// 140AA7D00: using guessed type wchar_t aDbSpell4modifi[26];
// 140AA7D38: using guessed type wchar_t aSpell4modifica[19];
// 140AD9478: using guessed type wchar_t *off_140AD9478;
...
// 140C6412C: using guessed type int dword_140C6412C;
// 140C64F24: using guessed type int dword_140C64F24;
