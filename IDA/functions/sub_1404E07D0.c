//----- (00000001404E07D0) ----------------------------------------------------
__int64 __fastcall sub_1404E07D0(_QWORD* a1, int* a2, unsigned int a3, int** a4)
{
	__int64 result; // rax
	float* v7; // r13
	int* v8; // r12
	...
	if (result)
	{
		...
		if (sub_14018E5E0(v8, L"mod"))
		{
			...
			{
				sub_1404DE760((__int64)a1, v35, v25);
			}
			else if (v26)
			{
...
// 1404E0B48: variable 'v35' is possibly undefined
// 1404E0C46: variable 'v36' is possibly undefined
// 140B0B360: using guessed type wchar_t aPctsub_2[7];
// 140B0B370: using guessed type wchar_t aPct_2[4];
// 140B0B378: using guessed type wchar_t aAbs_2[4];
// 140B0B380: using guessed type wchar_t aMod[4];
// 140B0B3A8: using guessed type wchar_t aPctadd_2[7];
// 140B0B4B0: using guessed type wchar_t aMod_0[4];
// 140B0B4B8: using guessed type wchar_t aMs_3[3];
// 140B0B4C0: using guessed type wchar_t aRawint_3[7];
// 140B0B4D0: using guessed type wchar_t aD_47[3];
