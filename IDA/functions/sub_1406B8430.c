//----- (00000001406B8430) ----------------------------------------------------
__int64 __fastcall sub_1406B8430(_QWORD* a1)
{
	__int64 v2; // rax
	__int64 v3; // rax
	__int64 v4; // rcx
	...
	{
		v7 = (unsigned __int64*)sub_14018F0E0(&v10, word_1409F6CD4)[1];
		if (v7)
		{
			v8 = -1i64;
			do
...
// 1409F6CD4: using guessed type unsigned __int16 word_1409F6CD4[56];
