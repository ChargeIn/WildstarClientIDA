...
__int64 sub_14023AFA0()
{
	...
	if (qword_140C642F0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4StackGroup"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4StackGroup.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023B03C: variable 'v1' is possibly undefined
// 140A5C8A0: using guessed type wchar_t *off_140A5C8A0;
// 140AA82B0: using guessed type wchar_t aSpell4stackgro[17];
// 140AA83E0: using guessed type wchar_t aDbSpell4stackg[24];
...
// 140C64410: using guessed type int dword_140C64410;
// 140C64980: using guessed type int dword_140C64980;
// 140C64B24: using guessed type int dword_140C64B24;
