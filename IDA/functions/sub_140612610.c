...
//----- (0000000140612610) ----------------------------------------------------
__int64 __fastcall sub_140612610(__int64 a1, unsigned int* a2)
{
	__int64 v5; // rax
	__int64 v6; // rcx
	__int64 v7; // rbx
	...
	*(_DWORD*)(a1 + 28568) = 1;
	...
	if (v10 == v8 || (v12 = v10, a2[1] < *(_DWORD*)(v10 + 32)))
		v12 = *(_QWORD*)(v7 + 120);
	if (v12 != v8)
	{
...
// 14061266A: variable 'v6' is possibly undefined
// 1409ED834: using guessed type wchar_t asc_1409ED834[2];
