...
__int64 sub_1401F33C0()
{
	...
	if (qword_140C64DB8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ClassSecondaryStatBonus"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\ClassSecondaryStatBonus.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F345C: variable 'v1' is possibly undefined
// 140A573C0: using guessed type wchar_t *off_140A573C0;
// 140A631C0: using guessed type wchar_t aClasssecondary[24];
// 140A63430: using guessed type wchar_t aDbClassseconda[31];
