...
__int64 sub_140236FE0()
{
	...
	if (qword_140C64BD0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4CastResult"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4CastResult.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023707C: variable 'v1' is possibly undefined
// 140A57F70: using guessed type wchar_t *off_140A57F70;
// 140AA5AF8: using guessed type wchar_t aSpell4castresu[17];
// 140AA5C48: using guessed type wchar_t aDbSpell4castre[24];
...
// 140C64110: using guessed type int dword_140C64110;
// 140C645F4: using guessed type int dword_140C645F4;
