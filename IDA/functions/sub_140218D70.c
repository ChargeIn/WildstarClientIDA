...
//----- (0000000140218D70) ----------------------------------------------------
__int64 sub_140218D70()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6B860, qword_140C63858);
	if (dword_140C6466C || (int)sub_140218B60() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C63EB8 + 40i64))(qword_140C63EB8);
}
