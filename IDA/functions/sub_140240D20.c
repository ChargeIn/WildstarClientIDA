...
__int64 sub_140240D20()
{
	...
	if (qword_140C64B30)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TargetMarker"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\TargetMarker.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140240DBC: variable 'v1' is possibly undefined
// 140AAAB28: using guessed type wchar_t aDbTargetmarker[20];
// 140AAAB50: using guessed type wchar_t aTargetmarker[13];
// 140ADC318: using guessed type wchar_t *off_140ADC318;
...
// 140C6481C: using guessed type int dword_140C6481C;
// 140C64B30: using guessed type __int64 qword_140C64B30;
// 140C651E4: using guessed type int dword_140C651E4;
