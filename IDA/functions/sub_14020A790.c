...
//----- (000000014020A790) ----------------------------------------------------
__int64 sub_14020A790()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6AC90, qword_140C63858);
	if (dword_140C639D8 || (int)sub_14020A580() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C644B0 + 40i64))(qword_140C644B0);
}
