...
__int64 sub_1401FCCC0()
{
	...
	if (qword_140C63AE0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"DyeColorRamp"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\DyeColorRamp.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401FCD5C: variable 'v1' is possibly undefined
// 140A5E0F0: using guessed type wchar_t *off_140A5E0F0;
// 140A86BD0: using guessed type wchar_t aDyecolorramp[13];
// 140A86E28: using guessed type wchar_t aDbDyecolorramp[20];
...
// 140C6422C: using guessed type int dword_140C6422C;
// 140C64FA0: using guessed type int dword_140C64FA0;
