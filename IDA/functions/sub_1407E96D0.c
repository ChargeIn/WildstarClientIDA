...
//----- (00000001407E96D0) ----------------------------------------------------
__int64 __fastcall sub_1407E96D0(__int64 a1, signed __int8* a2, _OWORD* a3, int* a4)
{
	int v7; // r14d
	int v8; // r12d
	int v9; // eax
		...
		if (v12)
		{
			...
			do
			{
				...
				if ((unsigned __int8)(v12 - 32) > 0x58u)
					...
					v16 = *((_BYTE*)&off_140963400 + v12) & 0xF;
				v17 = v14;
				v14 = byte_140963420[8 * v16 + v14] >> 4;
				v60 = v14;
				switch (v14)
				{
				case 0:
...
// 1407E96D0: using guessed type int var_240[12];
