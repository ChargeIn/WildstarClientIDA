...
__int64 sub_1402076C0()
{
	...
	if (qword_140C64E88)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"HousingResource"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\HousingResource.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020775C: variable 'v1' is possibly undefined
// 140A73D60: using guessed type wchar_t *off_140A73D60;
// 140A8D140: using guessed type wchar_t aDbHousingresou[23];
// 140A8D1F8: using guessed type wchar_t aHousingresourc[16];
...
// 140C64858: using guessed type int dword_140C64858;
// 140C64E88: using guessed type __int64 qword_140C64E88;
// 140C650A8: using guessed type int dword_140C650A8;
