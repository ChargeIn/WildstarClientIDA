...
__int64 sub_140238960()
{
	...
	if (qword_140C63F40)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4EffectGroupList"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\Spell4EffectGroupList.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402389FC: variable 'v1' is possibly undefined
// 140AA7460: using guessed type wchar_t aSpell4effectgr[22];
// 140AA75F8: using guessed type wchar_t aDbSpell4effect_1[29];
// 140ACC240: using guessed type wchar_t *off_140ACC240;
