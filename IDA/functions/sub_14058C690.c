...
//----- (000000014058C690) ----------------------------------------------------
void __fastcall sub_14058C690(__int64 a1)
{
	__int64 v2; // rdx
	__int64 v3; // rax
	__int16* v4; // rax
...
LABEL_83:
	sub_1400B7090((__int64)v68, 282582);
...
// 14058C8FF: variable 'v18' is possibly undefined
// 14058CB76: variable 'v45' is possibly undefined
// 140A6A5C8: using guessed type wchar_t *off_140A6A5C8[2];
// 140B1F580: using guessed type wchar_t asc_140B1F580[4];
// 140B1F588: using guessed type wchar_t asc_140B1F588[5];
...
// 14058C690: using guessed type char var_158[8];
// 14058C690: using guessed type char var_178[8];
// 14058C690: using guessed type char var_138[8];
