...
__int64 sub_14020D440()
{
	...
	if (qword_140C65560)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ItemSetBonus"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ItemSetBonus.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020D4DC: variable 'v1' is possibly undefined
// 140A5C648: using guessed type wchar_t *off_140A5C648;
// 140A90388: using guessed type wchar_t aDbItemsetbonus[20];
// 140A90418: using guessed type wchar_t aItemsetbonus[13];
...
// 140C640FC: using guessed type int dword_140C640FC;
// 140C6508C: using guessed type int dword_140C6508C;
