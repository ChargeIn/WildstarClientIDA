...
__int64 sub_1402160E0()
{
	...
	if (qword_140C63A78)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"MaterialData"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\MaterialData.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021617C: variable 'v1' is possibly undefined
// 140A869A0: using guessed type wchar_t *off_140A869A0;
// 140A93400: using guessed type wchar_t aDbMaterialdata[20];
// 140A93428: using guessed type wchar_t aMaterialdata[13];
...
// 140C645F8: using guessed type int dword_140C645F8;
// 140C65478: using guessed type int dword_140C65478;
