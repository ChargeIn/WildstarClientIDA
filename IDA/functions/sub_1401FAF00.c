...
__int64 sub_1401FAF00()
{
	...
	if (qword_140C64FE0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PeriodicQuestSetCategory"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PeriodicQuestSetCategory.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401FAF9C: variable 'v1' is possibly undefined
// 140A84100: using guessed type wchar_t aPeriodicquests[25];
// 140A844C0: using guessed type wchar_t aDbPeriodicques[32];
// 140ADB280: using guessed type wchar_t *off_140ADB280;
