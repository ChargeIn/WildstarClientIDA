...
//----- (0000000140819CF0) ----------------------------------------------------
__int64 __fastcall sub_140819CF0(__int64 a1, __int64 a2)
{
	...
	if (v6 && v6 != -14)
		return v6;
	if (v6 == -14)
		qword_140C61288 = 0i64;
	if (qword_140C61288 && dword_140C61290 != dword_140C60980[v7])
		qword_140C61288 = 0i64;
	if (!qword_140C61288 && v4 && nvapi_QueryInterface)
	{
		qword_140C61288 = nvapi_QueryInterface(3092444379i64);
		dword_140C61290 = dword_140C60980[v7];
	}
	if (qword_140C61288)
	{
		v3 = (__int64(__fastcall*)(__int64, __int64))qword_140C61288;
		v5 = 0i64;
		if (qword_140C60938)
			qword_140C60938(3092444379i64, &v5);
		v6 = v3(a1, a2);
		if (qword_140C60940)
			qword_140C60940(3092444379i64, v5, v6);
		--dword_140C60970[v7];
		return v6;
	}
	else
...
// 140C61288: using guessed type __int64 qword_140C61288;
// 140C61290: using guessed type int dword_140C61290;
