...
__int64 sub_140201500()
{
	...
	if (qword_140C64490)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"GenericUnlockSet"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\GenericUnlockSet.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020159C: variable 'v1' is possibly undefined
// 140A8A0C8: using guessed type wchar_t aGenericunlocks[17];
// 140A8A238: using guessed type wchar_t aDbGenericunloc_0[24];
// 140ACC968: using guessed type wchar_t *off_140ACC968;
...
// 140C650AC: using guessed type int dword_140C650AC;
// 140C65538: using guessed type int dword_140C65538;
