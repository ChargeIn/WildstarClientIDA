...
__int64 sub_140237860()
{
	...
	if (qword_140C64368)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4Conditions"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4Conditions.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402378FC: variable 'v1' is possibly undefined
// 140A79698: using guessed type wchar_t *off_140A79698;
// 140AA64A0: using guessed type wchar_t aDbSpell4condit[24];
// 140AA6558: using guessed type wchar_t aSpell4conditio[17];
...
// 140C63E7C: using guessed type int dword_140C63E7C;
// 140C64368: using guessed type __int64 qword_140C64368;
// 140C6520C: using guessed type int dword_140C6520C;
