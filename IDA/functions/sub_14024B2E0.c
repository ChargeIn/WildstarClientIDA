...
__int64 sub_14024B2E0()
{
	...
	if (qword_140C63E90)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"WorldLayer"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\WorldLayer.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024B37C: variable 'v1' is possibly undefined
// 140A7D3E8: using guessed type wchar_t *off_140A7D3E8;
// 140AAFED8: using guessed type wchar_t aDbWorldlayerTb[18];
// 140AAFF00: using guessed type wchar_t aWorldlayer[11];
...
// 140C63CC0: using guessed type int dword_140C63CC0;
// 140C63E90: using guessed type __int64 qword_140C63E90;
// 140C643EC: using guessed type int dword_140C643EC;
