...
__int64 sub_140240060()
{
	...
	if (qword_140C64C70)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"StoryPanel"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\StoryPanel.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402400FC: variable 'v1' is possibly undefined
// 140A7EAC0: using guessed type wchar_t *off_140A7EAC0;
// 140AAA5B0: using guessed type wchar_t aStorypanel[11];
// 140AAA7D0: using guessed type wchar_t aDbStorypanelTb[18];
...
// 140C63B30: using guessed type int dword_140C63B30;
// 140C64C70: using guessed type __int64 qword_140C64C70;
// 140C64FF4: using guessed type int dword_140C64FF4;
