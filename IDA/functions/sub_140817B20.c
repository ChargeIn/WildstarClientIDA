//----- (0000000140817B20) ----------------------------------------------------
__int64 __fastcall sub_140817B20(unsigned int a1)
{
	...
	if (v5 && v5 != -14)
		return v5;
	if (v5 == -14)
		qword_140C61138 = 0i64;
	if (qword_140C61138 && dword_140C61140 != dword_140C60980[v6])
		qword_140C61138 = 0i64;
	if (!qword_140C61138 && v3 && nvapi_QueryInterface)
	{
		qword_140C61138 = nvapi_QueryInterface(1946631369i64);
		dword_140C61140 = dword_140C60980[v6];
	}
	if (qword_140C61138)
	{
		v2 = (__int64(__fastcall*)(_QWORD))qword_140C61138;
		v4 = 0i64;
		if (qword_140C60938)
			qword_140C60938(1946631369i64, &v4);
		v5 = v2(a1);
		if (qword_140C60940)
			qword_140C60940(1946631369i64, v4, v5);
		--dword_140C60970[v6];
		return v5;
	}
	else
...
// 140C61138: using guessed type __int64 qword_140C61138;
// 140C61140: using guessed type int dword_140C61140;
