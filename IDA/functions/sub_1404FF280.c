...
//----- (00000001404FF280) ----------------------------------------------------
__int64 __fastcall sub_1404FF280(unsigned __int64* a1, __int64 a2, unsigned int a3, unsigned int a4)
{
	...
	if (v9 < 0)
	{
		...
		*(_QWORD*)&v18 = &off_140B5E640;
		...
		v20[0] = v18;
		LODWORD(v13) = a4;
		v10 = sub_1401971E0(&dword_140C8AD5C, 13, &v21, a3, v13, v20, &v14);
		*(_QWORD*)&v18 = &off_140B5E648;
...
// 1404FF3E5: variable 'v13' is possibly undefined
...
// 140C8AD5C: using guessed type _DWORD dword_140C8AD5C;
