...
//----- (0000000140435DC0) ----------------------------------------------------
__int64 __fastcall sub_140435DC0(_QWORD* a1)
{
	int* v2; // rax
	__int64 v3; // r12
	char* v4; // rax
...
// 140435EF0: variable 'v12' is possibly undefined
...
// 140435DC0: using guessed type char var_148[8];
// 140435DC0: using guessed type char var_F8[8];
