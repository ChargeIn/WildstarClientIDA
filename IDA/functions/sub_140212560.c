...
__int64 sub_140212560()
{
	...
	if (qword_140C63BD0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"MapZone"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\MapZone.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402125FC: variable 'v1' is possibly undefined
// 140A790E0: using guessed type wchar_t *off_140A790E0;
// 140A92028: using guessed type wchar_t aDbMapzoneTbl[15];
// 140A920A8: using guessed type wchar_t aMapzone[8];
...
// 140C649DC: using guessed type int dword_140C649DC;
// 140C65370: using guessed type int dword_140C65370;
// 140C65394: using guessed type int dword_140C65394;
