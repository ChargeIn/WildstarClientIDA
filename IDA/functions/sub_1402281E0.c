...
__int64 sub_1402281E0()
{
	...
	if (qword_140C64890)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PublicEventObjective"))
	{
...
// 14022827C: variable 'v1' is possibly undefined
// 140A9B9D0: using guessed type wchar_t aDbPublicevento[28];
// 140A9BA08: using guessed type wchar_t aPubliceventobj[21];
// 140ACEBC8: using guessed type wchar_t *off_140ACEBC8;
...
// 140C64B80: using guessed type int dword_140C64B80;
// 140C6533C: using guessed type int dword_140C6533C;
