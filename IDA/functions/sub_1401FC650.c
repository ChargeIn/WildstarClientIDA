...
//----- (00000001401FC650) ----------------------------------------------------
__int64 sub_1401FC650()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6A0F8, qword_140C63858);
	if (dword_140C64594 || (int)sub_1401FC440() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C63948 + 40i64))(qword_140C63948);
}
