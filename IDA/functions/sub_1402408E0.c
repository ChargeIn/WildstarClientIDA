...
__int64 sub_1402408E0()
{
	...
	if (qword_140C63908)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TargetGroup"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\TargetGroup.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024097C: variable 'v1' is possibly undefined
// 140AAAA40: using guessed type wchar_t aDbTargetgroupT[19];
// 140AAAA68: using guessed type wchar_t aTargetgroup[12];
// 140AD3778: using guessed type wchar_t *off_140AD3778;
...
// 140C64564: using guessed type int dword_140C64564;
// 140C64C38: using guessed type int dword_140C64C38;
