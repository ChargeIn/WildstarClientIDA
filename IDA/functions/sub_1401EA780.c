...
__int64 sub_1401EA780()
{
	...
	if (qword_140C63F08)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"AchievementText"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\AchievementText.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401EA81C: variable 'v1' is possibly undefined
// 140A4C840: using guessed type wchar_t aAchievementtex[16];
// 140A4CBD8: using guessed type wchar_t aDbAchievementt[23];
// 140ADC4E0: using guessed type wchar_t *off_140ADC4E0;
...
// 140C650EC: using guessed type int dword_140C650EC;
// 140C655FC: using guessed type int dword_140C655FC;
