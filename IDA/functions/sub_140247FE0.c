...
__int64 sub_140247FE0()
{
	...
	if (qword_140C63F28)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"UnitVehicle"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\UnitVehicle.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024807C: variable 'v1' is possibly undefined
// 140AAE328: using guessed type wchar_t aDbUnitvehicleT[19];
// 140AAE3E0: using guessed type wchar_t aUnitvehicle[12];
// 140AD2798: using guessed type wchar_t *off_140AD2798;
...
// 140C63F70: using guessed type int dword_140C63F70;
// 140C640F8: using guessed type int dword_140C640F8;
// 140C64AC0: using guessed type int dword_140C64AC0;
