...
__int64 sub_1401FC440()
{
	...
	if (qword_140C63948)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"DatacubeVolume"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\DatacubeVolume.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401FC4DC: variable 'v1' is possibly undefined
// 140A86740: using guessed type wchar_t aDbDatacubevolu[22];
// 140A867F0: using guessed type wchar_t aDatacubevolume[15];
// 140ACAEF0: using guessed type wchar_t *off_140ACAEF0;
...
// 140C63D34: using guessed type int dword_140C63D34;
// 140C64190: using guessed type int dword_140C64190;
