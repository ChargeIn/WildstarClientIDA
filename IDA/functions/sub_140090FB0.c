//----- (0000000140090FB0) ----------------------------------------------------
__int64 __fastcall sub_140090FB0(__int64 a1, __int64 a2)
{
	__int64 v2; // r8
	...
	{
		result = sub_140336470(a1, *(_QWORD*)(a2 + 8), 0x40ui64);
		if ((int)result < 0)
			return result;
	}
	result = sub_1400A8C80(a1, (int*)(a2 + 16));
	if ((int)result >= 0)
	{
		result = sub_1400A8C80(a1, (int*)(a2 + 24));
		if ((int)result >= 0)
			return sub_1400A7110(a1, *(_DWORD*)(a2 + 32), 0x20ui64);
	}
	return result;
}
