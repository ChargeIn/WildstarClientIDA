...
__int64 sub_14021F5A0()
{
	...
	if (qword_140C64A70)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathReward"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PathReward.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021F63C: variable 'v1' is possibly undefined
// 140A62890: using guessed type wchar_t *off_140A62890;
// 140A96208: using guessed type wchar_t aPathreward[11];
// 140A96330: using guessed type wchar_t aDbPathrewardTb[18];
