...
//----- (00000001400AA030) ----------------------------------------------------
__int64 __fastcall sub_1400AA030(__int64 a1, unsigned int* a2)
{
	__int64 v2; // r8
			...
			(unsigned __int64)(8i64 * (*(_QWORD*)(v17 + 24) - *(_QWORD*)(v17 + 32)) - v19) >= 0x40))
	{
		...
		v21 = *(_QWORD**)(v17 + 32);
		*v21 &= (1i64 << v19) - 1;
		*v21 |= (v20 & 0x3FFFF) << *(_QWORD*)(a1 + 16);
		v22 = *(_QWORD*)(a1 + 16);
		if (((v22 + 25) & 0xFFFFFFFFFFFFFFF8ui64) > 0x40)
			*(_BYTE*)(*(_QWORD*)(v17 + 32) + 8i64) = v20 >> (64 - (unsigned __int8)v22);
		*(_QWORD*)(v17 + 32) += (unsigned __int64)(*(_QWORD*)(a1 + 16) + 18i64) >> 3;
		*(_QWORD*)(a1 + 16) = ((unsigned __int8)*(_QWORD*)(a1 + 16) + 2) & 7;
	}
	else
	{
		result = sub_140336470(a1, v18, 0x12ui64);
		if ((int)result < 0)
			return result;
	}
	...
	if ((int)result >= 0)
	{
		...
		if ((int)result >= 0)
		{
			result = sub_1400A7160(a1, *((_QWORD*)a2 + 4));
			if ((int)result >= 0)
			{
				result = sub_1400A7110(a1, a2[10], 0x20ui64);
				if ((int)result >= 0)
				{
					result = sub_1400A7160(a1, *((_QWORD*)a2 + 6));
					if ((int)result >= 0)
					{
						result = sub_1400A7110(a1, a2[14], 0x12ui64);
						if ((int)result >= 0)
							return sub_1403360D0(a1, (unsigned __int16*)a2 + 30, (__int64)(a2 + 20));
					}
				}
			}
		}
