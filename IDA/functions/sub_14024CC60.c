...
__int64 sub_14024CC60()
{
	...
	if (qword_140C643C0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"WorldWaterType"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\WorldWaterType.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024CCFC: variable 'v1' is possibly undefined
// 140A807A8: using guessed type wchar_t *off_140A807A8;
// 140AB0620: using guessed type wchar_t aDbWorldwaterty[22];
// 140AB0650: using guessed type wchar_t aWorldwatertype[15];
...
// 140C643F0: using guessed type int dword_140C643F0;
// 140C64E78: using guessed type int dword_140C64E78;
