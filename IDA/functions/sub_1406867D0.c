...
//----- (00000001406867D0) ----------------------------------------------------
__int64 __fastcall sub_1406867D0(_QWORD* a1)
{
	__int64 v2; // rbx
	__int64 v3; // rax
	__int64 v4; // rdx
	...
	*(_QWORD*)v2 = v3;
	...
	{
		v11 = sub_14024B980(*(_DWORD*)(v10 + 36));
		v12 = v11;
		if (v11)
		{
			v13 = *(float*)(v11 + 12);
			...
			*(_DWORD*)(v15 + 8) = *((_DWORD*)v14 + 2);
			a1[2] += 16i64;
			v16 = -1i64;
			v17 = (unsigned __int64*)sub_14018F0E0(&v37, L"x")[1];
			if (v17)
			{
				v18 = -1i64;
				do
			...
			*(_DWORD*)(v30 + 8) = *((_DWORD*)v29 + 2);
			a1[2] += 16i64;
			v31 = (unsigned __int64*)sub_14018F0E0(&v37, L"z")[1];
			if (v31)
			{
				do
					++v16;
...
// 140686872: variable 'v7' is possibly undefined
// 14068687F: variable 'v10' is possibly undefined
// 140686982: variable 'v23' is possibly undefined
// 140686A42: variable 'v30' is possibly undefined
// 140686AFA: variable 'v35' is possibly undefined
// 140686B29: variable 'v4' is possibly undefined
// 1409F568C: using guessed type wchar_t aY_8[2];
// 1409F56C4: using guessed type wchar_t aZ_8[2];
// 1409F56EC: using guessed type wchar_t asc_1409F56EC[2];
