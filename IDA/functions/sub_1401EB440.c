...
__int64 sub_1401EB440()
{
	...
	if (qword_140C63D68)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ArchiveArticle"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ArchiveArticle.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401EB4DC: variable 'v1' is possibly undefined
// 140A51480: using guessed type wchar_t aDbArchiveartic[22];
// 140A51550: using guessed type wchar_t aArchivearticle[15];
// 140AD7310: using guessed type wchar_t *off_140AD7310;
...
// 140C63904: using guessed type int dword_140C63904;
...
// 140C65180: using guessed type int dword_140C65180;
