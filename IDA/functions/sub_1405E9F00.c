//----- (00000001405E9F00) ----------------------------------------------------
__int64 __fastcall sub_1405E9F00(_QWORD* a1)
{
	_DWORD* v1; // rax
	__int64 v3; // rax
	__int64 v4; // rcx
		...
		&& (v5 = sub_1403ACD90(qword_140C65B70, *(_DWORD*)(v4 + 8), *(_QWORD*)(qword_140C65898 + 120))) != 0)
	{
		...
		*((_QWORD*)&v22 + 1) = v6;
		...
		if (v6)
			*(_WORD*)v6 = 0;
		v8 = (int*)sub_14034BDD0(v7, *(_DWORD*)(*(_QWORD*)(v5 + 8) + 76i64));
...
// 1405E9FF1: variable 'v7' is possibly undefined
// 140A12138: using guessed type _DWORD dword_140A12138[4];
// 140B69230: using guessed type __int64 (__fastcall *off_140B69230[25])();
// 140C65898: using guessed type __int64 qword_140C65898;
// 140C65B70: using guessed type __int64 qword_140C65B70;
// 1405E9F00: using guessed type char var_E0[184];
