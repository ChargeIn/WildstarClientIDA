...
__int64 sub_1401EB000()
{
	...
	if (qword_140C64D80)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ActionSlotPrereq"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ActionSlotPrereq.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401EB09C: variable 'v1' is possibly undefined
// 140A50AA8: using guessed type wchar_t aDbActionslotpr[24];
// 140A50B68: using guessed type wchar_t aActionslotprer[17];
// 140A82298: using guessed type wchar_t *off_140A82298;
...
// 140C642D8: using guessed type int dword_140C642D8;
// 140C64764: using guessed type int dword_140C64764;
