...
__int64 sub_14020C340()
{
	...
	if (qword_140C653B8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ItemRandomStat"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ItemRandomStat.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020C3DC: variable 'v1' is possibly undefined
// 140A8FC60: using guessed type wchar_t aDbItemrandomst[22];
// 140A8FC90: using guessed type wchar_t aItemrandomstat[15];
// 140AE3080: using guessed type wchar_t *off_140AE3080;
...
// 140C6449C: using guessed type int dword_140C6449C;
// 140C65244: using guessed type int dword_140C65244;
