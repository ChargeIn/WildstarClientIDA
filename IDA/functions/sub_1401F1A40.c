...
__int64 sub_1401F1A40()
{
	...
	if (qword_140C639E0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"CharacterTitleCategory"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\CharacterTitleCategory.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F1ADC: variable 'v1' is possibly undefined
// 140A60C68: using guessed type wchar_t aDbCharactertit_0[30];
// 140A60E18: using guessed type wchar_t aCharactertitle_0[23];
// 140ADC760: using guessed type wchar_t *off_140ADC760;
...
// 140C65204: using guessed type int dword_140C65204;
// 140C652C8: using guessed type int dword_140C652C8;
