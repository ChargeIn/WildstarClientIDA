...
__int64 sub_14020BF00()
{
	...
	if (qword_140C65498)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ItemProficiency"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ItemProficiency.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020BF9C: variable 'v1' is possibly undefined
// 140A8FBA0: using guessed type wchar_t aDbItemproficie[23];
// 140A8FBD0: using guessed type wchar_t aItemproficienc[16];
// 140ACDEB8: using guessed type wchar_t *off_140ACDEB8;
...
// 140C64428: using guessed type int dword_140C64428;
// 140C6457C: using guessed type int dword_140C6457C;
