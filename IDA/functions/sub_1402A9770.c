//----- (00000001402A9770) ----------------------------------------------------
__int64 __fastcall sub_1402A9770(__int64 a1, int a2)
{
	__int64 v4; // rbx
	__int64 v5; // r9
	__int64 v6; // rcx
	...
	else
	{
		...
		*(_QWORD*)&v15 = &off_140B5E640;
		...
		LODWORD(v4) = sub_1401971E0(&dword_140C8A51C, 14, &v20, v5, v18, v19, v17);
		v8 = &off_140B5E648;
...
// 140C8A51C: using guessed type _DWORD dword_140C8A51C;
