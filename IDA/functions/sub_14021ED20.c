...
__int64 sub_14021ED20()
{
	...
	if (qword_140C65628)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathLevel"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PathLevel.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021EDBC: variable 'v1' is possibly undefined
// 140A6FE70: using guessed type wchar_t *off_140A6FE70;
// 140A95CA0: using guessed type wchar_t aPathlevel[10];
// 140A95DF8: using guessed type wchar_t aDbPathlevelTbl[17];
...
// 140C63C70: using guessed type int dword_140C63C70;
// 140C647E8: using guessed type int dword_140C647E8;
