...
//----- (00000001406B0560) ----------------------------------------------------
__int64 __fastcall sub_1406B0560(_QWORD* a1)
{
	__m128d v1; // xmm0
	__int64 v3; // rax
	__int64 v4; // rcx
	...
	if (v3 && qword_140C659F0)
	{
		...
		LABEL_13:
			...
			if (sub_1405B1510(&qword_140C7DFB0))
				sub_1405AB700(v21, (unsigned int*)&v23);
		}
	}
	return 0i64;
}
// 1406B059A: variable 'v4' is possibly undefined
// 1406B06B5: variable 'v1' is possibly undefined
// 1406B06FA: variable 'v21' is possibly undefined
