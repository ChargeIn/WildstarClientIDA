...
//----- (000000014081FFD0) ----------------------------------------------------
__int64 __fastcall sub_14081FFD0(__int64 a1)
{
	...
	if (v5 && v5 != -14)
		return v5;
	if (v5 == -14)
		qword_140C61678 = 0i64;
	if (qword_140C61678 && dword_140C61680 != dword_140C60980[v6])
		qword_140C61678 = 0i64;
	if (!qword_140C61678 && v3 && nvapi_QueryInterface)
	{
		qword_140C61678 = nvapi_QueryInterface(1156639953i64);
		dword_140C61680 = dword_140C60980[v6];
	}
	if (qword_140C61678)
	{
		v2 = (__int64(__fastcall*)(__int64))qword_140C61678;
		v4 = 0i64;
		if (qword_140C60938)
			qword_140C60938(1156639953i64, &v4);
		v5 = v2(a1);
		if (qword_140C60940)
			qword_140C60940(1156639953i64, v4, v5);
		--dword_140C60970[v6];
		return v5;
	}
	else
...
// 140C61678: using guessed type __int64 qword_140C61678;
// 140C61680: using guessed type int dword_140C61680;
