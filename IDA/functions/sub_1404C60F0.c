...
//----- (00000001404C60F0) ----------------------------------------------------
__int64 __fastcall sub_1404C60F0(unsigned int* a1)
{
	__m128 v2; // xmm3
	__int64 v3; // r10
	int v4; // r9d
...
// 1404C6186: variable 'v4' is possibly undefined
// 1404C6206: variable 'v3' is possibly undefined
// 1404C60F0: using guessed type double var_50[8];
