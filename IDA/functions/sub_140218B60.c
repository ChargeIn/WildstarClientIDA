...
__int64 sub_140218B60()
{
	...
	if (qword_140C63EB8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ModelCamera"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ModelCamera.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140218BFC: variable 'v1' is possibly undefined
// 140A93B80: using guessed type wchar_t aDbModelcameraT[19];
// 140A93BA8: using guessed type wchar_t aModelcamera[12];
// 140AD2418: using guessed type wchar_t *off_140AD2418;
...
// 140C641F8: using guessed type int dword_140C641F8;
// 140C6466C: using guessed type int dword_140C6466C;
// 140C65284: using guessed type int dword_140C65284;
