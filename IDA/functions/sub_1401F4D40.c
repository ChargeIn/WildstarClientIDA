...
__int64 sub_1401F4D40()
{
	...
	if (qword_140C64B78)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"CommunicatorMessages"))
	{
...
// 1401F4DDC: variable 'v1' is possibly undefined
// 140A64F40: using guessed type wchar_t aDbCommunicator[28];
// 140A64F78: using guessed type wchar_t aCommunicatorme[21];
// 140ACCA18: using guessed type wchar_t *off_140ACCA18;
