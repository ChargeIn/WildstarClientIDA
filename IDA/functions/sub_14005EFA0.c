...
//----- (000000014005EFA0) ----------------------------------------------------
__int64 __fastcall sub_14005EFA0(__int64 a1, __int64 a2, __int64 a3)
{
	__int64 v3; // rax
	__int64 v5; // rcx
	char* v8; // r8
	...
	result = sub_14005ED70(a1, (_DWORD*)a2, (_DWORD*)a3, 14);
	if ((_DWORD)result == -1)
	{
		v11 = sub_14005ED70(a1, (_DWORD*)a3, (_DWORD*)a2, 13);
		if (v11 == -1)
