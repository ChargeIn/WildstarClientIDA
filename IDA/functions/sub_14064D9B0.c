...
//----- (000000014064D9B0) ----------------------------------------------------
__int64 __fastcall sub_14064D9B0(__int64 a1)
{
	float* v2; // rsi
	__int64 v4; // rbx
	__int64 v5; // rax
	...
	if (v2)
	{
		...
		*(_QWORD*)(a1 + 16) += 16i64;
		v6 = sub_1400578C0(a1);
		v7 = sub_140464240((__int64)v2, v2[453] + v2[421], v2[575] + v2[657]).m128_f32[0] * 100.0;
		...
		*(_QWORD*)(a1 + 16) -= 48i64;
		sub_140464430((__int64)v2, v2[453] + v2[421]);
...
// 14064DB6A: variable 'v16' is possibly undefined
// 14064DB90: variable 'v18' is possibly undefined
// 14064DBA2: variable 'v19' is possibly undefined
// 140B2BF88: using guessed type wchar_t aNamount_22[8];
// 140B2BF98: using guessed type wchar_t aEdrstate_15[9];
