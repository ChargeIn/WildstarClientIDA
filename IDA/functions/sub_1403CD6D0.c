...
__int64 __fastcall sub_1403CD6D0(__int64 a1, __int64 a2)
{
	...
	*(_DWORD*)(a1 + 29976) = v2;
	if (v3 != (v2 & 1))
		Apollo_LUAEvent(*(_QWORD*)(qword_140C65898 + 29504), "HousingPrivacyUpdated", byte_1409EC064);
	Apollo_LUAEvent(*(_QWORD*)(qword_140C65898 + 29504), "HousingBasicsUpdated", byte_1409D1067);
	return 0i64;
}
