...
__int64 sub_1401ECDC0()
{
	...
	if (qword_140C64830)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"AttributeMiniMilestoneGroup"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\AttributeMiniMilestoneGroup.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401ECE5C: variable 'v1' is possibly undefined
// 140A5BE48: using guessed type wchar_t aAttributeminim[28];
// 140A5BF60: using guessed type wchar_t aDbAttributemin[35];
// 140AD7348: using guessed type wchar_t *off_140AD7348;
...
// 140C64184: using guessed type int dword_140C64184;
// 140C64830: using guessed type __int64 qword_140C64830;
// 140C652B0: using guessed type int dword_140C652B0;
