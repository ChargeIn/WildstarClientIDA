//----- (00000001400AC410) ----------------------------------------------------
__int64 __fastcall sub_1400AC410(__int64 a1, unsigned int* a2)
{
	__int64 v2; // r8
	...
	{
		result = sub_140336470(a1, v12, 8ui64);
		if ((int)result < 0)
			return result;
	}
	for (i = 0; i < *((_BYTE*)a2 + 4); ++i)
	{
		result = sub_140336040(a1, *(unsigned __int16**)(*((_QWORD*)a2 + 1) + 8i64 * i));
		if ((int)result < 0)
			break;
	}
	return result;
