...
__int64 sub_1401F8D00()
{
	...
	if (qword_140C65098)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Creature2DisplayGroupEntry"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\Creature2DisplayGroupEntry.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F8D9C: variable 'v1' is possibly undefined
// 140A63078: using guessed type wchar_t *off_140A63078;
// 140A80060: using guessed type wchar_t aDbCreature2dis_0[34];
// 140A800F8: using guessed type wchar_t aCreature2displ_0[27];
...
// 140C63CF8: using guessed type int dword_140C63CF8;
// 140C64D6C: using guessed type int dword_140C64D6C;
