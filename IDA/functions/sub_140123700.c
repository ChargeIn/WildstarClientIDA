//----- (0000000140123700) ----------------------------------------------------
__int64 __fastcall sub_140123700(__int64 a1, __int64 a2, __int64 a3, int a4, int a5)
{
	__int64 v8; // rax
	__int64 v9; // rcx
	int v10; // ebp
	...
	sub_140122A00((int*)&v29, *(_QWORD*)(v8 + 96), a3);
	v9 = *(_QWORD*)(a1 + 2928);
	if (*(_BYTE*)(v9 + 992))
		v10 = *(_DWORD*)(v9 + 996);
	else
	...
	if (v19 < 200)
		v19 = 200;
	v27 = v19;
	v28 = v12 + v10 + HIDWORD(v29) + 32;
	v20 = sub_14018B280(1152i64, 0);
	if (v20)
		v21 = sub_1401224C0((__int64)v20, a1, &v27, a4, a5);
	else
		v21 = 0i64;
	*(_QWORD*)(v21 + 1096) = sub_140123230(v21, a3, v18);
	v23 = sub_14034BDD0(v22, 3);
	v24 = sub_140123490(v21, 1, (__int64)v23);
	v25 = *(_QWORD*)(v21 + 32);
	*(_QWORD*)(v21 + 1024) = v24;
	*(_QWORD*)(v21 + 1120) = 0i64;
	sub_1400E7280(v25, (void(__fastcall***)(_QWORD))v21, L"DefaultStratum");
	sub_1400E8B00(*(_QWORD*)(v21 + 32), v21);
	return v21;
}
// 140123831: variable 'v22' is possibly undefined
// 140A1EDC8: using guessed type wchar_t aDefaultstratum_4[15];
// 140A1EFE0: using guessed type wchar_t aChat_0[5];
