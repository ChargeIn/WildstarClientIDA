...
//----- (00000001406A2EC0) ----------------------------------------------------
__int64 __fastcall sub_1406A2EC0(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Game.Contract");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6;
	sub_140057020(a1, "Contract", &off_140B70000);
	return 1i64;
}
// 1406A2FD3: variable 'v14' is possibly undefined
// 140B70000: using guessed type char *off_140B70000;
// 140C5D5F0: using guessed type char *off_140C5D5F0;
