...
//----- (000000014081F500) ----------------------------------------------------
__int64 __fastcall sub_14081F500(__int64 a1, unsigned int a2)
{
	...
	if (v6 && v6 != -14)
		return v6;
	if (v6 == -14)
		qword_140C61608 = 0i64;
	if (qword_140C61608 && dword_140C61610 != dword_140C60980[v7])
		qword_140C61608 = 0i64;
	if (!qword_140C61608 && v4 && nvapi_QueryInterface)
	{
		qword_140C61608 = nvapi_QueryInterface(2532223480i64);
		dword_140C61610 = dword_140C60980[v7];
	}
	if (qword_140C61608)
	{
		v3 = (__int64(__fastcall*)(__int64, _QWORD))qword_140C61608;
		v5 = 0i64;
		if (qword_140C60938)
			qword_140C60938(2532223480i64, &v5);
		v6 = v3(a1, a2);
		if (qword_140C60940)
			qword_140C60940(2532223480i64, v5, v6);
		--dword_140C60970[v7];
		return v6;
	}
	else
...
// 140C61608: using guessed type __int64 qword_140C61608;
// 140C61610: using guessed type int dword_140C61610;
