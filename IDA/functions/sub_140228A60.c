...
__int64 sub_140228A60()
{
	...
	if (qword_140C65378)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PublicEventObjectiveGatherResource"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PublicEventObjectiveGatherResource.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140228AFC: variable 'v1' is possibly undefined
// 140A5CE78: using guessed type wchar_t *off_140A5CE78;
// 140A9BE50: using guessed type wchar_t aDbPublicevento_1[42];
// 140A9BFD0: using guessed type wchar_t aPubliceventobj_1[35];
...
// 140C63EFC: using guessed type int dword_140C63EFC;
// 140C6470C: using guessed type int dword_140C6470C;
// 140C651EC: using guessed type int dword_140C651EC;
