...
__int64 sub_1401F6F40()
{
	...
	if (qword_140C64958)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Creature2Resist"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Creature2Resist.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F6FDC: variable 'v1' is possibly undefined
// 140A4C398: using guessed type wchar_t *off_140A4C398;
// 140A7C678: using guessed type wchar_t aDbCreature2res[23];
// 140A7C738: using guessed type wchar_t aCreature2resis[16];
