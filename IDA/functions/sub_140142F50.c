//----- (0000000140142F50) ----------------------------------------------------
void __fastcall sub_140142F50(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Apollo.ApolloColor");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	if (off_140C577B0)
	{
		do
		{
			...
			*(_DWORD*)(v12 + 8) = 6;
			...
			v19 = v17;
			v20 = 4;
			sub_14005EA50((__int64)a1, v16, (int*)&v19, v18);
			a1[2] -= 16i64;
			v6 = a1[2];
			v7 += 2;
		} while (*v7);
	...
	a1[2] = v6;
	sub_140057020(a1, "ApolloColor", &off_140C57770);
}
// 140143063: variable 'v14' is possibly undefined
// 140C57770: using guessed type void *off_140C57770;
// 140C577B0: using guessed type char *off_140C577B0;
