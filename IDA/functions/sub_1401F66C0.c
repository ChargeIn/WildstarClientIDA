...
__int64 sub_1401F66C0()
{
	...
	if (qword_140C650A0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Creature2Tier"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Creature2Tier.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F675C: variable 'v1' is possibly undefined
// 140A76830: using guessed type wchar_t *off_140A76830;
// 140A78BF8: using guessed type wchar_t aCreature2tier[14];
// 140A78F50: using guessed type wchar_t aDbCreature2tie[21];
...
// 140C64F84: using guessed type int dword_140C64F84;
// 140C64F88: using guessed type int dword_140C64F88;
