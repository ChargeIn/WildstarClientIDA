//----- (0000000140678DD0) ----------------------------------------------------
__int64 __fastcall sub_140678DD0(_QWORD* a1)
{
	int* v1; // r8
	int* v2; // rdx
	_DWORD* v3; // rax
	...
	*(_QWORD*)v2 = v9;
	...
	a1[2] += 16i64;
	v10 = a1[4];
	v11 = sub_140062650((__int64)a1, (unsigned __int64*)"Game.SoldierEvent", 0x11ui64);
	v12 = a1[2];
	v18 = v11;
	v19 = 4;
...
// 140678EE0: variable 'v14' is possibly undefined
