...
//----- (00000001405BA670) ----------------------------------------------------
void __fastcall sub_1405BA670(__int64 a1)
{
	_QWORD* v1; // rdi
	int v3; // r9d
	int v4; // r8d
	...
	v8 = 0;
	v9 = &v46[v7 / 8];
	v10 = (char*)&(&off_140C5A460)[v7 / 0xFFFFFFFFFFFFFFF8ui64] - (char*)v46;
	do
	{
	...
	} while ((unsigned __int64)v8 < 2);
	sub_1400569B0((__int64)v1, (unsigned __int64*)"Apollo.BuffWindow");
	v12 = v1[2];
	if (*(_DWORD*)(v12 - 8) != 2)
	{
...
LABEL_35:
	...
	if (!sub_1405BA9F0)
		v43 = 0i64;
	v45 = v43;
	sub_1400F85D0(a1 + 2688, (int*)L"BuffWindow", &v44);
}
// 140B21958: using guessed type wchar_t aBuffwindow[11];
// 140C56A80: using guessed type char *off_140C56A80;
// 140C5A460: using guessed type char *off_140C5A460;
