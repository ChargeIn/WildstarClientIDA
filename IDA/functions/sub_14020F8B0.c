...
//----- (000000014020F8B0) ----------------------------------------------------
__int64 sub_14020F8B0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6B0B8, qword_140C63858);
	if (dword_140C63CD4 || (int)sub_14020F6A0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C646F8 + 40i64))(qword_140C646F8);
}
