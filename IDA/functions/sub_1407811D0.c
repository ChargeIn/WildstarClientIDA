...
//----- (00000001407811D0) ----------------------------------------------------
__m128* __fastcall sub_1407811D0(__int64 a1, __int64 a2, int a3, __m128* a4, __m128* a5, __m128* a6)
{
	_DWORD* v7; // rax
	__m128 v8; // xmm5
	__m128 v9; // xmm0
	...
	unsigned int v22; // [rsp+44h] [rbp-24h]
	unsigned int v23; // [rsp+48h] [rbp-20h]
	int v24[6]; // [rsp+50h] [rbp-18h] BYREF
	int v25; // [rsp+70h] [rbp+8h] BYREF

	v7 = sub_140783E10((unsigned int*)(a1 + 56), v24, a3, &v25, &v21, v20, a1);
	v8 = (__m128)v23;
	...
	*a4 = _mm_unpacklo_ps(_mm_unpacklo_ps(v11, v9), _mm_unpacklo_ps(v10, (__m128)0i64));
	if (v12)
	{
		v13 = _mm_unpacklo_ps((__m128)v22, (__m128)0i64);
		v14 = _mm_unpacklo_ps(_mm_unpacklo_ps((__m128)v21, v8), v13);
	...
	result = a6;
	v17 = _mm_unpacklo_ps(_mm_unpacklo_ps((__m128)v21, v8), _mm_unpacklo_ps((__m128)v22, (__m128)0i64));
...
// 1407811F9: variable 'v20' is possibly undefined
// 1407811D0: using guessed type int var_18[6];
