...
__int64 sub_14024DD60()
{
	...
	if (qword_140C63988)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"XpPerLevel"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\XpPerLevel.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024DDFC: variable 'v1' is possibly undefined
// 140A83238: using guessed type wchar_t *off_140A83238;
// 140AB0DB8: using guessed type wchar_t aDbXpperlevelTb[18];
// 140AB0DE0: using guessed type wchar_t aXpperlevel[11];
...
// 140C63F18: using guessed type int dword_140C63F18;
// 140C649A0: using guessed type int dword_140C649A0;
