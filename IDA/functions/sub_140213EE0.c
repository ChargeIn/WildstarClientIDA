...
__int64 sub_140213EE0()
{
	...
	if (qword_140C64998)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"MapZonePOI"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\MapZonePOI.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140213F7C: variable 'v1' is possibly undefined
// 140A83568: using guessed type wchar_t *off_140A83568;
// 140A926A0: using guessed type wchar_t aMapzonepoi[11];
// 140A927A0: using guessed type wchar_t aDbMapzonepoiTb[18];
...
// 140C644C4: using guessed type int dword_140C644C4;
// 140C64998: using guessed type __int64 qword_140C64998;
// 140C65318: using guessed type int dword_140C65318;
