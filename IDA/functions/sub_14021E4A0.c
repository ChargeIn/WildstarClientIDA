...
__int64 sub_14021E4A0()
{
	...
	if (qword_140C649D0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathExplorerScavengerClue"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PathExplorerScavengerClue.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021E53C: variable 'v1' is possibly undefined
// 140A7E9F0: using guessed type wchar_t *off_140A7E9F0;
// 140A957C0: using guessed type wchar_t aDbPathexplorer_5[33];
// 140A95838: using guessed type wchar_t aPathexplorersc[26];
...
// 140C647C0: using guessed type int dword_140C647C0;
// 140C649D0: using guessed type __int64 qword_140C649D0;
// 140C64E6C: using guessed type int dword_140C64E6C;
