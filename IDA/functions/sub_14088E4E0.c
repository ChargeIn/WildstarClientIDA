...
//----- (000000014088E4E0) ----------------------------------------------------
__int64 __fastcall sub_14088E4E0(__int64 a1, __int64 a2, __int64 a3, struct _RTL_CRITICAL_SECTION* a4)
{
	unsigned int v8; // ebx
	unsigned int* v9; // rax
	...
	v14 = sub_1408916F0(v12);
	v13 = v14;
	if (v14)
	{
		v8 = sub_140892390(v14, v10, *(_DWORD*)(a2 + 1));
		if (v8 != 1)
