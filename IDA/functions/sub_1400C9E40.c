...
//----- (00000001400C9E40) ----------------------------------------------------
__m128 __fastcall sub_1400C9E40(_QWORD* a1)
{
	__int128 v1; // xmm0
	__int64 v3; // rcx
	__int128 v4; // xmm6
	...
	if (v3)
	{
		...
		{
			v5 = a1[36];
			if ((int)sub_1400FB720(v5, L"fNCOpacity", 3) >= 0)
			{
	...
	if (v11)
	{
		*(double*)&v1 = (**(double(__fastcall***)(__int64))(v11 + 48))(v11 + 48);
		v4 = v1;
	}
	v12 = (__m128*)a1[56];
	if (!v12)
...
// 1400C9F1B: variable 'v1' is possibly undefined
// 140A15200: using guessed type wchar_t aFncopacity[11];
