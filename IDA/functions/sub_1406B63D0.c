...
//----- (00000001406B63D0) ----------------------------------------------------
__int64 __fastcall sub_1406B63D0(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Game.PetFlair");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6;
	sub_140057020(a1, "PetFlair", &off_140B70290);
	return 1i64;
}
// 1406B64E3: variable 'v14' is possibly undefined
// 140B70290: using guessed type void *off_140B70290;
// 140C5DF70: using guessed type char *off_140C5DF70;
