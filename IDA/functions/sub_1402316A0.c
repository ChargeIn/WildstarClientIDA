...
__int64 sub_1402316A0()
{
	...
	if (qword_140C64E60)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"SalvageException"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\SalvageException.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023173C: variable 'v1' is possibly undefined
// 140A51398: using guessed type wchar_t *off_140A51398;
// 140AA2510: using guessed type wchar_t aSalvageexcepti[17];
// 140AA2630: using guessed type wchar_t aDbSalvageexcep[24];
...
// 140C640B4: using guessed type int dword_140C640B4;
// 140C6443C: using guessed type int dword_140C6443C;
