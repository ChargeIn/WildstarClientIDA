...
__int64 sub_140235660()
{
	...
	if (qword_140C652F0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"SoundSwitch"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\SoundSwitch.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402356FC: variable 'v1' is possibly undefined
// 140A64AA8: using guessed type wchar_t *off_140A64AA8;
// 140AA38B8: using guessed type wchar_t aSoundswitch[12];
// 140AA3A40: using guessed type wchar_t aDbSoundswitchT[19];
...
// 140C646D8: using guessed type int dword_140C646D8;
// 140C64AB8: using guessed type int dword_140C64AB8;
