...
__int64 sub_140241160()
{
	...
	if (qword_140C64968)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TaxiNode"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\TaxiNode.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402411FC: variable 'v1' is possibly undefined
// 140A60910: using guessed type wchar_t *off_140A60910;
// 140AAAD28: using guessed type wchar_t aDbTaxinodeTbl[16];
// 140AAAD48: using guessed type wchar_t aTaxinode[9];
