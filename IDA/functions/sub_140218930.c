...
//----- (0000000140218930) ----------------------------------------------------
__int64 sub_140218930()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6B828, qword_140C63858);
	if (dword_140C64710 || (int)sub_140218720() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C63B60 + 40i64))(qword_140C63B60);
}
