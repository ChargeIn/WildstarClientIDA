//----- (000000014013A410) ----------------------------------------------------
__int64 __fastcall sub_14013A410(__int64 a1, int* a2)
{
	__int64 v5; // rbp
	__int64 v6; // rax
	int* v7; // r14
...
// 14013A563: conditional instruction was optimized away because eax.4 is in (==1|==FFFFFFFF)
