...
__int64 sub_14020A140()
{
	...
	if (qword_140C64AC8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Item2Type"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Item2Type.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020A1DC: variable 'v1' is possibly undefined
// 140A8E8F8: using guessed type wchar_t aItem2type[10];
// 140A8EA28: using guessed type wchar_t aDbItem2typeTbl[17];
// 140AD1490: using guessed type wchar_t *off_140AD1490;
