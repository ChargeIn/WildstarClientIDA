...
//----- (000000014060FEC0) ----------------------------------------------------
void __fastcall sub_14060FEC0(int* a1)
{
	__int64 v2; // rbx
	__int64 v3; // rdx
	__int64 v4; // rdi
	...
	*(_QWORD*)(v2 + 16) += 16i64;
	v10 = 0;
	v11 = (unsigned __int64*)sub_14018F0E0(&v17, L"bDismounted")[1];
	if (v11)
	{
		v12 = -1i64;
		do
	...
	*(_QWORD*)(v2 + 16) += 16i64;
	...
	v15 = qword_140C65898;
	*(_QWORD*)(v2 + 16) -= 48i64;
	Apollo_LUAEvent(*(_QWORD*)(v15 + 29504), "CombatLogMount", L"T", v6, v17);
	sub_1400579E0(v2, v16, v6);
}
// 140610051: variable 'v16' is possibly undefined
// 1409EB3FC: using guessed type wchar_t aT_36[2];
// 140B26CE0: using guessed type wchar_t aBdismounted[12];
