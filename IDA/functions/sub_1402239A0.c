...
__int64 sub_1402239A0()
{
	...
	if (qword_140C652D8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathSoldierEvent"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PathSoldierEvent.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140223A3C: variable 'v1' is possibly undefined
// 140A51AE8: using guessed type wchar_t *off_140A51AE8;
// 140A99AC8: using guessed type wchar_t aDbPathsoldiere[24];
// 140A99AF8: using guessed type wchar_t aPathsoldiereve[17];
...
// 140C640F0: using guessed type int dword_140C640F0;
// 140C64670: using guessed type int dword_140C64670;
