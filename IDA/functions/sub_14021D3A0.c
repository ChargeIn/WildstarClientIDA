...
__int64 sub_14021D3A0()
{
	...
	if (qword_140C64F68)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathExplorerDoor"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PathExplorerDoor.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021D43C: variable 'v1' is possibly undefined
// 140A63948: using guessed type wchar_t *off_140A63948;
// 140A95058: using guessed type wchar_t aDbPathexplorer_1[24];
// 140A95110: using guessed type wchar_t aPathexplorerdo[17];
...
// 140C63B3C: using guessed type int dword_140C63B3C;
// 140C6467C: using guessed type int dword_140C6467C;
// 140C64D38: using guessed type int dword_140C64D38;
