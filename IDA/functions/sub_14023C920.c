...
__int64 sub_14023C920()
{
	...
	if (qword_140C654A8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4TierRequirements"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\Spell4TierRequirements.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023C9BC: variable 'v1' is possibly undefined
// 140A51570: using guessed type wchar_t *off_140A51570;
// 140AA8A18: using guessed type wchar_t aSpell4tierrequ[23];
// 140AA8B90: using guessed type wchar_t aDbSpell4tierre[30];
