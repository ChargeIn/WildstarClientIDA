...
__int64 sub_140214320()
{
	...
	if (qword_140C63C38)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"MapZoneSprite"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\MapZoneSprite.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402143BC: variable 'v1' is possibly undefined
// 140A92738: using guessed type wchar_t aDbMapzonesprit[21];
// 140A92768: using guessed type wchar_t aMapzonesprite[14];
// 140AE2700: using guessed type wchar_t *off_140AE2700;
...
// 140C63D7C: using guessed type int dword_140C63D7C;
// 140C64CE4: using guessed type int dword_140C64CE4;
// 140C65630: using guessed type int dword_140C65630;
