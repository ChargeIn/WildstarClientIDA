...
__int64 sub_1402490E0()
{
	...
	if (qword_140C64330)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Vital"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Vital.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024917C: variable 'v1' is possibly undefined
// 140A88560: using guessed type wchar_t *off_140A88560;
// 140AAEB40: using guessed type wchar_t aVital[6];
// 140AAEC90: using guessed type wchar_t aDbVitalTbl[13];
...
// 140C65278: using guessed type int dword_140C65278;
// 140C65500: using guessed type int dword_140C65500;
