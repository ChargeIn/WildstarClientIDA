...
__int64 sub_140249DA0()
{
	...
	if (qword_140C642B0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"WindSpawn"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\WindSpawn.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140249E3C: variable 'v1' is possibly undefined
// 140AAF0E8: using guessed type wchar_t aDbWindspawnTbl[17];
// 140AAF110: using guessed type wchar_t aWindspawn[10];
// 140AD97E0: using guessed type wchar_t *off_140AD97E0;
...
// 140C63EC4: using guessed type int dword_140C63EC4;
// 140C642B0: using guessed type __int64 qword_140C642B0;
// 140C645E0: using guessed type int dword_140C645E0;
