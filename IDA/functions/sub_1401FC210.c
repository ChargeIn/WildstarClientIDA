...
//----- (00000001401FC210) ----------------------------------------------------
__int64 sub_1401FC210()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6A0C0, qword_140C63858);
	if (dword_140C645C4 || (int)sub_1401FC000() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64BF0 + 40i64))(qword_140C64BF0);
}
