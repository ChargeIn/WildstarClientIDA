...
__int64 sub_140224220()
{
	...
	if (qword_140C647F0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathSoldierSWAT"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PathSoldierSWAT.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402242BC: variable 'v1' is possibly undefined
// 140A99C30: using guessed type wchar_t aDbPathsoldiers[23];
// 140A99CF0: using guessed type wchar_t aPathsoldierswa[16];
// 140ADC1A0: using guessed type wchar_t *off_140ADC1A0;
...
// 140C64A30: using guessed type int dword_140C64A30;
// 140C65290: using guessed type int dword_140C65290;
