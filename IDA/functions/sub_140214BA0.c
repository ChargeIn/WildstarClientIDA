...
__int64 sub_140214BA0()
{
	...
	if (qword_140C652E0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"MatchingGameType"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\MatchingGameType.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140214C3C: variable 'v1' is possibly undefined
// 140A59F00: using guessed type wchar_t *off_140A59F00;
// 140A92A08: using guessed type wchar_t aMatchinggamety[17];
// 140A92B98: using guessed type wchar_t aDbMatchinggame[24];
...
// 140C64038: using guessed type int dword_140C64038;
// 140C64060: using guessed type int dword_140C64060;
