//----- (0000000140332CF0) ----------------------------------------------------
__int64 __fastcall sub_140332CF0(LARGE_INTEGER a1, unsigned __int16 a2)
{
	__int64 v2; // rbx
	__int64 v3; // r8
	__int64 v4; // rdx
	...
	if (!v2)
		return 0i64;
	sub_140332AE0(a1, v2);
	v3 = *(unsigned int*)(v2 + 756);
	v4 = *(_QWORD*)(v2 + 16i64 * (((int)v3 + 9) % 0xAu) + 600) - *(_QWORD*)(16 * v3 + v2 + 600);
	v5 = (float)(int)v4;
	if (v4 < 0)
		v5 = v5 + 1.8446744e19;
	v6 = *(_QWORD*)(v2 + 16 * (((int)v3 + 9) % 0xAu + 37i64)) - *(_QWORD*)(16 * (v3 + 37) + v2);
	v7 = (float)(int)v6;
	if (v6 < 0)
		v7 = v7 + 1.8446744e19;
