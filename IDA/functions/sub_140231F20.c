...
__int64 sub_140231F20()
{
	...
	if (qword_140C63990)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"SkyTrackCloudSet"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\SkyTrackCloudSet.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140231FBC: variable 'v1' is possibly undefined
// 140AA2AD8: using guessed type wchar_t aSkytrackclouds[17];
// 140AA2BB8: using guessed type wchar_t aDbSkytrackclou[24];
// 140AD0898: using guessed type wchar_t *off_140AD0898;
...
// 140C6456C: using guessed type int dword_140C6456C;
// 140C65430: using guessed type int dword_140C65430;
