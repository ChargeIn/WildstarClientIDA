...
__int64 sub_140224EE0()
{
	...
	if (qword_140C64528)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PlayerNotificationType"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PlayerNotificationType.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140224F7C: variable 'v1' is possibly undefined
// 140A9A0C8: using guessed type wchar_t aPlayernotifica[23];
// 140A9A1B0: using guessed type wchar_t aDbPlayernotifi[30];
// 140AD73D0: using guessed type wchar_t *off_140AD73D0;
...
// 140C6486C: using guessed type int dword_140C6486C;
// 140C64DF8: using guessed type int dword_140C64DF8;
