...
//----- (00000001401D9370) ----------------------------------------------------
__int64 __fastcall sub_1401D9370(__int64 a1, int a2)
{
	__int64 v4; // rax
	__int64 v5; // rdx
	int v6; // eax
	...
	if (a2)
		v10 = v5;
	v11 = (*(__int64 (**)(void))(**(_QWORD**)(a1 + 184) + 32i64))();
	result = (*(__int64(__fastcall**)(_QWORD, __int64, __int64, _QWORD, __int64))(v9 + 168))(
		*(_QWORD*)(a1 + 16),
		v8 + *(_QWORD*)(a1 + 176),
		v8 + v11,
		v10,
