...
__int64 sub_1402054C0()
{
	...
	if (qword_140C63938)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"HousingMapInfo"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\HousingMapInfo.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020555C: variable 'v1' is possibly undefined
// 140A80250: using guessed type wchar_t *off_140A80250;
// 140A8B778: using guessed type wchar_t aHousingmapinfo[15];
// 140A8B958: using guessed type wchar_t aDbHousingmapin[22];
...
// 140C64448: using guessed type int dword_140C64448;
// 140C648BC: using guessed type int dword_140C648BC;
// 140C655DC: using guessed type int dword_140C655DC;
