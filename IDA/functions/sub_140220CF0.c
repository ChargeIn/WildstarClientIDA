...
//----- (0000000140220CF0) ----------------------------------------------------
__int64 sub_140220CF0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6BEF0, qword_140C63858);
	if (dword_140C64B00 || (int)sub_140220AE0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64F58 + 40i64))(qword_140C64F58);
}
