...
__int64 sub_1401FD540()
{
	...
	if (qword_140C653A0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"EldanAugmentation"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\EldanAugmentation.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401FD5DC: variable 'v1' is possibly undefined
// 140A881A8: using guessed type wchar_t aDbEldanaugment_0[25];
// 140A88280: using guessed type wchar_t aEldanaugmentat_0[18];
// 140ACB118: using guessed type wchar_t *off_140ACB118;
