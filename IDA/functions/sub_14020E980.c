...
__int64 sub_14020E980()
{
	...
	if (qword_140C64298)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ItemSpecial"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ItemSpecial.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020EA1C: variable 'v1' is possibly undefined
// 140A78E20: using guessed type wchar_t *off_140A78E20;
// 140A90C40: using guessed type wchar_t aDbItemspecialT[19];
// 140A90CE0: using guessed type wchar_t aItemspecial[12];
...
// 140C65450: using guessed type int dword_140C65450;
// 140C654B8: using guessed type int dword_140C654B8;
