//----- (00000001405C4C10) ----------------------------------------------------
__int64 __fastcall sub_1405C4C10(__int64 a1, __int64 a2, int* a3)
{
	__int64 v3; // r10
	__int64 v6; // r8
	bool v8; // al
	...
	if (v8)
	{
		if (v9 == *(_QWORD*)(v3 + 16))
		{
			v12 = *sub_1405C56D0(a1, &v20, v6, v9, a3);
			result = a2;
			*(_QWORD*)a2 = v12;
			*(_BYTE*)(a2 + 8) = 1;
			return result;
...
// 1405C4D16: conditional instruction was optimized away because r8.8==0
