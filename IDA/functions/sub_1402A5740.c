//----- (00000001402A5740) ----------------------------------------------------
__int64 __fastcall sub_1402A5740(__int64 a1, __int64* a2)
{
	__int64 v5; // rbx
	int v6; // ebx
	__int64 v7; // rax
	...
	if (*(_QWORD*)(a1 + 72))
	{
		...
		LODWORD(v5) = sub_1401971E0(&dword_140C8A4C0, 14, &v38, v35, v32);
		v18 = &off_140B5E648;
	...
	if (*((_DWORD*)a2 + 13) == 1)
	{
		...
		*((_QWORD*)&v17 + 1) = TlsGetValue(dwTlsIndex);
		...
		v39 = 0x141DE6200i64;
		v34 = v17;
		v6 = sub_1401971E0(&dword_140C8A4B0, 14, &v39, &v33);
		v16 = &off_140B5E648;
...
// 140C8A4B0: using guessed type _DWORD dword_140C8A4B0;
// 140C8A4C0: using guessed type _DWORD dword_140C8A4C0;
// 1402A5740: using guessed type int var_20[8];
