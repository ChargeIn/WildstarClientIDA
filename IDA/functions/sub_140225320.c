...
__int64 sub_140225320()
{
	...
	if (qword_140C64200)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PositionalRequirement"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PositionalRequirement.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402253BC: variable 'v1' is possibly undefined
// 140A5B5E0: using guessed type wchar_t *off_140A5B5E0;
// 140A9A328: using guessed type wchar_t aDbPositionalre[29];
// 140A9A368: using guessed type wchar_t aPositionalrequ[22];
...
// 140C64054: using guessed type int dword_140C64054;
// 140C64200: using guessed type __int64 qword_140C64200;
// 140C64384: using guessed type int dword_140C64384;
