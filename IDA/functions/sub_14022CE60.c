...
__int64 sub_14022CE60()
{
	...
	if (qword_140C652A0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"QuestObjective"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\QuestObjective.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022CEFC: variable 'v1' is possibly undefined
// 140A6E8F0: using guessed type wchar_t *off_140A6E8F0;
// 140A9EF58: using guessed type wchar_t aQuestobjective[15];
// 140A9F120: using guessed type wchar_t aDbQuestobjecti[22];
...
// 140C64400: using guessed type int dword_140C64400;
// 140C64EA8: using guessed type int dword_140C64EA8;
