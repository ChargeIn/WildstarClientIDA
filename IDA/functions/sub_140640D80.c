//----- (0000000140640D80) ----------------------------------------------------
__int64 __fastcall sub_140640D80(__int64 a1, __int64 a2, unsigned __int16* a3, _DWORD* a4)
{
	int v6; // ebp
	wchar_t** v7; // rsi
	...
	do
	{
		...
		++v7;
		++v6;
	} while ((__int64)v7 < (__int64)off_140C392E0);
	return 0i64;
}
// 140A40AF0: using guessed type __int16 word_140A40AF0[986];
// 140A41A80: using guessed type __int16 word_140A41A80[992];
// 140C39280: using guessed type wchar_t *off_140C39280[75];
// 140C392E0: using guessed type wchar_t *off_140C392E0[63];
