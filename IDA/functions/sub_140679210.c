...
//----- (0000000140679210) ----------------------------------------------------
__int64 __fastcall sub_140679210(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Game.PathEpisode");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6;
	sub_140057020(a1, "PathEpisode", &off_140B6FDF0);
	return 1i64;
}
// 140679323: variable 'v14' is possibly undefined
// 140B6FDF0: using guessed type void *off_140B6FDF0;
// 140C5C3E0: using guessed type char *off_140C5C3E0;
