...
__int64 sub_14022D6E0()
{
	...
	if (qword_140C64A50)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"RandomTextLine"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\RandomTextLine.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022D77C: variable 'v1' is possibly undefined
// 140A7A398: using guessed type wchar_t *off_140A7A398;
// 140A9F6F0: using guessed type wchar_t aDbRandomtextli[22];
// 140A9F7B0: using guessed type wchar_t aRandomtextline[15];
...
// 140C63AFC: using guessed type int dword_140C63AFC;
// 140C64538: using guessed type int dword_140C64538;
