...
//----- (00000001405F7380) ----------------------------------------------------
__int64 __fastcall sub_1405F7380(__int64* a1, int* a2)
{
	__int64 v2; // r15
	int* v5; // rbp
	int* v6; // rcx
	...
	v2 = a1[1];
	v5 = sub_14018DB00(*a1, v2 + 1, 224i64);
	v6 = &v5[56 * v2];
	if (v6)
	{
		if ((((unsigned __int8)((_BYTE)v5 - 32 * v2) | (unsigned __int8)a2) & 0xF) != 0)
		{
			sub_1407DB590(v6, a2, 0xE0ui64);
		}
		else
		{
			v7 = 1i64;
		...
		if (a1[1])
		{
			...
			do
			{
				if (v10)
				{
					...
					{
						sub_1407DB590(v10, (int*)v12, 0xE0ui64);
					}
					else
					{
						v13 = 1i64;
