...
__int64 sub_14093A870()
{
	...
	v0 = (__m128)(unsigned int)xmmword_140C79C60;
	v1 = (__m128)DWORD2(xmmword_140C79C60);
	v1.m128_f32[0] = (float)((float)(*((float*)&xmmword_140C79C60 + 2) + *(float*)&dword_140C3B738)
		* (float)(1.0 / *(float*)&dword_140C66F48))
		+ 1.0;
	v0.m128_f32[0] = (float)((float)(*(float*)&xmmword_140C79C60 + *(float*)&dword_140C3B738)
	...
	v15 = (__m128)(unsigned int)xmmword_140C79C50;
	v16 = (int)v3.m128_f32[0];
	v17 = (__m128)DWORD2(xmmword_140C79C50);
	v18 = v16 + 2;
	v17.m128_f32[0] = (float)((float)(*((float*)&xmmword_140C79C50 + 2) + *(float*)&dword_140C3B738)
		* (float)(1.0 / *(float*)&dword_140C66F48))
		+ 1.0;
	v15.m128_f32[0] = (float)((float)(*(float*)&xmmword_140C79C50 + *(float*)&dword_140C3B738)
		* (float)(1.0 / *(float*)&dword_140C66F1C))
		+ 0.5;
	...
	dword_140C79C38 = v14 + 2;
	result = (unsigned int)((int)v20.m128_f32[0] - 1);
	dword_140C79C30 = (int)(float)(v29 + v22.m128_f32[0]) - 1;
	dword_140C79C3C = v18;
	dword_140C79C34 = (int)v20.m128_f32[0] - 1;
	return result;
}
...
// 140C79C30: using guessed type int dword_140C79C30;
// 140C79C34: using guessed type int dword_140C79C34;
// 140C79C38: using guessed type int dword_140C79C38;
// 140C79C3C: using guessed type int dword_140C79C3C;
