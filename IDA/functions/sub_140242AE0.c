...
__int64 sub_140242AE0()
{
	...
	if (qword_140C64068)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Tradeskill"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Tradeskill.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140242B7C: variable 'v1' is possibly undefined
// 140A5BFB8: using guessed type wchar_t *off_140A5BFB8;
// 140AAB5C8: using guessed type wchar_t aTradeskill[11];
// 140AAB778: using guessed type wchar_t aDbTradeskillTb[18];
...
// 140C6477C: using guessed type int dword_140C6477C;
// 140C64D70: using guessed type int dword_140C64D70;
// 140C64EF8: using guessed type int dword_140C64EF8;
