...
__int64 sub_1401EF840()
{
	...
	if (qword_140C64450)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ChallengeTier"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ChallengeTier.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401EF8DC: variable 'v1' is possibly undefined
// 140A5D5E8: using guessed type wchar_t aDbChallengetie[21];
// 140A5D618: using guessed type wchar_t aChallengetier[14];
// 140AE06A0: using guessed type wchar_t *off_140AE06A0;
...
// 140C638F0: using guessed type int dword_140C638F0;
...
// 140C65610: using guessed type int dword_140C65610;
