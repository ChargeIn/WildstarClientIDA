...
__int64 sub_140215860()
{
	...
	if (qword_140C63930)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"MatchingMapPrerequisite"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\MatchingMapPrerequisite.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402158FC: variable 'v1' is possibly undefined
// 140A80E38: using guessed type wchar_t *off_140A80E38;
// 140A92FA0: using guessed type wchar_t aMatchingmappre[24];
// 140A93160: using guessed type wchar_t aDbMatchingmapp[31];
...
// 140C64B10: using guessed type int dword_140C64B10;
// 140C64CA8: using guessed type int dword_140C64CA8;
// 140C64EF4: using guessed type int dword_140C64EF4;
