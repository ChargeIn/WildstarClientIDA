...
__int64 sub_1402305A0()
{
	...
	if (qword_140C64E90)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"RewardRotationModifier"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\RewardRotationModifier.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023063C: variable 'v1' is possibly undefined
// 140A670F8: using guessed type wchar_t *off_140A670F8;
// 140AA1D80: using guessed type wchar_t aDbRewardrotati_2[30];
// 140AA1DC0: using guessed type wchar_t aRewardrotation_2[23];
...
// 140C64770: using guessed type int dword_140C64770;
// 140C6489C: using guessed type int dword_140C6489C;
