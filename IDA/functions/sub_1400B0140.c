...
//----- (00000001400B0140) ----------------------------------------------------
__int64 __fastcall sub_1400B0140(__int64 a1, unsigned int* a2)
{
	__int64 v2; // r8
	...
	{
		result = sub_140336470(a1, v18, 1ui64);
		if ((int)result < 0)
			return result;
	}
	result = sub_1400A7250(a1, a2[3] != 0, 1ui64);
	if ((int)result >= 0)
	{
		result = sub_1400A7110(a1, a2[4], 5ui64);
		if ((int)result >= 0)
		{
			for (i = 0i64; (unsigned int)i < a2[4]; i = (unsigned int)(i + 1))
			{
				result = sub_1400AF840(a1, (int*)(*((_QWORD*)a2 + 3) + 72 * i));
				if ((int)result < 0)
					break;
			}
		}
