...
__int64 sub_14020B680()
{
	...
	if (qword_140C64BA8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ItemColorSet"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ItemColorSet.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020B71C: variable 'v1' is possibly undefined
// 140A5EF88: using guessed type wchar_t *off_140A5EF88;
// 140A8F3F8: using guessed type wchar_t aDbItemcolorset[20];
// 140A8F498: using guessed type wchar_t aItemcolorset[13];
...
// 140C63F9C: using guessed type int dword_140C63F9C;
// 140C64818: using guessed type int dword_140C64818;
