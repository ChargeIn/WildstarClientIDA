...
__int64 sub_14024BB60()
{
	...
	if (qword_140C64CD0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"WorldSky"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\WorldSky.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024BBFC: variable 'v1' is possibly undefined
// 140AB00A0: using guessed type wchar_t aDbWorldskyTbl[16];
// 140AB0118: using guessed type wchar_t aWorldsky[9];
// 140AE1CD0: using guessed type wchar_t *off_140AE1CD0;
