...
//----- (0000000140248A70) ----------------------------------------------------
__int64 sub_140248A70()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6DFC0, qword_140C63858);
	if (dword_140C63B58 || (int)sub_140248860() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64810 + 40i64))(qword_140C64810);
}
