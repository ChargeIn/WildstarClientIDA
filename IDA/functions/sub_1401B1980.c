...
//----- (00000001401B1980) ----------------------------------------------------
__m128i* __fastcall sub_1401B1980(__m128i* a1, unsigned __int16* a2)
{
	__m128i si128; // xmm11
	__m128i v3; // xmm3
	__m128i v4; // xmm9
	...
	v3 = _mm_unpacklo_epi32(
		_mm_unpacklo_epi32(_mm_cvtsi32_si128(*a2), _mm_cvtsi32_si128(a2[2])),
		_mm_unpacklo_epi32(_mm_cvtsi32_si128(a2[1]), _mm_cvtsi32_si128(a2[3])));
	v4 = _mm_andnot_si128(si128, v3);
	v5 = _mm_slli_epi32(_mm_and_si128(si128, v3), 0x10u);
	v6 = v4;
	v7 = _mm_add_epi32(_mm_slli_epi32(v4, 0xDu), (__m128i)xmmword_140B7AB00);
	v8 = _mm_cmpeq_epi32(v6, (__m128i)0i64);
	...
	result = a1;
	*a1 = _mm_or_si128(_mm_andnot_si128(v8, v7), v5);
	return result;
}
