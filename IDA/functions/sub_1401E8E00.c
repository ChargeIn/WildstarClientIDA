...
__int64 sub_1401E8E00()
{
	...
	if (qword_140C63A58)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"AccountItemCooldownGroup"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\AccountItemCooldownGroup.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401E8E9C: variable 'v1' is possibly undefined
// 140A4B728: using guessed type wchar_t aAccountitemcoo[25];
// 140A4BBC0: using guessed type wchar_t aDbAccountitemc[32];
// 140A75B38: using guessed type wchar_t *off_140A75B38;
...
// 140C6404C: using guessed type int dword_140C6404C;
// 140C64CBC: using guessed type int dword_140C64CBC;
