...
__int64 sub_1402404A0()
{
	...
	if (qword_140C64790)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"CustomerSurvey"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\CustomerSurvey.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024053C: variable 'v1' is possibly undefined
// 140A62A28: using guessed type wchar_t *off_140A62A28;
// 140AAA840: using guessed type wchar_t aDbCustomersurv[22];
// 140AAA910: using guessed type wchar_t aCustomersurvey[15];
