...
__int64 sub_14021F160()
{
	...
	if (qword_140C64E80)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathMission"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PathMission.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021F1FC: variable 'v1' is possibly undefined
// 140A95FB0: using guessed type wchar_t aPathmission[12];
// 140A96150: using guessed type wchar_t aDbPathmissionT[19];
// 140AD1D18: using guessed type wchar_t *off_140AD1D18;
...
// 140C64180: using guessed type int dword_140C64180;
// 140C64424: using guessed type int dword_140C64424;
