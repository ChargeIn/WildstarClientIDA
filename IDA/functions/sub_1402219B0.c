...
//----- (00000001402219B0) ----------------------------------------------------
__int64 sub_1402219B0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6BF98, qword_140C63858);
	if (dword_140C650B0 || (int)sub_1402217A0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64660 + 40i64))(qword_140C64660);
}
