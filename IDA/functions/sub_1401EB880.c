...
__int64 sub_1401EB880()
{
	...
	if (qword_140C64FB0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ArchiveCategory"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ArchiveCategory.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401EB91C: variable 'v1' is possibly undefined
// 140A519E0: using guessed type wchar_t aDbArchivecateg[23];
// 140A51E10: using guessed type wchar_t aArchivecategor[16];
// 140A869E8: using guessed type wchar_t *off_140A869E8;
...
// 140C63C74: using guessed type int dword_140C63C74;
// 140C645D0: using guessed type int dword_140C645D0;
