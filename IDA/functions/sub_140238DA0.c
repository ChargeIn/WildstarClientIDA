...
__int64 sub_140238DA0()
{
	...
	if (qword_140C63C48)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4GroupList"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4GroupList.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140238E3C: variable 'v1' is possibly undefined
// 140A7E6F8: using guessed type wchar_t *off_140A7E6F8;
// 140AA7978: using guessed type wchar_t aDbSpell4groupl[23];
// 140AA7A30: using guessed type wchar_t aSpell4grouplis[16];
...
// 140C638C0: using guessed type int dword_140C638C0;
...
// 140C644E0: using guessed type int dword_140C644E0;
