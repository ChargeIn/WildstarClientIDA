...
__int64 sub_1401E9F00()
{
	...
	if (qword_140C65020)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"AchievementSubGroup"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\AchievementSubGroup.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401E9F9C: variable 'v1' is possibly undefined
// 140A4C540: using guessed type wchar_t aDbAchievements[27];
// 140A4C578: using guessed type wchar_t aAchievementsub[20];
// 140ADC980: using guessed type wchar_t *off_140ADC980;
...
// 140C63FCC: using guessed type int dword_140C63FCC;
// 140C64AB0: using guessed type int dword_140C64AB0;
