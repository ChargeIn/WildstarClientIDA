...
//----- (00000001400DB610) ----------------------------------------------------
__int64 __fastcall sub_1400DB610(_QWORD* a1)
{
	__int64 v1; // rbx
...
LABEL_7:
	...
	{
		v7 = *(_QWORD**)(v1 + 400);
		v8 = (char*)sub_14018F0E0(&v12, word_1409D329C)[1];
		...
		if (v13)
			sub_14018B900(v13, 0);
		v10 = v15;
		sub_1400D2D60(v6, v15);
		if (v10)
			sub_14018B900((__int64)v10, 0);
	}
	return 0i64;
}
// 1409D329C: using guessed type unsigned __int16 word_1409D329C[48];
