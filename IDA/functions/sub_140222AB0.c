...
//----- (0000000140222AB0) ----------------------------------------------------
__int64 sub_140222AB0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6C078, qword_140C63858);
	if (dword_140C645E4 || (int)sub_1402228A0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C641D0 + 40i64))(qword_140C641D0);
}
