...
__int64 sub_140244020()
{
	...
	if (qword_140C63968)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TradeskillCatalyst"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\TradeskillCatalyst.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402440BC: variable 'v1' is possibly undefined
// 140AAC3D8: using guessed type wchar_t aDbTradeskillca[26];
// 140AAC498: using guessed type wchar_t aTradeskillcata[19];
// 140AD0288: using guessed type wchar_t *off_140AD0288;
...
// 140C641AC: using guessed type int dword_140C641AC;
// 140C64290: using guessed type int dword_140C64290;
