...
//----- (000000014021A6F0) ----------------------------------------------------
__int64 sub_14021A6F0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6B9B0, qword_140C63858);
	if (dword_140C64964 || (int)sub_14021A4E0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C652E8 + 40i64))(qword_140C652E8);
}
