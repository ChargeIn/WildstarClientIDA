...
__int64 sub_1401FC000()
{
	...
	if (qword_140C64BF0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Datacube"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Datacube.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401FC09C: variable 'v1' is possibly undefined
// 140A86070: using guessed type wchar_t aDbDatacubeTbl[16];
// 140A860F8: using guessed type wchar_t aDatacube[9];
// 140AE2830: using guessed type wchar_t *off_140AE2830;
...
// 140C65088: using guessed type int dword_140C65088;
// 140C65390: using guessed type int dword_140C65390;
