...
//----- (000000014080ECE0) ----------------------------------------------------
__int64 __fastcall sub_14080ECE0(__int64 a1, unsigned int a2)
{
	...
	if (v6 && v6 != -14)
		return v6;
	if (v6 == -14)
		qword_140C60B98 = 0i64;
	if (qword_140C60B98 && dword_140C60BA0 != dword_140C60980[v7])
		qword_140C60B98 = 0i64;
	if (!qword_140C60B98 && v4 && nvapi_QueryInterface)
	{
		qword_140C60B98 = nvapi_QueryInterface(885637844i64);
		dword_140C60BA0 = dword_140C60980[v7];
	}
	if (qword_140C60B98)
	{
		v3 = (__int64(__fastcall*)(__int64, _QWORD))qword_140C60B98;
		v5 = 0i64;
		if (qword_140C60938)
			qword_140C60938(885637844i64, &v5);
		v6 = v3(a1, a2);
		if (qword_140C60940)
			qword_140C60940(885637844i64, v5, v6);
		--dword_140C60970[v7];
		return v6;
	}
	else
...
// 140C60B98: using guessed type __int64 qword_140C60B98;
// 140C60BA0: using guessed type int dword_140C60BA0;
