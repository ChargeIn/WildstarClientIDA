//----- (000000014014D6D0) ----------------------------------------------------
__int64 __fastcall sub_14014D6D0(__int64 a1)
{
	_DWORD* v2; // rax
	int v3; // ecx
	__int64 v4; // rax
	...
	*(_QWORD*)(a1 + 16) += 16i64;
	v9 = *(_QWORD*)(a1 + 32);
	v10 = sub_140062650(a1, (unsigned __int64*)"EulerAngles", 0xBui64);
	v11 = *(_QWORD*)(a1 + 16);
	v17 = v10;
	v18 = 4;
...
// 14014D7D9: variable 'v13' is possibly undefined
