...
__int64 sub_14024D4E0()
{
	...
	if (qword_140C65330)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"WorldWaterWake"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\WorldWaterWake.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024D57C: variable 'v1' is possibly undefined
// 140A74B88: using guessed type wchar_t *off_140A74B88;
// 140AB0B10: using guessed type wchar_t aDbWorldwaterwa[22];
// 140AB0B40: using guessed type wchar_t aWorldwaterwake[15];
...
// 140C647B0: using guessed type int dword_140C647B0;
// 140C64E28: using guessed type int dword_140C64E28;
