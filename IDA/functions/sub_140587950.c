//----- (0000000140587950) ----------------------------------------------------
void __fastcall sub_140587950(__int64 a1)
{
	__int64 v2; // rdx
	__int64 v3; // rax
	__int16* v4; // rax
...
// 140587B6C: variable 'v14' is possibly undefined
// 140B1F3C8: using guessed type wchar_t asc_140B1F3C8[5];
// 140C658A0: using guessed type __int64 qword_140C658A0;
// 140C7DE18: using guessed type __int64 qword_140C7DE18;
// 140C7DE20: using guessed type __int64 qword_140C7DE20;
// 140587950: using guessed type char var_88[8];
// 140587950: using guessed type char var_68[8];
// 140587950: using guessed type char var_48[8];
