...
//----- (000000014060D880) ----------------------------------------------------
void __fastcall sub_14060D880(__int64 a1)
{
	_QWORD* v2; // rdi
	__int64 v3; // rdx
	__int64 v4; // rbx
	...
	*(_DWORD*)(v13 + 8) = *((_DWORD*)v12 + 2);
	v2[2] += 16i64;
	sub_1400F06F0((__int64)v2, v13, L"nHealthStolen", v14);
	v2[2] -= 16i64;
	v15 = sub_14005C3C0(*(_QWORD*)(v2[4] + 160i64), v8);
	*(_QWORD*)v16 = *v15;
	*(_DWORD*)(v16 + 8) = *((_DWORD*)v15 + 2);
	v2[2] += 16i64;
	sub_1400F06F0((__int64)v2, v17, L"nAbsorption", v18);
	v19 = qword_140C65898;
	v2[2] -= 16i64;
	Apollo_LUAEvent(*(_QWORD*)(v19 + 29504), "CombatLogLifeSteal", "T", v8, v21, v22, v23, v24);
	sub_1400579E0((__int64)v2, v20, v8);
}
// 14060D9AC: variable 'v14' is possibly undefined
// 14060D9DD: variable 'v16' is possibly undefined
// 14060D9EF: variable 'v17' is possibly undefined
// 14060D9EF: variable 'v18' is possibly undefined
// 14060DA32: variable 'v20' is possibly undefined
// 140B26A48: using guessed type wchar_t aNhealthstolen[14];
// 140B26A68: using guessed type wchar_t aNabsorption_5[12];
