...
__int64 sub_140222460()
{
	...
	if (qword_140C64028)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathSettlerImprovement"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PathSettlerImprovement.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402224FC: variable 'v1' is possibly undefined
// 140A98E08: using guessed type wchar_t aDbPathsettleri_1[30];
// 140A98EC8: using guessed type wchar_t aPathsettlerimp_0[23];
// 140ACC478: using guessed type wchar_t *off_140ACC478;
...
// 140C640D0: using guessed type int dword_140C640D0;
// 140C649EC: using guessed type int dword_140C649EC;
