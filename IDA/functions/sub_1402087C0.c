...
__int64 sub_1402087C0()
{
	...
	if (qword_140C64350)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"InputAction"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\InputAction.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020885C: variable 'v1' is possibly undefined
// 140A8DA58: using guessed type wchar_t aDbInputactionT[19];
// 140A8DAF0: using guessed type wchar_t aInputaction[12];
// 140ACFCC8: using guessed type wchar_t *off_140ACFCC8;
...
// 140C65248: using guessed type int dword_140C65248;
// 140C65578: using guessed type int dword_140C65578;
