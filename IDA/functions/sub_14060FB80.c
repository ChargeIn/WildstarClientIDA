...
//----- (000000014060FB80) ----------------------------------------------------
void __fastcall sub_14060FB80(__int64 a1)
{
	_QWORD* v2; // rdi
	__int64 v3; // rdx
	__int64 v4; // rbx
	...
	*(_QWORD*)v4 = v5;
	...
	Apollo_LUAEvent(*(_QWORD*)(qword_140C65898 + 29504), "CombatLogResurrect", "T", v8, v13, v14, v15, v16);
	sub_1400579E0((__int64)v2, v12, v8);
}
// 14060FCAD: variable 'v12' is possibly undefined
