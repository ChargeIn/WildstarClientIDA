...
__int64 sub_140227520()
{
	...
	if (qword_140C64600)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PublicEventStatDisplay"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PublicEventStatDisplay.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402275BC: variable 'v1' is possibly undefined
// 140A9B208: using guessed type wchar_t aDbPublicevents[30];
// 140A9B2E0: using guessed type wchar_t aPubliceventsta[23];
// 140AD3468: using guessed type wchar_t *off_140AD3468;
...
// 140C648D4: using guessed type int dword_140C648D4;
// 140C64A4C: using guessed type int dword_140C64A4C;
// 140C64B90: using guessed type int dword_140C64B90;
