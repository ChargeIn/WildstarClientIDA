...
//----- (000000014060F970) ----------------------------------------------------
void __fastcall sub_14060F970(int* a1)
{
	__int64 v2; // rdi
	__int64 v3; // rdx
	__int64 v4; // rbx
	...
	*(_QWORD*)(v2 + 16) += 16i64;
	...
	Apollo_LUAEvent(*(_QWORD*)(qword_140C65898 + 29504), "CombatLogKillPVP", "T", (unsigned int)v4, v7);
	sub_1400579E0(v2, v6, v4);
}
// 14060FA3A: variable 'v6' is possibly undefined
