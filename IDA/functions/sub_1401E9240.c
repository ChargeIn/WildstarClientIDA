...
__int64 sub_1401E9240()
{
	...
	if (qword_140C64218)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Achievement"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Achievement.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401E92DC: variable 'v1' is possibly undefined
// 140A4C0A8: using guessed type wchar_t aDbAchievementT[19];
// 140A4C150: using guessed type wchar_t aAchievement_0[12];
// 140A5CA18: using guessed type wchar_t *off_140A5CA18;
...
// 140C64DFC: using guessed type int dword_140C64DFC;
// 140C650D8: using guessed type int dword_140C650D8;
