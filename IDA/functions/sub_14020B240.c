...
__int64 sub_14020B240()
{
	...
	if (qword_140C644D8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ItemImbuementReward"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ItemImbuementReward.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020B2DC: variable 'v1' is possibly undefined
// 140A77B98: using guessed type wchar_t *off_140A77B98;
// 140A8F380: using guessed type wchar_t aDbItemimbuemen_0[27];
// 140A8F3B8: using guessed type wchar_t aItemimbuementr[20];
...
// 140C64248: using guessed type int dword_140C64248;
// 140C644D8: using guessed type __int64 qword_140C644D8;
// 140C64734: using guessed type int dword_140C64734;
