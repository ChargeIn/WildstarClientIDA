//----- (0000000140640C20) ----------------------------------------------------
__int64 __fastcall sub_140640C20(__int64 a1, __int64 a2, unsigned __int16* a3, _DWORD* a4)
{
	int v6; // ebp
	wchar_t** v7; // rsi
