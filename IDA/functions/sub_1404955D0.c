//----- (00000001404955D0) ----------------------------------------------------
void __fastcall sub_1404955D0(__int64 a1, __int64* a2)
{
	__int64 v3; // rcx
	__int64* v4; // rdx
	int v5; // ebx
	...
	if ((__int64*)v3 == v4)
	{
		...
		*((_QWORD*)&v8 + 1) = TlsGetValue(dwTlsIndex);
		...
		v11 = 0x141E4F6B0i64;
		v10 = v8;
		v5 = sub_1401971E0(&dword_140C8AD04, 1, &v11, &v9);
		TlsValue = &off_140B5E648;
	...
	else
	{
		...
		sub_140494C80((__int64*)(v6 + 40));
		sub_14018B900(v6, 0);
		--* (_QWORD*)(a1 + 16);
	}
}
// 140B5E648: using guessed type __int64 (__fastcall *off_140B5E648)();
// 140C8AD04: using guessed type _DWORD dword_140C8AD04;
