...
__int64 sub_1401FEEC0()
{
	...
	if (qword_140C64D20)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Faction2"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Faction2.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401FEF5C: variable 'v1' is possibly undefined
// 140A7B750: using guessed type wchar_t *off_140A7B750;
// 140A892E0: using guessed type wchar_t aFaction2[9];
// 140A893F8: using guessed type wchar_t aDbFaction2Tbl[16];
...
// 140C64884: using guessed type int dword_140C64884;
// 140C648FC: using guessed type int dword_140C648FC;
