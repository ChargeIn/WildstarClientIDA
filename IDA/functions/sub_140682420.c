...
//----- (0000000140682420) ----------------------------------------------------
__int64 __fastcall sub_140682420(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Game.SoldierImprovement");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6;
	sub_140057020(a1, "SoldierImprovement", &off_140B6FDD0);
	return 1i64;
}
// 140682533: variable 'v14' is possibly undefined
// 140B6FDD0: using guessed type void *off_140B6FDD0;
// 140C5C340: using guessed type char *off_140C5C340;
