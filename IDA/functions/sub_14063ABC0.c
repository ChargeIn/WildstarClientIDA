...
//----- (000000014063ABC0) ----------------------------------------------------
int* __fastcall sub_14063ABC0(__int64 a1, __int64 a2)
{
	...
	v3 = *(_QWORD*)(a1 + 8) - 1i64;
	result = sub_1407DB590((int*)(*(_QWORD*)a1 + 20 * a2), (int*)(*(_QWORD*)a1 + 20 * a2 + 20), 20 * (v3 - a2));
	v5 = *(int**)a1;
	if (v3)
	{
		if (v5)
		{
			if (v3 <= *((_QWORD*)v5 - 1))
				goto LABEL_10;
			v6 = (sub_14018A3E0(20 * v3 + 16) - 16) / 0x14ui64;
			v7 = 20 * v6 + 16;
...
LABEL_10:
	if (*(int**)a1 != v5)
	{
		result = sub_1407DB590(v5, *(int**)a1, 20 * v3);
		if (*(_QWORD*)a1)
