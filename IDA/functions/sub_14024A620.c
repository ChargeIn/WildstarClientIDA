...
__int64 sub_14024A620()
{
	...
	if (qword_140C65660)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"WordFilterChina"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\WordFilterAlt.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024A6BC: variable 'v1' is possibly undefined
// 140A4BCE0: using guessed type wchar_t *off_140A4BCE0;
// 140AAF298: using guessed type wchar_t aDbWordfilteral[21];
// 140AAF2C8: using guessed type wchar_t aWordfilterchin[16];
...
// 140C64390: using guessed type int dword_140C64390;
// 140C64B84: using guessed type int dword_140C64B84;
