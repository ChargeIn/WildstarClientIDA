...
//----- (000000014020F580) ----------------------------------------------------
__int64 sub_14020F580(void(__fastcall*** a1)(_QWORD), __int64* a2, unsigned __int16* a3, ...)
{
	int v5; // eax
	int* v6; // rax
	__int64 v7; // r8
