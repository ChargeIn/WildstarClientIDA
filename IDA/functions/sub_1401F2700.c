...
__int64 sub_1401F2700()
{
	...
	if (qword_140C63BC0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"CinematicRace"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\CinematicRace.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F279C: variable 'v1' is possibly undefined
// 140A61530: using guessed type wchar_t aDbCinematicrac[21];
// 140A61560: using guessed type wchar_t aCinematicrace[14];
// 140ACFEC0: using guessed type wchar_t *off_140ACFEC0;
...
// 140C648F4: using guessed type int dword_140C648F4;
// 140C65134: using guessed type int dword_140C65134;
