//----- (00000001400F8AD0) ----------------------------------------------------
int** __fastcall sub_1400F8AD0(__int64 a1, int** a2, __int64* a3, __int64 a4)
{
	_QWORD* v4; // rbx
	__int64 v5; // rdi
	_QWORD* v9; // rdi
	...
	if ((_QWORD*)v5 != v4)
	{
		...
		if ((int)sub_1400454D0(v15[5], v15[6], *(unsigned __int16**)(a4 + 8), *(_QWORD*)(a4 + 16)) < 0
			&& (int)sub_1400454D0(
				*(_QWORD*)(a4 + 8),
				*(_QWORD*)(a4 + 16),
				*(unsigned __int16**)(v5 + 40),
				*(_QWORD*)(v5 + 48)) < 0)
		{
			if (!v15[3])
			{
				sub_1400F8EF0(a1, a2, 0i64, (__int64)v15, a4);
				return a2;
			}
			goto LABEL_4;
		}
	LABEL_30:
		*a2 = *(int**)sub_1400F8FD0(a1, (__int64)v19, a4);
		return a2;
	}
	v9 = (_QWORD*)v4[3];
...
// 1400F8B8E: variable 'v10' is possibly undefined
// 1400F8AD0: using guessed type char var_18[24];
