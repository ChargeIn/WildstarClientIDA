...
__int64 sub_140225FE0()
{
	...
	if (qword_140C65078)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PrimalMatrixReward"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PrimalMatrixReward.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022607C: variable 'v1' is possibly undefined
// 140A72F18: using guessed type wchar_t *off_140A72F18;
// 140A9A8E0: using guessed type wchar_t aDbPrimalmatrix[26];
// 140A9A9A0: using guessed type wchar_t aPrimalmatrixre[19];
...
// 140C65084: using guessed type int dword_140C65084;
// 140C652C0: using guessed type int dword_140C652C0;
