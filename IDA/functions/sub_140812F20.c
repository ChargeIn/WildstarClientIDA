...
//----- (0000000140812F20) ----------------------------------------------------
__int64 __fastcall sub_140812F20(__int64 a1)
{
	...
	if (v5 && v5 != -14)
		return v5;
	if (v5 == -14)
		qword_140C60E38 = 0i64;
	if (qword_140C60E38 && dword_140C60E40 != dword_140C60980[v6])
		qword_140C60E38 = 0i64;
	if (!qword_140C60E38 && v3 && nvapi_QueryInterface)
	{
		qword_140C60E38 = nvapi_QueryInterface(2585498469i64);
		dword_140C60E40 = dword_140C60980[v6];
	}
	if (qword_140C60E38)
	{
		v2 = (__int64(__fastcall*)(__int64))qword_140C60E38;
		v4 = 0i64;
		if (qword_140C60938)
			qword_140C60938(2585498469i64, &v4);
		v5 = v2(a1);
		if (qword_140C60940)
			qword_140C60940(2585498469i64, v4, v5);
		--dword_140C60970[v6];
		return v5;
	}
	else
...
// 140C60E38: using guessed type __int64 qword_140C60E38;
// 140C60E40: using guessed type int dword_140C60E40;
