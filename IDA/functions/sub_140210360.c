...
__int64 sub_140210360()
{
	...
	if (qword_140C64408)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"LoadingScreenTip"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\LoadingScreenTip.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402103FC: variable 'v1' is possibly undefined
// 140A914F0: using guessed type wchar_t aDbLoadingscree[24];
// 140A915A0: using guessed type wchar_t aLoadingscreent[17];
// 140ADDBE8: using guessed type wchar_t *off_140ADDBE8;
...
// 140C63DF4: using guessed type int dword_140C63DF4;
// 140C64408: using guessed type __int64 qword_140C64408;
// 140C64B0C: using guessed type int dword_140C64B0C;
