//----- (00000001405BB040) ----------------------------------------------------
void __fastcall sub_1405BB040(__int64 a1)
{
	_QWORD* v1; // rdi
	int v3; // r9d
	int v4; // r8d
	...
	v8 = 0;
	v9 = &v46[v7 / 8];
	v10 = (char*)&(&off_140C5A450)[v7 / 0xFFFFFFFFFFFFFFF8ui64] - (char*)v46;
	do
	{
	...
	sub_1400569B0((__int64)v1, (unsigned __int64*)"Apollo.BuffContainerWindow");
	v12 = v1[2];
	if (*(_DWORD*)(v12 - 8) != 2)
	{
...
LABEL_35:
	...
	if (!sub_1405BB3C0)
		v43 = 0i64;
	v45 = v43;
	sub_1400F85D0(a1 + 2688, (int*)L"BuffContainerWindow", &v44);
}
// 140B21900: using guessed type wchar_t aBuffcontainerw_0[20];
// 140C56A80: using guessed type char *off_140C56A80;
// 140C5A450: using guessed type char *off_140C5A450;
