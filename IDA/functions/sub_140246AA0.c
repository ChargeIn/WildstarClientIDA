...
__int64 sub_140246AA0()
{
	...
	if (qword_140C64138)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TutorialAnchor"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\TutorialAnchor.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140246B3C: variable 'v1' is possibly undefined
// 140A61950: using guessed type wchar_t *off_140A61950;
// 140AAD7D0: using guessed type wchar_t aDbTutorialanch[22];
// 140AAD800: using guessed type wchar_t aTutorialanchor[15];
