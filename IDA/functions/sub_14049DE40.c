...
//----- (000000014049DE40) ----------------------------------------------------
_BOOL8 __fastcall sub_14049DE40(__int64 a1, __int64 a2, int a3, int a4)
{
	int v6; // edi
	__int64 v7; // rax
	__int64 v8; // rbx
	...
	v10 = sub_1405BFE80(qword_140C65B98, 0, 0xFFFFFFFF);
	if (v10)
	{
		v6 = *(_DWORD*)(v10 + 4);
	}
...
// 14049DF51: variable 'v11' is possibly undefined
