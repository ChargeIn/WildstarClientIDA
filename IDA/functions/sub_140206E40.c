...
__int64 sub_140206E40()
{
	...
	if (qword_140C64DE8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"HousingPropertyInfo"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\HousingPropertyInfo.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140206EDC: variable 'v1' is possibly undefined
// 140A76FB0: using guessed type wchar_t *off_140A76FB0;
// 140A8CDA8: using guessed type wchar_t aDbHousingprope[27];
// 140A8CDE0: using guessed type wchar_t aHousingpropert[20];
...
// 140C63874: using guessed type int dword_140C63874;
// 140C63970: using guessed type __int64 qword_140C63970;
// 140C64A8C: using guessed type int dword_140C64A8C;
