//----- (00000001401EADD0) ----------------------------------------------------
__int64 sub_1401EADD0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A69288, qword_140C63858);
	if (dword_140C64ABC || (int)sub_1401EABC0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C646A0 + 40i64))(qword_140C646A0);
}
