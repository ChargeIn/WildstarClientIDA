...
__int64 sub_1401F1600()
{
	...
	if (qword_140C653D0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"CharacterTitle"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\CharacterTitle.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F169C: variable 'v1' is possibly undefined
// 140A60A48: using guessed type wchar_t aDbCharactertit[22];
// 140A60AC8: using guessed type wchar_t aCharactertitle[15];
// 140A67E18: using guessed type wchar_t *off_140A67E18;
...
// 140C64150: using guessed type int dword_140C64150;
// 140C648B4: using guessed type int dword_140C648B4;
