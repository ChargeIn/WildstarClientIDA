...
__int64 sub_1401E9AC0()
{
	...
	if (qword_140C64588)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"AchievementGroup"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\AchievementGroup.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401E9B5C: variable 'v1' is possibly undefined
// 140A4C438: using guessed type wchar_t aDbAchievementg[24];
// 140A4C468: using guessed type wchar_t aAchievementgro[17];
// 140A795C0: using guessed type wchar_t *off_140A795C0;
...
// 140C63C98: using guessed type int dword_140C63C98;
// 140C6434C: using guessed type int dword_140C6434C;
