//----- (000000014002B2D0) ----------------------------------------------------
__int64 __fastcall sub_14002B2D0(_QWORD* a1)
{
	char* v2; // rax
	_DWORD* v3; // rbp
	_DWORD* v4; // rax
	...
	unsigned __int16* v37; // [rsp+28h] [rbp-20h]

	v2 = (char*)sub_140056BB0(a1, 2u, 0i64);
	sub_14018F2D0(&v36, v2);
	v3 = dword_140A12138;
	...
	v6 = (__int64)v37;
	if (!(unsigned int)sub_14018E2C0((__int64)v37, L"SliderBarChanged"))
	{
		v7 = a1[2];
		v8 = dword_140A12138;
		...
		*(_DWORD*)(v7 + 8) = 3;
		...
		if (*(_DWORD*)(v10 + 8) != 4)
		{
			if (!(unsigned int)sub_14005E620((__int64)a1, a1[2] - 16i64))
			{
				v11 = 0i64;
			LABEL_19:
				sub_14018F2D0(&v36, v11);
				v12 = v37;
				a1[2] -= 16i64;
				v14 = sub_14019D200(v13, v12);
				v15 = v14;
				if (v14 && (*(unsigned int(__fastcall**)(__int64))(*(_QWORD*)v14 + 8i64))(v14) == 5)
				{
				...
				LABEL_44:
					...
					v32 = sub_140058480((__int64)a1, -1);
					v33 = *(_DWORD*)(v15 + 16);
					if (*(_DWORD*)qword_140C63750 < v33)
						v33 = *(_DWORD*)qword_140C63750;
					v34 = v32;
					sub_14001A820(v15, v33, v34);
					a1[2] -= 16i64;
					goto LABEL_49;
				}
				goto LABEL_49;
...
LABEL_32:
	...
	*(_DWORD*)(v23 + 8) = 3;
	...
	sub_14018F2D0(&v36, v19);
	v12 = v37;
	a1[2] -= 16i64;
	v28 = sub_14019D200(v27, v12);
	v15 = v28;
	if (v28 && (*(unsigned int(__fastcall**)(__int64))(*(_QWORD*)v28 + 8i64))(v28) == 5)
	{
		v29 = a1[2];
...
// 14002B425: variable 'v13' is possibly undefined
// 14002B5BE: variable 'v27' is possibly undefined
// 1409EE8B8: using guessed type wchar_t aSliderbarchang[17];
// 1409EE8F0: using guessed type wchar_t aButtonsignal[13];
