//----- (00000001406ADFD0) ----------------------------------------------------
__int64 __fastcall sub_1406ADFD0(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Game.Decor");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6;
	sub_140057020(a1, "Decor", &off_140B70090);
	return 1i64;
}
// 1406AE0E3: variable 'v14' is possibly undefined
// 140B70090: using guessed type void *off_140B70090;
// 140C5DC40: using guessed type char *off_140C5DC40;
