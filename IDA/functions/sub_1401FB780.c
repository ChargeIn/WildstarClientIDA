...
__int64 sub_1401FB780()
{
	...
	if (qword_140C645A0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PeriodicQuestGroup"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PeriodicQuestGroup.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401FB81C: variable 'v1' is possibly undefined
// 140A84620: using guessed type wchar_t aDbPeriodicques_1[26];
// 140A84768: using guessed type wchar_t aPeriodicquestg[19];
// 140ACB358: using guessed type wchar_t *off_140ACB358;
...
// 140C63AD8: using guessed type int dword_140C63AD8;
// 140C63C18: using guessed type int dword_140C63C18;
