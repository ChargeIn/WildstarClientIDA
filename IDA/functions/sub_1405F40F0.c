...
//----- (00000001405F40F0) ----------------------------------------------------
__int64 __fastcall sub_1405F40F0(__int64 a1, __int64 a2, unsigned int a3, unsigned int a4)
{
	__int64 v6; // rax
	__int64 v7; // rdi
	int v9; // esi
	...
	v9 = (*(__int64(__fastcall**)(__int64, _QWORD, _QWORD))(*(_QWORD*)v6 + 296i64))(v6, a3, a4);
	if (v9 >= 0)
	{
		if ((*(unsigned int(__fastcall**)(__int64))(*(_QWORD*)v7 + 248i64))(v7))
		{
			...
			Apollo_LUAEvent(v10, "PublicEventObjectiveLocationRemoved", byte_1409ED28C, v11);
		}
	}
