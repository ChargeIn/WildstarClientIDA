...
__int64 sub_1401EC540()
{
	...
	if (qword_140C63CE0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ArchiveLink"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ArchiveLink.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401EC5DC: variable 'v1' is possibly undefined
// 140A52A58: using guessed type wchar_t aDbArchivelinkT[19];
// 140A52BE8: using guessed type wchar_t aArchivelink[12];
// 140ADA058: using guessed type wchar_t *off_140ADA058;
...
// 140C64F80: using guessed type int dword_140C64F80;
// 140C650C8: using guessed type int dword_140C650C8;
// 140C652F8: using guessed type int dword_140C652F8;
