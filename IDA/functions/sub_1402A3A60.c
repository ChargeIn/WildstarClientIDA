...
//----- (00000001402A3A60) ----------------------------------------------------
__int64 __fastcall sub_1402A3A60(__int64 a1, int* a2, int a3, unsigned int a4, int a5, int a6, int a7)
{
	int v8; // ebx
	__int64 result; // rax
	__int64 v10; // rdi
	...
	if (a4 <= 1)
	{
		...
		*(_QWORD*)(a1 + 72) = sub_14018E9C0(a2);
		...
		if ((int)result >= 0)
		{
			...
			*v13 = v15;
			++* (_QWORD*)v11;
			v18 = (__int64*)(*(_QWORD*)(a1 + 16) + 6864i64);
			if (!*(_QWORD*)(a1 + 280))
			{
				*(_QWORD*)(a1 + 280) = v18;
				*(_QWORD*)(a1 + 288) = *v18;
			...
			*((_QWORD*)&v23 + 1) = a1;
			v24 = sub_1402A43A0;
			sub_1401B6BF0((__int64)v18, &TlsValue, (int**)(a1 + 224));
			return 0i64;
		}
	}
	else
	{
		...
		*((_QWORD*)&v23 + 1) = TlsGetValue(dwTlsIndex);
		...
		v21 = 0x141DE6070i64;
		v28 = v23;
		v8 = sub_1401971E0(&dword_140C8A4D8, 14, &v21, &v27);
		TlsValue = &off_140B5E648;
...
// 140C8A4D8: using guessed type _DWORD dword_140C8A4D8;
