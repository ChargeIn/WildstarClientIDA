...
//----- (000000014022BB30) ----------------------------------------------------
__int64 sub_14022BB30()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6C7E8, qword_140C63858);
	if (dword_140C63A18 || (int)sub_14022B920() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C63D00 + 40i64))(qword_140C63D00);
}
