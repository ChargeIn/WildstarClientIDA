...
__int64 sub_1401FD100()
{
	...
	if (qword_140C63FB8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"EldanAugmentationCategory"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\EldanAugmentationCategory.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401FD19C: variable 'v1' is possibly undefined
// 140A84B80: using guessed type wchar_t *off_140A84B80;
// 140A87798: using guessed type wchar_t aEldanaugmentat[26];
// 140A87850: using guessed type wchar_t aDbEldanaugment[33];
...
// 140C64504: using guessed type int dword_140C64504;
// 140C65224: using guessed type int dword_140C65224;
