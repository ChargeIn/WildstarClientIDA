...
//----- (00000001401DD570) ----------------------------------------------------
__int64 __fastcall sub_1401DD570(unsigned __int16* a1)
{
	__int64 v1; // rbp
	_QWORD* v3; // rbx
	__int64 v4; // rdi
	...
	v15 = *(int**)v15;
	*sub_1401DDE60((__int64)&unk_140C79A20, (__int64*)&v15) = v7;
	return v7;
}
// 1401DD688: variable 'v9' is possibly undefined
