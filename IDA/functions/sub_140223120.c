...
__int64 sub_140223120()
{
	...
	if (qword_140C65210)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathSoldierActivate"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PathSoldierActivate.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402231BC: variable 'v1' is possibly undefined
// 140A996C0: using guessed type wchar_t aDbPathsoldiera[27];
// 140A99798: using guessed type wchar_t aPathsoldieract[20];
// 140AD0828: using guessed type wchar_t *off_140AD0828;
...
// 140C6444C: using guessed type int dword_140C6444C;
// 140C64AE8: using guessed type int dword_140C64AE8;
