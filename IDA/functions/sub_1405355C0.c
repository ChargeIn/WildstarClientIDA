...
//----- (00000001405355C0) ----------------------------------------------------
__int64 __fastcall sub_1405355C0(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rdi
		...
		if (v6)
		{
			...
			if (v9 != v8)
			{
				do
				{
					...
					sub_140773F70(v9 + 48, (__int64)&v20);
					v13 = *(_QWORD*)(v9 + 24);
					if (v13)
					{
						v9 = *(_QWORD*)(v9 + 24);
...
// 140535605: variable 'v2' is possibly undefined
// 1405356B1: variable 'v11' is possibly undefined
// 14053575D: variable 'v7' is possibly undefined
