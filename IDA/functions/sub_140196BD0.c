//----- (0000000140196BD0) ----------------------------------------------------
__int64 sub_140196BD0(_DWORD* a1, int a2, _QWORD* a3, ...)
{
	...
	int v10; // eax
	HANDLE EventW; // rcx
	__int64 v13[2]; // [rsp+20h] [rbp-448h] BYREF
	char v14[1024]; // [rsp+30h] [rbp-438h] BYREF
	va_list va; // [rsp+488h] [rbp+20h] BYREF
...
LABEL_8:
	...
	if (v8 == 1)
	{
		v9 = sub_1407DF5FC(v14, 0x3FFui64, (signed __int8*)(*a3 - 19899968i64), (int*)va);
		if (v9 < 0 || (unsigned __int64)v9 >= 0x3FF)
			v14[1023] = 0;
		v13[1] = 0i64;
		v13[0] = 0x141D3E258i64;
