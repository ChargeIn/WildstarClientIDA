...
//----- (000000014030A400) ----------------------------------------------------
unsigned __int64 __fastcall sub_14030A400(int* a1, unsigned int a2, _DWORD* a3, __int64 a4, char* a5)
{
	unsigned int v5; // ebx
