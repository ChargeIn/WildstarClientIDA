...
__int64 sub_140247320()
{
	...
	if (qword_140C64130)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TutorialPage"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\TutorialPage.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402473BC: variable 'v1' is possibly undefined
// 140A7B8A8: using guessed type wchar_t *off_140A7B8A8;
// 140AADA60: using guessed type wchar_t aDbTutorialpage[20];
// 140AADB00: using guessed type wchar_t aTutorialpage[13];
...
// 140C638A8: using guessed type int dword_140C638A8;
...
// 140C65288: using guessed type int dword_140C65288;
