//----- (000000014009EA00) ----------------------------------------------------
__int64 __fastcall sub_14009EA00(__int64 a1, __int64 a2)
{
	__int64 result; // rax
	__int64 v5; // r8
	...
	if ((int)result >= 0)
	{
		...
		result = sub_1400A7300(a1, *(_DWORD*)(a2 + 28));
		if ((int)result >= 0)
		{
			result = sub_14006BD80(a1, *(float*)(a2 + 32));
			if ((int)result >= 0)
			{
				result = sub_14006BD80(a1, *(float*)(a2 + 36));
				if ((int)result >= 0)
				{
					...
					if ((int)result >= 0)
					{
						...
						if ((int)result >= 0)
						{
							...
							if ((int)result >= 0)
							{
								...
								if ((int)result >= 0)
									return sub_14006BD80(a1, *(float*)(a2 + 56));
							}
						}
					}
				}
