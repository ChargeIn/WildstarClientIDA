...
//----- (000000014014EBC0) ----------------------------------------------------
__int64 __fastcall sub_14014EBC0(__int64 a1, int a2)
{
	_DWORD* v4; // rax
	int v5; // ecx
	__int64 v6; // rax
	...
	*(_QWORD*)(a1 + 16) += 16i64;
	v11 = *(_QWORD*)(a1 + 32);
	v12 = sub_140062650(a1, (unsigned __int64*)"Apollo.WindowLocation", 0x15ui64);
	v13 = *(_QWORD*)(a1 + 16);
	v21 = v12;
	v22 = 4;
...
// 14014ED0D: variable 'v18' is possibly undefined
