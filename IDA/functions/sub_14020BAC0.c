...
__int64 sub_14020BAC0()
{
	...
	if (qword_140C654E8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ItemDisplay"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ItemDisplay.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020BB5C: variable 'v1' is possibly undefined
// 140A8FAC0: using guessed type wchar_t aDbItemdisplayT[19];
// 140A8FAE8: using guessed type wchar_t aItemdisplay[12];
// 140ACD150: using guessed type wchar_t *off_140ACD150;
