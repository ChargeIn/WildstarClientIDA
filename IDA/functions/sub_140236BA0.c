...
__int64 sub_140236BA0()
{
	...
	if (qword_140C654E0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4Base"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4Base.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140236C3C: variable 'v1' is possibly undefined
// 140A5CF38: using guessed type wchar_t *off_140A5CF38;
// 140AA59E0: using guessed type wchar_t aSpell4base[11];
// 140AA5BA0: using guessed type wchar_t aDbSpell4baseTb[18];
...
// 140C64704: using guessed type int dword_140C64704;
// 140C65374: using guessed type int dword_140C65374;
