...
__int64 sub_14023B3E0()
{
	...
	if (qword_140C65570)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4Tag"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4Tag.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023B47C: variable 'v1' is possibly undefined
// 140A5BAC0: using guessed type wchar_t *off_140A5BAC0;
// 140AA83B0: using guessed type wchar_t aSpell4tag[10];
// 140AA8500: using guessed type wchar_t aDbSpell4tagTbl[17];
...
// 140C639B8: using guessed type int dword_140C639B8;
// 140C64A18: using guessed type int dword_140C64A18;
