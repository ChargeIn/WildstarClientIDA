//----- (0000000140693310) ----------------------------------------------------
__int64 __fastcall sub_140693310(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Game.Achievement");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6;
	sub_140057020(a1, "Achievement", &off_140B6FF00);
	return 1i64;
}
// 140693423: variable 'v14' is possibly undefined
// 140B6FF00: using guessed type char *off_140B6FF00;
// 140C5D0A0: using guessed type char *off_140C5D0A0;
