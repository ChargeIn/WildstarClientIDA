//----- (000000014058FF30) ----------------------------------------------------
int** __fastcall sub_14058FF30(__int64 a1, int** a2, _QWORD** a3, unsigned __int64* a4)
{
	__int64 v4; // rax
	_QWORD* v5; // r8
	int** result; // rax
	...
	if (v5 == *(_QWORD**)(v4 + 16))
	{
		if (*(_QWORD*)(a1 + 16) && *a4 < v5[4])
		{
			v22 = a4;
		LABEL_5:
			sub_140590B50(a1, a2, (__int64)v5, v5, v22);
			return a2;
		}
		v10 = a4;
		goto LABEL_7;
	...
	if (v5 == (_QWORD*)v4)
	{
		...
		if (v13[4] >= *a4)
		{
			v18 = *(int**)sub_140590C10(a1, (__int64)v23, a4);
			result = a2;
			*a2 = v18;
		}
		else
	...
	else
	{
		...
		if (v19[4] >= *a4 || *a4 >= v5[4])
		{
			v10 = a4;
		LABEL_7:
			v11 = *(int**)sub_140590C10(a1, (__int64)v23, v10);
			result = a2;
			*a2 = v11;
			return result;
		}
		...
		if (v19[3])
			goto LABEL_5;
		sub_140590B50(a1, a2, 0i64, v19, a4);
		return a2;
	}
	return result;
}
