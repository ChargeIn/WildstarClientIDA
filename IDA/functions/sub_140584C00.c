...
//----- (0000000140584C00) ----------------------------------------------------
void __fastcall sub_140584C00(__int64 a1)
{
	__int64 v1; // rax
	int* v3; // rbp
	bool v4; // zf
	...
	if (v13 >= 2)
	{
		...
		do
		{
			...
			if (v17 != v13 - 1)
			{
				v19 = 0i64;
				do
					v4 = *((_WORD*)&unk_1409F2E9C + ++v19) == 0;
				while (!v4);
				sub_14001C310(&v33, (int*)&unk_1409F2E9C, (int*)((char*)&unk_1409F2E9C + 2 * v19));
			}
			v17 = ++v16;
		} while (v16 < v13);
		v20 = v34;
		v21 = sub_14034BDD0(v18, 230806);
		v23 = sub_14034BDD0(v22, 230805);
		v25 = sub_14034BDD0(v24, 148653);
		sub_140584360(v26, 1, v20, (__int64)v25, (__int64)v23, (__int64)v21);
		if (v20)
			sub_14018B900((__int64)v20, 0);
	}
	else
	{
		v14 = sub_14034BDD0(v10, 113066);
...
// 140584DDF: conditional instruction was optimized away because rdi.8>=2u
// 140584D84: variable 'v10' is possibly undefined
// 140584E5B: variable 'v18' is possibly undefined
// 140584E68: variable 'v22' is possibly undefined
// 140584E75: variable 'v24' is possibly undefined
// 140584E8F: variable 'v26' is possibly undefined
// 140B1F310: using guessed type wchar_t asc_140B1F310[5];
// 140C658A0: using guessed type __int64 qword_140C658A0;
// 140584C00: using guessed type char var_88[8];
// 140584C00: using guessed type char var_48[8];
