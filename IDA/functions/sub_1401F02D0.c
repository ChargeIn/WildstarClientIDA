...
//----- (00000001401F02D0) ----------------------------------------------------
__int64 sub_1401F02D0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A696E8, qword_140C63858);
	if (dword_140C64804 || (int)sub_1401F00C0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64370 + 40i64))(qword_140C64370);
}
