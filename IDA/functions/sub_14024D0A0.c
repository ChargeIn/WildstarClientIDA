...
__int64 sub_14024D0A0()
{
	...
	if (qword_140C63A00)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"WorldWaterFog"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\WorldWaterFog.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024D13C: variable 'v1' is possibly undefined
// 140A61F00: using guessed type wchar_t *off_140A61F00;
// 140AB07C0: using guessed type wchar_t aDbWorldwaterfo[21];
// 140AB0878: using guessed type wchar_t aWorldwaterfog[14];
...
// 140C6493C: using guessed type int dword_140C6493C;
// 140C64ED0: using guessed type int dword_140C64ED0;
