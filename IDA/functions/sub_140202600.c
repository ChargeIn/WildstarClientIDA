...
__int64 sub_140202600()
{
	...
	if (qword_140C64AA0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"GuildStandardPart"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\GuildStandardPart.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020269C: variable 'v1' is possibly undefined
// 140A8A5C8: using guessed type wchar_t aGuildstandardp[18];
// 140A8A740: using guessed type wchar_t aDbGuildstandar[25];
// 140ACFC90: using guessed type wchar_t *off_140ACFC90;
