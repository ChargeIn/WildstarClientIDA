...
//----- (0000000140684F50) ----------------------------------------------------
__int64 __fastcall sub_140684F50(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Game.Challenges");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6;
	sub_140057020(a1, "Challenges", &off_140B6FE40);
	return 1i64;
}
// 140685063: variable 'v14' is possibly undefined
// 140B6FE40: using guessed type void *off_140B6FE40;
// 140C5C800: using guessed type char *off_140C5C800;
