...
__int64 sub_14020F6A0()
{
	...
	if (qword_140C646F8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"LevelUpUnlockType"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\LevelUpUnlockType.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020F73C: variable 'v1' is possibly undefined
// 140A90F90: using guessed type wchar_t aLevelupunlockt[18];
// 140A91158: using guessed type wchar_t aDbLevelupunloc_0[25];
// 140AD58D0: using guessed type wchar_t *off_140AD58D0;
...
// 140C63DB0: using guessed type int dword_140C63DB0;
// 140C646F8: using guessed type __int64 qword_140C646F8;
// 140C649E8: using guessed type int dword_140C649E8;
