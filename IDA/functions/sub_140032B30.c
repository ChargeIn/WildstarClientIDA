...
//----- (0000000140032B30) ----------------------------------------------------
int** __fastcall sub_140032B30(__int64 a1, int** a2, __int64* a3, _QWORD* a4)
{
	__int64 v4; // rax
	__int64 v5; // r8
	int** result; // rax
	...
	if (v5 == v4)
	{
		...
		{
			v16 = *(int**)sub_140032F50(a1, (__int64)v21, a4);
			result = a2;
			*a2 = v16;
		}
		else
	...
	else
	{
		...
		if (*(_DWORD*)(v17 + 32) >= *(_DWORD*)a4 || *(_DWORD*)a4 >= *(_DWORD*)(v5 + 32))
		{
			v10 = a4;
		LABEL_7:
			v11 = *(int**)sub_140032F50(a1, (__int64)v21, v10);
			result = a2;
			*a2 = v11;
			return result;
		}
		...
		if (*(_QWORD*)(v17 + 24))
			goto LABEL_5;
		sub_1400334F0(a1, a2, 0i64, v17, a4);
		return a2;
	}
	return result;
}
