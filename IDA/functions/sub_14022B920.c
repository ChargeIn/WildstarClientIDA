...
__int64 sub_14022B920()
{
	...
	if (qword_140C63D00)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"QuestDirectionEntry"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\QuestDirectionEntry.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022B9BC: variable 'v1' is possibly undefined
// 140A9E978: using guessed type wchar_t aDbQuestdirecti_0[27];
// 140A9EA60: using guessed type wchar_t aQuestdirection_0[20];
// 140ADA1F8: using guessed type wchar_t *off_140ADA1F8;
...
// 140C63C84: using guessed type int dword_140C63C84;
// 140C63D00: using guessed type __int64 qword_140C63D00;
// 140C64AEC: using guessed type int dword_140C64AEC;
