...
__int64 sub_1401ED640()
{
	...
	if (qword_140C65410)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"BinkMovie"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\BinkMovie.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401ED6DC: variable 'v1' is possibly undefined
// 140A5C240: using guessed type wchar_t aDbBinkmovieTbl[17];
// 140A5C268: using guessed type wchar_t aBinkmovie[10];
// 140A63E08: using guessed type wchar_t *off_140A63E08;
...
// 140C64348: using guessed type int dword_140C64348;
// 140C65258: using guessed type int dword_140C65258;
