...
__int64 sub_1401FC880()
{
	...
	if (qword_140C65540)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"DistanceDamageModifier"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\DistanceDamageModifier.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401FC91C: variable 'v1' is possibly undefined
// 140A629B0: using guessed type wchar_t *off_140A629B0;
// 140A86A20: using guessed type wchar_t aDbDistancedama[30];
// 140A86B58: using guessed type wchar_t aDistancedamage[23];
...
// 140C63CC8: using guessed type int dword_140C63CC8;
// 140C64684: using guessed type int dword_140C64684;
