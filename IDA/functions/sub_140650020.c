...
//----- (0000000140650020) ----------------------------------------------------
__int64 __fastcall sub_140650020(_QWORD* a1)
{
	__m128d v1; // xmm0
	int* v3; // rax
	__int64 v4; // r9
			...
			(v8 = *(_QWORD*)(v5 + 28048)) != 0))
	{
		...
		v10 = (unsigned __int16*)(*(__int64(__fastcall**)(__int64, _QWORD))(*(_QWORD*)v8 + 80i64))(
			v8,
...
// 1406500E5: conditional instruction was optimized away because rdx.8<100000000u
// 1406500F5: variable 'v1' is possibly undefined
