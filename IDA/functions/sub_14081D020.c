...
__int64 sub_14081D020()
{
	...
	if (v5 && v5 != -14)
		return v5;
	if (v5 == -14)
		qword_140C61488 = 0i64;
	if (qword_140C61488)
	{
		v0 = v6;
		if (dword_140C61490 != dword_140C60980[v6])
			qword_140C61488 = 0i64;
	}
	if (!qword_140C61488 && v3 && nvapi_QueryInterface)
	{
		qword_140C61488 = nvapi_QueryInterface(784665643i64);
		v0 = v6;
		dword_140C61490 = dword_140C60980[v6];
	}
	if (qword_140C61488)
	{
		v2 = (__int64(__fastcall*)(__int64))qword_140C61488;
		v4 = 0i64;
		if (qword_140C60938)
			qword_140C60938(784665643i64, &v4);
		v5 = v2(v0);
		if (qword_140C60940)
			qword_140C60940(784665643i64, v4, v5);
		--dword_140C60970[v6];
		return v5;
	}
	else
...
// 14081D13C: variable 'v0' is possibly undefined
...
// 140C61488: using guessed type __int64 qword_140C61488;
// 140C61490: using guessed type int dword_140C61490;
