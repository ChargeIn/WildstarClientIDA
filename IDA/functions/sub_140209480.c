...
__int64 sub_140209480()
{
	...
	if (qword_140C640E8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Item2"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Item2.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020951C: variable 'v1' is possibly undefined
// 140A8E458: using guessed type wchar_t aDbItem2Tbl[13];
// 140A8E4E0: using guessed type wchar_t aItem2[6];
// 140ADB218: using guessed type wchar_t *off_140ADB218;
