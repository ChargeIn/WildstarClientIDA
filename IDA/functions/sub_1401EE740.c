...
__int64 sub_1401EE740()
{
	...
	if (qword_140C64090)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"CCStateAdditionalData"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\CCStateAdditionalData.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401EE7DC: variable 'v1' is possibly undefined
// 140A5C960: using guessed type wchar_t aDbCcstateaddit[29];
// 140A5CAA8: using guessed type wchar_t aCcstateadditio[22];
// 140A5D4D0: using guessed type wchar_t *off_140A5D4D0;
...
// 140C63D58: using guessed type int dword_140C63D58;
// 140C63DC0: using guessed type int dword_140C63DC0;
