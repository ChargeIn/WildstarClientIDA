...
//----- (0000000140184370) ----------------------------------------------------
__int64 __fastcall sub_140184370(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Time");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6 - 16;
	sub_140057020(a1, "Time", &off_140B5E460);
	a1[2] -= 16i64;
	return 0i64;
}
// 140184483: variable 'v14' is possibly undefined
// 140B5E460: using guessed type char *off_140B5E460;
// 140C58660: using guessed type char *off_140C58660;
