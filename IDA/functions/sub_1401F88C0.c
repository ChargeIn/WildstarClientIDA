...
__int64 sub_1401F88C0()
{
	...
	if (qword_140C64A40)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Creature2DisplayInfo"))
	{
...
// 1401F895C: variable 'v1' is possibly undefined
// 140A7D500: using guessed type wchar_t *off_140A7D500;
// 140A7FF20: using guessed type wchar_t aDbCreature2dis[28];
// 140A7FFE8: using guessed type wchar_t aCreature2displ[21];
...
// 140C63964: using guessed type int dword_140C63964;
// 140C63970: using guessed type __int64 qword_140C63970;
// 140C63E40: using guessed type int dword_140C63E40;
