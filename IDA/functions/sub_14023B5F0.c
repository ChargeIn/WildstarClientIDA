...
//----- (000000014023B5F0) ----------------------------------------------------
__int64 sub_14023B5F0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6D4D0, qword_140C63858);
	if (dword_140C64BE4 || (int)sub_14023B3E0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C65570 + 40i64))(qword_140C65570);
}
