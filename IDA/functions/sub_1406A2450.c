...
//----- (00000001406A2450) ----------------------------------------------------
__int64 __fastcall sub_1406A2450(_QWORD* a1)
{
	__int64 v2; // rcx
	__int64 v3; // rdi
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Game.GenericMapNode");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6;
	sub_140057020(a1, "GenericMapNode", &off_140B6FFE0);
	sub_140058710((__int64)a1, (unsigned __int64*)"GenericMapNodeType", 0x12ui64);
	if (*(_QWORD*)(a1[4] + 120i64) >= *(_QWORD*)(a1[4] + 112i64))
		sub_14005E2C0((__int64)a1);
	v19 = a1[2];
...
// 1406A2563: variable 'v14' is possibly undefined
// 1406A263A: variable 'v21' is possibly undefined
// 140B6FFE0: using guessed type char *off_140B6FFE0;
// 140C35040: using guessed type wchar_t *off_140C35040;
// 140C5D550: using guessed type char *off_140C5D550;
