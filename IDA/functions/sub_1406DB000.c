...
//----- (00000001406DB000) ----------------------------------------------------
void __fastcall sub_1406DB000(__int64 a1)
{
	_QWORD* v1; // rdi
	int v3; // r9d
	int v4; // r8d
	...
	int v14; // eax
	__int64 v15; // rbx
	int* (__fastcall * v16)(__int64, __int64, __int64, __int64, __int64); // rax
	unsigned int* v17; // r9
	...
	__int64* v28; // rbp
	int* (__fastcall * v29)(__int64, __int64, __int64, __int64, __int64); // rax
	unsigned int* v30; // r9
	__int64 v31; // rbx
	int* (__fastcall * v32)(__int64, __int64, __int64, __int64, __int64); // rax
	__int64 v33; // r9
	__int64 v34; // rdx
	int v35; // ecx
	__int64 v36; // rdx
	...
	int* (__fastcall * v44)(__int64, __int64, __int64, __int64, __int64); // [rsp+20h] [rbp-4048h] BYREF
	...
	v8 = 0;
	v9 = &v46[v7 / 8];
	v10 = (char*)&(&off_140C5E830)[v7 / 0xFFFFFFFFFFFFFFF8ui64] - (char*)v46;
	do
	{
	...
	sub_1400569B0((__int64)v1, (unsigned __int64*)"Apollo.AbilityItemWindow");
	v12 = v1[2];
	if (*(_DWORD*)(v12 - 8) != 2)
	{
...
LABEL_16:
	...
	*(_DWORD*)(v12 + 8) = *(_DWORD*)(v12 - 8);
	v1[2] += 16i64;
	v15 = v1[2];
	v16 = (int* (__fastcall*)(__int64, __int64, __int64, __int64, __int64))sub_140062650(
		(__int64)v1,
		...
		do
		{
			...
			*(_DWORD*)(v25 + 8) = 6;
			...
			do
				++v27;
			while (*((_BYTE*)v18 + v27));
			v29 = (int* (__fastcall*)(__int64, __int64, __int64, __int64, __int64))sub_140062650((__int64)v1, v18, v27);
	...
	v31 = v1[4];
	v1[2] = v19 - 16;
	v32 = (int* (__fastcall*)(__int64, __int64, __int64, __int64, __int64))sub_140062650(
		(__int64)v1,
...
LABEL_35:
	...
	if (!sub_1406DB380)
		v43 = 0i64;
	v45 = v43;
	sub_1400F85D0(a1 + 2688, (int*)L"AbilityItemWindow", &v44);
}
// 140B3D1F0: using guessed type wchar_t aAbilityitemwin[18];
// 140C56A80: using guessed type char *off_140C56A80;
// 140C5E830: using guessed type char *off_140C5E830;
