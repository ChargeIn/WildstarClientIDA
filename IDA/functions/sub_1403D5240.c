...
//----- (00000001403D5240) ----------------------------------------------------
int** __fastcall sub_1403D5240(__int64 a1, int** a2, __int64* a3, int* a4)
{
	__int64 v4; // rax
	__int64 v5; // r8
	int** result; // rax
	...
	if (v5 == v4)
	{
		...
		{
			v18 = *(int**)sub_1403D7410(a1, (__int64)v23, a4);
			result = a2;
			*a2 = v18;
		}
		else
	...
	else
	{
		...
		if (*(_DWORD*)(v19 + 32) >= (unsigned int)*a4 || (unsigned int)*a4 >= *(_DWORD*)(v5 + 32))
		{
			v10 = a4;
		LABEL_7:
			v11 = *(int**)sub_1403D7410(a1, (__int64)v23, v10);
			result = a2;
			*a2 = v11;
			return result;
		}
		...
		if (*(_QWORD*)(v19 + 24))
			goto LABEL_5;
		sub_1403D7350(a1, a2, 0i64, v19, a4);
		return a2;
	}
	return result;
}
