...
__int64 sub_14020DCC0()
{
	...
	if (qword_140C63E18)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ItemRuneInstance"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ItemRuneInstance.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020DD5C: variable 'v1' is possibly undefined
// 140A90810: using guessed type wchar_t aDbItemruneinst[24];
// 140A908C0: using guessed type wchar_t aItemruneinstan[17];
// 140ACE878: using guessed type wchar_t *off_140ACE878;
...
// 140C63E74: using guessed type int dword_140C63E74;
// 140C65354: using guessed type int dword_140C65354;
