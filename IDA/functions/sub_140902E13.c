//----- (0000000140902E13) ----------------------------------------------------
__int64 __fastcall sub_140902E13(
	__int64 a1,
	__int64 a2,
	unsigned __int64 a3,
	unsigned __int64 a4,
	...
	__int128* a31)
{
	...
	for (i = 0i64; i < 2; ++i)
	{
		if ((v36 & 1) != 0)
		{
			...
			{
				v41 = (unsigned int*)((char*)&unk_140E4F000 + (((unsigned int)(v40 - 16224) >> 7) & 0xFFFC) + 224);
				...
				v56 = epi16 & 0x8000;
				v57 = 8 * ((_DWORD)v41 - ((unsigned int)&unk_140E4F000 + 224)) + 19 - (((epi16 >> 4) & 0x7FF) - 1023);
				...
				if (a4 || (v59 += 64, a4 = v50, v50 = a3, a3 = 0i64, a4) || (v59 += 64, a4 = v50, v50 = 0i64, a4))
				{
					...
					v71 = *((double*)&unk_140E4F000 + 27) * (v70 + v69) + v69 * v68;
				...
				v74 = (__m128d)_mm_loadl_epi64((const __m128i*) & unk_140E4F000 + 7);
				v74.m128d_f64[0] = v74.m128d_f64[0] * v39.m128d_f64[0];
				v75 = (int)v74.m128d_f64[0];
				v74.m128d_f64[0] = v74.m128d_f64[0] + *((double*)&unk_140E4F000 + 16) - *((double*)&unk_140E4F000 + 16);
				v76 = *((double*)&unk_140E4F000 + 10) * v74.m128d_f64[0];
				v77 = _mm_unpacklo_pd(v74, v74);
				v78 = _mm_move_epi64((__m128i)v39);
				v79 = (char*)&unk_140E4F000 + 32 * ((8 * (_BYTE)v51 + (_BYTE)v75) & 0x3Fu) + 400;
				v80 = _mm_mul_pd(*((__m128d*) & unk_140E4F000 + 4), v77);
				...
				*(double*)v78.m128i_i64 = *(double*)v78.m128i_i64 - v80.m128d_f64[0];
				...
				v91 = _mm_mul_pd(*((__m128d*) & unk_140E4F000 + 1), v86);
				...
				*(double*)v78.m128i_i64 = *(double*)v78.m128i_i64 * *(double*)v79;
				v93 = _mm_mul_pd(_mm_add_pd(v85, *((__m128d*) & unk_140E4F000 + 2)), _mm_mul_pd(v86, v86));
				...
				*(double*)v78.m128i_i64 = *(double*)v78.m128i_i64 + *(double*)v89.m128i_i64;
				v95 = _mm_mul_pd(_mm_add_pd(_mm_add_pd(v91, unk_140E4F000), v93), v92);
...
// 140902E19: variable 'v31' is possibly undefined
// 140902E1E: variable 'v34' is possibly undefined
// 140902E23: variable 'v33' is possibly undefined
// 140902E2D: variable 'v32' is possibly undefined
// 140902E63: variable 'v35' is possibly undefined
// 140902E6B: using guessed type __int64 __fastcall sub_140902E6B(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, __int128 *__struct_ptr, __int128 *__struct_ptr);
