//----- (00000001401D8980) ----------------------------------------------------
__int64 __fastcall sub_1401D8980(__int64 a1)
{
	int* v2; // rax
	__int64 v3; // rcx
	__int64 v4; // r8
	...
	v5 = 0;
	if (v2)
		v6 = (void(__fastcall***)(_QWORD))sub_1401D9D90((__int64)v2, a1);
	else
		v6 = 0i64;
	v11 = 0i64;
...
// 1401D89CD: variable 'v3' is possibly undefined
// 1401D89CD: variable 'v4' is possibly undefined
// 1401D8980: using guessed type int var_18[6];
