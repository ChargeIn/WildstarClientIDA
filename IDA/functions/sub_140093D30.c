...
//----- (0000000140093D30) ----------------------------------------------------
__int64 __fastcall sub_140093D30(__int64 a1, unsigned int* a2)
{
	__int64 v2; // r8
			...
			(unsigned __int64)(8i64 * (*(_QWORD*)(v11 + 24) - *(_QWORD*)(v11 + 32)) - v13) >= 0x40))
	{
		...
		v15 = *(_QWORD**)(v11 + 32);
		*v15 &= (1i64 << v13) - 1;
		*v15 |= (v14 & 0xF) << *(_QWORD*)(a1 + 16);
		v16 = *(_QWORD*)(a1 + 16);
		if (((v16 + 11) & 0xFFFFFFFFFFFFFFF8ui64) > 0x40)
	...
	{
		result = sub_140336470(a1, v12, 4ui64);
		if ((int)result < 0)
			return result;
	}
	v17 = *(_QWORD*)(a1 + 8);
			...
			(unsigned __int64)(8i64 * (*(_QWORD*)(v17 + 24) - *(_QWORD*)(v17 + 32)) - v18) >= 0x40))
	{
		...
		v20 = *(_QWORD**)(v17 + 32);
		*v20 &= (1i64 << v18) - 1;
		*v20 |= (v19 & 0xF) << *(_QWORD*)(a1 + 16);
		v21 = *(_QWORD*)(a1 + 16);
		if (((v21 + 11) & 0xFFFFFFFFFFFFFFF8ui64) > 0x40)
			*(_BYTE*)(*(_QWORD*)(v17 + 32) + 8i64) = v19 >> (64 - (unsigned __int8)v21);
		*(_QWORD*)(v17 + 32) += (unsigned __int64)(*(_QWORD*)(a1 + 16) + 4i64) >> 3;
		*(_QWORD*)(a1 + 16) = ((unsigned __int8)*(_QWORD*)(a1 + 16) - 4) & 7;
	}
	else
	{
		result = sub_140336470(a1, (int)a2[2], 4ui64);
		if ((int)result < 0)
			return result;
	}
	result = sub_1400A7110(a1, a2[3], 0x20ui64);
	if ((int)result >= 0)
		return sub_1400A89E0(a1, (float*)a2 + 4);
	return result;
}
