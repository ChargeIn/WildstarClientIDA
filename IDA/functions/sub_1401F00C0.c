...
__int64 sub_1401F00C0()
{
	...
	if (qword_140C64370)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"CharacterCreationPreset"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\CharacterCreationPreset.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F015C: variable 'v1' is possibly undefined
// 140A5E840: using guessed type wchar_t aDbCharactercre_0[31];
// 140A5E940: using guessed type wchar_t aCharactercreat_4[24];
// 140ACD690: using guessed type wchar_t *off_140ACD690;
