//----- (000000014064F010) ----------------------------------------------------
__int64 __fastcall sub_14064F010(__int64 a1)
{
	float* v2; // rsi
	__int64 v4; // rbx
	__int64 v5; // rax
	...
	if (v2)
	{
		...
		*(_QWORD*)(a1 + 16) += 16i64;
		v6 = sub_1400578C0(a1);
		v7 = sub_1404658A0(v2).m128_f32[0] * 100.0;
...
// 14064F19A: variable 'v16' is possibly undefined
// 14064F1C0: variable 'v18' is possibly undefined
// 14064F1D2: variable 'v19' is possibly undefined
// 140B2C0F0: using guessed type wchar_t aNamount_29[8];
// 140B2C100: using guessed type wchar_t aEdrstate_22[9];
