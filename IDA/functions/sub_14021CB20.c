...
__int64 sub_14021CB20()
{
	...
	if (qword_140C65270)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathExplorerActivate"))
	{
...
// 14021CBBC: variable 'v1' is possibly undefined
// 140A94E58: using guessed type wchar_t aDbPathexplorer[28];
// 140A94F10: using guessed type wchar_t aPathexplorerac[21];
// 140ACDE80: using guessed type wchar_t *off_140ACDE80;
...
// 140C64DAC: using guessed type int dword_140C64DAC;
// 140C65270: using guessed type __int64 qword_140C65270;
// 140C65490: using guessed type int dword_140C65490;
