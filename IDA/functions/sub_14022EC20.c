...
__int64 sub_14022EC20()
{
	...
	if (qword_140C64838)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ResourceConversionGroup"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\ResourceConversionGroup.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022ECBC: variable 'v1' is possibly undefined
// 140A6E730: using guessed type wchar_t *off_140A6E730;
// 140AA1360: using guessed type wchar_t aResourceconver_0[24];
// 140AA1508: using guessed type wchar_t aDbResourceconv_0[31];
...
// 140C64058: using guessed type int dword_140C64058;
// 140C64838: using guessed type __int64 qword_140C64838;
// 140C64B28: using guessed type int dword_140C64B28;
