...
__int64 sub_14021BA20()
{
	...
	if (qword_140C64748)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ModelSkinFX"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ModelSkinFX.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021BABC: variable 'v1' is possibly undefined
// 140A94A98: using guessed type wchar_t aDbModelskinfxT[19];
// 140A94AC0: using guessed type wchar_t aModelskinfx[12];
// 140AD5EB8: using guessed type wchar_t *off_140AD5EB8;
