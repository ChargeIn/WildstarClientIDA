...
//----- (0000000140417DE0) ----------------------------------------------------
__int64 __fastcall sub_140417DE0(__int64 a1)
{
	unsigned int v1; // ebx
...
// 140417DE0: using guessed type _DWORD var_578[6];
// 140417DE0: using guessed type char var_500[8];
// 140417DE0: using guessed type char var_520[8];
// 140417DE0: using guessed type char var_540[8];
// 140417DE0: using guessed type char var_560[8];
