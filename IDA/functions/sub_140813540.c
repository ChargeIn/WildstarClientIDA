//----- (0000000140813540) ----------------------------------------------------
__int64 __fastcall sub_140813540(__int64 a1, __int64 a2)
{
	...
	if (v6 && v6 != -14)
		return v6;
	if (v6 == -14)
		qword_140C60E78 = 0i64;
	if (qword_140C60E78 && dword_140C60E80 != dword_140C60980[v7])
		qword_140C60E78 = 0i64;
	if (!qword_140C60E78 && v4 && nvapi_QueryInterface)
	{
		qword_140C60E78 = nvapi_QueryInterface(1677293982i64);
		dword_140C60E80 = dword_140C60980[v7];
	}
	if (qword_140C60E78)
	{
		v3 = (__int64(__fastcall*)(__int64, __int64))qword_140C60E78;
		v5 = 0i64;
		if (qword_140C60938)
			qword_140C60938(1677293982i64, &v5);
		v6 = v3(a1, a2);
		if (qword_140C60940)
			qword_140C60940(1677293982i64, v5, v6);
		--dword_140C60970[v7];
		return v6;
	}
	else
...
// 140C60E78: using guessed type __int64 qword_140C60E78;
// 140C60E80: using guessed type int dword_140C60E80;
