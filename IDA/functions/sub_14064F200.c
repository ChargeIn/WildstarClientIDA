...
//----- (000000014064F200) ----------------------------------------------------
__int64 __fastcall sub_14064F200(__int64 a1)
{
	float* v2; // rsi
	__int64 v4; // rbx
	__int64 v5; // rax
	...
	if (v2)
	{
		...
		*(_QWORD*)(a1 + 16) += 16i64;
		v6 = sub_1400578C0(a1);
		v7 = sub_140465C40(v2).m128_f32[0] * 100.0;
...
// 14064F38A: variable 'v16' is possibly undefined
// 14064F3B0: variable 'v18' is possibly undefined
// 14064F3C2: variable 'v19' is possibly undefined
// 140B2C0C8: using guessed type wchar_t aNamount_30[8];
// 140B2C0D8: using guessed type wchar_t aEdrstate_23[9];
