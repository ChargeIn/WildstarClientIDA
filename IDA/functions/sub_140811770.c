//----- (0000000140811770) ----------------------------------------------------
__int64 __fastcall sub_140811770(__int64 a1, __int64 a2)
{
	...
	if (v6 && v6 != -14)
		return v6;
	if (v6 == -14)
		qword_140C60D48 = 0i64;
	if (qword_140C60D48 && dword_140C60D50 != dword_140C60980[v7])
		qword_140C60D48 = 0i64;
	if (!qword_140C60D48 && v4 && nvapi_QueryInterface)
	{
		qword_140C60D48 = nvapi_QueryInterface(4035571445i64);
		dword_140C60D50 = dword_140C60980[v7];
	}
	if (qword_140C60D48)
	{
		v3 = (__int64(__fastcall*)(__int64, __int64))qword_140C60D48;
		v5 = 0i64;
		if (qword_140C60938)
			qword_140C60938(4035571445i64, &v5);
		v6 = v3(a1, a2);
		if (qword_140C60940)
			qword_140C60940(4035571445i64, v5, v6);
		--dword_140C60970[v7];
		return v6;
	}
	else
...
// 140C60D48: using guessed type __int64 qword_140C60D48;
// 140C60D50: using guessed type int dword_140C60D50;
