...
__int64 sub_14021AD60()
{
	...
	if (qword_140C63EE8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ModelSequenceBySeatPosture"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\ModelSequenceBySeatPosture.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021ADFC: variable 'v1' is possibly undefined
// 140A70E38: using guessed type wchar_t *off_140A70E38;
// 140A944F0: using guessed type wchar_t aDbModelsequenc_1[34];
// 140A945D8: using guessed type wchar_t aModelsequenceb_0[27];
...
// 140C64B44: using guessed type int dword_140C64B44;
// 140C64B54: using guessed type int dword_140C64B54;
