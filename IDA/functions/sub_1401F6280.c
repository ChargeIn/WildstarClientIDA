...
__int64 sub_1401F6280()
{
	...
	if (qword_140C64688)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Creature2Difficulty"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Creature2Difficulty.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F631C: variable 'v1' is possibly undefined
// 140A73CC8: using guessed type wchar_t aDbCreature2dif[27];
// 140A73D00: using guessed type wchar_t aCreature2diffi[20];
// 140A77C08: using guessed type wchar_t *off_140A77C08;
...
// 140C63D48: using guessed type int dword_140C63D48;
// 140C64688: using guessed type __int64 qword_140C64688;
// 140C649C4: using guessed type int dword_140C649C4;
