...
__int64 sub_140216DA0()
{
	...
	if (qword_140C64FA8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"MaterialType"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\MaterialType.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140216E3C: variable 'v1' is possibly undefined
// 140A76A60: using guessed type wchar_t *off_140A76A60;
// 140A93540: using guessed type wchar_t aMaterialtype[13];
// 140A936A8: using guessed type wchar_t aDbMaterialtype[20];
...
// 140C64EBC: using guessed type int dword_140C64EBC;
// 140C64FA8: using guessed type __int64 qword_140C64FA8;
// 140C65058: using guessed type int dword_140C65058;
