...
__int64 sub_140222020()
{
	...
	if (qword_140C650B8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathSettlerHub"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PathSettlerHub.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402220BC: variable 'v1' is possibly undefined
// 140A986F8: using guessed type wchar_t aPathsettlerhub[15];
// 140A98DD8: using guessed type wchar_t aDbPathsettlerh[22];
// 140AD2050: using guessed type wchar_t *off_140AD2050;
...
// 140C64340: using guessed type int dword_140C64340;
// 140C64524: using guessed type int dword_140C64524;
