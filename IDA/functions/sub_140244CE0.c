...
__int64 sub_140244CE0()
{
	...
	if (qword_140C63978)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TradeskillMaterial"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\TradeskillMaterial.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140244D7C: variable 'v1' is possibly undefined
// 140A82998: using guessed type wchar_t *off_140A82998;
// 140AAC788: using guessed type wchar_t aTradeskillmate[19];
// 140AAC908: using guessed type wchar_t aDbTradeskillma[26];
...
// 140C64C50: using guessed type int dword_140C64C50;
// 140C64D3C: using guessed type int dword_140C64D3C;
