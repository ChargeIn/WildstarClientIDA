...
//----- (0000000140209690) ----------------------------------------------------
__int64 sub_140209690()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6ABB0, qword_140C63858);
	if (dword_140C649FC || (int)sub_140209480() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C640E8 + 40i64))(qword_140C640E8);
}
