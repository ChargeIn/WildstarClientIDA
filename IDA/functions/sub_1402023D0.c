...
//----- (00000001402023D0) ----------------------------------------------------
__int64 sub_1402023D0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6A5C8, qword_140C63858);
	if (dword_140C63BB0 || (int)sub_1402021C0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C648C8 + 40i64))(qword_140C648C8);
}
