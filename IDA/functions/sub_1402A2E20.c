...
//----- (00000001402A2E20) ----------------------------------------------------
__int64 __fastcall sub_1402A2E20(__int64* a1, const __m128i* a2)
{
	int v4; // ebx
	__int64 v6; // rax
	__int64 v7; // rdx
	...
	if (*((_DWORD*)a1 + 13) == 1)
	{
		...
		*((_QWORD*)&v13 + 1) = TlsGetValue(dwTlsIndex);
		...
		v16 = 0x141DE5CA0i64;
		v15 = v13;
		v4 = sub_1401971E0(&dword_140C8A478, 14, &v16, &v14);
		TlsValue = &off_140B5E648;
	...
	v9 = 0;
	v16 = 0i64;
	v10 = sub_140279E20(v8, v7, &v16);
	v11 = v16;
	if (v10 < 0 || (v10 = sub_1402B1DE0((__int64*)v16, a2), v10 < 0))
		v9 = v10;
	if (v11)
...
// 140C8A478: using guessed type _DWORD dword_140C8A478;
