//----- (00000001408130A0) ----------------------------------------------------
__int64 __fastcall sub_1408130A0(__int64 a1)
{
	...
	if (v5 && v5 != -14)
		return v5;
	if (v5 == -14)
		qword_140C60E48 = 0i64;
	if (qword_140C60E48 && dword_140C60E50 != dword_140C60980[v6])
		qword_140C60E48 = 0i64;
	if (!qword_140C60E48 && v3 && nvapi_QueryInterface)
	{
		qword_140C60E48 = nvapi_QueryInterface(39100807i64);
		dword_140C60E50 = dword_140C60980[v6];
	}
	if (qword_140C60E48)
	{
		v2 = (__int64(__fastcall*)(__int64))qword_140C60E48;
		v4 = 0i64;
		if (qword_140C60938)
			qword_140C60938(39100807i64, &v4);
		v5 = v2(a1);
		if (qword_140C60940)
			qword_140C60940(39100807i64, v4, v5);
		--dword_140C60970[v6];
		return v5;
	}
	else
...
// 140C60E48: using guessed type __int64 qword_140C60E48;
// 140C60E50: using guessed type int dword_140C60E50;
