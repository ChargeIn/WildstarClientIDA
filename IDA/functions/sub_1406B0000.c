//----- (00000001406B0000) ----------------------------------------------------
__int64 __fastcall sub_1406B0000(_QWORD* a1)
{
	__m128d v1; // xmm0
	__int64 v3; // rax
	__int64 v4; // rcx
	...
	if (v3 && qword_140C659F0)
	{
		...
		LABEL_13:
			...
			if (sub_1405B1510(&qword_140C7DFB0))
			{
				...
				if (v21)
					(*(void(__fastcall**)(__int64, __m128*))(*(_QWORD*)v21 + 48i64))(v21, &v23);
			}
		}
	}
	return 0i64;
}
// 1406B003A: variable 'v4' is possibly undefined
// 1406B0155: variable 'v1' is possibly undefined
