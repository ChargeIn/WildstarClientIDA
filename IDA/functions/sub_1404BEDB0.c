//----- (00000001404BEDB0) ----------------------------------------------------
__int64 __fastcall sub_1404BEDB0(__int64 a1, __int64 a2)
{
	__int64 v3; // rbx
...
// 1404BEE9B: variable 'v5' is possibly undefined
// 1404BEDB0: using guessed type char var_138[64];
// 1404BEDB0: using guessed type char var_F8[64];
// 1404BEDB0: using guessed type double var_A8[8];
// 1404BEDB0: using guessed type __m128 var_178[4];
