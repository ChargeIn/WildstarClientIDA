//----- (00000001402E5E60) ----------------------------------------------------
__int64 __fastcall sub_1402E5E60(__int64* a1, int** a2)
{
	__int64 v5; // rax
	__int64* v6; // rbx
	__int64 v7; // rax
	...
	if (v8)
	{
		...
		do
		{
			if (v10 < *(_QWORD*)(v11 + 5400))
				v13 = *(unsigned __int16**)(*(_QWORD*)(v11 + 5392) + 8 * v10);
			else
				v13 = 0i64;
			if (v12 >= v13[40] && v12 < v13[42])
			{
				v14 = *((_DWORD*)a1 + 9);
				if (v14 >= v13[41] && v14 < v13[43])
					++v9;
			}
			++v10;
		} while (v10 < v8);
	...
	*((_QWORD*)v15 + 2) = v17;
	...
	for (*((_QWORD*)v15 + 1) = 0i64; v19 < v8; ++v19)
	{
		v20 = (__int64*)a1[2];
		if (v19 < v20[675])
			v21 = *(unsigned int**)(v20[674] + 8 * v19);
		else
			v21 = 0i64;
		v22 = *((_DWORD*)a1 + 8);
		if (v22 >= *((unsigned __int16*)v21 + 40) && v22 < *((unsigned __int16*)v21 + 42))
		{
			v23 = *((_DWORD*)a1 + 9);
			if (v23 >= *((unsigned __int16*)v21 + 41) && v23 < *((unsigned __int16*)v21 + 43))
			{
				v24 = *v21;
				v25 = *v20;
				v26 = a1[2];
				...
				{
					v29 = (v27 + v28) >> 1;
					v30 = **(_DWORD**)(v20[674] + 8 * v29);
					if (v30 >= v24)
					{
						if (v30 <= v24)
						{
							if ((int)sub_1402E01D0(v20, v29, &v34) >= 0)
...
// 1402E5E60: using guessed type int var_58[4];
// 1402E5E60: using guessed type int var_48[4];
// 1402E5E60: using guessed type int var_38[4];
