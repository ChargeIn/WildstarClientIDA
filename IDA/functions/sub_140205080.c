...
__int64 sub_140205080()
{
	...
	if (qword_140C646E8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"HousingMannequinPose"))
	{
...
// 14020511C: variable 'v1' is possibly undefined
// 140A8B6D0: using guessed type wchar_t aHousingmannequ[21];
// 140A8B800: using guessed type wchar_t aDbHousingmanne[28];
// 140AD45E8: using guessed type wchar_t *off_140AD45E8;
