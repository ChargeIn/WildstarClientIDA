...
//----- (0000000140228C70) ----------------------------------------------------
__int64 sub_140228C70()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6C580, qword_140C63858);
	if (dword_140C6470C || (int)sub_140228A60() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C65378 + 40i64))(qword_140C65378);
}
