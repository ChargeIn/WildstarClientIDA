...
__int64 sub_140248860()
{
	...
	if (qword_140C64810)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"VirtualItem"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\VirtualItem.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402488FC: variable 'v1' is possibly undefined
// 140A80B60: using guessed type wchar_t *off_140A80B60;
// 140AAE550: using guessed type wchar_t aVirtualitem[12];
// 140AAE690: using guessed type wchar_t aDbVirtualitemT[19];
...
// 140C63DEC: using guessed type int dword_140C63DEC;
// 140C63E8C: using guessed type int dword_140C63E8C;
