...
//----- (0000000140248630) ----------------------------------------------------
__int64 sub_140248630()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6DF88, qword_140C63858);
	if (dword_140C63E88 || (int)sub_140248420() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C63AA0 + 40i64))(qword_140C63AA0);
}
