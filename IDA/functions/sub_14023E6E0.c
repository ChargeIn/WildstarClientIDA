...
__int64 sub_14023E6E0()
{
	...
	if (qword_140C64AF8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"SpellPhase"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\SpellPhase.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023E77C: variable 'v1' is possibly undefined
// 140AA9EF0: using guessed type wchar_t aDbSpellphaseTb[18];
// 140AA9FC0: using guessed type wchar_t aSpellphase[11];
// 140AD6998: using guessed type wchar_t *off_140AD6998;
...
// 140C654A4: using guessed type int dword_140C654A4;
// 140C655E8: using guessed type int dword_140C655E8;
