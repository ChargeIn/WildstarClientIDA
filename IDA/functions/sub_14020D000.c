...
__int64 sub_14020D000()
{
	...
	if (qword_140C64608)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ItemSet"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ItemSet.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020D09C: variable 'v1' is possibly undefined
// 140A5CC78: using guessed type wchar_t *off_140A5CC78;
// 140A90358: using guessed type wchar_t aDbItemsetTbl[15];
// 140A90378: using guessed type wchar_t aItemset[8];
...
// 140C64250: using guessed type int dword_140C64250;
// 140C642D0: using guessed type int dword_140C642D0;
