...
//----- (0000000140154850) ----------------------------------------------------
void __fastcall sub_140154850(__int64 a1, int* a2, int* a3, _DWORD* a4, __int64* a5)
{
	int* v9; // rax
	__int64 v10; // rax
	__int64* v11; // r15
	...
	*a5 = v10;
	...
	if (v16)
		*v16 = 0;
	v17 = *v11;
	*(_QWORD*)sub_1400EDA60(a1 + 40, (__int64)v18) = v17;
	if (v14)
		sub_14018B900((__int64)v14, 0);
}
// 140C65670: using guessed type __int64 qword_140C65670;
// 140154850: using guessed type char var_48[8];
