...
__int64 sub_14022AC60()
{
	...
	if (qword_140C64F70)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Quest2Difficulty"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Quest2Difficulty.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022ACFC: variable 'v1' is possibly undefined
// 140A9E240: using guessed type wchar_t aQuest2difficul[17];
// 140A9E388: using guessed type wchar_t aDbQuest2diffic[24];
// 140AD4A30: using guessed type wchar_t *off_140AD4A30;
...
// 140C65050: using guessed type int dword_140C65050;
// 140C6544C: using guessed type int dword_140C6544C;
