...
__int64 sub_140206180()
{
	...
	if (qword_140C65528)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"HousingPlotType"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\HousingPlotType.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020621C: variable 'v1' is possibly undefined
// 140A8BC40: using guessed type wchar_t aHousingplottyp[16];
// 140A8BDF8: using guessed type wchar_t aDbHousingplott[23];
