...
//----- (00000001405EEAB0) ----------------------------------------------------
__int64 __fastcall sub_1405EEAB0(_QWORD* a1)
{
	_DWORD* v1; // rax
	__int64 v3; // rax
	__int64 v4; // rcx
		...
		&& *(_QWORD*)(v5 + 8))
	{
		...
		*((_QWORD*)&v22 + 1) = v7;
		...
		if (v7)
			*(_WORD*)v7 = 0;
		v9 = (int*)sub_14034BDD0(v8, *(_DWORD*)(*(_QWORD*)(v6 + 8) + 56i64));
...
// 1405EEBAC: variable 'v8' is possibly undefined
// 140A12138: using guessed type _DWORD dword_140A12138[4];
// 140B69230: using guessed type __int64 (__fastcall *off_140B69230[25])();
// 140C65898: using guessed type __int64 qword_140C65898;
// 140C65B70: using guessed type __int64 qword_140C65B70;
// 1405EEAB0: using guessed type char var_E0[184];
