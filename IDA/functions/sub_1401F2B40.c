...
__int64 sub_1401F2B40()
{
	...
	if (qword_140C64540)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"CityDirection"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\CityDirection.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F2BDC: variable 'v1' is possibly undefined
// 140A616B0: using guessed type wchar_t aCitydirection[14];
// 140A619D8: using guessed type wchar_t aDbCitydirectio[21];
// 140A7EC10: using guessed type wchar_t *off_140A7EC10;
...
// 140C64BBC: using guessed type int dword_140C64BBC;
// 140C64BDC: using guessed type int dword_140C64BDC;
