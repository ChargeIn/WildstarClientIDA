...
__int64 sub_140242260()
{
	...
	if (qword_140C65120)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TicketSubCategory"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\TicketSubCategory.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402422FC: variable 'v1' is possibly undefined
// 140A7F6B8: using guessed type wchar_t *off_140A7F6B8;
// 140AAB240: using guessed type wchar_t aTicketsubcateg[18];
// 140AAB460: using guessed type wchar_t aDbTicketsubcat[25];
