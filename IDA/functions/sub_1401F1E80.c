...
__int64 sub_1401F1E80()
{
	...
	if (qword_140C64728)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ChatChannel"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ChatChannel.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F1F1C: variable 'v1' is possibly undefined
// 140A61390: using guessed type wchar_t aDbChatchannelT[19];
// 140A613B8: using guessed type wchar_t aChatchannel[12];
// 140ACEB90: using guessed type wchar_t *off_140ACEB90;
...
// 140C65400: using guessed type int dword_140C65400;
// 140C65550: using guessed type int dword_140C65550;
