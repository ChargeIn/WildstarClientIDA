...
__int64 sub_140210BE0()
{
	...
	if (qword_140C64378)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"LocalizedEnum"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\LocalizedEnum.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140210C7C: variable 'v1' is possibly undefined
// 140A51E70: using guessed type wchar_t *off_140A51E70;
// 140A91708: using guessed type wchar_t aDbLocalizedenu[21];
// 140A91738: using guessed type wchar_t aLocalizedenum[14];
...
// 140C63FF4: using guessed type int dword_140C63FF4;
// 140C64378: using guessed type __int64 qword_140C64378;
// 140C64940: using guessed type int dword_140C64940;
