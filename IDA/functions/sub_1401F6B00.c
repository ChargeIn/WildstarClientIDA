...
__int64 sub_1401F6B00()
{
	...
	if (qword_140C63D10)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Creature2"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Creature2.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F6B9C: variable 'v1' is possibly undefined
// 140A61CA0: using guessed type wchar_t *off_140A61CA0;
// 140A7C5C8: using guessed type wchar_t aDbCreature2Tbl[17];
// 140A7C5F0: using guessed type wchar_t aCreature2[10];
