...
__int64 sub_140200840()
{
	...
	if (qword_140C64460)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"GenericMapNode"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\GenericMapNode.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402008DC: variable 'v1' is possibly undefined
// 140A89BF8: using guessed type wchar_t aGenericmapnode[15];
// 140A89DD8: using guessed type wchar_t aDbGenericmapno[22];
// 140AD1C30: using guessed type wchar_t *off_140AD1C30;
...
// 140C6510C: using guessed type int dword_140C6510C;
// 140C65510: using guessed type int dword_140C65510;
