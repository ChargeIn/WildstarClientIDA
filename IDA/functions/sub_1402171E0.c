...
__int64 sub_1402171E0()
{
	...
	if (qword_140C65548)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"MiniMapMarker"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\MiniMapMarker.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021727C: variable 'v1' is possibly undefined
// 140A88490: using guessed type wchar_t *off_140A88490;
// 140A93638: using guessed type wchar_t aMinimapmarker[14];
// 140A93760: using guessed type wchar_t aDbMinimapmarke[21];
...
// 140C64530: using guessed type int dword_140C64530;
// 140C647BC: using guessed type int dword_140C647BC;
