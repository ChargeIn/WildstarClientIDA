...
__int64 sub_140220F20()
{
	...
	if (qword_140C64A20)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathScientistSpecimenSurvey"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PathScientistSpecimenSurvey.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140220FBC: variable 'v1' is possibly undefined
// 140A7A580: using guessed type wchar_t *off_140A7A580;
// 140A97808: using guessed type wchar_t aPathscientists[28];
// 140A978B0: using guessed type wchar_t aDbPathscientis_4[35];
