//----- (00000001402CE2F0) ----------------------------------------------------
int* __fastcall sub_1402CE2F0(_QWORD* a1, unsigned int a2, unsigned int a3)
{
	__int64 v3; // rax
	int* result; // rax
	__int64 v8; // rcx
	...
	if ((*(unsigned int(__fastcall**)(_QWORD*, int*, __int64))(v3 + 64))(a1, v9, 5i64))
	{
		...
		if (!a3 || result != (int*)-1i64)
			return (int*)(*(__int64(__fastcall**)(_QWORD*, _QWORD, int*))(*a1 + 464i64))(a1, a2, result);
	}
	else
	{
		...
		if (result)
		{
			...
			*((_QWORD*)result + 4) = a1[62];
			...
			result[10] = a3;
			result[11] = a2;
			*(_QWORD*)result = off_140B62C40;
		}
	}
	return result;
}
// 140B62C40: using guessed type __int64 (__fastcall *off_140B62C40[13])();
// 140B62CA0: using guessed type __int64 (__fastcall *off_140B62CA0)();
// 1402CE2F0: using guessed type int var_18[6];
