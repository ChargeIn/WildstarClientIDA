...
//----- (000000014064E680) ----------------------------------------------------
__int64 __fastcall sub_14064E680(__int64 a1)
{
	float* v2; // rsi
	__int64 v4; // rbx
	__int64 v5; // rax
	...
	if (v2)
	{
		...
		*(_QWORD*)(a1 + 16) += 16i64;
		v6 = sub_1400578C0(a1);
		v7 = (*(double(__fastcall**)(float*, _QWORD))(*(_QWORD*)v2 + 168i64))(v2, 0i64);
...
// 14064E818: variable 'v16' is possibly undefined
// 14064E83E: variable 'v18' is possibly undefined
// 14064E850: variable 'v19' is possibly undefined
// 140B2C168: using guessed type wchar_t aNamount_26[8];
// 140B2C178: using guessed type wchar_t aEdrstate_19[9];
