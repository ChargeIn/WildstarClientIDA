...
//----- (0000000140513300) ----------------------------------------------------
__int64 __fastcall sub_140513300(__int64 a1)
{
	int* v2; // rax
	__int64 v3; // rbx
	int* v4; // rdi
	...
	*v4 = 10;
	sub_1400F0A10(a1, 1, (__int64)&unk_1409F1824, (float*)v4 + 4);
	sub_1400F0A10(a1, 1, (__int64)&unk_1409F1894, (float*)v4 + 5);
	sub_1400F0A10(a1, 1, (__int64)&unk_1409F187C, (float*)v4 + 6);
...
// 140513408: variable 'v6' is possibly undefined
