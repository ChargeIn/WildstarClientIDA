...
__int64 sub_14021CF60()
{
	...
	if (qword_140C64720)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathExplorerArea"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PathExplorerArea.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021CFFC: variable 'v1' is possibly undefined
// 140A94FD8: using guessed type wchar_t aDbPathexplorer_0[24];
// 140A95008: using guessed type wchar_t aPathexplorerar[17];
// 140AD37E8: using guessed type wchar_t *off_140AD37E8;
...
// 140C64754: using guessed type int dword_140C64754;
// 140C65148: using guessed type int dword_140C65148;
// 140C65314: using guessed type int dword_140C65314;
