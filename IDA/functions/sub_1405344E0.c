...
//----- (00000001405344E0) ----------------------------------------------------
__int64 __fastcall sub_1405344E0(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rdi
	...
	if (v3)
	{
		...
		*(_DWORD*)(v4 + 8) = v5[2];
		...
		if (v8 != v7)
		{
			do
			{
				sub_140772670(v8 + 48, (__int64)&v13, 1);
				v9 = *(_QWORD*)(v8 + 24);
				if (v9)
				{
					v8 = *(_QWORD*)(v8 + 24);
...
// 140534525: variable 'v2' is possibly undefined
// 140534611: variable 'v6' is possibly undefined
