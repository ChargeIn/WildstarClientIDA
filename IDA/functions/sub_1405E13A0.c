...
//----- (00000001405E13A0) ----------------------------------------------------
__int64 __fastcall sub_1405E13A0(__int64 a1, __int64 a2)
{
	int* v4; // rsi
	__int64 v5; // r15
	__int64 v6; // rbx
	...
	else
	{
		...
		if (v12)
		{
			...
			{
				v14 = *v13;
				sub_1405DC9A0((__int64)v14, *(int**)(a2 + 8));
				Apollo_LUAEvent(*(_QWORD*)(qword_140C65898 + 29504), "FriendshipAccountDataUpdate", byte_1409EACD4, *v14);
			}
		}
		return 0i64;
	}
