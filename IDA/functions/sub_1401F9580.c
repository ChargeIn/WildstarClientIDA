...
__int64 sub_1401F9580()
{
	...
	if (qword_140C64398)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Creature2OutfitGroupEntry"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\Creature2OutfitGroupEntry.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F961C: variable 'v1' is possibly undefined
// 140A805B8: using guessed type wchar_t aCreature2outfi_0[26];
// 140A808C0: using guessed type wchar_t aDbCreature2out_0[33];
// 140A84D88: using guessed type wchar_t *off_140A84D88;
...
// 140C63E20: using guessed type int dword_140C63E20;
// 140C64398: using guessed type __int64 qword_140C64398;
// 140C646CC: using guessed type int dword_140C646CC;
