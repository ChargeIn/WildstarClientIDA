...
//----- (0000000140082D90) ----------------------------------------------------
__int64 __fastcall sub_140082D90(__int64 a1, __int64 a2)
{
	__int64 v2; // r8
	...
	if (!v10)
		return sub_140336470(a1, v11, 0x20ui64);
	v12 = *(_QWORD*)(a1 + 16);
	if ((unsigned __int64)(8i64 * (*(_QWORD*)(v10 + 24) - *(_QWORD*)(v10 + 32)) - v12) < 0x40)
		return sub_140336470(a1, v11, 0x20ui64);
