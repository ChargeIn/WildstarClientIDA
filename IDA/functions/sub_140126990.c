...
//----- (0000000140126990) ----------------------------------------------------
void __fastcall sub_140126990(__int64 a1)
{
	int v1; // esi
	__int64 v3; // rcx
	__int64 v4; // rax
	...
	do
	{
		...
		{
			v6 += 8i64;
			*(_DWORD*)(v6 - 8) = v8 | v9 | (65280 - (*(_DWORD*)(a1 + 1048) << 8)) | 0xFF000000;
			v10 = v8 + 1;
			v8 += 2;
			*(_DWORD*)(v6 - 4) = v9 | v10 | (65280 - (*(_DWORD*)(a1 + 1048) << 8)) | 0xFF000000;
		} while (v8 < 256);
		++v5;
		v6 = v7 + v33;
	} while (v5 < 256);
	...
	do
	{
		...
		{
			v12 += 16i64;
			*(_DWORD*)(v12 - 24) = *(_DWORD*)(a1 + 1052) | v14 | (-65536 - (*(_DWORD*)(a1 + 1056) << 16)) | 0xFF000000;
			*(_DWORD*)(v12 - 20) = *(_DWORD*)(a1 + 1052) | v14 | (-65536 - (*(_DWORD*)(a1 + 1056) << 16)) | 0xFF000000;
			*(_DWORD*)(v12 - 16) = *(_DWORD*)(a1 + 1052) | v14 | (-65536 - (*(_DWORD*)(a1 + 1056) << 16)) | 0xFF000000;
			*(_DWORD*)(v12 - 12) = *(_DWORD*)(a1 + 1052) | v14 | (-65536 - (*(_DWORD*)(a1 + 1056) << 16)) | 0xFF000000;
			--v13;
		} while (v13);
		++v1;
		v11 += v33;
	...
	v18 = qword_140C63678;
	v19 = *(_DWORD*)(a1 + 1052) | (65280 - (*(_DWORD*)(a1 + 1048) << 8)) | (16711680 - (*(_DWORD*)(a1 + 1056) << 16)) | ((unsigned __int8)(int)v17 << 24);
	*(_DWORD*)(a1 + 1040) = v19;
	v32 = _mm_mul_ps(
		_mm_cvtepi32_ps(
			_mm_shuffle_epi32(
