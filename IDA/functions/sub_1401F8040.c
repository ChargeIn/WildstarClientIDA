...
__int64 sub_1401F8040()
{
	...
	if (qword_140C65420)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Creature2Affiliation"))
	{
...
// 1401F80DC: variable 'v1' is possibly undefined
// 140A5BB88: using guessed type wchar_t *off_140A5BB88;
// 140A7E4A8: using guessed type wchar_t aDbCreature2aff[28];
// 140A7E4E0: using guessed type wchar_t aCreature2affil[21];
...
// 140C645AC: using guessed type int dword_140C645AC;
// 140C65230: using guessed type int dword_140C65230;
