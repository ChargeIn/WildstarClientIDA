...
__int64 sub_1402043C0()
{
	...
	if (qword_140C63998)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"HousingDecorType"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\HousingDecorType.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020445C: variable 'v1' is possibly undefined
// 140A7AAB0: using guessed type wchar_t *off_140A7AAB0;
// 140A8B148: using guessed type wchar_t aHousingdecorty[17];
// 140A8B1E8: using guessed type wchar_t aDbHousingdecor_1[24];
...
// 140C63EE4: using guessed type int dword_140C63EE4;
// 140C64960: using guessed type int dword_140C64960;
