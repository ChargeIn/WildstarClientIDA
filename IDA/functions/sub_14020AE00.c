...
__int64 sub_14020AE00()
{
	...
	if (qword_140C65168)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ItemImbuement"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ItemImbuement.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020AE9C: variable 'v1' is possibly undefined
// 140A7EA48: using guessed type wchar_t *off_140A7EA48;
// 140A8F058: using guessed type wchar_t aItemimbuement[14];
// 140A8F290: using guessed type wchar_t aDbItemimbuemen[21];
...
// 140C64870: using guessed type int dword_140C64870;
// 140C65144: using guessed type int dword_140C65144;
