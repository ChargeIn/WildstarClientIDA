...
__int64 sub_14023AB60()
{
	...
	if (qword_140C64D78)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4SpellTypes"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4SpellTypes.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023ABFC: variable 'v1' is possibly undefined
// 140A748E8: using guessed type wchar_t *off_140A748E8;
// 140AA8190: using guessed type wchar_t aSpell4spelltyp[17];
// 140AA82F8: using guessed type wchar_t aDbSpell4spellt[24];
...
// 140C63E78: using guessed type int dword_140C63E78;
// 140C648A4: using guessed type int dword_140C648A4;
