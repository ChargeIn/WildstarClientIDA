...
__int64 sub_140247760()
{
	...
	if (qword_140C64930)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"UnitProperty2"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\UnitProperty2.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402477FC: variable 'v1' is possibly undefined
// 140AADC80: using guessed type wchar_t aDbUnitproperty[21];
// 140AADD40: using guessed type wchar_t aUnitproperty2[14];
// 140AD91D8: using guessed type wchar_t *off_140AD91D8;
...
// 140C644BC: using guessed type int dword_140C644BC;
// 140C64930: using guessed type __int64 qword_140C64930;
// 140C65048: using guessed type int dword_140C65048;
