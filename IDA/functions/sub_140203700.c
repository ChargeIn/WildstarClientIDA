...
__int64 sub_140203700()
{
	...
	if (qword_140C64A10)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"HookType"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\HookType.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020379C: variable 'v1' is possibly undefined
// 140A62168: using guessed type wchar_t *off_140A62168;
// 140A8AC78: using guessed type wchar_t aHooktype[9];
// 140A8ADD8: using guessed type wchar_t aDbHooktypeTbl[16];
