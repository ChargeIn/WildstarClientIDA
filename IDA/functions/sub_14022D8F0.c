//----- (000000014022D8F0) ----------------------------------------------------
__int64 sub_14022D8F0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6C970, qword_140C63858);
	if (dword_140C65234 || (int)sub_14022D6E0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64A50 + 40i64))(qword_140C64A50);
}
