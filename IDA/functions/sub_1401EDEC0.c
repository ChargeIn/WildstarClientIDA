...
__int64 sub_1401EDEC0()
{
	...
	if (qword_140C63A08)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"BugCategory"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\BugCategory.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401EDF5C: variable 'v1' is possibly undefined
// 140A5C620: using guessed type wchar_t aDbBugcategoryT[19];
// 140A5C680: using guessed type wchar_t aBugcategory[12];
// 140ACD938: using guessed type wchar_t *off_140ACD938;
...
// 140C651DC: using guessed type int dword_140C651DC;
// 140C65508: using guessed type int dword_140C65508;
