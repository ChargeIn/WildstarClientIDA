...
//----- (0000000140145490) ----------------------------------------------------
__int64 __fastcall sub_140145490(__int64 a1, int a2)
{
	_DWORD* v3; // rax
	int v4; // r10d
	int v5; // ecx
	...
	*(_QWORD*)(a1 + 16) += 16i64;
	v11 = *(_QWORD*)(a1 + 32);
	v12 = sub_140062650(a1, (unsigned __int64*)"Vector2", 7ui64);
	v13 = *(_QWORD*)(a1 + 16);
	v19 = v12;
	v20 = 4;
...
// 1401454CD: variable 'v4' is possibly undefined
// 140145595: variable 'v15' is possibly undefined
