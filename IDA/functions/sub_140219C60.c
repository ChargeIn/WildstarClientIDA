...
__int64 sub_140219C60()
{
	...
	if (qword_140C64788)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ModelMesh"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ModelMesh.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140219CFC: variable 'v1' is possibly undefined
// 140A634B0: using guessed type wchar_t *off_140A634B0;
// 140A93EB8: using guessed type wchar_t aModelmesh[10];
// 140A94058: using guessed type wchar_t aDbModelmeshTbl[17];
...
// 140C64C48: using guessed type int dword_140C64C48;
// 140C654D4: using guessed type int dword_140C654D4;
