//----- (00000001400AE910) ----------------------------------------------------
__int64 __fastcall sub_1400AE910(__int64 a1, unsigned int* a2)
{
	__int64 v2; // r8
	...
	result = sub_1400A8A90(a1, (unsigned __int16*)a2 + 2);
	if ((int)result >= 0)
	{
		result = sub_14006BD80(a1, *((float*)a2 + 2));
		if ((int)result >= 0)
		{
			result = sub_1400A73C0(a1, a2[3]);
			if ((int)result >= 0)
			{
				result = sub_1400A7110(a1, a2[4], 0x20ui64);
				if ((int)result >= 0)
				{
					result = sub_1400A7250(a1, a2[5] != 0, 1ui64);
					if ((int)result >= 0)
						return sub_1400A7250(a1, a2[6] != 0, 1ui64);
				}
			}
		}
	}
