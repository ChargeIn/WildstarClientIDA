...
//----- (00000001400ADD60) ----------------------------------------------------
__int64 __fastcall sub_1400ADD60(__int64 a1, unsigned int* a2)
{
	__int64 v2; // r8
	...
	if ((int)result >= 0)
	{
		...
		if ((int)result >= 0)
		{
			result = sub_1400A8B30(a1, (unsigned __int16*)a2 + 6);
			if ((int)result >= 0)
			{
				result = sub_1400A73C0(a1, a2[5]);
				if ((int)result >= 0)
				{
					result = sub_1400A7110(a1, a2[6], 0x20ui64);
					if ((int)result >= 0)
					{
						result = sub_1400A7250(a1, a2[7] != 0, 1ui64);
						if ((int)result >= 0)
						{
							result = sub_1400A7250(a1, a2[8] != 0, 1ui64);
							if ((int)result >= 0)
								return sub_1400A7250(a1, a2[9] != 0, 1ui64);
						}
					}
				}
			}
