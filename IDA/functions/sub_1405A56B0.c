...
//----- (00000001405A56B0) ----------------------------------------------------
__int64 __fastcall sub_1405A56B0(__int64 a1, __int64 a2)
{
	_DWORD* v4; // rsi
	unsigned int v5; // ecx
	int v6; // edi
...
// 1405A5779: variable 'v7' is possibly undefined
// 1409D135B: using guessed type _BYTE byte_1409D135B[3];
// 140C3FE68: using guessed type __int64 qword_140C3FE68;
// 140C3FE70: using guessed type __int64 qword_140C3FE70;
// 140C65B70: using guessed type __int64 qword_140C65B70;
// 140DC3490: using guessed type int dword_140DC3490;
// 140DC3494: using guessed type int dword_140DC3494;
