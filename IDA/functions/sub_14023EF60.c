...
__int64 sub_14023EF60()
{
	...
	if (qword_140C63B18)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spline2Node"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spline2Node.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023EFFC: variable 'v1' is possibly undefined
// 140AAA148: using guessed type wchar_t aSpline2node[12];
// 140AAA2C8: using guessed type wchar_t aDbSpline2nodeT[19];
// 140ADD430: using guessed type wchar_t *off_140ADD430;
...
// 140C644CC: using guessed type int dword_140C644CC;
// 140C647B4: using guessed type int dword_140C647B4;
// 140C650E8: using guessed type int dword_140C650E8;
