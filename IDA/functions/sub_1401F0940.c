...
__int64 sub_1401F0940()
{
	...
	if (qword_140C63FD8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"CharacterCustomizationLabel"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\CharacterCustomizationLabel.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F09DC: variable 'v1' is possibly undefined
// 140A52090: using guessed type wchar_t *off_140A52090;
// 140A5EE88: using guessed type wchar_t aCharactercusto_0[28];
// 140A5EF20: using guessed type wchar_t aDbCharactercus_0[35];
...
// 140C648A8: using guessed type int dword_140C648A8;
// 140C64A7C: using guessed type int dword_140C64A7C;
