...
__int64 sub_140212DE0()
{
	...
	if (qword_140C64888)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"MapZoneHexGroup"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\MapZoneHexGroup.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140212E7C: variable 'v1' is possibly undefined
// 140A5ED48: using guessed type wchar_t *off_140A5ED48;
// 140A921B8: using guessed type wchar_t aDbMapzonehexgr[23];
// 140A921E8: using guessed type wchar_t aMapzonehexgrou[16];
...
// 140C63E14: using guessed type int dword_140C63E14;
// 140C6423C: using guessed type int dword_140C6423C;
