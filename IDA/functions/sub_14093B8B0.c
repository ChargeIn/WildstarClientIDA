...
__int64 sub_14093B8B0()
{
	...
	v0 = (__m128)(unsigned int)xmmword_140C79DC0;
	v1 = (__m128)DWORD2(xmmword_140C79DC0);
	v1.m128_f32[0] = (float)((float)(*((float*)&xmmword_140C79DC0 + 2) + *(float*)&dword_140C3B738)
		* (float)(1.0 / *(float*)&dword_140C66F48))
		+ 1.0;
	v0.m128_f32[0] = (float)((float)(*(float*)&xmmword_140C79DC0 + *(float*)&dword_140C3B738)
	...
	v15 = (__m128)(unsigned int)xmmword_140C79DB0;
	v16 = (int)v3.m128_f32[0];
	v17 = (__m128)DWORD2(xmmword_140C79DB0);
	v18 = v16 + 2;
	v17.m128_f32[0] = (float)((float)(*((float*)&xmmword_140C79DB0 + 2) + *(float*)&dword_140C3B738)
		* (float)(1.0 / *(float*)&dword_140C66F48))
		+ 1.0;
	v15.m128_f32[0] = (float)((float)(*(float*)&xmmword_140C79DB0 + *(float*)&dword_140C3B738)
		* (float)(1.0 / *(float*)&dword_140C66F1C))
		+ 0.5;
	...
	dword_140C79D98 = v14 + 2;
	result = (unsigned int)((int)v20.m128_f32[0] - 1);
	dword_140C79D90 = (int)(float)(v29 + v22.m128_f32[0]) - 1;
	dword_140C79D9C = v18;
	dword_140C79D94 = (int)v20.m128_f32[0] - 1;
	return result;
}
...
// 140C79D90: using guessed type int dword_140C79D90;
// 140C79D94: using guessed type int dword_140C79D94;
// 140C79D98: using guessed type int dword_140C79D98;
// 140C79D9C: using guessed type int dword_140C79D9C;
