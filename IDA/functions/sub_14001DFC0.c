//----- (000000014001DFC0) ----------------------------------------------------
int* __fastcall sub_14001DFC0(__int64 a1, unsigned int* a2)
{
	__int64 v2; // r9
	__int64 v5; // rax
	int* v6; // rbx
	...
	if (v6 == (int*)v2 || *a2 < v6[8])
	{
		...
		*((_QWORD*)v8 + 1) = v8;
		...
		v18 = v8;
		v19 = v9;
		sub_14001FDD0(v9, &v19, v10, v7);
		v19 = (__int64)v6;
		sub_14001EAF0(a1, &v20, &v19, v17);
		v11 = v18;
		v6 = v20;
		v12 = *(int**)v18;
		while (v12 != v11)
...
// 14001DFC0: using guessed type unsigned int var_38[4];
