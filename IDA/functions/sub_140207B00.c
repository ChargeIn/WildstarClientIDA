...
__int64 sub_140207B00()
{
	...
	if (qword_140C63E68)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"HousingWallpaperInfo"))
	{
...
// 140207B9C: variable 'v1' is possibly undefined
// 140A8D320: using guessed type wchar_t aHousingwallpap[21];
// 140A8D510: using guessed type wchar_t aDbHousingwallp[28];
// 140AD1C68: using guessed type wchar_t *off_140AD1C68;
...
// 140C6403C: using guessed type int dword_140C6403C;
// 140C64850: using guessed type int dword_140C64850;
