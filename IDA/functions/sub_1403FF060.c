...
//----- (00000001403FF060) ----------------------------------------------------
__int64 __fastcall sub_1403FF060(__int64 a1, __int64 a2, __int64 a3)
{
	__int64 v4; // rcx
	__int64 v6; // rdi
	bool v8; // al
	...
	if (v8)
	{
		if (v9 == *(_QWORD*)(v4 + 16))
		{
			*(_QWORD*)a2 = *sub_1403FEF80(a1, &v23, v6, v9, a3);
			*(_BYTE*)(a2 + 8) = 1;
			return a2;
		}
...
// 1403FF18E: conditional instruction was optimized away because rdi.8==0
// 1403FF1AA: variable 'v17' is possibly undefined
