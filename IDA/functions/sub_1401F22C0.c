...
__int64 sub_1401F22C0()
{
	...
	if (qword_140C63FE8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Cinematic"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Cinematic.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F235C: variable 'v1' is possibly undefined
// 140A61490: using guessed type wchar_t aDbCinematicTbl[17];
// 140A614B8: using guessed type wchar_t aCinematic[10];
// 140ACDE48: using guessed type wchar_t *off_140ACDE48;
...
// 140C644C0: using guessed type int dword_140C644C0;
// 140C64E40: using guessed type int dword_140C64E40;
