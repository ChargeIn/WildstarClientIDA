...
//----- (0000000140813E90) ----------------------------------------------------
__int64 __fastcall sub_140813E90(__int64 a1)
{
	...
	if (v5 && v5 != -14)
		return v5;
	if (v5 == -14)
		qword_140C60ED8 = 0i64;
	if (qword_140C60ED8 && dword_140C60EE0 != dword_140C60980[v6])
		qword_140C60ED8 = 0i64;
	if (!qword_140C60ED8 && v3 && nvapi_QueryInterface)
	{
		qword_140C60ED8 = nvapi_QueryInterface(2870358167i64);
		dword_140C60EE0 = dword_140C60980[v6];
	}
	if (qword_140C60ED8)
	{
		v2 = (__int64(__fastcall*)(__int64))qword_140C60ED8;
		v4 = 0i64;
		if (qword_140C60938)
			qword_140C60938(2870358167i64, &v4);
		v5 = v2(a1);
		if (qword_140C60940)
			qword_140C60940(2870358167i64, v4, v5);
		--dword_140C60970[v6];
		return v5;
	}
	else
...
// 140C60ED8: using guessed type __int64 qword_140C60ED8;
// 140C60EE0: using guessed type int dword_140C60EE0;
