...
__int64 sub_140218FA0()
{
	...
	if (qword_140C64EA0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ModelCluster"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ModelCluster.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021903C: variable 'v1' is possibly undefined
// 140A93C28: using guessed type wchar_t aDbModelcluster[20];
// 140A93CB8: using guessed type wchar_t aModelcluster[13];
// 140ACD620: using guessed type wchar_t *off_140ACD620;
