...
//----- (00000001402821A0) ----------------------------------------------------
int __fastcall sub_1402821A0(__int64 a1)
{
...
LABEL_8:
	for (i = *(_QWORD*)(a1 + 6856); i; i = *(_QWORD*)(i + 296))
	{
	...
	for (j = *(_QWORD*)(a1 + 6864); j; j = *(_QWORD*)(j + 288))
	{
	...
	for (k = *(_QWORD*)(a1 + 6872); k; k = *(_QWORD*)(k + 576))
	{
...
// 140282227: variable 'v3' is possibly undefined
// 140282227: variable 'v4' is possibly undefined
