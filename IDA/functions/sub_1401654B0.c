//----- (00000001401654B0) ----------------------------------------------------
int* __fastcall sub_1401654B0(__int64 a1)
{
	_QWORD* v1; // rdi
	__int64 v3; // rsi
	int v4; // r8d
	...
	v9 = 0;
	v10 = &v46[v8 / 8];
	v11 = (char*)&(&off_140C57CC0)[v8 / 0xFFFFFFFFFFFFFFF8ui64] - (char*)v46;
	do
	{
	...
	} while ((unsigned __int64)v9 < 0x28);
	sub_1400569B0((__int64)v1, (unsigned __int64*)"Apollo.GridWindow");
	v13 = v1[2];
	switch (*(_DWORD*)(v13 - 8))
	{
	case 2:
...
// 140C57CC0: using guessed type char *off_140C57CC0;
