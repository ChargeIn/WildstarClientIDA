...
__int64 sub_140226420()
{
	...
	if (qword_140C64AD8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PrimalMatrixNode"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PrimalMatrixNode.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402264BC: variable 'v1' is possibly undefined
// 140A6F0A8: using guessed type wchar_t *off_140A6F0A8;
// 140A9AAD8: using guessed type wchar_t aPrimalmatrixno[17];
// 140A9AD68: using guessed type wchar_t aDbPrimalmatrix_0[24];
