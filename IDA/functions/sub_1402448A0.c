...
__int64 sub_1402448A0()
{
	...
	if (qword_140C646E0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TradeskillHarvestingInfo"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\TradeskillHarvestingInfo.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024493C: variable 'v1' is possibly undefined
// 140AAC638: using guessed type wchar_t aTradeskillharv[25];
// 140AAC820: using guessed type wchar_t aDbTradeskillha[32];
// 140AD37B0: using guessed type wchar_t *off_140AD37B0;
...
// 140C63880: using guessed type int dword_140C63880;
// 140C63970: using guessed type __int64 qword_140C63970;
// 140C646AC: using guessed type int dword_140C646AC;
