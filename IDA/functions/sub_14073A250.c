//----- (000000014073A250) ----------------------------------------------------
__int64 __fastcall sub_14073A250(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Game.MatchMakingEntry");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6;
	sub_140057020(a1, "MatchMakingEntry", &off_140B74C70);
	return 1i64;
}
// 14073A363: variable 'v14' is possibly undefined
// 140B74C70: using guessed type void *off_140B74C70;
// 140C5EEC0: using guessed type char *off_140C5EEC0;
