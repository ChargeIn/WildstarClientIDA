...
__int64 sub_140227960()
{
	...
	if (qword_140C64518)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PublicEventDepot"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PublicEventDepot.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402279FC: variable 'v1' is possibly undefined
// 140A5C9E0: using guessed type wchar_t *off_140A5C9E0;
// 140A9B358: using guessed type wchar_t aDbPubliceventd[24];
// 140A9B400: using guessed type wchar_t aPubliceventdep[17];
...
// 140C63A60: using guessed type int dword_140C63A60;
// 140C6416C: using guessed type int dword_140C6416C;
