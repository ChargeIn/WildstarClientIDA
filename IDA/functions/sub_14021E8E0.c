...
__int64 sub_14021E8E0()
{
	...
	if (qword_140C64418)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathExplorerScavengerHunt"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PathExplorerScavengerHunt.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021E97C: variable 'v1' is possibly undefined
// 140A95B38: using guessed type wchar_t aPathexplorersc_0[26];
// 140A95B70: using guessed type wchar_t aDbPathexplorer_6[33];
// 140ACD6C8: using guessed type wchar_t *off_140ACD6C8;
...
// 140C63A34: using guessed type int dword_140C63A34;
// 140C63F78: using guessed type int dword_140C63F78;
// 140C642E4: using guessed type int dword_140C642E4;
