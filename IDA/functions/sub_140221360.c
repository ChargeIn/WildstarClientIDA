...
__int64 sub_140221360()
{
	...
	if (qword_140C640A0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathScientistScanBotProfile"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PathScientistScanBotProfile.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402213FC: variable 'v1' is possibly undefined
// 140A97BE8: using guessed type wchar_t aPathscientists_0[28];
// 140A97D00: using guessed type wchar_t aDbPathscientis_5[35];
// 140ADA758: using guessed type wchar_t *off_140ADA758;
...
// 140C64AE4: using guessed type int dword_140C64AE4;
// 140C64CFC: using guessed type int dword_140C64CFC;
