...
__int64 sub_140239A60()
{
	...
	if (qword_140C64D98)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4Prerequisites"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4Prerequisites.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140239AFC: variable 'v1' is possibly undefined
// 140AA7C60: using guessed type wchar_t aSpell4prerequi[20];
// 140AA7DD0: using guessed type wchar_t aDbSpell4prereq[27];
// 140AD5770: using guessed type wchar_t *off_140AD5770;
...
// 140C63EC8: using guessed type int dword_140C63EC8;
// 140C64438: using guessed type int dword_140C64438;
