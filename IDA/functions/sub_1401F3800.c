...
__int64 sub_1401F3800()
{
	...
	if (qword_140C64CF0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ClientEvent"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ClientEvent.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F389C: variable 'v1' is possibly undefined
// 140A635E8: using guessed type wchar_t aClientevent[12];
// 140A63A98: using guessed type wchar_t aDbClienteventT[19];
// 140A79450: using guessed type wchar_t *off_140A79450;
...
// 140C64938: using guessed type int dword_140C64938;
// 140C64C90: using guessed type int dword_140C64C90;
