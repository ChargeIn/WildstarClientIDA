...
__int64 sub_1401EA340()
{
	...
	if (qword_140C63A90)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"AchievementChecklist"))
	{
...
// 1401EA3DC: variable 'v1' is possibly undefined
// 140A4C6E8: using guessed type wchar_t aAchievementche[21];
// 140A4C948: using guessed type wchar_t aDbAchievementc_0[28];
// 140A74958: using guessed type wchar_t *off_140A74958;
...
// 140C63CBC: using guessed type int dword_140C63CBC;
// 140C64AA8: using guessed type int dword_140C64AA8;
// 140C64D58: using guessed type int dword_140C64D58;
