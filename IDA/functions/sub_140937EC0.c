...
__int64 sub_140937EC0()
{
	...
	v0 = (__m128)(unsigned int)xmmword_140C66F30;
	v1 = (__m128)DWORD2(xmmword_140C66F30);
	v1.m128_f32[0] = (float)((float)(*((float*)&xmmword_140C66F30 + 2) + *(float*)&dword_140C3B738)
		* (float)(1.0 / *(float*)&dword_140C66F48))
		+ 1.0;
	v0.m128_f32[0] = (float)((float)(*(float*)&xmmword_140C66F30 + *(float*)&dword_140C3B738)
	...
	v15 = (__m128)(unsigned int)xmmword_140C66F20;
	v16 = (int)v3.m128_f32[0];
	v17 = (__m128)DWORD2(xmmword_140C66F20);
	v18 = v16 + 2;
	v17.m128_f32[0] = (float)((float)(*((float*)&xmmword_140C66F20 + 2) + *(float*)&dword_140C3B738)
		* (float)(1.0 / *(float*)&dword_140C66F48))
		+ 1.0;
	v15.m128_f32[0] = (float)((float)(*(float*)&xmmword_140C66F20 + *(float*)&dword_140C3B738)
		* (float)(1.0 / *(float*)&dword_140C66F1C))
		+ 0.5;
	...
	dword_140C66F10 = v14 + 2;
	result = (unsigned int)((int)v20.m128_f32[0] - 1);
	dword_140C66F08 = (int)(float)(v29 + v22.m128_f32[0]) - 1;
	dword_140C66F14 = v18;
	dword_140C66F0C = (int)v20.m128_f32[0] - 1;
	return result;
}
// 140C3B738: using guessed type int dword_140C3B738;
// 140C66F08: using guessed type int dword_140C66F08;
// 140C66F0C: using guessed type int dword_140C66F0C;
// 140C66F10: using guessed type int dword_140C66F10;
// 140C66F14: using guessed type int dword_140C66F14;
