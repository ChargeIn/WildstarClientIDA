//----- (00000001401F57D0) ----------------------------------------------------
__int64 sub_1401F57D0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A69B48, qword_140C63858);
	if (dword_140C64080 || (int)sub_1401F55C0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C65300 + 40i64))(qword_140C65300);
}
