...
//----- (0000000140212FF0) ----------------------------------------------------
__int64 sub_140212FF0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6B390, qword_140C63858);
	if (dword_140C63A98 || (int)sub_140212DE0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64888 + 40i64))(qword_140C64888);
}
