...
//----- (0000000140428500) ----------------------------------------------------
void __fastcall sub_140428500(__int64 a1, unsigned __int16* a2, unsigned int a3, int a4)
{
	__int64 v8; // rdx
	__int64 v9; // rcx
	__int64 v10; // rax
	...
	*(_DWORD*)(v22 + 8) = *((_DWORD*)v21 + 2);
	v12[2] += 16i64;
	v23 = (unsigned __int64*)sub_14018F0E0(&v38, L"bNeed")[1];
	if (v23)
	{
		v24 = -1i64;
		do
			++v24;
		while (*((_BYTE*)v23 + v24));
		sub_140058710((__int64)v12, v23, v24);
	}
	else
	{
		*(_DWORD*)(v12[2] + 8i64) = 0;
	...
	*v25 = a4 != 0;
	v12[2] += 16i64;
	v26 = (__int64*)sub_1400580E0((__int64)v12, -3);
	sub_14005EA50((__int64)v12, v26, (int*)(v12[2] - 32i64), (unsigned int*)(v12[2] - 16i64));
	v12[2] -= 48i64;
	v27 = sub_14005C3C0(*(_QWORD*)(v12[4] + 160i64), v17);
	*(_QWORD*)v28 = *v27;
	*(_DWORD*)(v28 + 8) = *((_DWORD*)v27 + 2);
	v12[2] += 16i64;
	sub_1400F0870((__int64)v12, v29, L"strPlayer", a2);
	v12[2] -= 16i64;
	...
	if (v31)
		sub_14018B900(v31, 0);
	Apollo_LUAEvent(a1, "LootRollSelected", byte_1409EAD3C, v17, v33, v34, v35, v36, v37);
...
// 140428677: variable 'v22' is possibly undefined
// 140428739: variable 'v28' is possibly undefined
// 14042874B: variable 'v29' is possibly undefined
// 1404287D6: variable 'v32' is possibly undefined
// 1409EAD3C: using guessed type _BYTE byte_1409EAD3C[24];
// 140B00B20: using guessed type wchar_t aStrplayer[10];
// 140B00B38: using guessed type wchar_t aBneed[6];
// 140B00B48: using guessed type wchar_t aNlootid_0[8];
// 140B569F0: using guessed type __int64 (__fastcall *off_140B569F0[6])();
// 140C65898: using guessed type __int64 qword_140C65898;
// 140428500: using guessed type char var_9C0[1224];
