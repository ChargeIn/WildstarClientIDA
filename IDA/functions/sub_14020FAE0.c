...
__int64 sub_14020FAE0()
{
	...
	if (qword_140C63C10)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"LiveEvent"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\LiveEvent.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020FB7C: variable 'v1' is possibly undefined
// 140A80308: using guessed type wchar_t *off_140A80308;
// 140A912C8: using guessed type wchar_t aDbLiveeventTbl[17];
// 140A91378: using guessed type wchar_t aLiveevent[10];
