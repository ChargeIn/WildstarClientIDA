//----- (00000001408202F0) ----------------------------------------------------
__int64 __fastcall sub_1408202F0(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
	...
	if (v8 && v8 != -14)
		return v8;
	if (v8 == -14)
		qword_140C61698 = 0i64;
	if (qword_140C61698 && dword_140C616A0 != dword_140C60980[v9])
		qword_140C61698 = 0i64;
	if (!qword_140C61698 && v6 && nvapi_QueryInterface)
	{
		qword_140C61698 = nvapi_QueryInterface(465705830i64);
		dword_140C616A0 = dword_140C60980[v9];
	}
	if (qword_140C61698)
	{
		v5 = (__int64(__fastcall*)(__int64, __int64, __int64, _QWORD, _QWORD))qword_140C61698;
		v7 = 0i64;
		if (qword_140C60938)
			qword_140C60938(465705830i64, &v7);
		v8 = v5(a1, a2, a3, a4, v5);
		if (qword_140C60940)
			qword_140C60940(465705830i64, v7, v8);
		--dword_140C60970[v9];
		return v8;
	}
	else
...
// 140C61698: using guessed type __int64 qword_140C61698;
// 140C616A0: using guessed type int dword_140C616A0;
