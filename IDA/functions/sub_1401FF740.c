...
__int64 sub_1401FF740()
{
	...
	if (qword_140C64A58)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"FinishingMoveDeathVisual"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\FinishingMoveDeathVisual.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401FF7DC: variable 'v1' is possibly undefined
// 140A64138: using guessed type wchar_t *off_140A64138;
// 140A89598: using guessed type wchar_t aFinishingmoved[25];
// 140A89720: using guessed type wchar_t aDbFinishingmov[32];
