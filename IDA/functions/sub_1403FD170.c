...
//----- (00000001403FD170) ----------------------------------------------------
unsigned __int64 __fastcall sub_1403FD170(unsigned int a1, _DWORD* a2, __int64 a3)
{
	...
	while (1)
	{
		...
		if (!v18)
			goto LABEL_33;
		result = (unsigned int)(a2[3] - v18[3]);
		if ((_DWORD)result || (result = (unsigned int)(a2[4] - v18[4]), (_DWORD)result))
		{
	...
	while (2)
	{
		...
		if (*v15)
		{
			...
			if ((_DWORD)result == v20[3])
			{
				...
				if ((_DWORD)result == v20[4])
				{
					v21 = a2[5];
					result = (unsigned int)v20[5];
		...
		do
		{
			if (a2)
			{
				...
				if ((_DWORD)result != v22[3])
					break;
				result = (unsigned int)a2[4];
				if ((_DWORD)result != v22[4])
					break;
				v23 = a2[5];
				result = (unsigned int)v22[5];
...
// 1403FD2AC: conditional instruction was optimized away because eax.4>=1
