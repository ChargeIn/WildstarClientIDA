...
__int64 sub_1401F11C0()
{
	...
	if (qword_140C64FD0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"CharacterCreationArmorSet"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\CharacterCreationArmorSet.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F125C: variable 'v1' is possibly undefined
// 140A607C0: using guessed type wchar_t aCharactercreat_5[26];
// 140A60980: using guessed type wchar_t aDbCharactercre_1[33];
// 140AD55D8: using guessed type wchar_t *off_140AD55D8;
...
// 140C647E4: using guessed type int dword_140C647E4;
// 140C648F8: using guessed type int dword_140C648F8;
