//----- (00000001405E3C10) ----------------------------------------------------
void __fastcall sub_1405E3C10(__int64 a1)
{
	int* v2; // rax
	int* v3; // rax
	int* v4; // rdi
	...
	if (v10)
	{
		v11 = v10;
		v12 = 0i64;
		sub_1400161D0(qword_140C635F0, 0x3A1u, (__int64)&v11);
	}
	if (v20)
...
// 140B22ED0: using guessed type wchar_t asc_140B22ED0[5];
