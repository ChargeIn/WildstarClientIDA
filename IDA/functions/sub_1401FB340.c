...
__int64 sub_1401FB340()
{
	...
	if (qword_140C651B8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PeriodicQuestSet"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PeriodicQuestSet.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401FB3DC: variable 'v1' is possibly undefined
// 140A841B8: using guessed type wchar_t aPeriodicquests_0[17];
// 140A84590: using guessed type wchar_t aDbPeriodicques_0[24];
// 140AD70A8: using guessed type wchar_t *off_140AD70A8;
