...
//----- (00000001402E64F0) ----------------------------------------------------
__int64 __fastcall sub_1402E64F0(__int64* a1, int** a2)
{
	__int64 v5; // rax
	int* v6; // rax
	int* v7; // rbx
	...
	*((_QWORD*)v7 + 2) = v11;
	if (!*((_QWORD*)v7 + 1) || v11)
	{
		if (a1[60])
		{
			...
			do
			{
				*(_QWORD*)(*((_QWORD*)v7 + 2) + 8 * v12) = *(_QWORD*)(a1[61] + 8 * v12);
				v13 = *(void(__fastcall****)(_QWORD))(a1[61] + 8 * v12);
				(**v13)(v13);
				v12 = ++v8;
			} while (v8 < (unsigned __int64)a1[60]);
		}
		*a2 = v7;
		return 0i64;
	}
...
// 1402E64F0: using guessed type int var_18[6];
