...
//----- (000000014074A9F0) ----------------------------------------------------
void __fastcall sub_14074A9F0(__int64 a1)
{
	int* v2; // rax
	int v3; // ebp
	__int64* v4; // rbx
				...
				if (v9 > 0)
				{
					...
					do
					{
						...
						sub_1401589F0(
							(__int64)&v32[16 * v14],
							(__int64)v30,
							(unsigned __int8(__fastcall*)(__int64*, __int64))sub_14074A230);
						++v15;
						*v16 = (__int64)v5;
						v16 += 2;
						++v14;
...
// 14074A9F0: using guessed type char var_438[8];
// 14074A9F0: using guessed type char var_448[8];
