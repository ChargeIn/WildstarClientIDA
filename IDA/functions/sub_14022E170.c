...
//----- (000000014022E170) ----------------------------------------------------
__int64 sub_14022E170()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6C9E0, qword_140C63858);
	if (dword_140C63CDC || (int)sub_14022DF60() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64D00 + 40i64))(qword_140C64D00);
}
