//----- (0000000140295010) ----------------------------------------------------
__int64 __fastcall sub_140295010(__int64* a1, const __m128i* a2)
{
	int v4; // ebx
	__int64 v6; // rax
	__int64 v7; // rdx
	...
	if (*((_DWORD*)a1 + 13) == 1)
	{
		...
		*((_QWORD*)&v13 + 1) = TlsGetValue(dwTlsIndex);
		...
		v16 = 0x141DE4D10i64;
		v15 = v13;
		v4 = sub_1401971E0(&dword_140C8A424, 14, &v16, &v14);
		TlsValue = &off_140B5E648;
...
// 140C8A424: using guessed type _DWORD dword_140C8A424;
