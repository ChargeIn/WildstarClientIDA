...
__int64 sub_140232360()
{
	...
	if (qword_140C63B00)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"SoundBank"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\SoundBank.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402323FC: variable 'v1' is possibly undefined
// 140A74000: using guessed type wchar_t *off_140A74000;
// 140AA2B60: using guessed type wchar_t aSoundbank[10];
// 140AA2D10: using guessed type wchar_t aDbSoundbankTbl[17];
...
// 140C63D98: using guessed type int dword_140C63D98;
// 140C640C8: using guessed type int dword_140C640C8;
// 140C65128: using guessed type int dword_140C65128;
