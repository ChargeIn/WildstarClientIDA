...
__int64 sub_140205D40()
{
	...
	if (qword_140C63C30)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"HousingPlotInfo"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\HousingPlotInfo.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140205DDC: variable 'v1' is possibly undefined
// 140A8BB40: using guessed type wchar_t aHousingplotinf[16];
// 140A8BC80: using guessed type wchar_t aDbHousingploti[23];
// 140AD6F20: using guessed type wchar_t *off_140AD6F20;
...
// 140C64268: using guessed type int dword_140C64268;
// 140C64978: using guessed type int dword_140C64978;
