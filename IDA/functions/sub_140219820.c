...
__int64 sub_140219820()
{
	...
	if (qword_140C641B0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ModelEventVisualJoin"))
	{
...
// 1402198BC: variable 'v1' is possibly undefined
// 140A93DB8: using guessed type wchar_t aModeleventvisu[21];
// 140A93EE8: using guessed type wchar_t aDbModeleventvi[28];
// 140AD97A8: using guessed type wchar_t *off_140AD97A8;
...
// 140C6410C: using guessed type int dword_140C6410C;
// 140C641B0: using guessed type __int64 qword_140C641B0;
// 140C64750: using guessed type int dword_140C64750;
