...
//----- (00000001408A2C40) ----------------------------------------------------
float* __fastcall sub_1408A2C40(__int64 a1, __int64 a2, float* a3)
{
	int v6; // ebx
	double v7; // xmm6_8
	float v8; // xmm7_4
	...
	for (i = *(unsigned __int16*)(a2 + 18) - 1; i >= 0; v15 = v54)
	{
		...
		v34 = v55
			- (float)((float)((float)((float)((float)((float)((float)(v33 * v33) * 0.33333334) + 1.0) * (float)(v33 * 2.0))
		...
		v36 = (float)-(float)(v18 * v8) * 0.050000001;
		if (v36 >= -37.0)
		{
...
// 1408A2C40: using guessed type __int64 var_100[7];
