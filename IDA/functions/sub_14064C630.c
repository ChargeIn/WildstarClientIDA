...
//----- (000000014064C630) ----------------------------------------------------
__int64 __fastcall sub_14064C630(__int64 a1)
{
	float* v2; // rsi
	__int64 v4; // rbx
	__int64 v5; // rax
	...
	if (v2)
	{
		...
		*(_QWORD*)(a1 + 16) += 16i64;
		v6 = sub_1400578C0(a1);
		v7 = sub_140462570(v2).m128_f32[0] * 100.0;
...
// 14064C7BA: variable 'v16' is possibly undefined
// 14064C7E0: variable 'v18' is possibly undefined
// 14064C7F2: variable 'v19' is possibly undefined
// 140B2BDF8: using guessed type wchar_t aNamount_16[8];
// 140B2BE08: using guessed type wchar_t aEdrstate_9[9];
