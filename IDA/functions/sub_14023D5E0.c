...
__int64 sub_14023D5E0()
{
	...
	if (qword_140C65368)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4VisualGroup"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4VisualGroup.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023D67C: variable 'v1' is possibly undefined
// 140AA9288: using guessed type wchar_t aSpell4visualgr[18];
// 140AA9B50: using guessed type wchar_t aDbSpell4visual_0[25];
// 140AD3E88: using guessed type wchar_t *off_140AD3E88;
...
// 140C642B8: using guessed type int dword_140C642B8;
// 140C64A68: using guessed type int dword_140C64A68;
// 140C64BB8: using guessed type int dword_140C64BB8;
