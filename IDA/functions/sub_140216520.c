...
__int64 sub_140216520()
{
	...
	if (qword_140C64918)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"MaterialRemap"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\MaterialRemap.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402165BC: variable 'v1' is possibly undefined
// 140A66B78: using guessed type wchar_t *off_140A66B78;
// 140A93460: using guessed type wchar_t aDbMaterialrema[21];
// 140A93520: using guessed type wchar_t aMaterialremap[14];
...
// 140C64228: using guessed type int dword_140C64228;
// 140C64918: using guessed type __int64 qword_140C64918;
// 140C64C78: using guessed type int dword_140C64C78;
