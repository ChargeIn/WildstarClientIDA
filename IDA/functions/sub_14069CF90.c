...
//----- (000000014069CF90) ----------------------------------------------------
__int64 __fastcall sub_14069CF90(_QWORD* a1)
{
	__int64 v2; // rax
	__int64 v3; // rcx
	__int64 v4; // rdx
...
// 14069CFC8: variable 'v3' is possibly undefined
// 14069D045: variable 'v8' is possibly undefined
