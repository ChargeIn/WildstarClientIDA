//----- (00000001401339D0) ----------------------------------------------------
__int64 __fastcall sub_1401339D0(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Apollo.ApolloTimer");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6 - 16;
	sub_140057020(a1, "ApolloTimer", &off_140B57EB8);
	a1[2] -= 16i64;
	return 0i64;
}
// 140133AE3: variable 'v14' is possibly undefined
// 140B57EB8: using guessed type char *off_140B57EB8;
// 140B57EF0: using guessed type char *off_140B57EF0;
