//----- (000000014073C7D0) ----------------------------------------------------
__int64 __fastcall sub_14073C7D0(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Game.CustomerSurvey");
	v2 = a1[2];
...
// 14073C8E3: variable 'v14' is possibly undefined
// 140C5F030: using guessed type char *off_140C5F030;
