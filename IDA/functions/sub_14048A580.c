//----- (000000014048A580) ----------------------------------------------------
__int64 __fastcall sub_14048A580(__int64 a1, __int64* a2)
{
	double v2; // xmm0_8
	...
	while (1)
	{
		...
		else
		{
			...
			if (v21 && (v22 = sub_1401FB5A0(*v21)) != 0)
				v23 = *(_DWORD*)(v22 + 12);
			else
				v23 = 0;
			v24 = (_QWORD*)v19[3];
			...
			v42 = v19;
			sub_14048B480((__int64)v43, (__int64*)&v42);
			v14 = v44;
			if (v24 != v44)
			{
				while (1)
...
// 14048A84F: conditional instruction was optimized away because rdx.8==0
// 14048A6B6: variable 'v2' is possibly undefined
// 140C65938: using guessed type __int64 qword_140C65938;
// 140C65940: using guessed type __int64 qword_140C65940;
// 14048A580: using guessed type char var_40[8];
