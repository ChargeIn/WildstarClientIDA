//----- (00000001401635C0) ----------------------------------------------------
__int64 __fastcall sub_1401635C0(__int64 a1, __int64 a2, __int64 a3)
{
	__int64 v3; // r12
	int v4; // r15d
	__int64 v5; // r14
	...
	bool v76; // zf
	_WORD* v77; // rax
	int v79; // [rsp+20h] [rbp-68h] BYREF
	unsigned int v80; // [rsp+24h] [rbp-64h] BYREF
	_QWORD v81[5]; // [rsp+28h] [rbp-60h] BYREF
	...
	LABEL_17:
		...
		*(_QWORD*)(v23 + 24) = v81[3];
		...
		for (i = 0i64; i < 6; ++i)
		{
			...
			if (v45)
			{
				...
				sub_1401A52E0(v46, (bool*)&v82);
				if ((_BYTE)v82)
					v42 |= 1i64 << i;
			}
		}
		*(_DWORD*)(v23 + 76) = v42;
		v47 = sub_1400F66F0(&v80, v5, &word_140A31AB8, 0);
		v48 = qword_140C63678;
		...
		*(_BYTE*)(v23 + 80) = 0;
		...
		if (v54)
		{
			...
			if ((unsigned int)sub_1407DF428(v59, (__int64)L"%d", &v84) == 1)
				*(_BYTE*)(v23 + 80) = v84 != 0;
		}
	LABEL_97:
		v60 = *(_QWORD*)(v5 + 96);
		...
		if (v60)
		{
			...
			if ((unsigned int)sub_1407DF428(v65, (__int64)L"%d", &v79) == 1)
				*(_BYTE*)(v23 + 81) = v79 != 0;
		}
	LABEL_112:
		v66 = *(_QWORD*)(v5 + 96);
		if (v66)
		{
			...
			sub_1407DF428(v71, (__int64)L"%d", v41 + 68);
		}
	LABEL_126:
		v72 = *(_QWORD*)(v5 + 96);
		if (v72)
		{
			...
			v77 = (_WORD*)sub_1401A4F40(v72 + 32);
			sub_1407DF428(v77, (__int64)L"%d", v41 + 72);
		}
	LABEL_140:
		++v4;
		++v6;
...
// 140163697: conditional instruction was optimized away because rdi.8!=0
// 140163ABA: conditional instruction was optimized away because rdi.8!=0
// 140163AD1: conditional instruction was optimized away because rdi.8!=0
// 140163AE8: conditional instruction was optimized away because rdi.8!=0
// 140163BAA: conditional instruction was optimized away because rdi.8!=0
// 140163C4F: conditional instruction was optimized away because rdi.8!=0
// 140163CE7: conditional instruction was optimized away because rdi.8!=0
// 14016377E: variable 'v21' is possibly undefined
...
// 140A322D8: using guessed type wchar_t aSimplesort[11];
// 140A36BB0: using guessed type wchar_t *off_140A36BB0[6];
