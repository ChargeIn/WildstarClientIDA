...
__int64 sub_140248CA0()
{
	...
	if (qword_140C63B40)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"VisualEffect"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\VisualEffect.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140248D3C: variable 'v1' is possibly undefined
// 140AAEBA8: using guessed type wchar_t aDbVisualeffect[20];
// 140AAEBD0: using guessed type wchar_t aVisualeffect[13];
// 140AD09A8: using guessed type wchar_t *off_140AD09A8;
...
// 140C647C4: using guessed type int dword_140C647C4;
// 140C64C04: using guessed type int dword_140C64C04;
// 140C653D8: using guessed type int dword_140C653D8;
