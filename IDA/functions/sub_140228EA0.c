...
__int64 sub_140228EA0()
{
	...
	if (qword_140C64C98)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PublicEventObjectiveState"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PublicEventObjectiveState.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140228F3C: variable 'v1' is possibly undefined
// 140A635B0: using guessed type wchar_t *off_140A635B0;
// 140A9C1C8: using guessed type wchar_t aPubliceventobj_2[26];
// 140A9C370: using guessed type wchar_t aDbPublicevento_2[33];
...
// 140C63BB4: using guessed type int dword_140C63BB4;
// 140C63DDC: using guessed type int dword_140C63DDC;
// 140C64000: using guessed type int dword_140C64000;
