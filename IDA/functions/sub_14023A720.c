...
__int64 sub_14023A720()
{
	...
	if (qword_140C64198)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4ServiceTokenCost"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\Spell4ServiceTokenCost.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023A7BC: variable 'v1' is possibly undefined
// 140A82820: using guessed type wchar_t *off_140A82820;
// 140AA80A0: using guessed type wchar_t aSpell4servicet[23];
// 140AA81D8: using guessed type wchar_t aDbSpell4servic[30];
...
// 140C641C4: using guessed type int dword_140C641C4;
// 140C64498: using guessed type int dword_140C64498;
