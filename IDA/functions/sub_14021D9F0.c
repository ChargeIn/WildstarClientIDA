...
//----- (000000014021D9F0) ----------------------------------------------------
__int64 sub_14021D9F0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6BC50, qword_140C63858);
	if (dword_140C653E4 || (int)sub_14021D7E0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C63BF8 + 40i64))(qword_140C63BF8);
}
