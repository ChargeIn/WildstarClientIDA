//----- (0000000140691150) ----------------------------------------------------
__int64 __fastcall sub_140691150(_QWORD* a1)
{
	__int64 v2; // rax
	__int64 v3; // rax
	__int64 v4; // rax
	...
	if (*(_QWORD*)(qword_140C65898 + 120)
		...
		&& (v4 = (*(__int64(__fastcall**)(__int64, _QWORD, _QWORD))(*(_QWORD*)qword_140C65980 + 48i64))(
			...
			**(unsigned int**)(*(_QWORD*)(v3 + 8) + 8i64),
			0i64)) != 0)
	{
		v5 = *(_DWORD*)(*(_QWORD*)((*(__int64(__fastcall**)(__int64))(*(_QWORD*)v4 + 320i64))(v4) + 8) + 84i64);
		if (v5)
		{
...
// 14069129B: variable 'v10' is possibly undefined
// 140B69230: using guessed type __int64 (__fastcall *off_140B69230[25])();
// 140C65898: using guessed type __int64 qword_140C65898;
// 140C65980: using guessed type __int64 qword_140C65980;
// 140691150: using guessed type char var_100[8];
