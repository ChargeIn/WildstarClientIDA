...
//----- (0000000140707640) ----------------------------------------------------
__int64 __fastcall sub_140707640(_QWORD* a1)
{
	unsigned int v2; // edx
	_DWORD* v3; // rcx
	_DWORD* v4; // rax
	...
	v5 = sub_1404ACB30((__int64)v3, v2);
	if (v5 && **(_QWORD**)(v5 + 8) != *(_QWORD*)(v5 + 8))
		return sub_140706CE0((__int64)a1, v5, 0);
	result = 1i64;
	*(_DWORD*)(a1[2] + 8i64) = 0;
	a1[2] += 16i64;
	return result;
}
// 140707688: variable 'v3' is possibly undefined
