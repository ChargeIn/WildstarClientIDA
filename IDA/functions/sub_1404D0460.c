//----- (00000001404D0460) ----------------------------------------------------
int* __fastcall sub_1404D0460(__int64 a1, int* a2)
{
	__int64 v2; // r9
	__int64 v5; // rax
	int* v6; // rbx
	...
	if (v6 == (int*)v2 || *a2 < v6[8])
	{
		...
		*((_QWORD*)v9 + 3) = v9;
		...
		v14 = v6;
		sub_1404D0970(a1, &v15, (__int64*)&v14, &v11);
		v6 = v15;
...
// 1404D0460: using guessed type char var_58[8];
// 1404D0460: using guessed type char var_30[8];
