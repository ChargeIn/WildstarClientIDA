...
//----- (000000014024CA30) ----------------------------------------------------
__int64 sub_14024CA30()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6E308, qword_140C63858);
	if (dword_140C64B50 || (int)sub_14024C820() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C65110 + 40i64))(qword_140C65110);
}
