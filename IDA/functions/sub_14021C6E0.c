...
__int64 sub_14021C6E0()
{
	...
	if (qword_140C65408)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathEpisode"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PathEpisode.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021C77C: variable 'v1' is possibly undefined
// 140A72788: using guessed type wchar_t *off_140A72788;
// 140A94DE0: using guessed type wchar_t aDbPathepisodeT[19];
// 140A94E08: using guessed type wchar_t aPathepisode[12];
...
// 140C63F3C: using guessed type int dword_140C63F3C;
// 140C63F80: using guessed type int dword_140C63F80;
