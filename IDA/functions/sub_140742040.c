//----- (0000000140742040) ----------------------------------------------------
__int64 __fastcall sub_140742040(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Game.CommDialog");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6;
	sub_140057020(a1, "CommDialog", &off_140B74D18);
	return 1i64;
}
// 140742153: variable 'v14' is possibly undefined
// 140B74D18: using guessed type char *off_140B74D18;
// 140C5F380: using guessed type char *off_140C5F380;
