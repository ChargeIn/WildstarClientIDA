...
//----- (00000001407200B0) ----------------------------------------------------
int** __fastcall sub_1407200B0(__int64 a1, int** a2, __int64* a3, unsigned int* a4)
{
	__int64 v4; // r8
	__int64 v6; // rdx
	unsigned int v9; // ecx
	...
	if (v4 == *(_QWORD*)(v6 + 16))
	{
		if (*(_QWORD*)(a1 + 16))
		{
			...
			{
				sub_140720470(a1, a2, v4, v4, (__int64)a4);
				return a2;
			}
		}
		v11 = (__int64)a4;
	...
	if (v4 == v6)
	{
		...
		{
			v16 = *(int**)sub_140720540(a1, (__int64)v28, (__int64)a4);
			result = a2;
			*a2 = v16;
		}
	}
	else
	{
			...
			|| (v27 = *(_DWORD*)(v4 + 32), v26 >= v27) && (v27 < v26 || a4[1] >= *(_DWORD*)(v4 + 36)))
		{
			v11 = (__int64)a4;
		LABEL_8:
			v12 = *(int**)sub_140720540(a1, (__int64)v28, v11);
			result = a2;
			*a2 = v12;
			return result;
		}
		if (*(_QWORD*)(v22 + 24))
			...
			sub_140720470(a1, a2, 0i64, v22, (__int64)a4);
		return a2;
	}
	return result;
}
