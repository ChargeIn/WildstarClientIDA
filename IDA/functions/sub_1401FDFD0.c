...
//----- (00000001401FDFD0) ----------------------------------------------------
__int64 sub_1401FDFD0()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6A248, qword_140C63858);
	if (dword_140C63F1C || (int)sub_1401FDDC0() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64018 + 40i64))(qword_140C64018);
}
