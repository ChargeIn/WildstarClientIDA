...
__int64 sub_14093CE00()
{
	...
	v0 = (__m128)(unsigned int)xmmword_140C7AC20;
	v1 = (__m128)DWORD2(xmmword_140C7AC20);
	v1.m128_f32[0] = (float)((float)(*((float*)&xmmword_140C7AC20 + 2) + *(float*)&dword_140C3B738)
		* (float)(1.0 / *(float*)&dword_140C66F48))
		+ 1.0;
	v0.m128_f32[0] = (float)((float)(*(float*)&xmmword_140C7AC20 + *(float*)&dword_140C3B738)
	...
	v15 = (__m128)(unsigned int)xmmword_140C7AC10;
	v16 = (int)v3.m128_f32[0];
	v17 = (__m128)DWORD2(xmmword_140C7AC10);
	v18 = v16 + 2;
	v17.m128_f32[0] = (float)((float)(*((float*)&xmmword_140C7AC10 + 2) + *(float*)&dword_140C3B738)
		* (float)(1.0 / *(float*)&dword_140C66F48))
		+ 1.0;
	v15.m128_f32[0] = (float)((float)(*(float*)&xmmword_140C7AC10 + *(float*)&dword_140C3B738)
		* (float)(1.0 / *(float*)&dword_140C66F1C))
		+ 0.5;
	...
	dword_140C7AC08 = v14 + 2;
	result = (unsigned int)((int)v20.m128_f32[0] - 1);
	dword_140C7AC00 = (int)(float)(v29 + v22.m128_f32[0]) - 1;
	dword_140C7AC0C = v18;
	dword_140C7AC04 = (int)v20.m128_f32[0] - 1;
	return result;
}
...
// 140C7AC00: using guessed type int dword_140C7AC00;
// 140C7AC04: using guessed type int dword_140C7AC04;
// 140C7AC08: using guessed type int dword_140C7AC08;
// 140C7AC0C: using guessed type int dword_140C7AC0C;
