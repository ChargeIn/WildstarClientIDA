...
//----- (000000014020A350) ----------------------------------------------------
__int64 sub_14020A350()
{
	if (qword_140C63838)
		return qword_140C63838(off_140A6AC58, qword_140C63858);
	if (dword_140C650D4 || (int)sub_14020A140() < 0)
		return 0i64;
	return (*(__int64(__fastcall**)(__int64))(*(_QWORD*)qword_140C64AC8 + 40i64))(qword_140C64AC8);
}
