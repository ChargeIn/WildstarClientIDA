...
__int64 sub_1402118A0()
{
	...
	if (qword_140C64F00)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"LootSpell"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\LootSpell.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021193C: variable 'v1' is possibly undefined
// 140A6F838: using guessed type wchar_t *off_140A6F838;
// 140A91BA0: using guessed type wchar_t aLootspell[10];
// 140A91D10: using guessed type wchar_t aDbLootspellTbl[17];
...
// 140C63FE4: using guessed type int dword_140C63FE4;
// 140C64EAC: using guessed type int dword_140C64EAC;
