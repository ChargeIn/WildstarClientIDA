...
//----- (0000000140691690) ----------------------------------------------------
__int64 __fastcall sub_140691690(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Game.ChatChannel");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6;
	sub_140057020(a1, "ChatChannelLib", &off_140B6FEE0);
	return 1i64;
}
// 1406917A3: variable 'v14' is possibly undefined
// 140B6FEE0: using guessed type char *off_140B6FEE0;
// 140C5CEB0: using guessed type char *off_140C5CEB0;
