...
__int64 sub_140218720()
{
	...
	if (qword_140C63B60)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ModelBoneSet"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ModelBoneSet.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402187BC: variable 'v1' is possibly undefined
// 140A93A90: using guessed type wchar_t aModelboneset[13];
// 140A93BD8: using guessed type wchar_t aDbModelboneset[20];
// 140AD0860: using guessed type wchar_t *off_140AD0860;
...
// 140C6464C: using guessed type int dword_140C6464C;
// 140C64710: using guessed type int dword_140C64710;
// 140C65504: using guessed type int dword_140C65504;
