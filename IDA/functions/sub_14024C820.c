...
__int64 sub_14024C820()
{
	...
	if (qword_140C65110)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"WorldWaterLayer"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\WorldWaterLayer.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024C8BC: variable 'v1' is possibly undefined
// 140A63550: using guessed type wchar_t *off_140A63550;
// 140AB0550: using guessed type wchar_t aDbWorldwaterla[23];
// 140AB0580: using guessed type wchar_t aWorldwaterlaye[16];
...
// 140C640CC: using guessed type int dword_140C640CC;
// 140C6411C: using guessed type int dword_140C6411C;
