//----- (0000000140127440) ----------------------------------------------------
void __fastcall sub_140127440(__int64 a1)
{
	__int64 v2; // rcx
	int i; // r10d
	__int64 v4; // r8
	...
	for (i = 255; i > -1; i = v7 - 1)
	{
		...
		do
		{
			v6 = sub_1401280F0((float)(int)v4 * 1.4078431, (float)(255 - *(_DWORD*)(a1 + 1048)) * 0.0039215689, v5);
	...
	{
		v12 = (float)j * 0.0039215689;
		do
		{
			v13 = sub_1401280F0(
				(float)*(int*)(a1 + 1052) * 1.4078431,
				v12,
	...
	*(_DWORD*)(a1 + 1040) = sub_1401280F0(
		(float)*(int*)(a1 + 1052) * 1.4078431,
		(float)(255 - *(_DWORD*)(a1 + 1048)) * 0.0039215689,
		(float)(255 - *(_DWORD*)(a1 + 1056)) * 0.0039215689);
	v18 = *(_QWORD*)(a1 + 1288);
	*(_BYTE*)(a1 + 1043) = 0;
...
// 1401274DC: variable 'v9' is possibly undefined
// 1401274E3: variable 'v10' is possibly undefined
// 1401274F5: variable 'v7' is possibly undefined
// 1401274F8: variable 'v8' is possibly undefined
// 14012757F: variable 'v16' is possibly undefined
// 140127586: variable 'v17' is possibly undefined
// 14012758D: variable 'v14' is possibly undefined
// 140127590: variable 'v15' is possibly undefined
