//----- (000000014058C3E0) ----------------------------------------------------
void __fastcall sub_14058C3E0(__int64 a1)
{
	__int64 v2; // rdx
	__int64 v3; // rax
	__int16* v4; // rax
...
// 14058C5FC: variable 'v14' is possibly undefined
// 140B1F560: using guessed type wchar_t asc_140B1F560[5];
// 140C658A0: using guessed type __int64 qword_140C658A0;
// 140C7DE18: using guessed type __int64 qword_140C7DE18;
// 140C7DE20: using guessed type __int64 qword_140C7DE20;
// 14058C3E0: using guessed type char var_88[8];
// 14058C3E0: using guessed type char var_68[8];
// 14058C3E0: using guessed type char var_48[8];
