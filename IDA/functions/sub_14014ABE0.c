//----- (000000014014ABE0) ----------------------------------------------------
__int64 __fastcall sub_14014ABE0(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Quaternion");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6 - 16;
	sub_140057020(a1, "Quaternion", &off_140B5C330);
	a1[2] -= 16i64;
	return 0i64;
}
// 14014ACF3: variable 'v14' is possibly undefined
// 140B5C330: using guessed type char *off_140B5C330;
// 140C57880: using guessed type char *off_140C57880;
