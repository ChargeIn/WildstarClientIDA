...
__int64 sub_1402338A0()
{
	...
	if (qword_140C63D88)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"SoundEvent"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\SoundEvent.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023393C: variable 'v1' is possibly undefined
// 140AA31B0: using guessed type wchar_t aSoundevent[11];
// 140AA3318: using guessed type wchar_t aDbSoundeventTb[18];
// 140ACD658: using guessed type wchar_t *off_140ACD658;
...
// 140C63884: using guessed type int dword_140C63884;
// 140C63970: using guessed type __int64 qword_140C63970;
// 140C639FC: using guessed type int dword_140C639FC;
