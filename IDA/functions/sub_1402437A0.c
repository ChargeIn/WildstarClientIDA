...
__int64 sub_1402437A0()
{
	...
	if (qword_140C64CB0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"TradeskillAdditive"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\TradeskillAdditive.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024383C: variable 'v1' is possibly undefined
// 140AABD98: using guessed type wchar_t aDbTradeskillad[26];
// 140AABDD0: using guessed type wchar_t aTradeskilladdi[19];
// 140ACD890: using guessed type wchar_t *off_140ACD890;
...
// 140C640A8: using guessed type int dword_140C640A8;
// 140C64468: using guessed type int dword_140C64468;
