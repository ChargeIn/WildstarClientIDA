...
//----- (0000000140406E70) ----------------------------------------------------
void __fastcall sub_140406E70(__int64 a1)
{
	int v1; // ebp
	__int64 v2; // rdi
	__int64 v3; // rcx
	...
	if ((unsigned int)sub_1403E1170(lpv, 0))
	{
		...
		LODWORD(v19) = v1;
		LODWORD(v16) = v14;
		sub_1403F4740(qword_140C65898, 0x1CDu, (__int64)&v16);
	}
	else
	{
...
// 140406F15: variable 'v3' is possibly undefined
// 140406FD0: variable 'v15' is possibly undefined
