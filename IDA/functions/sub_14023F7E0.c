...
__int64 sub_14023F7E0()
{
	...
	if (qword_140C650E0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"StoreLink"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\StoreLink.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023F87C: variable 'v1' is possibly undefined
// 140A83B80: using guessed type wchar_t *off_140A83B80;
// 140AAA448: using guessed type wchar_t aDbStorelinkTbl[17];
// 140AAA470: using guessed type wchar_t aStorelink[10];
...
// 140C64CF8: using guessed type int dword_140C64CF8;
// 140C650E0: using guessed type __int64 qword_140C650E0;
// 140C651B4: using guessed type int dword_140C651B4;
