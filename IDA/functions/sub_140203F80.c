...
__int64 sub_140203F80()
{
	...
	if (qword_140C63DB8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"HousingDecorLimitCategory"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\HousingDecorLimitCategory.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020401C: variable 'v1' is possibly undefined
// 140A76AD0: using guessed type wchar_t *off_140A76AD0;
// 140A8B038: using guessed type wchar_t aHousingdecorli[26];
// 140A8B170: using guessed type wchar_t aDbHousingdecor_0[33];
...
// 140C63D28: using guessed type int dword_140C63D28;
// 140C63DA8: using guessed type int dword_140C63DA8;
