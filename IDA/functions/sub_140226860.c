...
__int64 sub_140226860()
{
	...
	if (qword_140C63B90)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PropAdditionalDetail"))
	{
...
// 1402268FC: variable 'v1' is possibly undefined
// 140A51F18: using guessed type wchar_t *off_140A51F18;
// 140A9ACD0: using guessed type wchar_t aPropadditional[21];
// 140A9AE38: using guessed type wchar_t aDbPropaddition[28];
