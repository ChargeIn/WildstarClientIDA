...
__int64 sub_1401F5180()
{
	...
	if (qword_140C65118)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ComponentRegion"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ComponentRegion.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F521C: variable 'v1' is possibly undefined
// 140A65378: using guessed type wchar_t aDbComponentreg[23];
// 140A653A8: using guessed type wchar_t aComponentregio_0[16];
// 140AD2088: using guessed type wchar_t *off_140AD2088;
...
// 140C642A0: using guessed type int dword_140C642A0;
// 140C64DE4: using guessed type int dword_140C64DE4;
