//----- (0000000140693920) ----------------------------------------------------
__int64 __fastcall sub_140693920(_QWORD* a1)
{
	__int64 v2; // rax
	__int64 v3; // rax
	__int64 v4; // rsi
	...
	if (v2 && (v3 = *(_QWORD*)(v2 + 8)) != 0 && (v4 = *(_QWORD*)(v3 + 8)) != 0)
	{
		...
		*((_QWORD*)&v20 + 1) = v5;
		...
		if (v5)
			*(_WORD*)v5 = 0;
		v6 = (int*)sub_14034BDD0((__int64)v5, *(_DWORD*)(*(_QWORD*)v4 + 28i64));
		if (v6)
		{
			v7 = 0i64;
			if (*(_WORD*)v6)
	...
	{
		v11 = (unsigned __int64*)sub_14018F0E0(&v14, word_1409F6094)[1];
		if (v11)
		{
			v12 = -1i64;
			do
...
// 1409F6094: using guessed type unsigned __int16 word_1409F6094[2];
// 140B69230: using guessed type __int64 (__fastcall *off_140B69230[25])();
// 140693920: using guessed type char var_E0[8];
