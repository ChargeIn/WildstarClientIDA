//----- (000000014014D4A0) ----------------------------------------------------
__int64 __fastcall sub_14014D4A0(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"EulerAngles");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6 - 16;
	sub_140057020(a1, "EulerAngles", &off_140B5C2E0);
	a1[2] -= 16i64;
	return 0i64;
}
// 14014D5B3: variable 'v14' is possibly undefined
// 140B5C2E0: using guessed type char *off_140B5C2E0;
// 140C57830: using guessed type char *off_140C57830;
