...
__int64 sub_1401F55C0()
{
	...
	if (qword_140C65300)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ComponentRegionRect"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ComponentRegionRect.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F565C: variable 'v1' is possibly undefined
// 140A653C8: using guessed type wchar_t aComponentregio_1[20];
// 140A65BF8: using guessed type wchar_t aDbComponentreg_0[27];
// 140ACAA38: using guessed type wchar_t *off_140ACAA38;
...
// 140C64610: using guessed type int dword_140C64610;
// 140C651F4: using guessed type int dword_140C651F4;
