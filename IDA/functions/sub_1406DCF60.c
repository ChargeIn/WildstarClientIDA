...
//----- (00000001406DCF60) ----------------------------------------------------
void __fastcall sub_1406DCF60(__int64 a1)
{
	_QWORD* v1; // rdi
	int v3; // r9d
	int v4; // r8d
	...
	v8 = 0;
	v9 = &v46[v7 / 8];
	v10 = (char*)&(&off_140C5E890)[v7 / 0xFFFFFFFFFFFFFFF8ui64] - (char*)v46;
	do
	{
	...
	} while ((unsigned __int64)v8 < 6);
	sub_1400569B0((__int64)v1, (unsigned __int64*)"Apollo.ProtostarMapWindow");
	v12 = v1[2];
	if (*(_DWORD*)(v12 - 8) != 2)
	{
...
LABEL_35:
	...
	if (!sub_1406DD2E0)
		v43 = 0i64;
	v45 = v43;
	sub_1400F85D0(a1 + 2688, (int*)L"ProtostarMapWindow", &v44);
}
// 140B3D7E0: using guessed type wchar_t aProtostarmapwi[19];
// 140C56A80: using guessed type char *off_140C56A80;
// 140C5E890: using guessed type char *off_140C5E890;
