//----- (00000001401A0040) ----------------------------------------------------
__int64 __fastcall sub_1401A0040(__int64 a1, DWORD a2)
{
	unsigned int v2; // edi
	DWORD v3; // esi
	DWORD LastError; // eax
	...
	if (v3 == -1)
	{
		...
		*(_QWORD*)&v12 = &off_140B5E640;
		...
		v15 = 0x141D3EDE0i64;
		v14[0] = v12;
		v6 = sub_1401971E0(&dword_140C8A218, 39, &v15, v14, v11);
		*(_QWORD*)&v12 = &off_140B5E648;
...
// 140C8A218: using guessed type _DWORD dword_140C8A218;
