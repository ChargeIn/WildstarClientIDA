//----- (0000000140099940) ----------------------------------------------------
__int64 __fastcall sub_140099940(__int64 a1, __int64 a2)
{
	__int64 v2; // r8
	...
	if ((int)result >= 0)
	{
		...
		if ((int)result >= 0)
		{
			result = sub_1400A7250(a1, *(_DWORD*)(a2 + 32) != 0, 1ui64);
			if ((int)result >= 0)
			{
				result = sub_1400A7250(a1, *(_DWORD*)(a2 + 36) != 0, 1ui64);
				if ((int)result >= 0)
				{
					result = sub_1400A7160(a1, *(_QWORD*)(a2 + 40));
					if ((int)result >= 0)
						return sub_1400A7160(a1, *(_QWORD*)(a2 + 48));
				}
			}
		}
	}
