//----- (0000000140307DA0) ----------------------------------------------------
unsigned __int64 __fastcall sub_140307DA0(__int64 a1, _WORD* a2, __int64 a3, __int64 a4)
{
	__int64 v6; // rbp
	char* v7; // rdi
	unsigned int* v8; // r14
	...
	else
	{
		...
		for (result = sub_140309B80((int*)a1, *v8, a2, a4, v7); (_DWORD)v6; *a2 = v13)
		{
			v10 = *(_DWORD*)a1;
			v11 = *(v8 - 6);
			v7 -= 4;
					...
					if (*(_DWORD*)(v15 + 4 * v14) > v11 || v11 >= *(_DWORD*)(v15 + 4i64 * (unsigned int)(v14 + 1)))
					{
						...
						*(_DWORD*)v7 = v16;
						...
						if (*(_DWORD*)(v17 + 4 * v16) > v11 || v11 >= *(_DWORD*)(v17 + 4i64 * (unsigned int)(v14 + 2)))
							goto LABEL_16;
						result = *(_QWORD*)(a1 + 16);
						v13 = *(_WORD*)(result + 2i64 * (unsigned int)v16);
					}
					else
					{
						result = *(_QWORD*)(a1 + 16);
