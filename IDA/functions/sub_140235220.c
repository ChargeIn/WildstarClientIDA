...
__int64 sub_140235220()
{
	...
	if (qword_140C64C18)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"SoundStates"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\SoundStates.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402352BC: variable 'v1' is possibly undefined
// 140AA38F0: using guessed type wchar_t aDbSoundstatesT[19];
// 140AA3940: using guessed type wchar_t aSoundstates[12];
// 140ADD498: using guessed type wchar_t *off_140ADD498;
...
// 140C63E0C: using guessed type int dword_140C63E0C;
// 140C64050: using guessed type int dword_140C64050;
