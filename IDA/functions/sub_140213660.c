...
__int64 sub_140213660()
{
	...
	if (qword_140C63890)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"MapZoneLevelBand"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\MapZoneLevelBand.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402136FC: variable 'v1' is possibly undefined
// 140A924F8: using guessed type wchar_t aDbMapzonelevel[24];
// 140A92528: using guessed type wchar_t aMapzonelevelba[17];
// 140AE0040: using guessed type wchar_t *off_140AE0040;
...
// 140C63EF8: using guessed type int dword_140C63EF8;
// 140C651D4: using guessed type int dword_140C651D4;
