//----- (00000001401D8340) ----------------------------------------------------
__int64 __fastcall sub_1401D8340(__int64 a1, __int64 a2)
{
	__int64 result; // rax
	int v5; // ebx
	...
	{
		result = (*(__int64(__fastcall**)(__int64, __int64, __int64*, _QWORD))(*(_QWORD*)a1 + 88i64))(a1, a2, &v7, 0i64);
		if ((int)result < 0)
			return result;
		v6[0] = -1;
...
// 1401D8340: using guessed type int var_18[6];
