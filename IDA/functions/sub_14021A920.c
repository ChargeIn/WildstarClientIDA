...
__int64 sub_14021A920()
{
	...
	if (qword_140C63CB0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ModelSequenceByMode"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\ModelSequenceByMode.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021A9BC: variable 'v1' is possibly undefined
// 140A806D0: using guessed type wchar_t *off_140A806D0;
// 140A94220: using guessed type wchar_t aDbModelsequenc_0[27];
// 140A942F0: using guessed type wchar_t aModelsequenceb[20];
...
// 140C645F0: using guessed type int dword_140C645F0;
// 140C649C0: using guessed type int dword_140C649C0;
