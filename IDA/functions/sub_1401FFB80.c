...
__int64 sub_1401FFB80()
{
	...
	if (qword_140C65218)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"FullScreenEffect"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\FullScreenEffect.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401FFC1C: variable 'v1' is possibly undefined
// 140A89918: using guessed type wchar_t aDbFullscreenef[24];
// 140A89948: using guessed type wchar_t aFullscreeneffe[17];
// 140AD9D70: using guessed type wchar_t *off_140AD9D70;
...
// 140C63B34: using guessed type int dword_140C63B34;
// 140C63D9C: using guessed type int dword_140C63D9C;
