//----- (000000014026E080) ----------------------------------------------------
__int64 __fastcall sub_14026E080(
	__int64 a1,
	__m128i* a2,
	__int64 a3,
	unsigned int a4,
	...
	__int64 a8)
{
	...
	*(_QWORD*)&v25 = __PAIR64__(v14, v15);
	v26 = v10;
	v16 = (*(__int64(__fastcall**)(__int64(__fastcall***)()))(a1 + 7352))(&v24);
	v17 = *(_QWORD**)(*(_QWORD*)(a1 + 7344) + 8 * (v16 % *(_QWORD*)(a1 + 7336)));
	if (!v17)
		goto LABEL_18;
	while (v16 != *v17
		|| !(*(unsigned int(__fastcall**)(__int64(__fastcall***)(), _QWORD*))(a1 + 7360))(&v24, v17 + 2))
	{
		v17 = (_QWORD*)v17[1];
		if (!v17)
			goto LABEL_18;
	...
	{
	LABEL_18:
		v18 = sub_14018B280(240i64, 0);
		if (v18)
			v19 = sub_14028F500((__int64)v18, a1);
		else
			v19 = 0i64;
		v21 = sub_14028FA50(v19, v10->m128i_i32, v23, a4, a5, v14, a7);
		if (v21 >= 0)
		{
			*(_QWORD*)v22 = v19;
			sub_14003D880(&v29);
...
// 14026E080: using guessed type __m128i var_250[33];
