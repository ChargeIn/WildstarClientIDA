//----- (00000001403180D0) ----------------------------------------------------
__m128i* __fastcall sub_1403180D0(__int64 a1, __m128i* a2, __m128i** a3)
{
	__m128i* result; // rax
	__m128i* v7; // rbx
	_QWORD* v8; // rcx
	...
	if (*(_DWORD*)a1 <= 1u)
	{
		if (*(_DWORD*)a1)
		{
			result = sub_1401ADB90(&v10, *(unsigned __int16**)(a1 + 16));
			*a2 = v10;
		}
		else
		{
	...
	else
	{
		...
		if (result)
		{
			...
			v7->m128i_i64[0] = (__int64)off_140B64220;
...
// 140B64220: using guessed type __int64 (__fastcall *off_140B64220[7])();
// 1403180D0: using guessed type __m128i var_18;
