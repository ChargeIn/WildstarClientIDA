...
__int64 sub_140235AA0()
{
	...
	if (qword_140C63D60)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"SoundUIContext"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\SoundUIContext.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140235B3C: variable 'v1' is possibly undefined
// 140AA3980: using guessed type wchar_t aSounduicontext[15];
// 140AA3B58: using guessed type wchar_t aDbSounduiconte[22];
// 140AD0A68: using guessed type wchar_t *off_140AD0A68;
...
// 140C63B50: using guessed type int dword_140C63B50;
// 140C63D60: using guessed type __int64 qword_140C63D60;
// 140C64474: using guessed type int dword_140C64474;
