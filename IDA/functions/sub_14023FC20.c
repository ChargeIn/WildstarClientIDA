...
__int64 sub_14023FC20()
{
	...
	if (qword_140C64F38)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"StoreKeyword"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\StoreKeyword.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023FCBC: variable 'v1' is possibly undefined
// 140A7EB18: using guessed type wchar_t *off_140A7EB18;
// 140AAA528: using guessed type wchar_t aDbStorekeyword[20];
// 140AAA550: using guessed type wchar_t aStorekeyword[13];
