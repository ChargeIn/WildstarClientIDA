...
//----- (000000014049DF70) ----------------------------------------------------
_BOOL8 __fastcall sub_14049DF70(__int64 a1, __int64 a2, int a3, int a4)
{
	int v6; // edi
	__int64 v7; // rax
	__int64 v8; // rbx
	...
	v10 = sub_1405BFE80(qword_140C65B98, 1, 0xFFFFFFFF);
	if (v10)
	{
		v6 = *(_DWORD*)(v10 + 4);
	}
...
// 14049E084: variable 'v11' is possibly undefined
