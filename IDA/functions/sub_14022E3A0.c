...
__int64 sub_14022E3A0()
{
	...
	if (qword_140C655E0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ReplaceableMaterialInfo"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\ReplaceableMaterialInfo.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022E43C: variable 'v1' is possibly undefined
// 140A7C258: using guessed type wchar_t *off_140A7C258;
// 140AA1030: using guessed type wchar_t aDbReplaceablem[31];
// 140AA1070: using guessed type wchar_t aReplaceablemat[24];
...
// 140C64C28: using guessed type int dword_140C64C28;
// 140C64D30: using guessed type int dword_140C64D30;
