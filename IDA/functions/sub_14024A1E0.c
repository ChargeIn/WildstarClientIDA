...
__int64 sub_14024A1E0()
{
	...
	if (qword_140C65460)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"WordFilter"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\WordFilter.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14024A27C: variable 'v1' is possibly undefined
// 140A4C070: using guessed type wchar_t *off_140A4C070;
// 140AAF1C8: using guessed type wchar_t aWordfilter[11];
// 140AAF308: using guessed type wchar_t aDbWordfilterTb[18];
...
// 140C63F30: using guessed type int dword_140C63F30;
// 140C645D8: using guessed type int dword_140C645D8;
