...
//----- (00000001408D3500) ----------------------------------------------------
__int64 __fastcall sub_1408D3500(_DWORD* a1, unsigned __int64 a2, unsigned int a3)
{
	__int64 result; // rax
...
// 140C13240: using guessed type int dword_140C13240;
