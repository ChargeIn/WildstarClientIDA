//----- (00000001407415C0) ----------------------------------------------------
__int64 __fastcall sub_1407415C0(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Game.QuestHub");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6;
	sub_140057020(a1, "QuestHub", &off_140B74CF8);
	return 1i64;
}
// 1407416D3: variable 'v14' is possibly undefined
// 140B74CF8: using guessed type void *off_140B74CF8;
// 140C5F2F0: using guessed type char *off_140C5F2F0;
