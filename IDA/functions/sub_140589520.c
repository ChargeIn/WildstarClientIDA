...
//----- (0000000140589520) ----------------------------------------------------
void __fastcall sub_140589520(__int64 a1)
{
	int* v2; // rbp
	__int64 v3; // rax
	__int64 v5; // rdi
...
// 1405896A9: variable 'v10' is possibly undefined
// 140B1F378: using guessed type wchar_t asc_140B1F378[5];
// 140C658A0: using guessed type __int64 qword_140C658A0;
// 140589520: using guessed type char var_78[8];
// 140589520: using guessed type char var_58[8];
// 140589520: using guessed type char var_38[8];
