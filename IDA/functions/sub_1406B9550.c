//----- (00000001406B9550) ----------------------------------------------------
__int64 __fastcall sub_1406B9550(_QWORD* a1)
{
	__int64 v2; // rcx
	__int64 v3; // rdi
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Game.RewardTrack");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6;
	sub_140057020(a1, "RewardTrack", &off_140B702D0);
	sub_140058710((__int64)a1, (unsigned __int64*)"RewardTrackRewardType", 0x15ui64);
	if (*(_QWORD*)(a1[4] + 120i64) >= *(_QWORD*)(a1[4] + 112i64))
		sub_14005E2C0((__int64)a1);
	v19 = a1[2];
...
// 1406B9663: variable 'v14' is possibly undefined
// 1406B973A: variable 'v21' is possibly undefined
// 140B702D0: using guessed type void *off_140B702D0;
// 140C319C0: using guessed type wchar_t *off_140C319C0;
// 140C5E160: using guessed type char *off_140C5E160;
