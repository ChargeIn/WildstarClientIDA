//----- (0000000140123C10) ----------------------------------------------------
__int64 __fastcall sub_140123C10(__int64 a1, __int64 a2, __int64 a3, int a4, int a5)
{
	__int64 v8; // rax
	__int64 v9; // rcx
	int v10; // ebp
	...
	*(_QWORD*)(v21 + 1096) = sub_140123230(v21, a3, v18);
	v23 = sub_14034BDD0(v22, 226);
	*(_QWORD*)(v21 + 1056) = sub_140123490(v21, 3, (__int64)v23);
	v25 = sub_14034BDD0(v24, 227);
	*(_QWORD*)(v21 + 1064) = sub_140123490(v21, 2, (__int64)v25);
...
// 140123D41: variable 'v22' is possibly undefined
// 140123D62: variable 'v24' is possibly undefined
// 140123D83: variable 'v26' is possibly undefined
// 140A1EDC8: using guessed type wchar_t aDefaultstratum_4[15];
// 140A1F010: using guessed type wchar_t aChat_3[5];
