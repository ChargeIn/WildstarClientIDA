...
__int64 sub_1402021C0()
{
	...
	if (qword_140C648C8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"GuildPermission"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\GuildPermission.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020225C: variable 'v1' is possibly undefined
// 140A84410: using guessed type wchar_t *off_140A84410;
// 140A8A480: using guessed type wchar_t aDbGuildpermiss[23];
// 140A8A4B0: using guessed type wchar_t aGuildpermissio[16];
...
// 140C63F14: using guessed type int dword_140C63F14;
// 140C648C8: using guessed type __int64 qword_140C648C8;
// 140C65260: using guessed type int dword_140C65260;
