//----- (000000014026E9B0) ----------------------------------------------------
__int64 __fastcall sub_14026E9B0(__int64 a1, __m128i* a2, __int64* a3)
{
	...
	v5 = (*(__int64(__fastcall**)(__m128i**))(a1 + 7472))(&v17);
	v6 = *(_QWORD**)(*(_QWORD*)(a1 + 7464) + 8 * (v5 % *(_QWORD*)(a1 + 7456)));
	if (!v6)
		goto LABEL_8;
	while (v5 != *v6 || !(*(unsigned int(__fastcall**)(__m128i**, _QWORD*))(a1 + 7480))(&v17, v6 + 2))
	{
		v6 = (_QWORD*)v6[1];
		if (!v6)
			goto LABEL_8;
	...
	LABEL_8:
		...
		v11 = sub_140296710(v8, v17->m128i_i32);
		if (v11 < 0)
		{
			if (v8)
			{
...
// 14026E9B0: using guessed type int var_238[132];
