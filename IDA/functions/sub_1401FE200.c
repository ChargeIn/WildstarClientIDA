...
__int64 sub_1401FE200()
{
	...
	if (qword_140C64EE0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"EmoteSequenceTransition"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\EmoteSequenceTransition.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401FE29C: variable 'v1' is possibly undefined
// 140A84CF8: using guessed type wchar_t *off_140A84CF8;
// 140A88F08: using guessed type wchar_t aDbEmotesequenc[31];
// 140A88FE8: using guessed type wchar_t aEmotesequencet[24];
...
// 140C64174: using guessed type int dword_140C64174;
// 140C644B8: using guessed type int dword_140C644B8;
// 140C64E38: using guessed type int dword_140C64E38;
