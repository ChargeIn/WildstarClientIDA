...
__int64 sub_140234120()
{
	...
	if (qword_140C643F8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"SoundMusicSet"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\SoundMusicSet.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1402341BC: variable 'v1' is possibly undefined
// 140AA3470: using guessed type wchar_t aDbSoundmusicse[21];
// 140AA3518: using guessed type wchar_t aSoundmusicset[14];
// 140ACADE0: using guessed type wchar_t *off_140ACADE0;
...
// 140C64CE0: using guessed type int dword_140C64CE0;
// 140C64E7C: using guessed type int dword_140C64E7C;
