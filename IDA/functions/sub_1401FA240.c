...
__int64 sub_1401FA240()
{
	...
	if (qword_140C640D8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"CurrencyType"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\CurrencyType.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401FA2DC: variable 'v1' is possibly undefined
// 140A83828: using guessed type wchar_t aDbCurrencytype[20];
// 140A83978: using guessed type wchar_t aCurrencytype[13];
// 140AE27A0: using guessed type wchar_t *off_140AE27A0;
...
// 140C64E2C: using guessed type int dword_140C64E2C;
// 140C653E8: using guessed type int dword_140C653E8;
