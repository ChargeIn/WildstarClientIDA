...
//----- (00000001402A9290) ----------------------------------------------------
__int64 __fastcall sub_1402A9290(__int64 a1, int* a2)
{
	int* v3; // rax
	bool v4; // cc
	__int64 result; // rax
	...
	*(_QWORD*)(a1 + 24) = *(unsigned int*)(*(_QWORD*)(a1 + 16) + 176i64);
	v3 = sub_14018E9C0(a2);
	v4 = *(_DWORD*)(a1 + 40) < 1;
	*(_QWORD*)(a1 + 32) = v3;
	if (!v4 || (result = sub_1402A93E0(a1), (int)result >= 0))
	{
		v6 = *(_QWORD*)(a1 + 16) + 7056i64;
		*(_DWORD*)(a1 + 40) = 2;
		...
		*v8 = v9;
		++* (_QWORD*)v6;
		v12 = (__int64*)(*(_QWORD*)(a1 + 16) + 6880i64);
		if (!*(_QWORD*)(a1 + 152))
		{
			*(_QWORD*)(a1 + 152) = v12;
			*(_QWORD*)(a1 + 160) = *v12;
		...
		v19 = 0i64;
		v17 = sub_1402A9970;
		sub_1401B6BF0((__int64)v12, &v14, (int**)(a1 + 96));
		return 0i64;
	}
	return result;
}
