...
__int64 sub_1401E89C0()
{
	...
	if (qword_140C652D0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"AccountItem"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\AccountItem.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401E8A5C: variable 'v1' is possibly undefined
// 140A4B7A0: using guessed type wchar_t aDbAccountitemT[19];
// 140AD0728: using guessed type wchar_t *off_140AD0728;
// 140AE3488: using guessed type wchar_t aAccountitem[12];
