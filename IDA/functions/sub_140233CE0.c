...
__int64 sub_140233CE0()
{
	...
	if (qword_140C638E8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"SoundImpactEvents"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\SoundImpactEvents.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140233D7C: variable 'v1' is possibly undefined
// 140A4C3D0: using guessed type wchar_t *off_140A4C3D0;
// 140AA3408: using guessed type wchar_t aDbSoundimpacte[25];
// 140AA3440: using guessed type wchar_t aSoundimpacteve[18];
...
// 140C63B10: using guessed type int dword_140C63B10;
// 140C64614: using guessed type int dword_140C64614;
// 140C65208: using guessed type int dword_140C65208;
