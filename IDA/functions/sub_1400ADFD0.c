...
//----- (00000001400ADFD0) ----------------------------------------------------
__int64 __fastcall sub_1400ADFD0(__int64 a1, unsigned int* a2)
{
	__int64 v2; // r8
		...
		if ((int)result >= 0)
		{
			...
			if ((int)result >= 0)
			{
				...
				if ((int)result >= 0)
				{
					...
					if ((int)result >= 0)
					{
						result = sub_1400A8B30(a1, (unsigned __int16*)a2 + 16);
						if ((int)result >= 0)
						{
							result = sub_1400A73C0(a1, a2[10]);
							if ((int)result >= 0)
							{
								result = sub_1400A7110(a1, a2[11], 0x20ui64);
								if ((int)result >= 0)
								{
									result = sub_1400A7110(a1, a2[12], 0x20ui64);
									if ((int)result >= 0)
									{
										result = sub_1400A7250(a1, a2[13] != 0, 1ui64);
										if ((int)result >= 0)
											return sub_1400A7250(a1, a2[14] != 0, 1ui64);
									}
								}
							}
						}
