...
__int64 sub_1401F7C00()
{
	...
	if (qword_140C648C0)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Creature2ActionText"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Creature2ActionText.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F7C9C: variable 'v1' is possibly undefined
// 140A5B2E0: using guessed type wchar_t *off_140A5B2E0;
// 140A7D360: using guessed type wchar_t aCreature2actio_1[20];
// 140A7D6A0: using guessed type wchar_t aDbCreature2act_1[27];
...
// 140C645D4: using guessed type int dword_140C645D4;
// 140C64844: using guessed type int dword_140C64844;
