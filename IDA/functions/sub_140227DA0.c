...
__int64 sub_140227DA0()
{
	...
	if (qword_140C64E48)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PublicEventVirtualItemDepot"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PublicEventVirtualItemDepot.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140227E3C: variable 'v1' is possibly undefined
// 140A9B618: using guessed type wchar_t aPubliceventvir[28];
// 140A9B650: using guessed type wchar_t aDbPubliceventv[35];
// 140AD02F8: using guessed type wchar_t *off_140AD02F8;
...
// 140C655D4: using guessed type int dword_140C655D4;
// 140C65638: using guessed type int dword_140C65638;
