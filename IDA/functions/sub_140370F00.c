//----- (0000000140370F00) ----------------------------------------------------
_QWORD* __fastcall sub_140370F00(
	__int64* a1,
	__int64 a2,
	...
	__int64 a5)
{
	...
	if (*a1)
	{
		...
		if (v10 == 1)
		{
			return sub_140370B30(a1, 112i64, a3, 0i64);
		}
		else
		{
			if (v10)
...
// 140371097: conditional instruction was optimized away because rbx.8!=0
// 1403710B7: conditional instruction was optimized away because rbx.8!=0
// 1403710E4: conditional instruction was optimized away because rcx.8!=0
// 140371136: conditional instruction was optimized away because rbx.8!=0
