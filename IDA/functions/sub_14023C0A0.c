...
__int64 sub_14023C0A0()
{
	...
	if (qword_140C63A88)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4Telegraph"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4Telegraph.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023C13C: variable 'v1' is possibly undefined
// 140AA86A0: using guessed type wchar_t aDbSpell4telegr[23];
// 140AA86D0: using guessed type wchar_t aSpell4telegrap[16];
// 140AD3680: using guessed type wchar_t *off_140AD3680;
...
// 140C646C4: using guessed type int dword_140C646C4;
// 140C64A60: using guessed type int dword_140C64A60;
