...
__int64 sub_1401F4900()
{
	...
	if (qword_140C64A90)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"CombatReward"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\CombatReward.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401F499C: variable 'v1' is possibly undefined
// 140A645C0: using guessed type wchar_t aDbCombatreward[20];
// 140A64798: using guessed type wchar_t aCombatreward[13];
// 140AD2EF8: using guessed type wchar_t *off_140AD2EF8;
...
// 140C64B18: using guessed type int dword_140C64B18;
// 140C64B6C: using guessed type int dword_140C64B6C;
// 140C652BC: using guessed type int dword_140C652BC;
