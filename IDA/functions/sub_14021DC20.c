...
__int64 sub_14021DC20()
{
	...
	if (qword_140C64BF8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathExplorerNode"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\PathExplorerNode.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14021DCBC: variable 'v1' is possibly undefined
// 140A95378: using guessed type wchar_t aDbPathexplorer_3[24];
// 140A953A8: using guessed type wchar_t aPathexplorerno[17];
// 140ADE3C0: using guessed type wchar_t *off_140ADE3C0;
...
// 140C64154: using guessed type int dword_140C64154;
// 140C64BF8: using guessed type __int64 qword_140C64BF8;
// 140C65600: using guessed type int dword_140C65600;
