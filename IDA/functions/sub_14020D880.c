...
__int64 sub_14020D880()
{
	...
	if (qword_140C63A68)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"ItemDisplaySourceEntry"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\ItemDisplaySourceEntry.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14020D91C: variable 'v1' is possibly undefined
// 140A90468: using guessed type wchar_t aItemdisplaysou[23];
// 140A905A8: using guessed type wchar_t aDbItemdisplays[30];
// 140AD3368: using guessed type wchar_t *off_140AD3368;
...
// 140C63C50: using guessed type int dword_140C63C50;
// 140C63FB4: using guessed type int dword_140C63FB4;
