...
__int64 sub_14023DE60()
{
	...
	if (qword_140C64DD8)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"SpellEffectType"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\SpellEffectType.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023DEFC: variable 'v1' is possibly undefined
// 140A619A0: using guessed type wchar_t *off_140A619A0;
// 140AA9C60: using guessed type wchar_t aSpelleffecttyp[16];
// 140AA9DE8: using guessed type wchar_t aDbSpelleffectt[23];
...
// 140C639A0: using guessed type int dword_140C639A0;
// 140C63FC8: using guessed type int dword_140C63FC8;
// 140C643BC: using guessed type int dword_140C643BC;
