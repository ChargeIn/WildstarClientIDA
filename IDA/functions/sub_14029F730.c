...
//----- (000000014029F730) ----------------------------------------------------
__int64 __fastcall sub_14029F730(__int64 a1, int a2)
{
	_DWORD* v5; // rbx
...
LABEL_10:
	...
	v13 = *(int*)(a1 + 32);
	*(_DWORD*)(a1 + 36) = 0;
	_InterlockedExchangeAdd((volatile signed __int32*)(*(_QWORD*)(a1 + 16) + 48 * v13 + 536), a2 - *(_DWORD*)(a1 + 24));
	*(_DWORD*)(a1 + 24) = a2;
	v14 = sub_14029F5D0(a1, 2);
	v15 = 0;
	if (v14 < 0)
		v15 = v14;
	if (*v9 <= 1ui64)
...
// 14029F7CC: variable 'v8' is possibly undefined
