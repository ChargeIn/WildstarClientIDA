//----- (0000000140816B50) ----------------------------------------------------
__int64 __fastcall sub_140816B50(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
	...
	if (v8 && v8 != -14)
		return v8;
	if (v8 == -14)
		qword_140C61098 = 0i64;
	if (qword_140C61098 && dword_140C610A0 != dword_140C60980[v9])
		qword_140C61098 = 0i64;
	if (!qword_140C61098 && v6 && nvapi_QueryInterface)
	{
		qword_140C61098 = nvapi_QueryInterface(3962737742i64);
		dword_140C610A0 = dword_140C60980[v9];
	}
	if (qword_140C61098)
	{
		v5 = (__int64(__fastcall*)(__int64, __int64, __int64, __int64, _QWORD))qword_140C61098;
		v7 = 0i64;
		if (qword_140C60938)
			qword_140C60938(3962737742i64, &v7);
		v8 = v5(a1, a2, a3, a4, v5);
		if (qword_140C60940)
			qword_140C60940(3962737742i64, v7, v8);
		--dword_140C60970[v9];
		return v8;
	}
	else
...
// 140C61098: using guessed type __int64 qword_140C61098;
// 140C610A0: using guessed type int dword_140C610A0;
