...
__int64 sub_1402309E0()
{
	...
	if (qword_140C64718)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"RewardTrack"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\RewardTrack.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140230A7C: variable 'v1' is possibly undefined
// 140A66E18: using guessed type wchar_t *off_140A66E18;
// 140AA2118: using guessed type wchar_t aDbRewardtrackT[19];
// 140AA2140: using guessed type wchar_t aRewardtrack[12];
...
// 140C64118: using guessed type int dword_140C64118;
// 140C64718: using guessed type __int64 qword_140C64718;
// 140C64C34: using guessed type int dword_140C64C34;
