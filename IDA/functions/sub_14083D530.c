...
//----- (000000014083D530) ----------------------------------------------------
__int64 __fastcall sub_14083D530(__int64 a1, __int64 a2, __int64 a3, struct _RTL_CRITICAL_SECTION* a4)
{
	unsigned int v8; // ebx
	unsigned int* v9; // rax
	__int64 v10; // r14
	...
	v14 = (_BYTE*)sub_140869390(v12);
	v13 = (__int64)v14;
	if (v14)
	{
		v8 = sub_140869D80(v14, v10, *(_DWORD*)(a2 + 1));
		if (v8 != 1)
