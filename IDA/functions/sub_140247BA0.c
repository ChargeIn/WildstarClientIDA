...
__int64 sub_140247BA0()
{
	...
	if (qword_140C63C58)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"UnitRace"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\UnitRace.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 140247C3C: variable 'v1' is possibly undefined
// 140A638F8: using guessed type wchar_t *off_140A638F8;
// 140AADD60: using guessed type wchar_t aUnitrace[9];
// 140AADF50: using guessed type wchar_t aDbUnitraceTbl[16];
...
// 140C644AC: using guessed type int dword_140C644AC;
// 140C646D4: using guessed type int dword_140C646D4;
// 140C65018: using guessed type int dword_140C65018;
