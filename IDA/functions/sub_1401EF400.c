...
__int64 sub_1401EF400()
{
	...
	if (qword_140C63860)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Challenge"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Challenge.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 1401EF49C: variable 'v1' is possibly undefined
// 140A5D480: using guessed type wchar_t aDbChallengeTbl[17];
// 140A5D550: using guessed type wchar_t aChallenge[10];
// 140ADED08: using guessed type wchar_t *off_140ADED08;
...
// 140C63E24: using guessed type int dword_140C63E24;
// 140C647FC: using guessed type int dword_140C647FC;
