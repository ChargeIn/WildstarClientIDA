...
//----- (000000014025F560) ----------------------------------------------------
__int64 __fastcall sub_14025F560(__int64 a1, __m128* a2, __m128* a3)
{
	__m128 v3; // xmm0
	__m128 v4; // xmm4
	__m128 v5; // xmm3
	...
	v3 = _mm_shuffle_ps((__m128)a2[1].m128_u32[0], (__m128)a2[1].m128_u32[0], 0);
	v4 = _mm_sub_ps(*a2, v3);
	v5 = _mm_sub_ps(_mm_add_ps(v3, *a2), v4);
