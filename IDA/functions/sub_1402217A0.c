...
__int64 sub_1402217A0()
{
	...
	if (qword_140C64660)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"PathSettlerImprovementGroup"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(
		v2,
		L"DB\\PathSettlerImprovementGroup.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14022183C: variable 'v1' is possibly undefined
// 140A7E438: using guessed type wchar_t *off_140A7E438;
// 140A97E88: using guessed type wchar_t aPathsettlerimp[28];
// 140A98130: using guessed type wchar_t aDbPathsettleri[35];
