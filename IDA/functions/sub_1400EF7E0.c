...
//----- (00000001400EF7E0) ----------------------------------------------------
int** __fastcall sub_1400EF7E0(__int64 a1, int** a2, __int64 a3, __int64 a4, __int64 a5)
{
	int* v8; // rax
	int* v9; // rbx
	__int64 v10; // rax
...
// 1400EF822: variable 'a1' is possibly undefined
