//----- (00000001405AB190) ----------------------------------------------------
_DWORD* __fastcall sub_1405AB190(__int64 a1, _DWORD* a2, unsigned int a3, __m128* a4)
{
	int v8; // r14d
	__int64 v9; // rcx
	__int64 v10; // rax
	...
	v16 = 0;
	sub_1404BCB00((__int64)v26, a1 + 8, 0i64, a3, 0, 0, 0, v8, 6, 0, v22, 0i64, 0);
...
// 1405AB309: variable 'v18' is possibly undefined
// 1405AB190: using guessed type __m256 var_1C0[2];
// 1405AB190: using guessed type double var_180[8];
// 1405AB190: using guessed type __int128 var_140[11];
// 1405AB190: using guessed type int var_250[4];
