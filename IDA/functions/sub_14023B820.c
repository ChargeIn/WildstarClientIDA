...
__int64 sub_14023B820()
{
	...
	if (qword_140C64B98)
		goto LABEL_25;
	if (qword_140C63970 && (unsigned int)sub_1401E84A0(L"Spell4TargetAngle"))
	{
...
LABEL_12:
	...
	v4 = (*(__int64(__fastcall**)(__int64, const wchar_t*))(*(_QWORD*)v2 + 96i64))(v2, L"DB\\Spell4TargetAngle.tbl");
	if (v4 < 0)
	{
		(*(void(__fastcall**)(__int64))(*(_QWORD*)v2 + 8i64))(v2);
		return (unsigned int)v4;
...
// 14023B8BC: variable 'v1' is possibly undefined
// 140AA8478: using guessed type wchar_t aDbSpell4target[25];
// 140AA84B0: using guessed type wchar_t aSpell4targetan[18];
// 140AD02C0: using guessed type wchar_t *off_140AD02C0;
...
// 140C64950: using guessed type int dword_140C64950;
// 140C64B20: using guessed type int dword_140C64B20;
