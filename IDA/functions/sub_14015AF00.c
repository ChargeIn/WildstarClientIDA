...
//----- (000000014015AF00) ----------------------------------------------------
void __fastcall sub_14015AF00(_QWORD* a1)
{
	__int64 v2; // rdx
	__int64 v3; // rbx
	__int64 v4; // rax
	...
	sub_1400569B0((__int64)a1, (unsigned __int64*)"Apollo.Menu");
	v2 = a1[2];
	...
	*(_DWORD*)(v2 + 8) = *(_DWORD*)(v2 - 8);
	...
	a1[2] = v6 - 16;
	sub_140057020(a1, "Menu", &off_140C57C90);
	a1[2] -= 16i64;
}
// 14015B013: variable 'v14' is possibly undefined
// 140C57C20: using guessed type char *off_140C57C20;
// 140C57C90: using guessed type void *off_140C57C90;
