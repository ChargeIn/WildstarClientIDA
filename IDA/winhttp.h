...
BOOL WinHttpCreateUrl(LPURL_COMPONENTS,DWORD,LPWSTR,LPDWORD);
...
BOOL WinHttpQueryAuthParams(HINTERNET,DWORD,LPVOID*);
...
BOOL WinHttpTimeFromSystemTime(const SYSTEMTIME *,LPWSTR);
BOOL WinHttpTimeToSystemTime(LPCWSTR,SYSTEMTIME*);
